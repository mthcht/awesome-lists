...
urls =  {'https://raw.githubusercontent.com/0xDanielLopez/TweetFeed/master/year.csv': 'all',
        ...
        'https://blocklistproject.github.io/Lists/alt-version/phishing-nl.txt': 'abc',
        'https://blocklistproject.github.io/Lists/alt-version/malware-nl.txt': 'abc',
        'https://blocklistproject.github.io/Lists/alt-version/fraud-nl.txt': 'abc',
        'https://blocklistproject.github.io/Lists/alt-version/scam-nl.txt': 'abc',
        'https://blocklistproject.github.io/Lists/alt-version/torrent-nl.txt': 'abc',
        ...
        'https://malware-filter.gitlab.io/malware-filter/pup-filter-domains.txt': 'domain',
        'https://raw.githubusercontent.com/bigdargon/hostsVN/master/extensions/threat/hosts': 'abc',
        ...
        'https://raw.githubusercontent.com/KitsapCreator/pihole-blocklists/master/malware-malicious.txt': 'abc',
        'https://raw.githubusercontent.com/KitsapCreator/pihole-blocklists/master/scam-spam.txt': 'abc',
        'https://raw.githubusercontent.com/hagezi/dns-blocklists/main/domains/fake.txt': 'abc',
        'https://www.openphish.com/feed.txt': 'abc',
