...
rule Trojan_Win64_Dacic_MK_2147966029_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Dacic.MK!MTB"
        threat_id = "2147966029"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Dacic"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {4d 09 c3 4d 09 de 48 b9 ?? ?? ?? ?? ?? ?? ?? ?? 4c 31 f1 49 c1 e7 ?? 48 c1 e3 ?? 4c 09 fb 49 c1 e4 ?? 49 09 dc 49 c1 e1 ?? 4d 09 e1 c1 e7 18}  //weight: 20, accuracy: Low
        $x_15_2 = {48 09 ca 49 c1 e2 ?? 49 09 d2 48 c1 e5 ?? 4c 09 d5 41 c1 e3 ?? 49 09 eb 44 0f b6 94 24 ?? ?? ?? ?? 41 c1 e0 ?? 4d 09 d8 0f b6 94 24}  //weight: 15, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Dacic_AHA_2147967062_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Dacic.AHA!MTB"
        threat_id = "2147967062"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Dacic"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {48 8b 45 10 41 8b c8 48 03 c8 48 33 ce 48 89 4d 08 48 8b 45 08 48 8b 4d 08 a8 ?? 75}  //weight: 30, accuracy: Low
        $x_20_2 = {49 0f af ca 49 8b c1 49 33 cb 48 89 4d 20 48 8b 4d 20 48 f7 e1 48 8b c1 48 2b c2 48 d1}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Dacic_YBG_2147971934_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Dacic.YBG!MTB"
        threat_id = "2147971934"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Dacic"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = {c1 e1 0d 33 c8 8b d1 c1 ea 11 33 d1 8b c2 c1 e0 05 33 c2 8b c8 c1 e9 08 32 c8 41 30 09 49 ff c1 49 83 ea 01 75 d8}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Dacic_GVD_2147977332_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Dacic.GVD!MTB"
        threat_id = "2147977332"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Dacic"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "aim.silent_method" ascii //weight: 2
        $x_2_2 = "esp.bot_box_color" ascii //weight: 2
        $x_2_3 = "esp.loot_ammo" ascii //weight: 2
        $x_2_4 = "killfx.enabled" ascii //weight: 2
        $x_2_5 = "raycast" ascii //weight: 2
        $x_2_6 = "world.fog" ascii //weight: 2
        $x_2_7 = "TextChatService" ascii //weight: 2
        $x_2_8 = "CurrentCamera" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (4 of ($x*))
}
...
rule Trojan_Win64_Dacic_KK_2147978330_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {b8 1f 85 eb 51 4d 8b c2 f7 e1 49 83 ea 04 c1 ea 05 6b c2 64 2b c8 8b c1 8b ca 41 8b 04 81 41 89 02 41 3b d7}  //weight: 20, accuracy: High
        $x_10_2 = {0f b6 0c 02 41 32 0c 01 48 ff c0 44 0a d1 49 3b c0}  //weight: 10, accuracy: High
        $x_5_3 = "nkbihfbeogaeaoehlefnkodbefgpgknn" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
