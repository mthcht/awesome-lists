...
rule Trojan_Win64_Rhadamanthys_GVD_2147953149_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.GVD!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {48 8b 55 d8 48 8b 45 f8 48 01 d0 0f b6 10 48 8b 4d d8 48 8b 45 f8 48 01 c8 83 ea 4c 88 10 48 83 45 f8 01 48 8b 45 f8 48 3b 45 d0 72 d3}  //weight: 2, accuracy: High
        $x_1_2 = {48 8b 55 d8 48 8b 45 f0 48 01 d0 0f b6 10 48 8b 4d d8 48 8b 45 f0 48 01 c8 83 f2 39 88 10 4d 8d 6d}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Rhadamanthys_RR_2147957705_3
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {48 8b 55 f0 48 8b 45 f8 48 01 d0 44 0f b6 00 b9 00 01 00 00 48 8b 45 f8 ba 00 00 00 00 48 f7 f1 48 8d [0-6] 0f b6 0c 02 48 8b 55 f0 48 8b 45 f8 48 01 d0 44 89 c2 31 ca 88 10}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Rhadamanthys_RR_2147957705_4
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {48 8b 55 f0 48 8b 45 f8 48 01 d0 44 0f b6 00 b9 00 01 00 00 48 8b 45 f8 ba 00 00 00 00 48 f7 f1 48 8d 05 58 54 00 00 0f b6 0c 02 48 8b 55 f0 48 8b 45 f8 48 01 d0 44 89 c2 31 ca 88 10 48 83 45 f8 01}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Rhadamanthys_KK_2147957797_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.KK!MTB"
        threat_id = "2147957797"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {31 c9 ff d6 [0-5] 4d 8d 00 4d 8d 00 83 eb 01 75}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Rhadamanthys_GXV_2147960129_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.GXV!MTB"
        threat_id = "2147960129"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {45 89 ca 41 f7 d2 45 0f af d1 41 83 e2 01 41 0f 94 c1 41 83 f8 0a 41 0f 9c c3 45 08 cb}  //weight: 5, accuracy: High
        $x_5_2 = {41 20 d8 45 08 d0 45 30 c8 41 80 f0 ?? 44 88 04 01}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NRQ_2147960136_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NRQ!MTB"
        threat_id = "2147960136"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = "BCryptDecrypt" ascii //weight: 1
        $x_1_2 = {69 c0 6d 4e c6 41 b9 cd cc cc cc 05 39 30 00 00 25 ff ff ff 7f 89}  //weight: 1, accuracy: High
        $x_2_3 = {89 c2 48 8d 05 ?? ?? ?? ?? 31 c1 89 c8 31 d0 eb}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NRV_2147960266_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NRV!MTB"
        threat_id = "2147960266"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {48 01 d0 0f b6 08 48 8b 55 20 48 8b 45 f8 48 01 d0 44 89 c2 31 ca 88 10 48 83 45 f8}  //weight: 2, accuracy: High
        $x_3_2 = {89 45 ac 8b 55 98 8b 45 ac 01 d0 89 45 98 8b 55 84 8b 45 98 31 d0 89 45 84 8b 45 84}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NRW_2147960303_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NRW!MTB"
        threat_id = "2147960303"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 01 d0 44 89 c2 31 ca 88 10 48 83 45 f8 01}  //weight: 2, accuracy: High
        $x_3_2 = {44 89 f2 4c 8b 44 24 30 4c 8b 54 24 28 48 89 c1 48 8d 05 ?? ?? ?? ?? 4c 8b 4c 24 20 31 c2 89 d0 48 8b 54 24 38 31 c8}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NSA_2147960815_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NSA!MTB"
        threat_id = "2147960815"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {89 d9 4c 8b 44 24 30 48 89 c2 48 8d 05 ?? ?? ?? ?? 31 c1 89 c8 31 d0 eb 85}  //weight: 3, accuracy: Low
        $x_2_2 = {48 69 c9 1f 85 eb 51 48 c1 e9 ?? 6b c9 ?? 29 c8 8d 4c 07}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NSE_2147960897_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NSE!MTB"
        threat_id = "2147960897"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {89 f1 48 89 c2 48 8d 05 ?? ?? 00 00 31 c1 89 c8 31 d0 eb}  //weight: 3, accuracy: Low
        $x_2_2 = {48 0f af d1 48 c1 ea 24 8d 14 92 c1 e2 02 29 d0 83 f8 13}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NSH_2147961172_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NSH!MTB"
        threat_id = "2147961172"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {25 ff ff ff 7f 31 d2 89 05 ?? ?? 00 00 41 f7 f0 89 d0 48 83 c4 38}  //weight: 2, accuracy: Low
        $x_3_2 = {48 89 c1 48 8d 05 ?? ?? 00 00 44 89 ca c1 e8 04 c1 e2 05 44 29 ca 01 c2 89 c8 c1 e0 04 01 c1}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_AHE_2147961489_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.AHE!MTB"
        threat_id = "2147961489"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {f2 0f 59 f1 [0-8] 4d [0-11] 41 5c [0-3] 83 e8 01 75 e4}  //weight: 30, accuracy: Low
        $x_20_2 = {48 8b 45 d8 [0-4] 48 01 d0 0f b6 10 48 8b 4d 98 48 8b 45 ?? 48 01 c8 83 f2}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NSJ_2147961594_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NSJ!MTB"
        threat_id = "2147961594"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {c1 e2 05 31 d0 89 05 ?? ?? 00 00 48 8d 1b 48 89 e4 48 c1 e8 1c 83 f8 0e}  //weight: 2, accuracy: Low
        $x_3_2 = {89 c2 c1 e2 0d 31 d0 89 c2 c1 ea 11 31 d0 4d}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NSO_2147961595_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NSO!MTB"
        threat_id = "2147961595"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {89 c0 48 6b c0 64 48 c1 e8 20 8d 54 05 64}  //weight: 2, accuracy: High
        $x_3_2 = {89 c0 48 c1 e8 1c 83 f8 0e 0f 87}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Rhadamanthys_RRX_2147961959_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.RRX!MTB"
        threat_id = "2147961959"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {0f b6 0c 02 48 8b 55 f0 48 8b 45 f8 48 01 d0 44 89 c2 31 ca 88 10 48 83 45 f8 01}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NTB_2147962264_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTB!MTB"
        threat_id = "2147962264"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {b8 00 00 b9 ?? 00 00 00 ff d6 b9 ?? 00 00 00 ff d6 b9 ?? 00 00 00 ff d6 b9 ?? 00 00 00 ff d6 b9}  //weight: 2, accuracy: Low
        $x_3_2 = {48 69 c0 e8 03 00 00 48 8b 8c 24 ?? 00 00 00 48 89 c2 48 09 ca 48 c1 ea 20}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NTD_2147962301_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTD!MTB"
        threat_id = "2147962301"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {8d 00 00 b9 ?? 00 00 00 ff d6 b9 ?? 00 00 00 ff d6 b9 ?? 00 00 00 ff d6 b9 ?? 00 00 00 ff d6 b9}  //weight: 2, accuracy: Low
        $x_3_2 = {48 69 c0 e8 03 00 00 48 8b ?? ?? ?? 48 89 c2 48 09 ca 48 c1 ea 20 75 ?? 31 d2 f7 f1 48 3d}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NTF_2147962392_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTF!MTB"
        threat_id = "2147962392"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {b9 64 00 00 00 ff d6 b9 64 00 00 00 ff d6 b9 64 00 00 00 ff d6 b9}  //weight: 2, accuracy: High
        $x_3_2 = {48 69 c0 e8 03 00 00 48 8b ?? ?? ?? 48 89 c2 48 09 ca 48 c1 ea 20 75 ?? 31 d2 f7 f1 48 3d}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
...
rule Trojan_Win64_Rhadamanthys_NTH_2147962514_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTH!MTB"
        threat_id = "2147962514"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {66 44 0f df ee 66 44 0f eb ea 66 0f db f8 66 0f eb fd 66 0f 6f d7}  //weight: 2, accuracy: High
        $x_3_2 = {66 41 0f db d7 66 45 0f fc dc 66 45 0f db ef 66 45 0f df fb 66 45 0f eb fd 66 0f db c2 66 41 0f df d7 66 0f eb c2}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NTK_2147962651_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTK!MTB"
        threat_id = "2147962651"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
    ...
    strings:
        ...
        $x_1_2 = {0f b6 44 24 ?? 88 41 07 0f b6 44 24 08 88 41 ?? 0f b6 44 24 ?? 88 41 09 0f b6 44 24}  //weight: 1, accuracy: Low
        $x_3_3 = {45 31 c9 ff d3 48 89 c7 31 c9 ba ?? 00 00 00 45 31 c0 45 31 c9 ff d3 48 89 c3 48 85 ff 0f 95 c0 48 85 db 0f 95 c1 20 c1}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NTM_2147962749_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTM!MTB"
        threat_id = "2147962749"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
...
rule Trojan_Win64_Rhadamanthys_NTT_2147963449_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTT!MTB"
        threat_id = "2147963449"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {31 c2 48 8b 45 10 89 10 8b 55 ec 8b 45 f4 31 c2 48 8b 45 18 89 10 8b 55 e8 8b 45 f4 31 c2 48 8b 45 20 89 10 8b 55 e4 8b 45 f4 31 c2}  //weight: 2, accuracy: High
        $x_3_2 = {89 45 a4 8b 55 94 8b 45 a4 01 d0 89 45 94 8b 55 84 8b 45 94 31 d0 89 45 84 8b 45 84}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NTU_2147963469_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTU!MTB"
        threat_id = "2147963469"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {48 b9 cf f7 53 e3 a5 9b c4 20 48 f7 e9 48 89 d6 48 89 d0 48 c1 e8 3f 48 c1 fe 07 48 01 c6}  //weight: 1, accuracy: High
        $x_1_2 = {56 57 48 83 ec 28 89 ce 31 c9 ba 01 00 00 00 45 31 c0 45 31 c9}  //weight: 1, accuracy: High
        $x_3_3 = {0f b6 44 24 2b c1 e0 04 0f b6 4c 24 2a 09 c8 48 8b 4c 24 48}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NTY_2147963606_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTY!MTB"
        threat_id = "2147963606"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
    ...
    strings:
        $x_1_1 = {48 b9 cf f7 53 e3 a5 9b c4 20 48 f7 e9 48 89 d6 48 89 d0 48 c1 e8 3f 48 c1 fe 07 48 01 c6}  //weight: 1, accuracy: High
        $x_1_2 = {56 57 48 83 ec 28 89 ce 31 c9 ba 01 00 00 00 45 31 c0 45 31 c9}  //weight: 1, accuracy: High
        $x_3_3 = {0f b6 44 24 ?? c1 e0 04 0f b6 4c 24 ?? 09 c8 48 8b 4c 24}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NUB_2147963911_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NUB!MTB"
        threat_id = "2147963911"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {48 b8 b7 98 63 bb a6 ba 79 01 4c 89 c2 48 c1 ea 04 48 f7 e2 48 d1 ea 48 69 c2 b0 15 00 00 4c 89 c2 48 29 c2 48 83 fa 07}  //weight: 3, accuracy: High
        $x_2_2 = {48 ba 62 00 63 00 72 00 79 00 c7 44 24 30 14 00 16 00 48 89 54 24 40 4c 8d 44 24 30 48 ba 70 00 74 00 2e 00 64 00}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_CP_2147963928_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.CP!MTB"
        threat_id = "2147963928"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 f7 f1 48 8d 05 ?? ?? ?? ?? 0f b6 0c 02 48 8b 55 ?? 48 8b 45 ?? 48 01 d0 44 89 c2 31 ca 88 10}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NSY_2147963956_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NSY!MTB"
        threat_id = "2147963956"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {4c 0f 43 c2 45 89 c0 45 0f b6 04 08 44 30 44 04 ?? 48 8d 04 ?? 48 ff c0 eb}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NTS_2147963957_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTS!MTB"
        threat_id = "2147963957"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {48 b9 cf f7 53 e3 a5 9b c4 20 48 f7 e9 48 89 d6 48 89 d0 48 c1 e8 3f 48 c1 fe 07 48 01 c6 48 03 74 24}  //weight: 2, accuracy: High
        $x_3_2 = {48 83 ec 28 89 ce 31 c9 ba 01 00 00 00 45 31 c0 45 31 c9}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NUC_2147964520_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NUC!MTB"
        threat_id = "2147964520"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0f b7 08 81 f1 62 36 00 00 0f b6 40 02 83 f0 34 66 09}  //weight: 1, accuracy: High
        $x_3_2 = {4c 89 df 4c 31 c7 4c 89 cb 48 29 fb 4c 09 db 4d ?? ?? ?? 4d 31 c3 4c 89 cf 4c 29 df 4c 09 df 48 21 d3 48 21 fb}  //weight: 3, accuracy: Low
        $x_1_3 = {0f b7 08 81 f1 62 69 00 00 0f b6 50 02 83 f2 6e 66 09}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NSX_2147964738_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NSX!MTB"
        threat_id = "2147964738"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {4c 0f 43 c2 45 89 c0 45 0f b6 04 08 44 30 84 04 ?? ?? 00 00 48 8d 04 ?? 48 ff c0 eb ad}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NTZ_2147964739_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NTZ!MTB"
        threat_id = "2147964739"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {48 b9 cf f7 53 e3 a5 9b c4 20 48 f7 e9 48 89 d6 48 89 d0 48 c1 e8 3f 48 c1 fe}  //weight: 3, accuracy: High
        $x_2_2 = {56 57 48 83 ec 28 89 ce 31 c9 ba 01 00 00 00 45 31 c0 45 31 c9}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rhadamanthys_NUH_2147965236_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rhadamanthys.NUH!MTB"
        threat_id = "2147965236"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rhadamanthys"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {41 8d 45 01 41 0f af c5 0f af 05 08 e9 0f 00 41 89 c0 41 c1 e8 1f 41 01 c0 41 d1 f8 48 8d 15 b8 e2 0e 00 b9 1b 00 00 00 41 b9 6a c6 00 00}  //weight: 2, accuracy: High
        $x_1_2 = {8b 4c 24 3c 48 c1 e1 20 89 c2 48 09 ca 48 89 16 31 db 83 f8 ff}  //weight: 1, accuracy: High
        $x_1_3 = {41 80 f1 2a 0f b6 51 03 41 89 d2 41 80 f2 2f b8 04 00 00 00 45 08 ca}  //weight: 1, accuracy: High
        $x_1_4 = {80 f2 2a 44 0f b6 0c 01 45 89 ca 41 80 f2 2f 48 ff c0 41 08 d2 44 89 ca}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
