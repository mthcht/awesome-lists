...
rule Trojan_Win64_BumbleBee_GVA_2147938147_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/BumbleBee.GVA!MTB"
        threat_id = "2147938147"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "BumbleBee"
        severity = "Critical"
...
rule Trojan_Win64_BumbleBee_GLA_2147941611_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/BumbleBee.GLA!MTB"
        threat_id = "2147941611"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "BumbleBee"
        severity = "Critical"
...
rule Trojan_Win64_BumbleBee_KG_2147966671_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/BumbleBee.KG!MTB"
        threat_id = "2147966671"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "BumbleBee"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {48 8b e8 49 11 97 ?? ?? ?? ?? 49 bb ?? ?? ?? ?? ?? ?? ?? ?? 49 8b b7 ?? ?? ?? ?? 4d 8b 97 ?? ?? ?? ?? 49 81 8f ?? ?? ?? ?? ?? ?? ?? ?? 49 81 bf ?? ?? ?? ?? ?? ?? ?? ?? 49 89 a7 ?? ?? ?? ?? 45 31 9c 8f ?? ?? ?? ?? 41 80 af ?? ?? ?? ?? ?? 48 81 c8 ?? ?? ?? ?? 49 83 d0 ?? 49 83 d0 ?? 49 83 d1 ?? 49 81 c3 ?? ?? ?? ?? 48 81 ed ?? ?? ?? ?? 49 81 bf ?? ?? ?? ?? ?? ?? ?? ?? 49 23 9f ?? ?? ?? ?? 48 81 c1 ?? ?? ?? ?? 48 81 e0 ?? ?? ?? ?? 49 89 9f}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
