...
rule Trojan_Win64_Filecoder_PGFR_2147973683_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Filecoder_LRC_2147973720_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Filecoder.LRC!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {40 8a cd 32 0c 30 ff c2 41 88 08 49 ff c0 3b d3}  //weight: 20, accuracy: High
        $x_10_2 = {88 45 93 8a 44 24 50 34 67 88 45 94 8a 44 24 50 34 63 88 45 95 8a 44 24 50 34 39 88 45 96 8a 44 24 50 34 73}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
