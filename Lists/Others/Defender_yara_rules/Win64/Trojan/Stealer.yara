...
rule Trojan_Win64_Stealer_NVB_2147967171_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Stealer.NVB!MTB"
        threat_id = "2147967171"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Stealer"
        severity = "Critical"
    ...
    strings:
        $x_1_1 = "REMUS" ascii //weight: 1
        $x_1_2 = "GetClientRect" ascii //weight: 1
        $x_1_3 = "GetClipboardData" ascii //weight: 1
        $x_1_4 = "OpenClipboard" ascii //weight: 1
        $x_1_5 = "GetComputerNameA" ascii //weight: 1
        $x_2_6 = {41 81 e0 b1 79 37 9e 0d b1 79 37 9e 41 0f af c0 41 81 f0 b1 79 37 1e 44 0f af c2}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Stealer_NVC_2147967190_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Stealer.NVC!MTB"
        threat_id = "2147967190"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Stealer"
        severity = "Critical"
    ...
    strings:
        ...
        $x_2_2 = {81 e2 4e 86 c8 61 41 89 c1 41 81 e1 b1 79 37 9e 0d b1 79 37 9e 41 0f af c1 41 81 f1 b1 79 37 1e}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Stealer_NVE_2147967461_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Stealer.NVE!MTB"
        threat_id = "2147967461"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Stealer"
        severity = "Critical"
    ...
    strings:
        ...
        $x_1_3 = "OpenClipboard" ascii //weight: 1
        $x_1_4 = "GetComputerNameA" ascii //weight: 1
        $x_2_5 = {41 81 f0 b1 79 37 1e 41 81 e1 4e 86 c8 61}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Stealer_NVH_2147967833_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Stealer.NVH!MTB"
        threat_id = "2147967833"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Stealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {66 33 54 4c 30 8b 4c 24 2c 48 63 c9 66 89 54 4c 30 ff 44 24 2c 8b 4c 24 2c 83 f9 0c}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Stealer_BAB_2147972964_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Stealer.BAB!MTB"
        threat_id = "2147972964"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Stealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {48 8b 04 24 4c 03 c1 4c 03 c2 41 80 e8 0f 44 88 44 04 10 48 8b 04 24 48 ff c0 48 89 04 24 48 8b 04 24 48 83 f8 1d 72}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Stealer_NYA_2147973258_0
{
    meta:
        author = "defender2yara"
