...
rule Trojan_Win64_Sliver_K_2147971928_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Sliver.K!AMTB"
        threat_id = "2147971928"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Sliver"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = ".GetActiveC2" ascii //weight: 1
        $x_1_2 = ".GetMAC" ascii //weight: 1
