...
rule Trojan_Win64_Mikey_NM_2147903218_0
{
    ...
    strings:
        $x_2_1 = {48 85 c0 0f 84 59 01 00 00 48 8d 7d c8 48 8b 8d c8 05 00 00 48 89 0f 4c 89 6f 08 48 89 47 10 48 89 c1}  //weight: 2, accuracy: High
        $x_1_2 = {45 31 ff 4c 89 bd b8 04 00 00 48 89 85 c0 04 00 00 48 83 a5 c8 04 00 00 00 49 8d 87 00 04 00 00 89 c1 81 e1 ff 1f 00 00 4c 89 fa 48 29 ca 48 81 c2 00 24 00 00 48 39 c2 41 b8 00 20 00 00 4c 0f 43 c2 48 85 c9 4c 0f 44 c0 4c 89 85 00 06 00 00}  //weight: 1, accuracy: High
...
rule Trojan_Win64_Mikey_NM_2147903218_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.NM!MTB"
...
rule Trojan_Win64_Mikey_GXV_2147960282_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.GXV!MTB"
        threat_id = "2147960282"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {ba 02 16 c2 8e 00 de 1b 93 ?? ?? ?? ?? 30 0f 0b 17 f4 ?? ?? 06 24 e6 bc ?? ?? ?? ?? 09 07 c0 23 d1 fe 83}  //weight: 5, accuracy: Low
        $x_5_2 = {cc 31 62 09 4a 63 22 28 9e ?? ?? ?? ?? 49 ec}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_PAA_2147962093_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.PAA!MTB"
        threat_id = "2147962093"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {0f b6 04 24 48 8b 4c 24 20 0f b6 09 33 c8 8b c1 48 8b 4c 24 20 88 01 0f b6 04 24 48 8b 4c 24 20 0f b6 09 2b c8 8b c1 48 8b 4c 24 20 88 01 48 8b 44 24 20 48 ff c0 48 89 44 24 20}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_GHT_2147962601_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.GHT!MTB"
        threat_id = "2147962601"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {0f af c8 8b 85 ?? ?? ?? ?? 33 c1 89 85 ?? ?? ?? ?? 8b 8d ?? ?? ?? ?? 8b 85 ?? ?? ?? ?? 03 c8 89 8d ?? ?? ?? ?? 8b 8d ?? ?? ?? ?? c1 e9 1d 8b 85 ?? ?? ?? ?? c1 e0 03 0b c1 89 85 ?? ?? ?? ?? 8b 8d ?? ?? ?? ?? 8b 85 ?? ?? ?? ?? 33 c8 89 8d ?? ?? ?? ?? 83 ea 01 ?? ?? f3}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_AH_2147962859_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {41 0f b6 c7 32 04 29 88 01 48 8d 49 ?? 48 83 ea ?? 75}  //weight: 30, accuracy: Low
        $x_20_2 = {f3 0f 6f 4c 01 e0 f3 0f 7f 40 d0 0f 57 ce f3 0f 7f 48 e0 48 3b f2 72}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_AH_2147962859_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.AH!MTB"
...
rule Trojan_Win64_Mikey_AXC_2147963448_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.AXC!MTB"
        threat_id = "2147963448"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {0f b6 4c 04 20 30 0c 03 48 ff c0 48 83 f8 40 72 ef eb 3a}  //weight: 5, accuracy: High
        $x_4_2 = {0f b6 44 0c 20 30 04 0b 48 ff c1 48 3b cf 72 f0}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_LR_2147964559_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.LR!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {49 8b c1 49 f7 e0 48 c1 ea 05 48 8d 04 52 48 c1 e0 04 49 8b d0 48 2b d0 41 0f b6 c0 6b c8 07 80 c1 0d 42 32 0c 12 41 30 0c 28 49 ff c0 4d 3b c7}  //weight: 20, accuracy: High
        $x_10_2 = {bb ff 04 02 00 44 8b d7 49 c1 ea 02 41 83 e2 03 44 8b f3 4c 8d 9e fc 13 08 00 66 0f 1f 44 00 00 ff cb 8b 14 9e 46 8d 04 8d 00 00 00 00 8b c2 c1 e8 05 44 33 c0 41 8b c9 c1 e9 03}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_WD_2147965129_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.WD!MTB"
        threat_id = "2147965129"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {80 34 11 f9 48 ff c1 48 8b 5d a0 48 8b c3 48 8b 55 98 48 2b c2 48 3b c8 72 e6}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_LMM_2147965172_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.LMM!MTB"
        threat_id = "2147965172"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {44 8d 4d ff 44 8b c7 42 8b 14 8b 8b cf 41 c1 e0 02 8b c2 c1 e8 05 44 33 c0 c1 e9 03 8b c2 c1 e0 04 33 c8 8b c5}  //weight: 20, accuracy: High
        $x_10_2 = {41 8b 12 49 03 d1 45 33 c0 8a 02 48 ff c2 41 c1 c8 0e 0f be c0 44 03 c0 8a 02 84 c0}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_LRB_2147965371_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.LRB!MTB"
        threat_id = "2147965371"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {41 8d 49 0c c0 e1 03 41 0f b6 02 33 c8 88 0a 66 45 03 cb 66 44 89 4c 24 38 4d 03 d3 4c 89 14 24 49 03 d3 48 89 54 24 08}  //weight: 10, accuracy: High
        $x_20_2 = {0f b6 c1 4c 33 c8 42 8d 04 11 41 02 c0 24 3f a8 df 74 ?? 49 8b d1 0f b6 c8 48 d3 c2 4c 33 ca 49 ff c0 41 8a 08 84 c9}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_KKA_2147965899_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.KKA!MTB"
        threat_id = "2147965899"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b c6 66 83 f9 01 66 0f 45 c1 0f b7 c8 0f ?? ?? ?? ?? 30 02 66 ff c1 48 8d 52 01 49 83 e8 01}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_MKE_2147966200_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.MKE!MTB"
        threat_id = "2147966200"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {48 63 44 24 ?? 8b 4c 24 ?? 8b 54 24 ?? 03 d1 8b ca 48 63 c9 8a 84 04 ?? ?? ?? ?? 88 84 0c ?? ?? 00 00 8b 44 24 ?? ff c0 89 44 24}  //weight: 30, accuracy: Low
        $x_5_2 = ":Payload" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_MKF_2147967175_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.MKF!MTB"
        threat_id = "2147967175"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {0f b6 d1 4d 8d 49 01 41 0f b6 09 33 d7 44 69 c2 93 01 00 01 41 8b f8 c1 ef 10 41 33 f8 84 c9}  //weight: 20, accuracy: High
        $x_15_2 = {0f b6 c1 4d 8d 40 01 33 c2 69 c8 93 01 00 01 8b d1 c1 ea 10 33 d1 41 0f b6 08 84 c9}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_AMK_2147968445_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.AMK!MTB"
        threat_id = "2147968445"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {b8 c4 26 0c 6f b1 c7 8a 54 24 67 89 44 24 34 88 d0 f6 e1 88 84 24 cf 01 00 00 66 44 8b 44 24 5e 66 41 81 f0 ba 1f 66 44 89 84 24 d2 01 00 00 44 8b 4c 24 34 44 2b 8c 24 ac 01 00 00 44 89 c8 48 81 c4 d8 01 00 00}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_AMK_2147968445_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.AMK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {41 b9 40 00 00 00 4c 8b c6 48 8b d7 49 8b cf ff 15 ?? ?? ?? ?? 85 c0 74 3e 48 c7 44 24 20 00 00 00 00 4c 8b ce 4c 8b 43 08 48 8b d7 49 8b cf ff 15 ?? ?? ?? ?? 48 8d 85 b4 02 00 00 48 89 44 24 20 44 8b 8d b4 02 00 00 4c 8b c6 48 8b d7 49 8b cf}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_LRK_2147970064_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_7_1 = "YOU ARE WELCOME, YOUR COMPUTER IS DONE FOR. GOODBYE." ascii //weight: 7
        ...
        $x_1_7 = "Failed to read own executable." ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_AHD_2147970209_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.AHD!MTB"
        threat_id = "2147970209"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {45 0f 43 e6 45 0f b7 33 45 0f b6 ec 45 31 cd 45 69 cd ?? ?? ?? ?? 66 45 85}  //weight: 30, accuracy: Low
        $x_20_2 = {45 01 e5 45 31 d6 01 cb 41 c1 c6 ?? 41 31 d8 44 01 f5 41 c1 c0 ?? 41 31 ef}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_AHA_2147970288_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.AHA!MTB"
        threat_id = "2147970288"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {8b d0 4d 8d 40 ?? c1 e2 ?? 33 d0 0f b6 c1 41 0f b6 08 03 c2 84 c9 75}  //weight: 30, accuracy: Low
        $x_20_2 = {45 33 c9 42 8b 74 18 ?? 4d 03 d3 42 8b 6c 18 ?? 49 03 f3 42 8b 5c 18 ?? 49 03 eb 85 db 74}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_MKG_2147971190_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.MKG!MTB"
        threat_id = "2147971190"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {45 69 c0 6d 4e c6 41 b8 4f ec c4 4e 41 81 c0 39 30 00 00 41 8b c8 c1 e9 10 f7 e1 c1 ea 04 6b c2 34 2b c8 42 0f b6 04 11 88 44 3c 68 48 ff c7 49 3b f9}  //weight: 20, accuracy: High
        $x_15_2 = {40 32 79 f5 83 e2 03 40 32 71 f6 03 c2 44 8b f0 88 59 03 41 c1 fe 02 83 e0 03 45 0f b6 e0 44 0f b6 cb 44 88 41 04 44 0f b6 d7 40 88 79 05 44 0f b6 de 40 88 71 06 3b c2}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_SPR_2147971431_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.SPR!MTB"
        threat_id = "2147971431"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {48 8b 4c 24 70 48 83 c2 10 41 b9 ?? ?? ?? ?? 4c 89 6c 24 20 ff 15 ?? ?? ?? ?? 42 8b 44 27 28 48 8d 55 00 48 03 44 24 58}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_LRI_2147972421_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.LRI!MTB"
        threat_id = "2147972421"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
...
rule Trojan_Win64_Mikey_SNO_2147973579_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Mikey_PAHX_2147973597_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {8b 04 24 ff c0 89 04 24 8b 44 24 30 39 04 24 7d 1e 48 63 04 24 48 8b 4c 24 28 0f b6 04 01 83 f0 37 48 63 0c 24 48 8b 54 24 20 88 04 0a}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_SXL_2147973761_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = "\\SystemBin\\rat_debug.log" ascii //weight: 30
        $x_20_2 = "rat.dr4k-vault.workers.dev" ascii //weight: 20
        $x_10_3 = "X-Stealer-Upload: true" ascii //weight: 10
        $x_5_4 = "inforstealer" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_SXO_2147975796_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.SXO!MTB"
        threat_id = "2147975796"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {41 03 d5 48 8d 04 96 42 8b 0c 00 49 03 c8 41 bb ?? ?? ?? ?? 8a 01 84 c0 74 23 48 ff c1 0f b6 c0 41 33 c3 44 69 d8 43 01 00 00 8a 01 84 c0 75 ea}  //weight: 30, accuracy: Low
        $x_10_2 = {48 8b 45 00 48 89 45 ?? 48 b8 ?? ?? ?? ?? ?? ?? ?? ?? 48 89 45 00 48 8b 45 00 48 89 45 [0-4] 48 8d 0d ?? ?? ?? ?? f3 0f 6f 8c 08 ?? ?? ?? ?? f3 0f 6f 44 05 ?? 0f 57 c8 f3 0f 7f 4c 05 ?? 48 83 c0 10 48 83 f8 20 7c de}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Mikey_A_2147978309_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.A!MTB"
        threat_id = "2147978309"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {49 8b c8 49 8b c3 48 d3 e8 49 83 e8 04 83 e0 0f 8a 04 18 88 02 48 ff c2 49 83 e9 01 75 e2}  //weight: 10, accuracy: High
        $x_3_2 = {48 8b d7 48 8b cb ff 15 ?? ?? ?? ?? 4c 8d 8c ?? ?? ?? ?? 00 48 c7 44 ?? ?? 00 00 00 00 41 b8 02 00 00 00 48 8d 15 ?? ?? ?? ?? 48 8b cb ff 15}  //weight: 3, accuracy: Low
        $x_2_3 = {48 63 4f 3c 48 03 cf 81 39 50 45 00 00}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Mikey_AL_2147978438_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Mikey.AL!MTB"
        threat_id = "2147978438"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Mikey"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {44 32 04 01 45 88 01 49 ff c1 49 83 eb 01 75}  //weight: 5, accuracy: High
        $x_5_2 = {42 8a 04 02 41 88 00 49 ff c0 48 83 e9 01}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
