...
rule Trojan_Win64_ShellcodeLoader_LR_2147964560_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ShellcodeLoader.LR!MTB"
        threat_id = "2147964560"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ShellcodeLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {34 15 41 88 03 49 ff c3 41 8a 03 84 c0}  //weight: 20, accuracy: High
        $x_10_2 = {48 83 ec 50 48 8d 45 20 c7 45 20 75 00 72 00 48 89 45 d8 48 8d 55 d8 48 8d 45 28 c7 45 24 6c 00 00 00 48 89 45 e0 41 b8 04 00 00 00 48 8d 45 18 c7 45 28 6d 00 6f 00 48 89 45 e8 48 8d 45 d0 48 89 45 f0 c7 45 2c 6e 00 00 00 c7 45 18 2e 00 00 00 c7 45 d0 64 00 6c 00 c7 45 d4 6c 00 00 00}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ShellcodeLoader_RR_2147966533_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ShellcodeLoader.RR!MTB"
        threat_id = "2147966533"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ShellcodeLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {8b 0b 8b c1 83 e1 3f c1 f8 06 6b f1 38 8b 4d 14 c1 e9 10 8b 14 85 80 90 4d 00 32 4c 32 2d 80 e1 01 30 4c 32 2d f6 45 f4 48 75}  //weight: 1, accuracy: High
        $x_1_2 = "cnsezstezxod" ascii //weight: 1
        $x_1_3 = "aqyevidgmianjqbiwdjpfdtra" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ShellcodeLoader_AHA_2147967543_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ShellcodeLoader.AHA!MTB"
        threat_id = "2147967543"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ShellcodeLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {44 0f b6 c0 48 8b 44 24 10 48 8b 4c 24 08 0f b6 14 08 44 31 c2 88 14 08 44 0f b6 44 24 27 48 8b 44 24 10 48 8b 4c 24 08 0f b6 14 08 44 31 c2 88 14 08}  //weight: 30, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ShellcodeLoader_AKP_2147967736_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ShellcodeLoader.AKP!MTB"
        threat_id = "2147967736"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ShellcodeLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Failed to write to mailslot" ascii //weight: 1
        $x_1_2 = "sample_mailslot" ascii //weight: 1
        $x_1_3 = "iorlzupoahui" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
