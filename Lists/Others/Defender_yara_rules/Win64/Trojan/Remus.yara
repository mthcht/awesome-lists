...
rule Trojan_Win64_Remus_NY_2147976974_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Remus.NY!MTB"
        threat_id = "2147976974"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Remus"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {ff 44 24 2c 8b 54 24 2c 69 d2 ?? ?? ?? ?? 66 33 54 4c 30 66 89 54 4c 30 8b 4c 24 2c 83 f9 0e}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Remus_KK_2147977266_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {48 c7 00 ce 02 00 00 48 c7 40 08 df 02 00 00 48 c7 40 10 ed 02 00 00 48 c7 40 18 fb 02 00 00 48 c7 40 20 0a 03 00 00}  //weight: 20, accuracy: High
        $x_10_2 = {48 c7 00 24 03 00 00 48 c7 40 08 30 03 00 00 48 c7 40 10 3d 03 00 00 48 c7 40 18 49 03 00 00 48 c7 40 20 55 03 00 00}  //weight: 10, accuracy: High
        $x_5_3 = {48 c1 e0 04 48 89 bc 04 f0 0a 00 00 48 89 8c 04 e8 0a 00 00 49 8d 42 01}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Remus_PR_2147977561_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Remus.PR!MTB"
        threat_id = "2147977561"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Remus"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {83 e3 3f 0f b6 c0 41 0f b6 4c 0d 00 44 30 d1 48 8d 15 ?? ?? ?? ?? 32 0c 13 32 0c 28 44 30 f1 0f b6 c1 0f b6 04 28 8d 48 01 d2 c0 88 07 49 83 c1 03 48 ff c7 41 80 c2}  //weight: 5, accuracy: Low
        $x_3_2 = {89 f2 44 31 ca 8d 14 52 83 c2 0b 83 e2 3f 42 02 04 3a 30 d8 d2 c0 41 88 04 36 48 ff c6 45 01 d0}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Remus_AA_2147977890_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Remus.AA!MTB"
        threat_id = "2147977890"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Remus"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_11_1 = {44 8a 0c 11 41 30 c1 45 0f b6 c9 c1 e8 08 43 33 04 88 48 ff c2 48 81 fa}  //weight: 11, accuracy: High
        $x_9_2 = {45 89 ca 45 89 cb 41 d1 eb 45 89 d9 41 81 f1 ?? ?? ?? ?? 41 f6 c2 01 45 0f 44 cb 41 ff c8}  //weight: 9, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Remus_MY_2147978577_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Remus.MY!MTB"
        threat_id = "2147978577"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Remus"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "GtcU9bCd0ZwL-Ktpgvp/d5k_xr" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
