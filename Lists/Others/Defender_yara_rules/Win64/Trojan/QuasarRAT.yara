...
rule Trojan_Win64_QuasarRAT_AK_2147963903_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/QuasarRAT.AK!AMTB"
        threat_id = "2147963903"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {8b d1 44 69 c1 ?? ?? ?? ?? 41 81 f0 ?? ?? ?? ?? 44 89 44 96 ?? ff c1 83 f9 ?? 7c e4}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_QuasarRAT_PAA_2147970029_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/QuasarRAT.PAA!MTB"
        threat_id = "2147970029"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {44 0f b6 01 89 d0 83 e0 1f 44 89 c7 41 02 3c 03 89 f8 44 01 c8 44 0f b6 c8 0f b6 c0 44 0f b6 54 04 60 44 88 11 44 88 44 04 60 83 c2 01 48 83 c1 01 81 fa 00 01 00 00 75 c7}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_QuasarRAT_GVE_2147972261_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/QuasarRAT.GVE!MTB"
        threat_id = "2147972261"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {41 8b d2 44 33 5c 91 10 41 8b d7 45 8b c3 41 c1 c0 09 44 89 44 91 10 41 ff c7 41 83 ff 20 7c a8}  //weight: 1, accuracy: High
        $x_1_2 = {46 33 5c 91 10 41 c1 c3 09 44 89 5c 91 10 41 ff c7 41 83 ff 20 7c b4}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
