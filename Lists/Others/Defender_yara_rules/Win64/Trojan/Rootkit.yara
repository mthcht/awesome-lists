...
rule Trojan_Win64_Rootkit_SX_2147963103_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rootkit.SX!MTB"
        threat_id = "2147963103"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rootkit"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {42 0f b7 44 4f ?? 0f b7 f0 0f b7 c8 66 c1 e8 0c 66 83 f8 0a 75 ?? 49 23 f3 4c 01 04 16 eb}  //weight: 20, accuracy: Low
        $x_10_2 = {0f b7 c6 0f b7 fe 48 8d 14 80 0f b7 c1 45 8b 4c d4 ?? 41 2b c6 3b f8 75 ?? 8b 7b 50 eb}  //weight: 10, accuracy: Low
        $x_5_3 = {41 0f b7 c0 66 45 03 c1 48 8d 14 80 41 8b 74 d4 ?? 41 8b 7c d4 ?? 49 03 f6 41 8b 4c d4 ?? 48 03 fd f3 a4 66 44 3b 43}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rootkit_SXA_2147964480_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rootkit.SXA!MTB"
        threat_id = "2147964480"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rootkit"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {41 0f b7 c1 48 8d 0c 80 41 8b 54 ca ?? 45 8b 44 ca ?? 48 03 d3 41 8b 44 ca ?? 4d 03 c6 85 c0 74 ?? 8b c8 0f 1f 40 ?? 66 0f 1f 84}  //weight: 20, accuracy: Low
        $x_10_2 = {48 8b 17 48 85 d2 79 ?? 48 63 46 ?? 0f b7 d2 8b 8c 30 ?? ?? ?? ?? 8b 44 31 ?? 8b 4c 31 ?? 48 2b d0 48 03 ce 8b 04 91 48 03 c6 eb}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rootkit_LR_2147964865_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rootkit.LR!MTB"
        threat_id = "2147964865"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rootkit"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8b 0b 48 8b 43 08 44 89 3c 88 ff 03 41 ff c6 44 3b b5 80 00 00 00}  //weight: 20, accuracy: High
        $x_10_2 = {41 56 41 57 48 8d 6c 24 c0 48 81 ec 40 01 00 00 48 83 64 24 58 00 48 8d 85 80 00 00 00 48 83 64 24 50 00 4c 8b e2 48 83 64 24 48 00 48 8b d9 48 83 64 24 40 00 45 33 c9 48 89 44 24 38 45 33 c0 48 83 64 24 30 00 33 d2 48 83 64 24 28 00 49 8b cc}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Rootkit_KK_2147973188_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Rootkit_KKA_2147973189_0
{
    meta:
        author = "defender2yara"
