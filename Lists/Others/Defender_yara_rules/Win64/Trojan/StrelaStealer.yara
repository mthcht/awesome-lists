...
rule Trojan_Win64_StrelaStealer_GPAM_2147915544_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/StrelaStealer.GPAM!MTB"
        threat_id = "2147915544"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "StrelaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {4c 31 c1 48 09 d0 4c 09 c1 48 35 ff ff ff ff 48 21 c8 48 89 85}  //weight: 4, accuracy: High
        $x_4_2 = {44 21 d1 45 89 c3 41 83 f3 ff 41 81 e3 ?? ?? ?? ?? 45 21 d0 41 09 c9 45 09 c3 45 31 d9}  //weight: 4, accuracy: Low
        $x_4_3 = {48 31 ca 48 89 c1 48 31 d1 48 21 c1}  //weight: 4, accuracy: High
