...
rule Trojan_Win64_ZooFang_D_2147956901_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {42 0f b6 44 3a ?? 34 ?? 0f b6 c8 48 8d 45 ?? 48 83 7d ?? ?? 48 0f 47 45 ?? 66 89 0c 02 42 0f b6 44 3a ?? 34 ?? 0f b6 c8}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ZooFang_D_2147956901_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ZooFang.D!dha"
    ...
    strings:
        ...
        $x_1_3 = {32 0e 0f b6 d1 48 8b c3 48 83 7b ?? 08 72 ?? 48 8b 03 66 89 14 07 48 83 c7 02 48 81 ff ac 00 00 00 72}  //weight: 1, accuracy: Low
        $x_10_4 = "stobject.dll" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (
