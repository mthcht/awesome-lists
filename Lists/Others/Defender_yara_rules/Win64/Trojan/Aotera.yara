...
rule Trojan_Win64_Aotera_C_2147972969_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Aotera.C!MTB"
        threat_id = "2147972969"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Aotera"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {0f b6 09 03 c1 c1 c0 ?? 8b c8 c1 e9 ?? 33 c1 80 3a 00 48 8b ca 75}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Aotera_CA_2147973632_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Aotera_CB_2147975326_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Aotera.CB!MTB"
        threat_id = "2147975326"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Aotera"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {41 8d 04 0c 3b c6 0f 83 ?? ?? ?? ?? 44 8b c0 46 0f b6 54 03 ?? 44 8b c9 47 0f b6 4c 0f ?? 45 33 d1 3b 47 ?? 73 ?? 46 88 54 07 ?? ff c1 3b ca 7c}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Aotera_CZ_2147977129_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Aotera.CZ!MTB"
        threat_id = "2147977129"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Aotera"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {45 0f b6 5c 0f 10 45 33 d3 44 88 54 08 10 41 ff c5 41 83 fd 08 7c e0}  //weight: 10, accuracy: High
        $x_10_2 = {44 8b c0 42 0f b6 54 02 10 30 11 ff c0 83 f8 10 7c da}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
