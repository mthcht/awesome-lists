...
rule Trojan_Win64_Starter_MK_2147967547_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Starter.MK!MTB"
        threat_id = "2147967547"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Starter"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = "exist \"C:\\test\\setup.exe\" start \"\" \"C:\\test\\setup.exe\" /did=757674" ascii //weight: 20
