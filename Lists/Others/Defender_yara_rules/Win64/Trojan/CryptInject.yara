...
rule Trojan_Win64_CryptInject_CM_2147895740_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CryptInject.CM!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "dbseckey=" ascii //weight: 1
        $x_1_2 = "login.aspx" ascii //weight: 1
        $x_1_3 = "USERNAME" ascii //weight: 1
        $x_1_4 = "COMPUTERNAME" ascii //weight: 1
        $x_1_5 = "action=ping&mod=" ascii //weight: 1
        $x_1_6 = "User-Agent:" ascii //weight: 1
        $x_1_7 = "SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CryptInject_CH_2147957123_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CryptInject.CH!MTB"
        threat_id = "2147957123"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CryptInject"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {89 c2 0f b6 45 ?? 22 45 ?? f7 d0 21 d0 88 45 ?? 8b 45 ?? 48 63 d0 48 8b 45 ?? 48 01 c2 0f b6 45 ?? 88 02 83 45 ?? 01 83 45 ?? 01 8b 45 ?? 48 98 48 3b 45 ?? 72}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CryptInject_RR_2147959763_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CryptInject.RR!MTB"
        threat_id = "2147959763"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CryptInject"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "CastelaDLL.dll" ascii //weight: 1
        $x_1_2 = "MinHook DLL" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
