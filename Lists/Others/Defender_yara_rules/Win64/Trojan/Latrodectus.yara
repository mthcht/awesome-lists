...
rule Trojan_Win64_Latrodectus_DL_2147941365_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.DL!MTB"
        threat_id = "2147941365"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {45 29 d3 41 c1 e2 04 45 0f af d8 45 01 da 41 83 c2 08 41 c1 ea 04 41 20 c3 41 88 0c 08 66 41 09 c2 48 ff c1}  //weight: 5, accuracy: High
        $x_5_2 = {48 ff c2 41 30 db 48 81 fa}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Latrodectus_CCJY_2147942321_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.CCJY!MTB"
        threat_id = "2147942321"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_6_1 = {48 8b 44 24 28 48 8b 4c 24 58 48 03 c8 48 8b c1 0f b6 00 48 63 4c 24 20 0f b6 4c 0c 30 33 c1 48 8b 4c 24 28 48 8b 54 24 58 48 03 d1 48 8b ca 88 01 e9}  //weight: 6, accuracy: High
        $x_4_2 = {65 78 74 72 61 00 66 6f 6c 6c 6f 77 65 72 00 72 75 6e 00 73 63 75 62}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Latrodectus_MJV_2147942694_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.MJV!MTB"
        threat_id = "2147942694"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {49 f7 f2 48 83 c2 03 45 8a 5c 15 ?? 66 0f 70 fe 00 66 0f 70 fd 00 66 0f f1 da 66 0f f1 ec 66 0f 70 f7 00 66 0f 70 f3 00 66 0f 70 fe 00 66 0f 70 fc 00 c5 fc 28 c1 c5 fc 28 d3 c4 e2 7d 00 c4 c4 e2 6d 00 d5 c5 e5 73 db ?? c4 e2 7d 40 c3 c4 e2 6d 40 d4 44 30 1c 0f 66 0f 70 fa 00 66 0f e5 d4}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Latrodectus_BJ_2147943542_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.BJ!MTB"
        threat_id = "2147943542"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {66 0f fd c2 44 30 14 0f}  //weight: 2, accuracy: High
        $x_1_2 = {66 0f f9 d0 45 8a 14 11}  //weight: 1, accuracy: High
        $x_1_3 = {66 0f 6f cb 66 0f 6f c3 49 f7 f3}  //weight: 1, accuracy: High
        $x_1_4 = {66 0f 6f c8 48 31 d2}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Latrodectus_MZD_2147944754_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.MZD!MTB"
        threat_id = "2147944754"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {66 0f 6c c2 66 0f 6c d1 66 0f 6f c8 45 8a 14 11 66 0f 6c ca 66 0f f9 d0 66 0f 6f cb 66 0f 6f d8 66 0f 6c d3}  //weight: 5, accuracy: High
        $x_4_2 = {66 0f f9 d0 66 0f f9 cb 44 30 14 0f 66 0f 6a ca 66 0f 6d da 66 0f 38 30 d0 66 0f 61 ca 66 0f 6f c1}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Latrodectus_GVC_2147947266_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.GVC!MTB"
        threat_id = "2147947266"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {66 0f 6f c3 45 8a 14 11 66 0f 6d cf 66 0f 6f cb}  //weight: 2, accuracy: High
        $x_1_2 = {66 0f 6c ca 44 30 14 0f 66 0f 6f c1 66 0f dd e6}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Latrodectus_ZZM_2147948600_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.ZZM!MTB"
        threat_id = "2147948600"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {66 0f 6f cb 66 0f fd c2 49 f7 f3 66 0f 6c d7 66 0f 6f d1}  //weight: 3, accuracy: High
        $x_4_2 = {66 0f 6c ca 66 0f 6f c1 66 0f 6c ca 66 0f fd c1 45 8a 14 11 66 0f 6f cb}  //weight: 4, accuracy: High
        $x_5_3 = {66 0f 38 30 c1 66 0f 6c d3 44 30 14 0f 66 0f 6f c1 66 0f 6c d7}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Latrodectus_CG_2147955102_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.CG!MTB"
        threat_id = "2147955102"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
    ...
    strings:
        ...
        $x_5_2 = {49 f7 f3 66}  //weight: 5, accuracy: High
        $x_5_3 = {45 8a 14 11 66}  //weight: 5, accuracy: High
        ...
        $x_5_7 = {48 81 f9 01 92 01 00 0f 86}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Latrodectus_CH_2147957075_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.CH!MTB"
        threat_id = "2147957075"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
...
rule Trojan_Win64_Latrodectus_RR_2147957540_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.RR!MTB"
        threat_id = "2147957540"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {44 30 14 0f 66}  //weight: 1, accuracy: High
        $x_1_2 = {48 81 f9 01 92 01 00 0f}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Latrodectus_GVD_2147957759_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Latrodectus.GVD!MTB"
        threat_id = "2147957759"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Latrodectus"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {45 8a 14 11}  //weight: 2, accuracy: High
        $x_2_2 = {44 30 14 0f}  //weight: 2, accuracy: High
        $x_1_3 = {48 81 f9 d3 93 01 00 0f 86}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
