...
rule Trojan_Win64_Cerbu_A_2147925122_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {48 89 c1 45 88 1c ?? 48 83 c0 01 44 89 da 48 f7 d1 4c 01 c1 83 e1 ?? 4c 39 c0 73}  //weight: 20, accuracy: Low
        $x_30_2 = {0f b6 00 0f b6 c0 31 45 fc 8b 45 fc 69 c0 ?? ?? ?? ?? 89 45 fc 48 83 45 f0 ?? 48 8b 45 f0 48 83 c0 ?? 48 83 f8 ?? 76}  //weight: 30, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Cerbu_A_2147925122_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Cerbu.A!MTB"
...
rule Trojan_Win64_Cerbu_AHM_2147973722_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Cerbu_C_2147977803_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Cerbu.C!MTB"
        threat_id = "2147977803"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Cerbu"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {8b 44 24 50 69 c8 ?? ?? ?? ?? 8b 44 24 50 81 c1 ?? ?? ?? ?? 33 c1 89 44 24 50 48 83 ea 01 75 6c 6f}  //weight: 30, accuracy: Low
        $x_20_2 = {66 41 89 10 48 8d 40 02 0f b7 ?? ?? ?? ?? 00 00 4d 8d 40 ?? ff c1 66 85 d2 75}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Cerbu_B_2147978152_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = "Send payment via PIX to continue." ascii //weight: 30
        $x_20_2 = "{\"type\":\"device-list\",\"webcams\":" ascii //weight: 20
        $x_10_3 = "mirai_c2_trace.txt" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Cerbu_B_2147978152_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Cerbu.B!MTB"
