...
rule Trojan_Win64_Ulise_A_2147906573_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Ulise.A!MTB"
...
rule Trojan_Win64_Ulise_A_2147906573_2
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {48 8d 44 24 58 0f 57 05 ?? ?? ?? ?? 45 33 c9 f3 0f 7f 44 24 58 c6 44 24 68 5a 33 d2 80 70 10 5a 48 c7 c1 ff ff ff ff 48 8d 44 24 58 41 b8 04 00 00 00 48 89 44 24 28 c7 44 24 20 14 00 00 00 ff 15}  //weight: 30, accuracy: Low
        $x_20_2 = {44 8b c0 4c 03 c7 41 80 38 0f 75 12 8d 48 01 80 3c 0f 05 75 09 8d 48 02 80 3c 0f c3 74 1a}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Ulise_SXB_2147965500_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Ulise.SXB!MTB"
        threat_id = "2147965500"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Ulise"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {0f b6 44 13 ?? 48 8d 5b 01 34 aa 88 44 1d ?? 48 83 e9 01 75 eb}  //weight: 20, accuracy: Low
        $x_10_2 = {0f 57 c8 48 8d 4d ?? f3 0f 6f 05 ?? ?? ?? ?? 66 0f 6f d6 0f 57 d0 f3 0f 7f 55 ?? f3 0f 7f 4d}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Ulise_LR_2147978898_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Ulise.LR!MTB"
        threat_id = "2147978898"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Ulise"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {48 8b c1 83 e0 0f 8a 04 02 30 04 39 48 ff c1 48 3b cb 72 ?? 48 85 ff 74 ?? 80 3f 7b 75 ?? 48 8d 15 9f 28 02 00 48 8b cf}  //weight: 20, accuracy: Low
        $x_10_2 = {41 8b c1 41 8d 49 10 83 e0 0f 41 8a 04 02 41 32 04 0f 42 88 04 0b 41 ff c1 44 3b cf}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
