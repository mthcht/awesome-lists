...
rule Trojan_Win64_QuasarRat_YP_2147964266_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/QuasarRat.YP!MTB"
        threat_id = "2147964266"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "QuasarRat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {48 39 ca 74 3c 4c 8b 04 08 4d 89 c1 49 c1 e9 08 4d 31 c1 49 21 f1 4d 31 c8 49 c1 e1 08 4d 31 c1 4d 89 c8 49 c1 e8 04 4d 31 c8 4d 21 f8 4d 31 c1 49 c1 e0 04 4d 31 c8 4c 89 04 08 48 83 c1 08 eb bf}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_QuasarRat_AH_2147964603_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/QuasarRat.AH!MTB"
        threat_id = "2147964603"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "QuasarRat"
        severity = "Critical"
    ...
    strings:
        $x_30_1 = {48 8d 54 24 30 48 8d 14 82 8b 02 41 0f b6 c9 41 d3 c0 44 33 c0 44 89 02 8b 8d 20 01 00 00}  //weight: 30, accuracy: High
        $x_20_2 = {8b 4c 24 3c 8b 44 24 38 33 c8 89 4c 24 40 8b 4c 24 34 c1 e1 ?? 8b 44 24 30 33 c1}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
