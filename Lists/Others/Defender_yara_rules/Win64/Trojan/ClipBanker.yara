...
rule Trojan_Win64_ClipBanker_NC_2147912886_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.NC!MTB"
        threat_id = "2147912886"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {48 89 08 48 8b 8c 24 b8 00 00 00 48 89 48 08 48 c7 40 10 00 00 00 00 48 c7 40 18 3f 00 0f 00 48 8b 8c 24 b0 00 00 00 48 89 48 20 48 8b 0d 2b bb 0a 00 48 89 c3 bf 05 00 00 00 48 89 c8 48 89 f9}  //weight: 2, accuracy: High
        $x_1_2 = {48 8b 8c 24 c0 00 00 00 48 8b 11 48 89 10 48 8b 94 24 a8 00 00 00 48 89 50 08 48 c7 40 10 00 00 00 00 48 c7 40 18 01 00 00 00 48 8b 94 24 a0 00 00 00 48 89 50 20 48 8b 54 24 38 48 c1 e2 03 48 89 50 28 48 8b 15 a4 ba 0a 00}  //weight: 1, accuracy: High
...
rule Trojan_Win64_ClipBanker_MX_2147954635_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.MX!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "xv-clipper" ascii //weight: 1
        $x_1_2 = "main.getClipAddresses" ascii //weight: 1
        $x_1_3 = "$GetClipboardData" ascii //weight: 1
        $x_1_4 = "runMutexCheck" ascii //weight: 1
        $x_1_5 = "TelegramPayload" ascii //weight: 1
        $x_1_6 = "SendSeedNotification" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_ClipBanker_BMX_2147967442_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.BMX!MTB"
        threat_id = "2147967442"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Clipper - Background Clipboard Monitor" ascii //weight: 1
        $x_1_2 = "ClipperHidden" ascii //weight: 1
        $x_1_3 = "GetClipboardData" ascii //weight: 1
        $x_1_4 = "Start silent monitoring" ascii //weight: 1
        $x_1_5 = "Windows startup" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_ClipBanker_SNJ_2147971982_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.SNJ!MTB"
        threat_id = "2147971982"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {89 c2 31 c0 0f 1f 80 00 00 00 00 66 66 2e 0f 1f 84 00 00 00 00 00 66 66 2e 0f 1f 84 00 00 00 00 00 45 0f b6 0c 02 41 31 d1 44 88 0c 01 48 83 c0 01 49 39 c0 75 eb}  //weight: 2, accuracy: High
        $x_4_2 = {0f b6 44 1d 00 88 04 1e 48 83 c3 01 48 39 df 75 ef 31 c0 48 8d 0d ?? ?? ?? ?? 48 89 c2 83 e2 1f 0f b6 14 11 32 14 06 83 f2 f9 88 14 06 48 83 c0 01 48 39 d8 72 e4}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ClipBanker_MKA_2147972351_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.MKA!MTB"
        threat_id = "2147972351"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = {48 8d 0c 06 48 83 f9 40 72 30 b1 40 28 c1 44 0f b6 f1 4c 8d 7f 18 48 8d 0c 07 48 83 c1 18 48 89 da 4d 89 f0}  //weight: 15, accuracy: High
        $x_10_2 = "Win32_ComputerSystemProduct" ascii //weight: 10
        $x_5_3 = "Win32_DiskDrive" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ClipBanker_NCD_2147972489_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.NCD!MTB"
        threat_id = "2147972489"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = "11e42a38-602b-4be0-b5ec-a8beff66ab97" ascii //weight: 10
        $x_10_2 = "bitcoincash:" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_ClipBanker_SNQ_2147973581_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_ClipBanker_B_2147973835_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = "svchost_task.exeAdd-MpPreference" ascii //weight: 3
        $x_3_2 = "main.getReplacementAddress" ascii //weight: 3
        $x_3_3 = "main.(*WindowsClipboard).processClipboardChange" ascii //weight: 3
        $x_3_4 = "main.(*C2Client).sendTelegramMessage" ascii //weight: 3
        $x_2_5 = "main.listenForAdminCommands" ascii //weight: 2
        $x_2_6 = "main.addToDefenderExclusions" ascii //weight: 2
        $x_2_7 = "main.detectClipAddress" ascii //weight: 2
        $x_1_8 = "fatal error: bcryptprimitives.dll not found" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_ClipBanker_NZB_2147976141_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.NZB!MTB"
        threat_id = "2147976141"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "asynctimerchanCloseClipboardEmptyClipboardRegSetValueExW" ascii //weight: 1
        $x_2_2 = "h48lPFYpsTvQJZF4EKyI4aLHaev3CxivZmv7yZig9pc=" ascii //weight: 2
        $x_1_3 = "EH0zSVneZPSuFR11BlR9YppQTVDbh5+16AmcJi4g1z4=" ascii //weight: 1
        $x_1_4 = "ldflags=\"-H windowsgui -s -w" ascii //weight: 1
        $x_1_5 = "atotto/clipboard.readAll" ascii //weight: 1
        $x_1_6 = "Go build ID:" ascii //weight: 1
        $x_1_7 = "HanLaoMroNkoVaiaesadxshaavxfmanetcgodnstcpudpgcmTEMP.exe.lnktruereadopensyncpipefileStat.com.bat.cmd" ascii //weight: 1
...
rule Trojan_Win64_ClipBanker_AB_2147977039_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.AB!MTB"
        threat_id = "2147977039"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {48 8b c3 83 e0 1f 44 0f b6 8c 30 ?? ?? ?? ?? 44 32 8c 33 ?? ?? ?? ?? 48 3b ca 73 21 48 8d 41 01 48 83 fa 10 48 89 44 24 30 48 8d 44 24 20 49 0f 43 c0 44 88 0c 08}  //weight: 4, accuracy: Low
        $x_1_2 = "Global\\msv78runid-syncx59401" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ClipBanker_AB_2147977039_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.AB!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {48 8b c7 83 e0 1f 46 0f b6 0c 30 44 32 0c 2f 48 8b 4b 10 48 8b 53 18 48 3b ca 73 1f 48 8d 41 01 48 89 43 10 48 8b c3 48 83 fa}  //weight: 5, accuracy: High
        $x_3_2 = "Global\\msv78runid-syncx59401" ascii //weight: 3
        $x_2_3 = "bitcoincash" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ClipBanker_SY_2147977045_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ClipBanker.SY!MTB"
        threat_id = "2147977045"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_6_1 = {4c 8d 35 9a d0 fe ff 4d 8b e1 49 8b e8 4c 8b ea 4b 8b 8c fe 00 c7 02 00 4c 8b 15 2a 51 01 00 48 83 cf ff 41 8b c2 49 8b d2 48 33 d1 83 e0 3f 8a c8 48 d3 ca 48 3b d7 0f 84 5b 01 00 00}  //weight: 6, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
