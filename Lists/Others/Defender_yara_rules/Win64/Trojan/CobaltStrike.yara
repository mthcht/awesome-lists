...
rule Trojan_Win64_CobaltStrike_HP_2147897830_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.HP!MTB"
        threat_id = "2147897830"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {48 89 c2 48 c1 e2 ?? 48 8d 94 0a ?? ?? ?? ?? 83 e1 ?? 49 89 5c d3 ?? ba ?? ?? ?? ?? 48 89 d3 48 d3 e3 89 c1 41 ?? ?? ?? ?? ?? ?? ?? 83 e1 ?? 48 d3 e2 41 09 93 ?? ?? ?? ?? 48 83 c4 ?? 5b c3 48 83 ec ?? 48 89 4c 24}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_CCGY_2147901035_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.CCGY!MTB"
        threat_id = "2147901035"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {48 63 54 81 ?? 81 74 95 ?? ?? ?? ?? ?? 48 63 14 81 81 74 95 ?? ?? ?? ?? ?? 48 83 c0 ?? 48 83 f8}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_U_2147909481_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.U!MTB"
        threat_id = "2147909481"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 8b 07 48 33 01 0f b6 57 ?? 32 51 ?? 0f b6 d2 48 09 c2}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
