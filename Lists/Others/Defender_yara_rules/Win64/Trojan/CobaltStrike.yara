...
rule Trojan_Win64_CobaltStrike_D_2147784792_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {44 8a 14 01 49 89 c3 41 83 e3 ?? 44 89 d2 31 c2 42 32 14 1e 44 31 ca 45 89 d1 88 14 01 48 ff c0 eb}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_D_2147784792_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.D!MTB"
...
rule Trojan_Win64_CobaltStrike_PAB_2147809856_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.PAB!MTB"
        threat_id = "2147809856"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {8b 44 24 1c 44 89 df 83 e8 08 89 44 24 1c 8b 44 24 18 8b 4c 24 1c d3 e8 8b 4c 24 1c 41 88 04 38 b8 ff ff ff ff 8b 7c 24 18 d3 e0 f7 d0 21 f8 41 81 fb ff ff 0f 00 0f 95 c1 89 44 24 18 41 83 c3 01}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_AX_2147810766_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {48 63 d0 49 39 d1 74 18 41 0f b7 14 50 66 31 11 48 83 c1 02 83 c0 01 49 39 ca 75 e4}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_AX_2147810766_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.AX!MTB"
...
rule Trojan_Win64_CobaltStrike_BA_2147810767_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.BA!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {0f b7 02 44 8d 48 bf 44 0f b6 c0 83 c0 20 66 41 83 f9 1a 41 0f 43 c0 48 83 c2 02 0f b7 c0 31 ?? 69 ?? ?? ?? ?? ?? 49 39 d3 75}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_AH_2147812027_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b 44 24 20 83 c8 ?? 89 44 24 20 48 8d 94 24 80 01 00 00 48 8b 4c 24 38 e8 ?? ?? ?? ?? 0f b6 c0}  //weight: 20, accuracy: Low
        $x_30_2 = "VIRT_FIRMWARE=" ascii //weight: 30
        $x_40_3 = "; TpmEnabled=" ascii //weight: 40
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_AH_2147812027_5
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.AH!MTB"
...
rule Trojan_Win64_CobaltStrike_DZ_2147814631_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {ff c0 89 44 24 ?? 8b 44 24 ?? 39 44 24 ?? 73 ?? 6b 44 24 ?? ?? 8b 4c 24 ?? 03 c8 8b c1 33 d2 b9 ?? ?? ?? ?? f7 f1 8b c2}  //weight: 1, accuracy: Low
        $x_1_2 = {0f b6 04 02 33 c1 8b 4c 24 ?? 48 8b 54 24 ?? 88 04 0a 0f b6 04 24 d1 e0 0f b6 0c 24 c1 f9 ?? 0b c1 88 04 24 eb}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_DZ_2147814631_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.DZ!MTB"
...
rule Trojan_Win64_CobaltStrike_PA_2147814817_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.PA!MTB"
        threat_id = "2147814817"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {fc 53 55 56 57 41 54 41 55 41 56 41 57 e8 00 00 00 00 58 48 05 61 03 00 00 48 8b ec 48 83 ec 18 48 89 45 08 e8 11 00 00 00 48 83 c4 18 41 5f 41 5e 41 5d 41 5c 5f 5e 5d 5b c3 50 48 8b 45 08 44}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_C_2147828445_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {f3 42 0f 6f 04 38 0f 57 05 ?? ?? ?? ?? f3 42 0f 7f 04 38 48 83 c0 ?? 48 3b c1 75}  //weight: 20, accuracy: Low
        $x_5_2 = "pipe\\beacon_cmd" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_C_2147828445_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.C!MTB"
...
rule Trojan_Win64_CobaltStrike_E_2147828566_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {44 0f b6 0c 06 44 32 8c 04 ?? ?? ?? ?? 45 88 4c 05 00 48 83 c0 01 49}  //weight: 20, accuracy: Low
        $x_5_2 = ".bmp" ascii //weight: 5
        $x_5_3 = "\\*.lnk" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_E_2147828566_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.E!MTB"
...
rule Trojan_Win64_CobaltStrike_LK_2147830796_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "MZARUH" ascii //weight: 1
        $x_1_2 = "ExecutePayload" ascii //weight: 1
        $x_1_3 = "RunShellcode" ascii //weight: 1
        $x_1_4 = "ExecuteWriteCopy" ascii //weight: 1
        $x_1_5 = "GuardModifierflag" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_LK_2147830796_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.LK!MTB"
...
rule Trojan_Win64_CobaltStrike_BY_2147848671_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {80 34 38 81 83 c0 02 3b c3 72 f5 ff d7}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_BY_2147848671_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.BY!MTB"
...
rule Trojan_Win64_CobaltStrike_BZ_2147848951_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {48 c7 40 20 40 00 00 00 48 c7 40 28 00 00 00 08 48 c7 40 30 00 00 00 00 48 89 c3 b9 07 00 00 00 48 89 cf}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_BZ_2147848951_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.BZ!MTB"
...
rule Trojan_Win64_CobaltStrike_MX_2147851694_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {66 0f 6f 00 48 83 c0 10 48 83 c2 10 66 0f ef c1 0f 11 42 f0 48 39 c8 75 e7 c7}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_MX_2147851694_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.MX!MTB"
...
rule Trojan_Win64_CobaltStrike_CM_2147907597_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.CM!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {89 c1 d3 fa 41 89 d0 0f b6 44 24 ?? 0f b6 d0 0f b6 44 24 ?? 0f b6 c8 b8 ?? ?? ?? ?? 29 c8 89 c1 d3 e2 89 d0}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_GB_2147928172_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.GB!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {49 8b c7 0f 1f 00 80 34 38 2e 48 ff c0 48 83 f8 0f}  //weight: 5, accuracy: High
        $x_5_2 = {33 d2 48 8b c1 49 f7 f1 42 0f b6 04 02 41 30 04 0e 48 ff c1 48 3b cb 72}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_GVA_2147939450_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.GVA!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {48 8b 4c 24 08 84 01 48 8d 15 3d cb 20 00 48 89 54 c1 30 48 ff c0 48 3d 88 00 00 00 7c e2}  //weight: 1, accuracy: High
        $x_1_2 = "main.getShellcode" ascii //weight: 1
        $x_1_3 = "main.aesDecrypt" ascii //weight: 1
        $x_1_4 = "main.checkEnvironment" ascii //weight: 1
        $x_1_5 = "main.ntDelayExecution" ascii //weight: 1
        $x_1_6 = "main.extractSSN" ascii //weight: 1
        $x_1_7 = "main.ntOK" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_ABK_2147956677_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.ABK!MTB"
        threat_id = "2147956677"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {89 c2 8b 85 ?? ?? ?? ?? 48 98 0f b6 44 05 ?? 31 d0 89 c2 8b 85 ?? ?? ?? ?? 48 98 88 54 05}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_ABK_2147956677_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.ABK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 f7 74 24 ?? 0f b6 04 11 48 8b 4c 24 ?? 48 8b 14 24 44 0f b6 04 11 41 31 c0 44 88 04 11 48 8b 04 24 48 83 c0 01 48 89 04 24 eb}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_GKZ_2147959277_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.GKZ!MTB"
        threat_id = "2147959277"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {48 98 0f b6 44 05 ?? 83 f0 41 89 c2 8b 85 ?? ?? ?? ?? 48 98 88 54 05 ?? 83 85 ?? ?? ?? ?? 01 8b 85 ?? ?? ?? ?? 48 98 48 3d}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_ABCS_2147959488_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.ABCS!MTB"
        threat_id = "2147959488"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {48 89 c8 48 99 49 f7 f9 41 0f b6 04 13 41 30 04 0a 48 ff c1 48 89 0c 24 4c 39 04 24 ?? ?? 48 8b 0c 24 48 89 c8 4c 09 c8 48 c1 e8}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_ABCS_2147959488_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.ABCS!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {48 8b 4c 24 ?? 4d 8d 40 01 8b c2 ff c2 83 e0 0f 0f b6 44 04 ?? 42 30 44 01 ?? 3b d3 72 e2}  //weight: 6, accuracy: Low
        $x_4_2 = {4c 8b 44 24 ?? 4d 8d 52 01 41 8b c9 b8 ?? ?? ?? ?? 41 f7 e1 41 ff c1 c1 ea 03 6b c2 0f 2b c8 0f b6 4c 0c ?? 43 30 4c 10 ff 44 3b cb}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_AMR_2147963396_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.AMR!MTB"
        threat_id = "2147963396"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {8b 45 fc 48 63 d0 48 8b 45 10 48 01 d0 8b 55 fc 48 63 ca 48 8b 55 10 48 01 ca 0f b6 12 83 f2 9a 88 10 83 45 fc 01 8b 45 18 83 e8 01 3b 45 fc 7f cf}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_PAHL_2147963516_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.PAHL!MTB"
        threat_id = "2147963516"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {0f b6 c3 42 0f b6 04 00 49 ff c5 43 30 44 35 ff 4d 3b ec 0f}  //weight: 5, accuracy: High
        $x_1_2 = {41 ff c1 49 ff c2 41 f7 e9 c1 fa 04 8b c2 c1 e8 1f 03 d0 6b d2 53 44 2b ca 48 83 eb 01 75}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_VDP_2147963722_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.VDP!MTB"
        threat_id = "2147963722"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {66 89 48 06 0f b7 4f 08 66 83 e9 07 66 89 48 08 0f b7 4f 0a 66 83 e9 07 66 89 48 0a 0f b7 4f 0c 66 41 2b c9 66 89 48 0c 0f b7 4f 0e 66 2b ca 66 89 48 0e 0f b7 4f 10 66 83 e9 09}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_BMD_2147963727_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.BMD!MTB"
        threat_id = "2147963727"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "Encoding to PNG..." ascii //weight: 2
        $x_2_2 = "screenshot.png" ascii //weight: 2
        $x_2_3 = "Sending screenshot..." ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_BMD_2147963727_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.BMD!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 33 c4 48 89 44 24 ?? 4d 8b e0 4c 8b fa 48 8b d9 45 33 ed 45 33 c0 44 89 6c 24 ?? ba}  //weight: 2, accuracy: Low
        $x_2_2 = "msstudy\\zhizhen\\tufaqixiang\\x64\\Release\\tufaqixiang.pdb" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_FVD_2147963729_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.FVD!MTB"
        threat_id = "2147963729"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 8d 44 24 ?? 0f 1f 44 00 00 80 70 ?? ?? 48 83 c0 01 48 39 c2 75}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_BCMD_2147963825_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.BCMD!MTB"
        threat_id = "2147963825"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 8b 7c 24 ?? 48 63 f6 89 f3 49 0f af db 48 c1 eb ?? c1 e3 ?? 8d 1c 9b 41 89 f6 41 29 de 42 0f b6 1c 32 32 1c 37 88 1c 31 ff c6 83 fe 0d 4c 89 cf 49 0f 44 fa eb}  //weight: 2, accuracy: Low
        $x_2_2 = {45 30 04 0f 45 02 04 0f e2 f6}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_PKH_2147963838_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.PKH!MTB"
        threat_id = "2147963838"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {49 63 c1 0f b6 0c 04 41 8d 41 ?? 41 30 0a 25 ?? ?? ?? ?? 7d ?? ff c8 0d ?? ?? ?? ?? ff c0 49 ff c2 44 8b c8 48 83 ea ?? 75}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_NKI_2147963840_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.NKI!MTB"
        threat_id = "2147963840"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {4c 89 6c 24 ?? 49 83 fd ?? 73 ?? c1 e9 ?? 42 32 4c 2c ?? 42 88 0c 2a 49 ff c5 4c 89 6c 24 ?? 41 ff c4 44 89 64 24 ?? 41 83 fc ?? 0f 8c ?? ?? ?? ?? 49 83 fd ?? 4c 8d 2d ?? ?? ?? ?? 0f 82}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_GKI_2147963843_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.GKI!MTB"
        threat_id = "2147963843"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {89 d8 4c 39 d0 73 ?? 45 8d 44 18 ?? 41 31 d8 66 44 33 04 41 66 45 89 04 41 48 83 e2 ?? 31 c0 66 41 89 04 11}  //weight: 1, accuracy: Low
        $x_1_2 = {44 0f b7 04 41 45 31 d8 41 83 c3 ?? 41 31 c0 66 45 89 04 41 48 83 c0 ?? 49 39 c2 75}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_FK_2147964004_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.FK!MTB"
        threat_id = "2147964004"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {48 8b d6 4c 8d 0d ?? ?? ?? ?? 0f 1f 40 00 0f 1f 84 00 00 00 00 00 48 8d 41 05 ff c1 83 e0 1f 48 8d 52 01 42 0f b6 04 08 30 42 ff 48 63 c1 48 3b c7 72}  //weight: 10, accuracy: Low
        $x_1_2 = "RQVwlToEMOyk1QqOWICpqSesrfomtmIR" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_CP_2147964880_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.CP!MTB"
        threat_id = "2147964880"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {0f 57 c2 0f 57 c3 f3 0f 6f 4c 01 ?? f3 0f 7f 40 ?? 0f 57 ca 0f 57 cb f3 0f 7f 48 ?? 49 83 e8 01 75}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_AHF_2147965212_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.AHF!MTB"
        threat_id = "2147965212"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {0f b6 03 c1 e1 ?? 0b c8 0f b6 43 ff c1 e1 ?? 0b c8 0f b6 43 ?? 89 4c 24 30}  //weight: 30, accuracy: Low
        $x_20_2 = {44 8b c5 c1 e1 ?? 41 c1 e8 ?? 44 33 c1 8d 8e ?? ?? ?? ?? 48 c1 e9 ?? 44 03 c5 83 e1 ?? 41 8b 14 8c}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_CX_2147965441_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.CX!MTB"
        threat_id = "2147965441"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {89 c2 83 e2 ?? 8a 14 0a 41 30 14 00 48 ff c0 eb}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_SND_2147965965_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.SND!MTB"
        threat_id = "2147965965"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "/user_profiles_photo/cptchbuild.bin" ascii //weight: 1
        $x_1_2 = "svchost.exe" ascii //weight: 1
        $x_1_3 = "http://94.154.35.115/user_profiles_photo/cptchbuild.bin" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_AHA_2147966056_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.AHA!MTB"
        threat_id = "2147966056"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {49 89 c8 b9 ?? 00 00 00 f3 a4 48 39 d0 74 ?? 48 89 c1 83 e1 1f 8a 4c 0c 0f 41 30 0c 00 48 ff c0 eb}  //weight: 30, accuracy: Low
        $x_20_2 = "start /min \"\" regsvr32 /s \"%s" ascii //weight: 20
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_KIO_2147966636_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.KIO!MTB"
        threat_id = "2147966636"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {44 88 04 0b 48 ff c1 eb ?? 48 ff c0 48 83 f8 ?? 75 ?? 31 d2 8a 04 13 83 e8 ?? 83 f0 ?? d0 c8 88 04 13 48 ff c2 48 81 fa ?? ?? ?? ?? 75}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_AWK_2147966638_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.AWK!MTB"
        threat_id = "2147966638"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {48 8b 0e 33 d2 48 8b c3 48 f7 76 ?? 0f b6 04 0a 41 32 00 88 44 24 ?? 48 8b 57 ?? 48 3b 57 ?? 74 ?? 88 02 48 ff 47 ?? eb}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_MKJ_2147966643_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.MKJ!MTB"
        threat_id = "2147966643"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {49 8b c3 49 f7 e0 48 c1 ea ?? 48 8d 0c d2 48 c1 e1 ?? 49 8b c0 48 2b c1 42 0f b6 04 10 43 30 04 01 49 ff c0 48 8b 45 ?? 4c 8b 4d ?? 49 2b c1 4c 3b c0 72}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_CJT_2147966646_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.CJT!MTB"
        threat_id = "2147966646"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {41 f7 ff fe c2 41 0f b6 c4 32 04 3e 32 c2 88 07 48 8d 7f ?? 48 83 eb ?? 75 ?? 41 80 3e ?? 0f 85 ?? ?? ?? ?? 41 80 7e ?? ?? 0f 85}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_DFP_2147966648_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.DFP!MTB"
        threat_id = "2147966648"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {8b 44 24 44 ff c0 89 44 24 ?? 83 7c 24 ?? ?? 0f 83}  //weight: 1, accuracy: Low
        $x_1_2 = {8b 4c 0c 28 c1 e1 ?? 0b c1 b9 ?? ?? ?? ?? 48 6b c9 ?? 33 44 0c ?? b9 ?? ?? ?? ?? 48 6b c9 ?? 89 44 0c ?? b8 ?? ?? ?? ?? 48 6b c0 ?? b9 ?? ?? ?? ?? 48 6b c9 ?? 8b 44 04 ?? 89 44 0c}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_NZI_2147966649_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.NZI!MTB"
        threat_id = "2147966649"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {8b 45 fc 83 c0 01 89 45 fc 8b 4d fc 3b 4d 10 73 19 8b 55 0c 03 55 fc 0f b6 02 0f b6 4d 08 33 c1 8b 55 0c 03 55 fc 88 02 eb d6}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_DEB_2147966659_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.DEB!MTB"
        threat_id = "2147966659"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0f b6 f2 31 f1 69 c9 ?? ?? ?? ?? c1 f8 ?? 88 c2 44 0f b6 c2 44 31 c1 69 c9 ?? ?? ?? ?? 0f b6 f4 31 f1 69 c9 ?? ?? ?? ?? 89 8c 24 ?? ?? ?? ?? 41 89 c8 41 81 e8 ?? ?? ?? ?? 89 8c 24 ?? ?? ?? ?? 0f 84}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_DEH_2147966662_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.DEH!MTB"
        threat_id = "2147966662"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0f b6 d2 0f b6 84 14 ?? ?? ?? ?? 42 8d 0c 18 44 0f b6 d9 0f b6 c9 0f b6 ac 0c ?? ?? ?? ?? 40 88 ac 14 ?? ?? ?? ?? 88 84 0c ?? ?? ?? ?? 02 84 14 ?? ?? ?? ?? 0f b6 c0 0f b6 84 04 ?? ?? ?? ?? 41 30 00 49 83 c0 ?? 4c 39 c7 75}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_LAC_2147966663_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.LAC!MTB"
        threat_id = "2147966663"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {4c 8b c7 ba ?? ?? ?? ?? 48 8b ce e8 ?? ?? ?? ?? 4d 85 f6 7e ?? 49 8d 4e ?? 48 8b c6 48 c1 e9 ?? 48 ff c1 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 81 30 ?? ?? ?? ?? 48 8d 40 ?? 48 83 e9 ?? 75 ?? 48 8b cb}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_LAB_2147966664_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.LAB!MTB"
        threat_id = "2147966664"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {48 89 c8 31 d2 49 f7 f0 41 0f b6 04 12 30 04 0b 48 83 c1 ?? 49 39 c9 75}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_HWN_2147966667_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.HWN!MTB"
        threat_id = "2147966667"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {4d 89 c3 49 83 fb ?? 72 ?? 8b 7c 10 ?? 0f b7 5c 10 ?? 48 c1 e3 ?? 48 09 fb 4c 31 d3 48 8b 3c 10 4c 31 cf 48 09 df 74 ?? 49 ff cb 48 ff c2 eb}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_FBK_2147966805_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.FBK!MTB"
        threat_id = "2147966805"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {44 8a 04 91 31 c0 44 30 ?? 05 00 48 ff c0 48 3d ?? ?? ?? ?? 75 f0 48 ff ca 48 83 fa ?? 75}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_CAB_2147968364_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.CAB!MTB"
        threat_id = "2147968364"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {48 01 ca 0f b6 12 89 d1 8b 55 20 31 ca 88 10}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_DMK_2147968868_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.DMK!MTB"
        threat_id = "2147968868"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {c7 03 b8 57 00 07 4c 8d 4c 24 40 66 c7 43 04 80 c3}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_PAIB_2147968883_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.PAIB!MTB"
        threat_id = "2147968883"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {49 8b c0 49 ff c0 83 e0 ?? 8a 44 05 ?? 32 04 11 88 01 48 ff c1 49 83 e9}  //weight: 3, accuracy: Low
        $x_2_2 = {49 03 d1 48 8d 4d c0 49 03 c8 49 ff c0 8a 01 34 42 88 04 11 49 83 f8 ?? 7c e9}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_CAC_2147970226_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.CAC!MTB"
        threat_id = "2147970226"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {44 89 c2 32 16 4c 89 e1 44 88 44 24 ?? 88 54 24 ?? 4c 89 f2 4c 89 7c 24}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_AHC_2147970736_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.AHC!MTB"
        threat_id = "2147970736"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {66 0f 6f c6 66 0f 6f e6 66 0f fc c1 66 0f eb e2 66 0f d8 c3 66 0f 74 c5 66 0f db e0 66 0f df c6 66 0f eb c4 0f 29 44 24 20 48 83 f8 ?? 0f}  //weight: 30, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_SNI_2147970969_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.SNI!MTB"
        threat_id = "2147970969"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
    ...
    strings:
        ...
        $x_1_2 = "158.94.208.104" ascii //weight: 1
        $x_1_3 = "%s%s\\*.ps1" ascii //weight: 1
        $x_1_4 = "x7GkP2mQ9zL4/my_s.bin" ascii //weight: 1
        $x_1_5 = "x7GkP2mQ9zL4/my_downloader.bin" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_LIH_2147971349_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.LIH!MTB"
        threat_id = "2147971349"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
...
rule Trojan_Win64_CobaltStrike_BIT_2147971823_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.BIT!MTB"
        threat_id = "2147971823"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {41 8b 02 b9 05 15 00 00 49 03 c3 0f be 10 48 ff c0 85 d2 74 1c 66 66 66 0f 1f 84 00 00 00 00 00 6b c9 21 48 8d 40 01 03 ca 0f be 50 ff 85 d2 75 ef 3b cb 74 1e 41 ff c1 49 83 c2 04 45 3b c8 72 bf}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_GMF_2147972183_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.GMF!MTB"
        threat_id = "2147972183"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {33 d2 48 8b 74 24 ?? 48 8b cf 41 b9 00 10 00 00 c7 44 24 ?? 40 00 00 00 41 b8 ?? ?? ?? ?? ff 15 ?? ?? ?? ?? 41 b9 ?? ?? ?? ?? 48 89 6c 24 ?? 48 8b d0 4c 8d 84 24 ?? ?? ?? ?? 48 8b cf 48 8b d8 ff 15 ?? ?? ?? ?? 45 33 c0 48 8b d6 48 8b cb ff 15 ?? ?? ?? ?? 48 8b ce}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_SX_2147972619_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.SX!MTB"
        threat_id = "2147972619"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {c6 84 24 98 00 00 00 53 c6 84 24 99 00 00 00 65 c6 84 24 9a 00 00 00 6c c6 84 24 9b 00 00 00 66 c6 84 24 9c 00 00 00 52 c6 84 24 9d 00 00 00 65 c6 84 24 9e 00 00 00 66 c6 84 24 9f 00 00 00 6c c6 84 24 a0 00 00 00 65 c6 84 24 a1 00 00 00 63 c6 84 24 a2 00 00 00 74 c6 84 24 a3 00 00 00 69 c6 84 24 a4 00 00 00 76 c6 84 24 a5 00 00 00 65}  //weight: 30, accuracy: High
        $x_20_2 = {48 63 40 3c 48 8b 4c 24 38 48 03 c8 48 8b c1 48 89 44 24 70 b8 08 00 00 00 48 6b c0 00 48 8b 4c 24 70 48 8d 84 01 88 00 00 00 48 89 84 24 88 00 00 00 48 8b 84 24 88 00 00 00 8b 00 48 8b 4c 24 38}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_DVR_2147973609_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {89 c1 88 c2 8d 4a 33 30 8c 04 70 05 00 00 48 89 c1 48 ff c1 48 89 c8 48 83 f9 18 75 e3}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_CobaltStrike_PLA_2147976869_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.PLA!MTB"
        threat_id = "2147976869"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
...
rule Trojan_Win64_CobaltStrike_PAF_2147978219_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.PAF!MTB"
        threat_id = "2147978219"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {49 0f af d1 48 8d 49 01 49 03 d2 48 8b c2 48 c1 e8 20 30 41 ff 49 83 e8 01}  //weight: 2, accuracy: High
        $x_2_2 = {49 ba 52 45 44 55 54 53 59 4d}  //weight: 2, accuracy: High
        $x_1_3 = "\\BaseNamedObjects\\Global\\" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_CobaltStrike_RF_2147978314_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/CobaltStrike.RF!MTB"
        threat_id = "2147978314"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "CobaltStrike"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {5a 48 8b c8 4d 33 c0 4d 33 c9 41 51 41 51 6a 03 41 51 49 c7 c2 ba ac 89 22 e8}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
