...
rule Trojan_Win64_ShellLoader_SXB_2147965206_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ShellLoader.SXB!MTB"
        threat_id = "2147965206"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ShellLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {ba 00 00 10 00 33 c9 41 b9 40 00 00 00 41 b8 00 10 00 00 ff d0 48 8b d8 48 89 44 24 48 4c 89 7c 24 20 45 33 c9 41 b8 00 00 10 00 48 8b d0 48 8b ce ff 15}  //weight: 30, accuracy: High
        $x_10_2 = {b9 48 00 00 00 8b 04 39 ba 38 00 00 00 48 8d 1c 17 a8 01 75 2c 83 c8 01 89 04 39}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_ShellLoader_SXD_2147973772_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ShellLoader.SXD!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {c6 00 48 48 8b 44 24 60 c6 40 01 83 48 8b 44 24 60 c6 40 02 ec 48 8b 44 24 60 c6 40 03 28 48 8b 44 24 60 c6 40 04 48 48 8b 44 24 60 c6 40 05 8d 48 8b 44 24 60 c6 40 06 0d 48 8b 44 24 60 c6 40 07 05}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_ShellLoader_SXE_2147976261_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ShellLoader.SXE!MTB"
        threat_id = "2147976261"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ShellLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {48 63 44 24 20 8b 54 84 2c 41 23 d4 03 d2 48 63 44 24 20 8b 44 84 2c 2b c2 42 8d 14 38 48 63 44 24 20 89 54 84 2c}  //weight: 30, accuracy: High
        $x_5_2 = {0f be d0 03 d3 0f be 05 ?? ?? ?? ?? 03 c2 0f be 0d ?? ?? ?? ?? 33 d2 f7 f1 0f be 0d ?? ?? ?? ?? 2b c1 0f 57 c0 f2 48 0f 2a c0 f2 0f 59 45 80 f2 44 0f 2c f8}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
