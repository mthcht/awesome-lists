...
rule Trojan_Win64_Tedy_A_2147828733_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.A!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = "=== Zshell Built-in Commands ===" ascii //weight: 10
        $x_5_2 = "EXE hollow injection failed" ascii //weight: 5
        $x_3_3 = "keylogger started" ascii //weight: 3
        $x_2_4 = "PE data truncated" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_B_2147828754_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {48 b8 87 b4 15 76 2a f5 77 b9 48 89 44 24 30 4c 89 74 24 38 0f 28 44 24 30 0f 57 44 24 40 66 0f 7f 44 24 30 c7 44 24 28 01 00 00 00 48 89 74 24 20 48 8d 54 24 30 33 c9 ff 15}  //weight: 10, accuracy: High
        $x_5_2 = {49 bf f5 c1 7b 17 59 f5 77 b9 4c 89 7d 20 49 be 0a 29 6a e5 fc d8 89 ae 4c 89 75 28 48 b8 db a4 03 72 59 f5 77 b9}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_ATY_2147911512_4
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 83 c0 10 ff d0 ff 15 ?? ?? ?? ?? 33 d2 b9 c8 00 00 00 f7 f1 8b c2 83 c0 64 4c 8d 0d 3c ff ff ff 44 8b c0 ba ea 03 00 00 48 8b 4c 24 60}  //weight: 2, accuracy: Low
        $x_1_2 = {48 83 c0 10 ff d0 ff 15 ?? ?? ?? ?? 33 d2 b9 96 00 00 00 f7 f1 8b c2 83 c0 32 4c 8d 0d be fe ff ff 44 8b c0 ba eb 03 00 00 48 8b 4c 24 60}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_C_2147922679_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b 44 24 5c 8b 0d ?? ?? ?? ?? 33 c1 0f ba e8 1f 89 44 24 5c 8b 44 24 5c 89 84 24 0c 01 00 00 33 c0}  //weight: 20, accuracy: Low
        $x_10_2 = {48 c1 e8 10 48 8b 8c 24 b0 00 00 00 48 c1 e1 10 48 0b c1 48 89 84 24 b0 00 00 00 48 8b 84 24 b8 00 00 00 48 8b 8c 24 b0 00 00 00 48 33 c1}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_C_2147922679_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.C!MTB"
...
rule Trojan_Win64_Tedy_ARA_2147923215_3
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {0f b6 14 01 83 f2 7b 41 88 14 04 48 83 c0 01 48 83 f8 0d 75 eb}  //weight: 2, accuracy: High
        $x_2_2 = {48 89 c1 45 89 c2 83 e1 03 48 c1 e1 03 41 d3 ea 45 30 14 01 48 83 c0 01 48 39 c2 75 e3}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_ARA_2147923215_4
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 31 c2 8b 84 24 ?? ?? 00 00 48 98 48 31 c2 8b 84 24 ?? ?? 00 00 48 98 48 89 94 c4 ?? ?? 00 00 83 ac 24 ?? ?? 00 00 01 83 bc 24 ?? ?? 00 00 00 79 91}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ARA_2147923215_5
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARA!MTB"
...
rule Trojan_Win64_Tedy_ARA_2147923215_6
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARA!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "\\source_stealer\\src\\miniz.c" wide //weight: 2
        $x_2_2 = "\\Release\\TelegramStealer.pdb" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ARA_2147923215_7
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARA!MTB"
...
rule Trojan_Win64_Tedy_GB_2147928064_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.GB!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {48 89 5c 24 40 48 83 fb 0d 73 10 40 0f b6 c7 32 44 1c 58 88 04 33 48 ff c3 eb e5}  //weight: 5, accuracy: High
        $x_5_2 = {f7 ef 03 d7 c1 fa 07 8b ca c1 e9 1f 03 d1 69 ca ff 00 00 00 2b f9 33 db 8b cb 40 0f b6 c7 32 44 0c 48 88 44 0c 58 48 ff c1 48 83 f9 0d 72}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_AE_2147935806_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.AE!MTB"
        threat_id = "2147935806"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "[WORKER] Nibble-decoded: %lu -> %lu bytes" ascii //weight: 1
        $x_1_2 = "[WORKER] Calling payload SideloadBlock at %p" ascii //weight: 1
        $x_1_3 = "[WORKER] Payload SideloadBlock returned" ascii //weight: 1
        $x_1_4 = "[LOADER] VirtualProtect RWX: %s (err=%lu)" ascii //weight: 1
        $x_1_5 = "AmsiScanBuffer" ascii //weight: 1
        $x_1_6 = "VERSION.dll" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_AD_2147939495_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.AD!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "DEBUG - Crypto" ascii //weight: 1
        $x_1_2 = "Decryption complete: %lu bytes -> %lu bytes" ascii //weight: 1
        $x_1_3 = "Starting decryption..." ascii //weight: 1
        $x_1_4 = "Starting PE execution..." ascii //weight: 1
        $x_1_5 = "ExecuteFile succeeded, resuming thread..." ascii //weight: 1
        $x_1_6 = "ESMK allocated new buffer, freeing old one. New size: %lu" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_AH_2147939502_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {44 8b c0 41 81 f0 b9 79 37 9e 41 c1 c8 09 8b d0 81 f2 e1 a7 f5 1b c1 ca 0f 8b c8 81 f1 72 f3 6e 3c c1 c9 15 35 a5 a5 a5 a5}  //weight: 30, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_AH_2147939502_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.AH!MTB"
...
rule Trojan_Win64_Tedy_AH_2147939502_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.AH!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {66 48 0f 7e f7 66 0f 73 de ?? 66 49 0f 7e f7 4c 8d 74 24 78 66 48 0f 7e fe 49 83 ff ?? 4c 0f 47 f6}  //weight: 20, accuracy: Low
        $x_30_2 = {44 8b c0 41 81 f0 ?? ?? ?? ?? 41 c1 c8 ?? 8b d0 81 f2 ?? ?? ?? ?? c1 ca ?? 8b c8 81 f1 ?? ?? ?? ?? c1 c9 ?? 35 ?? ?? ?? ?? c1 c8 ?? 44 89 44 24 30}  //weight: 30, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_ATD_2147939770_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {0f b6 d0 0f b6 94 14 ?? ?? ?? ?? 30 14 06 48 83 c0 ?? 48 39 e8 72}  //weight: 5, accuracy: Low
        $x_5_2 = {f1 88 28 92 6d 31 0e 67 e9 b0 4e e4 3e da d9 8b 18 8b 40 8e b0 31 c5 2c 36 7e 43 ff 01 e8 a6 4e 94 a3}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ATD_2147939770_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ATD!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {4c 8d 8d 00 03 00 00 4c 8d 05 e8 ?? ?? ?? ?? 04 01 00 00 48 8d 8d f0 00 00 00 ?? ?? ?? ?? ?? 4c 8d 8d f0 00 00 00 4c 8d 05 01 2a 00 00 ba 04 01 00 00 48 8d 8d 20 07 00 00 e8 ?? ?? ?? ?? 4c 8d 8d f0 00 00 00 4c 8d 05 f2 29 00 00 ba 04 01 00 00 48 8d 8d 30 09 00 00 e8 b9 0f 00 00 4c 8d 8d f0 00 00 00 4c 8d 05 eb 29 00 00 ba 04 01 00 00 48 8d 8d 10 05 00 00}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ATD_2147939770_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ATD!MTB"
...
rule Trojan_Win64_Tedy_KK_2147943868_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {49 8d 04 1c 40 88 f1 8a 10 49 8d 44 1d 00 31 d1 88 08 40 0f b6 c6 d1 f8 88 c1 83 f1 b8 40 80 e6 01 40 88 ce 0f 44 f0 48 ff c3 31 d6}  //weight: 20, accuracy: High
        $x_10_2 = {48 8d 14 3f 48 8b 0c 38 4c 01 ea ff d6 85 c0 41 89 c6 74 11}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_KK_2147943868_2
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {48 b9 00 09 6e 88 f1 ff ff ff 48 8d 34 19 48 8d 76 ec 48 8b 7c 24 50 48 39 37 7d 93}  //weight: 20, accuracy: High
        $x_10_2 = {48 8b 94 24 20 07 00 00 48 81 c2 38 02 00 00 4c 8b 84 24 d0 04 00 00 49 ff c8 48 8b 84 24 10 07 00 00 48 89 cb 48 8b b4 24 18 07 00 00 4c 89 c1}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_KK_2147943868_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.KK!MTB"
...
rule Trojan_Win64_Tedy_KK_2147943868_4
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.KK!MTB"
...
rule Trojan_Win64_Tedy_BAB_2147956902_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.BAB!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "A9Awtmet2DxcfoMShSMxxkstjU5" ascii //weight: 1
        $x_1_2 = "AKO46LOK06Z2TWzn681BytoUTg2" ascii //weight: 1
        $x_1_3 = "AQPKuE0hKWHK0IxsBqbdBHGNk" ascii //weight: 1
        $x_1_4 = "DllRegisterServer" ascii //weight: 1
        $x_1_5 = "MzYdwDxGjj" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_ARR_2147957105_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_6_1 = {41 0f b6 08 48 33 c1 41 02 c9 80 e1}  //weight: 6, accuracy: High
        $x_4_2 = {48 8b d0 0f b6 c9 48 d3 c2 48 33 c2}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_ARR_2147957105_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_8_1 = {4c 0f 47 44 24 ?? 4c 8b 4c 24 ?? 49 ff c1 4c 89 7c 24 ?? 48 8b d0 48 8b ce}  //weight: 8, accuracy: Low
        $x_2_2 = "zetrexoa-create" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_ARR_2147957105_2
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_11_1 = {42 0f b6 0c 10 32 08 48 8d 44 15 ca 48 83 c2 ?? 88 4c 15 b5}  //weight: 11, accuracy: Low
        $x_9_2 = {88 04 19 42 0f b6 04 01 32 41 ?? 88 44 19 ?? 42 0f b6 04 11}  //weight: 9, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_ARR_2147957105_3
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_9_1 = {8b c6 f7 75 1c 8d 4d 08 52 e8 ?? ?? ?? ?? 8a 08 8d 04 1e 8a 14 07 32 d1 46 3b 75 24 88 10}  //weight: 9, accuracy: Low
        $x_11_2 = {8d 75 e4 34 aa 88 45 e0 ff 75 e0 8b cf 6a ?? e8 ?? ?? ?? ?? 46 8a 06 84 c0}  //weight: 11, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_ARR_2147957105_4
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_12_1 = {45 03 c1 44 33 ca 41 c1 c9 ?? 03 d3 f7 d2 c1 cb ?? 41 33 d8 41 8b ca 8a c3 32 c2 41 32 c1 41 32 c0 42 30 04 29 45 03 d6}  //weight: 12, accuracy: Low
        $x_8_2 = {80 74 04 30 ?? 49 03 c7 48 83 f8}  //weight: 8, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ARR_2147957105_5
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARR!MTB"
...
rule Trojan_Win64_Tedy_ARR_2147957105_7
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_11_1 = {48 89 c0 81 c2 ?? ?? ?? 00 49 c7 c3 ?? ?? ?? ?? 31 45 af 48 33 4d f5 48 89 4d e5}  //weight: 11, accuracy: Low
        $x_9_2 = {8b 4d 9e 48 89 4d ee 4c 89 4d ed 4c 33 55 f1 89 c9 49 01 d0 48 8b 4d eb 4c 2b 45 e4 89 d1 48 89 45 a2 48 01 c0 4d 89 e9}  //weight: 9, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ARR_2147957105_8
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {49 63 c0 41 ff c0 8b 4c 84 70 31 4c 94 40 48 ff c2 48 83 fa}  //weight: 6, accuracy: High
        $x_4_2 = {0f b6 02 42 0f b6 0c 0a 42 32 0c 12 88 0a 42 88 04 12 48 8d 52 ?? 49 83 e8}  //weight: 4, accuracy: Low
        $x_10_3 = "bloxholder.com" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ARR_2147957105_9
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARR!MTB"
...
rule Trojan_Win64_Tedy_ARR_2147957105_10
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARR!MTB"
...
rule Trojan_Win64_Tedy_ARR_2147957105_11
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_7_1 = {0f b6 c1 0f b7 0a 44 33 d0 45 69 d2 ?? ?? ?? ?? 66 85 c9 75}  //weight: 7, accuracy: Low
        $x_9_2 = {32 c1 41 88 04 10 48 ff c2 48 ff cf 75}  //weight: 9, accuracy: High
        $x_4_3 = {41 0f be 00 0f b6 c9 66 83 f8 ?? 66 41 89 01 41 0f 44 ce 49 ff c0 49 ff c3 ff c2 49 83 c1 ?? 45 38 28 75}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ARR_2147957105_12
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ARR!MTB"
...
rule Trojan_Win64_Tedy_ABT_2147958401_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ABT!MTB"
        threat_id = "2147958401"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {41 3b c8 48 8d 52 01 b8 ?? ?? ?? ?? 41 0f 43 c1 ff c1 32 44 32 ?? 88 44 3a ?? 3b cb 72}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_KKA_2147959407_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {41 0f b6 08 4d 8d 40 01 c1 ca 0d 8d 04 11 80 e9 61 80 f9 19 8d 50 e0 0f 47 d0 66 44 03 d3}  //weight: 20, accuracy: High
        $x_10_2 = {ff c1 4c 8d 4d a0 8b c1 4c 8d 45 a0 48 c1 e0 04 4c 03 c8 48 8b c2 48 c1 e0 04 4c 03 c0 49 8b 01 49 39 00}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_KKA_2147959407_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.KKA!MTB"
...
rule Trojan_Win64_Tedy_KKA_2147959407_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.KKA!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_6_1 = "L8mR4T--v4_stable" ascii //weight: 6
        $x_5_2 = "act=recive_message" ascii //weight: 5
        $x_4_3 = "api/get_key.php" ascii //weight: 4
        $x_3_4 = "TeslaBrowser/5.5" ascii //weight: 3
        $x_2_5 = "Starting exfiltration for BotID: %s to C2: %s" ascii //weight: 2
        $x_1_6 = "Attempting RunPE injection into: %ws" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_CM_2147960334_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CM!MTB"
        threat_id = "2147960334"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {44 8b c3 48 8b d6 48 8b cf ff 15}  //weight: 5, accuracy: High
        $x_5_2 = {45 33 c9 45 33 c0 ba 00 00 00 40 49 8b cf ff 15}  //weight: 5, accuracy: High
        $x_5_3 = {48 8b cf ff 15}  //weight: 5, accuracy: High
        $x_5_4 = {48 8d 4c 24 ?? ff 15}  //weight: 5, accuracy: Low
        $x_1_5 = "runas" wide //weight: 1
        $x_1_6 = "msiexec.exe" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_POTN_2147960409_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.POTN!MTB"
        threat_id = "2147960409"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "[Hollow] Starting hollowing..." ascii //weight: 5
        $x_5_2 = {53 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 73 00 76 00 63 00 68 00 6f 00 73 00 74 00 2e 00 65 00 78 00 65 00 20 00 2d 00 6b 00 20 00 6e 00 65 00 74 00 73 00 76 00 63 00 73 00 00 00 00 00 6e 00 6f 00 74 00 65 00 70 00 61 00 64 00 2e 00 65 00 78 00 65 00 00 00 4d 5a}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_BAC_2147960976_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.BAC!MTB"
        threat_id = "2147960976"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {e8 d9 00 00 00 48 8d 58 fb 51 52 41 50 41 51 48 83 ec 28 48 c7 c0 60 00 00 00 65 48 8b 38 48 8b 7f 18 48 8b 7f 20 48 8b 7f 20 48 8b 83 13 01 00 00 48 01 f8 ff d0 48 89 83 13 01 00 00 48 8b 83 1b 01}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_BAC_2147960976_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.BAC!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {06 85 dd f1 ec 53 88 cb 6d 12 2d a9 34 92 5d d3 cd ed 41 93 39 c8 ed 68 6e 46 e9 cb 2d 36 a4 02 d0 ad c5 88 bf 3d 92 26 a5 5a 3d 92 76 e0 dd d8 ed 5b d9 a2 43 40 68 c1 d7 d9 c9 74 04 22 8f 03 b5 c9 68 ee 57 ea dc 2c ff 7d c7 ae e6 3c da 4a 15 d2 3a 1f 54 df 2d d1 11 91 61 31 93 7a ee cb}  //weight: 2, accuracy: High
        $x_2_2 = {56 90 3c ad 52 54 65 2f 60 c0 c6 1d b1 42 34 53 68 2a 8f 17 89 6e 89 07 a8 88 79 5b cd e9 d7 0d 1f ad e7 96 17 e9 9e 94 d7 43 a9 99 07 93 57 f4 10 81 f2 f8 e2 e7 08 7b 89 3e f1 b6 c2 90 ec 4f 17 31 a9 91 f9 9e d7 89 2b dc 3b 13 54 da 33 88 a2 e4 80 3c 6c 3d 8f ed ab c2 38 11 0c bc 52 f5}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_BAD_2147961312_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.BAD!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {48 8d 54 24 20 c7 44 24 20 30 01 00 00 48 8b cf ff 15 ec 8c 01 00 85 c0 74 37 48 83 7b 18 0f 48 8b cb 76 03 48 8b 0b 48 8d 54 24 4c ff 15 88 93 01 00 85 c0 74 14 48 8d 54 24 20 48 8b cf ff 15 ee 8c 01 00}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_BAD_2147961312_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.BAD!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {e8 d9 00 00 00 48 8d 58 fb 51 52 41 50 41 51 48 83 ec 28 48 c7 c0 60 00 00 00 65 48 8b 38 48 8b 7f 18 48 8b 7f 20 48 8b 7f 20 48 8b 83 13 01 00 00 48 01 f8 ff d0 48 89 83 13 01 00 00 48 8b 83 1b 01 00 00 48 01 f8 ff d0 48 89 83 1b 01 00 00 48 8b 8b eb 00 00 00 48 01 f9 48 89 ca 48 8b 83 fb 00 00 00 48 01 f8 ff d0 4c 8b 83 1b 01 00 00 48 8b 93 13 01 00 00 48 8b 8b eb 00 00 00 48 01 f9 48 8b 83 03 01 00 00 48 01 f8 ff d0 48 31 d2}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_PGD_2147961755_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.PGD!MTB"
        threat_id = "2147961755"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = "WyvernInject" ascii //weight: 3
        $x_1_2 = "CryptGenRandom" ascii //weight: 1
        $x_1_3 = "CertFreeCertificateContext" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_SL_2147962044_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {41 8d 51 01 44 0f b6 ca 0f b6 d2 0f b6 44 14 60 42 8d 0c 10 44 0f b6 d1 0f b6 c9 44 0f b6 5c 0c 60 44 88 5c 14 60 88 44 0c 60 02 44 14 60 0f b6 c0 0f b6 44 04 60 41 30 00 49 83 c0 01 49 39 d8 75 be}  //weight: 2, accuracy: High
        $x_2_2 = "prefs.tmp" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ABM_2147962147_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ABM!MTB"
        threat_id = "2147962147"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = "aHR0cHM6Ly9oaXRwYWsub3JnL3BhZ2UucGhwP3R5bm9yPQ==" ascii //weight: 3
        $x_2_2 = "cG93ZXJzaGVsbC5leGUgLU5vUHJvZmlsZSAtRXhlY3V0aW9uUG9saWN5IEJ5cGFzcyAtV2luZG93U3R5bGUgSGlkZGVuIC1Db21tYW5k" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_GHT_2147962214_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Tedy_MCC_2147962459_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.MCC!MTB"
        threat_id = "2147962459"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {4c 8b c3 8b c1 ff c1 99 41 f7 f9 48 63 c2 8a 04 38 41 30 00 49 ff c0 3b ce 7c e8}  //weight: 5, accuracy: High
        $x_4_2 = {4c 2b c8 4c 8b c0 8b c2 ff c2 83 e0 03 42 8a 04 28 43 32 04 01 41 88 00 49 ff c0 81 fa f0 04 00 00 7c e3}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_RR_2147962573_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {94 33 01 00 b5 33 01 00 d3 33 01 00 f1 33 01 00 0f 34 01}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_RR_2147962573_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {41 80 30 84 41 80 70 01 85 41 80 70 02 86 41 80 70 03 87 41 80 70 04 88 41 80 70 05 89 41 80 70 06 8a 41 80 70 07 8b 41 80 70 08 8c 41 80 70 09 8d 41 80 70 0a 8e 41 88 78 0c}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_RR_2147962573_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.RR!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {49 03 ce 48 89 8c 24 e0 00 00 00 48 33 94 24 08 01 00 00 48 89 94 24 d8 00 00 00 4c 8b ac 24 00 01 00 00 4d 03 dd 4c 89 9c 24 d0 00 00 00 48 8b bc 24 f8 00 00 00 48 33 f7 44 89 84 24 f4 00 00 00 45 8b f9 45 2b f8 41 83 ff 20 7e 06}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_RR_2147962573_4
{
    ...
    strings:
        $x_1_1 = {49 03 ce 48 89 8c 24 e0 00 00 00 48 33 94 24 08 01 00 00 48 89 94 24 d8 00 00 00 4c 8b ac 24 00 01 00 00 4d 03 dd 4c 89 9c 24 d0 00 00 00 48 8b bc 24 f8 00 00 00 48 33 f7 44 89 84 24 f4 00 00 00 45 8b f9 45 2b f8 41 83 ff 20 7e 06}  //weight: 1, accuracy: High
        $x_1_2 = "0IC3b9xQlIYDEJU3" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_RR_2147962573_5
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.RR!MTB"
...
rule Trojan_Win64_Tedy_RR_2147962573_6
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.RR!MTB"
...
rule Trojan_Win64_Tedy_CQ_2147964031_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CQ!MTB"
        threat_id = "2147964031"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {48 c7 44 24 ?? ?? ?? ?? ?? 48 8d 15 ?? ?? ?? ?? 4c 8d 0d ?? ?? ?? ?? 48 8d 74 24 ?? 41 b8 ?? ?? ?? ?? 48 89 f1 ff d0}  //weight: 5, accuracy: Low
        $x_5_2 = {48 89 f8 48 03 05 ?? ?? ?? ?? 48 83 c4 ?? 5f 5e 48 ff e0}  //weight: 5, accuracy: Low
        $x_1_3 = "[+] hello wold!" ascii //weight: 1
...
rule Trojan_Win64_Tedy_SXI_2147964063_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.SXI!MTB"
        threat_id = "2147964063"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {48 8b 04 24 48 ff c0 48 89 04 24 48 83 3c 24 42 73 ?? 48 8b 04 24 48 8b 0d ?? ?? ?? ?? 48 03 c8 48 8b c1 0f be 00 83 f0 34 48 8b 0c 24 48 8b 54 24 ?? 48 03 d1 48 8b ca 88 01 eb}  //weight: 30, accuracy: Low
        $x_10_2 = {48 33 c4 48 89 84 24 ?? ?? ?? ?? 48 8d 84 24 ?? ?? ?? ?? 48 8b f8 33 c0 b9 43 00 00 00 f3 aa 48 8d 8c 24}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_LR_2147964862_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b c7 66 33 84 4b f0 17 0a 00 66 89 44 4c 20 49 03 cc 48 83 f9 0c 72 ?? 48 8d 55 80 48 8d 4c 24 20}  //weight: 20, accuracy: Low
        $x_10_2 = {48 63 c2 ff c2 45 6b c0 21 0f b6 4c 05 d7 48 63 c2 44 03 c1 80 7c 05 d7 00}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_SXK_2147964949_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Tedy_SXK_2147964949_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {aa bb cc dd c7 45 ?? ee ff 11 22 c7 45 ?? 33 44 55 66 48 c7 45 ?? 29 00 00 00 c6 45}  //weight: 20, accuracy: Low
        $x_10_2 = {48 ba 87 7d 33 57 6b 7a 5b a9 48 89 85 ?? ?? ?? ?? 48 8b cb 48 8b f0 e8 ?? ?? ?? ?? 48 ba 65 9e 4d 35 47 f8 20 65}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_MKI_2147964952_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.MKI!MTB"
        threat_id = "2147964952"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {48 8b 84 24 30 02 00 00 48 05 90 13 00 00 48 89 44 24 48 48 8b 44 24 48 48 89 44 24 50 48 8b 44 24 50 48 89 44 24 30 48 8b 44 24 30 48 c7 00 00 00 00 00 48 8b 44 24 30 48 c7 40 08 00 00 00 00 48 8b 44 24 30 48 c7 40 10}  //weight: 20, accuracy: High
        $x_15_2 = "nvmlSystemGetDriverVersion" ascii //weight: 15
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_LRB_2147965175_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.LRB!MTB"
        threat_id = "2147965175"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {4d 89 d1 49 83 c9 02 46 0f be 0c 09 41 c1 e1 10 49 83 ca 01 46 0f be 14 11 41 c1 e2 08 45 31 d1}  //weight: 20, accuracy: High
        $x_10_2 = {46 0f be 14 89 46 0f be 5c 89 01 41 c1 e3 08 45 09 d3 46 0f be 54 89 02 41 c1 e2 10 42 0f b6 74 89 03 c1 e6 18 44 09 d6 44 09 de}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_KKC_2147965480_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.KKC!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "mason_shH" ascii //weight: 5
        $x_4_2 = "mason_passwords" ascii //weight: 4
        $x_3_3 = "mason_keylog_start" ascii //weight: 3
        $x_2_4 = "mason_discord_tokens" ascii //weight: 2
        $x_1_5 = "mason_uac_bypass_cmstp" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_AHF_2147965512_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.AHF!MTB"
        threat_id = "2147965512"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {48 8b c1 83 e0 ?? 0f b6 44 10 ?? 32 04 0e 88 04 0f 48 ff c1 48 3b cb 72}  //weight: 30, accuracy: Low
        $x_20_2 = {66 0f 67 c9 66 0f 67 c9 66 0f 6e c0 0f 57 c8 66 0f 7e c8 66 89 04 0f}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_AHF_2147965512_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.AHF!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {89 c2 48 69 c9 ?? ?? ?? ?? 48 c1 e9 ?? 29 ca d1 ea 01 ca c1 ea ?? 69 d2 ?? ?? 00 00 29 d0 69 ?? ?? 0b 00 00 48 89 d0}  //weight: 30, accuracy: Low
        $x_20_2 = "\\\\.\\pipe\\dumper_pipe_" ascii //weight: 20
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_WD_2147965665_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.WD!MTB"
        threat_id = "2147965665"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {b8 d3 4d 62 10 41 f7 e0 c1 ea 03 0f be c2 6b c8 7d 41 0f b6 c0 2a c1 2c 71 41 30 01 41 ff c0 4d 8d 49 01 41 83 f8 10 7c d7}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_CZ_2147965920_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CZ!MTB"
        threat_id = "2147965920"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {44 31 e5 48 83 c3 01 40 88 2c 30 48 8b 84 24}  //weight: 5, accuracy: High
        $x_5_2 = {48 89 c8 0f b6 09 4c 8d 40 ?? 48 83 c0 01 29 c1 8d 14 01 30 10 48 83 c0 01 4c 39 c0 75}  //weight: 5, accuracy: Low
        $x_1_3 = "--no-antivm" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_CS_2147966000_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CS!MTB"
        threat_id = "2147966000"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {47 88 14 18 4d 8d 4b ?? 49 39 c9 7d 2f 4d 89 ca 49 83 e1 ?? 4d 89 d3 4d 29 ca 46 0f b6 0c 1a 49 83 fa}  //weight: 5, accuracy: Low
        $x_5_2 = {46 0f b6 54 14 ?? 45 31 ca 49 39 cb 72}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_MKJ_2147966288_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.MKJ!MTB"
        threat_id = "2147966288"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {46 0f b7 14 49 45 8d 5a bf 41 8d 5a 20 66 41 83 fb 1a 41 0f 43 da 44 0f b6 d3 49 31 c2 4d 0f af d0 0f b6 c7 4c 31 d0 49 0f af c0 49 ff c1 4c 39 ca}  //weight: 20, accuracy: High
        $x_15_2 = {44 0f b6 c1 49 31 d0 4d 0f af c1 8a 08 48 ff c0 4c 89 c2 84 c9}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_DC_2147966832_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.DC!MTB"
        threat_id = "2147966832"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {44 8d 4d ff 8b cf 42 8b 14 8b 44 8d 04 bd 00 00 00 00 8b c2 c1 e9 03 c1 e8 05 44 33 c0 8b c2 c1 e0 04 33 c8 8b c5 83 e0 03 44 03 c1 49 33 c3 41 8b e9 41 33 14 84 41 8b c2 33 c7 03 d0 44 33 c2 45 29 07 41 8b 3f 4d 8d 7f fc 45 85 c9 75}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_SXJ_2147967065_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.SXJ!MTB"
        threat_id = "2147967065"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {66 41 83 f8 19 0f 47 d1 0f b6 c2 41 33 c2 69 c8 93 01 00 01 41 0f b7 01 44 8b d1 41 c1 ea 10 44 33 d1 66 85 c0}  //weight: 30, accuracy: High
        $x_20_2 = {eb cc 48 89 6c 24 58 e8 ?? ?? ?? ?? b9 90 d4 15 9d 48 8b d8 e8 ?? ?? ?? ?? 4c 8b f0 48 85 db}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_AHT_2147968061_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {43 0f b6 14 08 8b c1 48 33 d0 0f b6 c2 c1 e9 ?? 33 0c 86 49 ff c0 4d 3b c2}  //weight: 3, accuracy: Low
        $x_1_2 = "shutdown /s /f /t 0" ascii //weight: 1
        $x_1_3 = "118.107.29.135" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_BAE_2147968386_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.BAE!MTB"
        threat_id = "2147968386"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "main.main" ascii //weight: 1
        $x_1_2 = "main.isvutvjr" ascii //weight: 1
        $x_1_3 = "main.bczdupzeveib" ascii //weight: 1
        $x_1_4 = "main.uywzuvxrdyvouxx" ascii //weight: 1
        $x_1_5 = "main.ndmndrlb" ascii //weight: 1
        $x_1_6 = "main.wrgkzfzxvpzioo" ascii //weight: 1
        $x_1_7 = "main.boooiygw" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_BAE_2147968386_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.BAE!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Shellcode thread created in callback" ascii //weight: 1
        $x_1_2 = "Shellcode copied to executable memory" ascii //weight: 1
        $x_1_3 = "Attempting self-injection" ascii //weight: 1
        $x_1_4 = "VirtualAllocEx succeeded" ascii //weight: 1
        $x_1_5 = "Self-injection thread is running" ascii //weight: 1
        $x_1_6 = "Self-injection completed - keeping thread alive" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_VGK_2147968691_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.VGK!MTB"
        threat_id = "2147968691"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {8b c2 48 8d 4d e4 48 03 c8 ff c2 0f b6 01 41 2a c1 41 32 c0 88 01 8b 45 e0 3b d0 73 0c 44 0f b6 4d fd 44 0f b6 45 fc eb d7}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_VGL_2147968692_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.VGL!MTB"
        threat_id = "2147968692"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {8b c2 48 8d 4c 24 24 48 03 c8 ff c2 0f b6 01 41 2a c1 41 32 c0 88 01 8b 44 24 20 3b d0 73 0e 44 0f b6 4c 24 31 44 0f b6 44 24 30 eb d3}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_CAE_2147968887_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CAE!MTB"
        threat_id = "2147968887"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {4c 89 c0 31 d2 49 f7 f2 89 c8 83 e0 1f 44 30 cb 40 30 eb 44 30 f7 40 30 df}  //weight: 1, accuracy: High
        $x_1_2 = {41 0f b6 1c 10 48 d3 e3 48 09 de 48 ff c2 48 83 c1 ?? 48 39 d7 75}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_CAF_2147969218_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CAF!MTB"
        threat_id = "2147969218"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {48 8d 94 24 ?? ?? ?? ?? 80 30 ?? 48 89 84 24 ?? ?? ?? ?? 48 8d 84 24 ?? ?? ?? ?? 0f 1f 44 00 00 80 30 ?? 80 70 01 ?? 48 83 c0 02 48 39 d0 75}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_CAG_2147969219_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CAG!MTB"
        threat_id = "2147969219"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {48 89 c2 83 e2 ?? 41 0f b6 14 16 41 32 54 06 ?? 88 14 06 48 83 c0 01 48 39 c3 75}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_LRL_2147969317_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.LRL!MTB"
        threat_id = "2147969317"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {41 0f b6 0c 31 41 8b c1 99 41 f7 ff 48 63 c2 42 2a 0c 28 b8 81 80 80 80 41 f7 e1 c1 ea 07 2a ca 41 2a c9 c0 c9 03 41 88 0c 31 41 ff c1 44 3b cf}  //weight: 20, accuracy: High
        $x_10_2 = {0f b6 44 0d 00 34 aa 88 84 0d e8 00 00 00 48 ff c1 48 83 f9 1d}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_CPIM_2147969399_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CPIM!MTB"
        threat_id = "2147969399"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {48 bb 21 2c 41 64 31 a1 49 e8 4c 8b d3 45 8b df 49 bc 5d ee a6 04 36 e6 7e f0}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_CAH_2147969419_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CAH!MTB"
        threat_id = "2147969419"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {31 c0 f3 48 ab 48 8d bc 24 ?? ?? ?? ?? 90 48 89 6c 24 ?? 48 8d 6c 24 ?? e8 ?? ?? ?? ?? 48 8b 6d 00 48 c7 84 24 ?? ?? ?? ?? 0a 00 00 00 48 8d 15 ?? ?? ?? ?? 48 89 94 24 ?? ?? ?? ?? 48 c7 84 24 ?? ?? ?? ?? 0a}  //weight: 10, accuracy: Low
...
rule Trojan_Win64_Tedy_PGTB_2147969422_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.PGTB!MTB"
        threat_id = "2147969422"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {40 0f b6 c6 0f b6 84 04 ?? ?? ?? ?? 41 30 04 37 48 83 c6 01 4c 39 e6 75}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_AHR_2147969437_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.AHR!MTB"
        threat_id = "2147969437"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {c7 44 24 68 65 00 55 00 c7 44 24 6c 70 00 64 00 c7 44 24 70 61 00 74 00 c7 44 24 74 65 00 00 00}  //weight: 20, accuracy: High
        $x_30_2 = {48 8b c2 48 8d 49 ?? 83 e0 ?? 48 ff c2 0f b6 44 04 40 30 41 ff 48 83 ef ?? 75}  //weight: 30, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_A_2147970184_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.A!AMTB"
        threat_id = "2147970184"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "re(.(gcm cu*l) -usebas https://" ascii //weight: 1
        $x_1_2 = "sal re (gcm ie?);" ascii //weight: 1
        $x_1_3 = "C:\\Users\\Work\\source\\repos\\Horinis" ascii //weight: 1
        $x_1_4 = "Horinis ltd  2026" ascii //weight: 1
...
rule Trojan_Win64_Tedy_MKO_2147970480_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.MKO!MTB"
        threat_id = "2147970480"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {c1 c8 0d 48 83 c1 01 89 c2 0f b6 41 ff 44 8d 58 9f 44 8d 48 e0 41 80 fb 1a 41 0f 42 c1 0f b6 c0 01 d0 48 39 ce}  //weight: 30, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_AHU_2147970794_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.AHU!MTB"
        threat_id = "2147970794"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {48 8b cf 48 8d ?? ?? ?? ?? ?? 8a 84 11 ?? ?? ?? ?? 34 ?? 88 84 0d f0 01 00 00 48 ff c1 48 83 f9 ?? 75 ?? 66 89 bd 0c 02 00 00 48 8b cf 8a 84 11 ?? ?? ?? ?? 34 ?? 88 84 0d 00 04 00 00 48 ff c1 48 83 f9 ?? 75}  //weight: 30, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_AHU_2147970794_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.AHU!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = "my_hidden_salt_" ascii //weight: 30
        $x_20_2 = "hmeobnfnfcmkhonpfncnpgohellobmbi" ascii //weight: 20
        $x_10_3 = "jpjhicpncnooeggpkclnfbhkihpnojn" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_GVX_2147971674_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.GVX!MTB"
        threat_id = "2147971674"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "://download.projectreal.net/" ascii //weight: 1
        $x_1_2 = "://api.projectreal.net/" ascii //weight: 1
        $x_1_3 = "/run /tn \"Real\\Launch" wide //weight: 1
        $x_1_4 = "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run" wide //weight: 1
        $x_1_5 = "Hidden -EncodedCommand" wide //weight: 1
        $x_1_6 = "-Recurse -Force -ErrorAction SilentlyContinue" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_MKT_2147972122_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.MKT!MTB"
        threat_id = "2147972122"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8b c8 b8 ad 8b db 68 f7 e9 c1 fa 0d 8b c2 c1 e8 1f 03 d0 69 c2 20 4e 00 00 2b c8 81 c1 88 13}  //weight: 20, accuracy: High
        $x_15_2 = {44 0f b6 04 10 45 84 c0 74 10 41 80 f0 7a 44 88 04 08 48 ff c0 49 3b c1}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_CAM_2147972784_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.CAM!MTB"
        threat_id = "2147972784"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "manx/shells" ascii //weight: 1
        $x_1_2 = "main.key=" ascii //weight: 1
        $x_1_3 = "socket[-] %sstatusbeacon[-]" ascii //weight: 1
        $x_1_4 = {41 e1 c1 07 e6 d6 18 e6 70 61 74 68 09 63 6f 6d 6d 61 6e 64 2d 6c 69 6e 65 2d 61 72 67 75 6d 65 6e 74 73}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ABTY_2147972953_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ABTY!MTB"
        threat_id = "2147972953"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {41 8b c0 48 8d 0d ?? ?? ?? ?? 83 e0 ?? 8a 04 08 41 32 04 30 41 88 04 18 41 ff c0 45 3b c7 72}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_YDQ_2147973571_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Tedy_YDR_2147973572_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {48 8d 84 24 a8 00 00 00 41 0f b6 c9 48 ff c0 30 0a 48 ff c2 41 ff c8 45 85 c0}  //weight: 1, accuracy: High
        $x_1_2 = "AadDDRTaSPtyAG57er#$ad!lDKTOPLTEL78pE" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_SNM_2147973578_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Tedy_CAN_2147973629_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {4c 89 cf 49 29 d1 45 31 c1 48 89 ca 48 c1 e1 ?? 48 29 d1 44 31 c9 88 0c 16 48 89 d1}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_AHV_2147973720_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Tedy_LRG_2147973742_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.LRG!MTB"
        threat_id = "2147973742"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "{\"ts\":%lld,\"injector\":true}" ascii //weight: 1
        $x_2_2 = "**Telegram tdata**" ascii //weight: 2
        $x_3_3 = "stealer_info" ascii //weight: 3
        $x_4_4 = "stealer_tokens" ascii //weight: 4
        $x_5_5 = "stealer_tdata" ascii //weight: 5
        $x_6_6 = "injector_heartbeat" ascii //weight: 6
        $x_7_7 = "SELECT host_key,name,encrypted_value FROM cookies LIMIT 200" ascii //weight: 7
        $x_8_8 = "powershell -nologo -noprofile -command \"Compress-Archive -Path '" ascii //weight: 8
        $x_10_9 = {41 8b 40 fc 4d 89 41 08 d3 e8 41 89 41 1c 41 0f b6 08 83 e1 0f 4a 0f be 84 19 c0 2d 04 00 42 8a 8c 19 d0 2d 04 00 4c 2b c0 41 8b 40 fc 49 8d 50 04 4d 89 41 08 d3 e8 41 89 41 20 41 8b 00}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (
...
rule Trojan_Win64_Tedy_SXP_2147973759_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {48 69 c9 6d 4e c6 41 48 8d 52 01 48 81 c1 39 30 00 00 48 8b c1 48 c1 e8 10 88 42 ff 49 83 e8 01 75 de}  //weight: 30, accuracy: High
        $x_20_2 = {49 63 46 3c 45 8b c7 40 32 ff 40 32 f6 40 32 ed 41 8b df 42 8b 8c 30 88 00 00 00 46 8b 5c 31 20 46 8b 54 31 1c 4d 03 de 46 8b 4c 31 24 4d 03 d6 46 8b 7c 31 18 4d 03 ce 45 85 ff 0f 84 0e 04 00 00}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_MKU_2147973785_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8b 4f 24 44 8b 96 88 00 00 00 49 03 c9 42 0f b7 14 41 8b 4f 1c 49 03 c9 44 8b 04 91 45 3b c2}  //weight: 20, accuracy: High
        $x_15_2 = {45 6b c9 21 41 0f b6 c0 44 03 c8 0f b6 02 84 c0}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_MKV_2147973790_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {6b d2 21 0f b6 c1 03 d0 49 03 de 8a 0b}  //weight: 20, accuracy: High
        $x_15_2 = {45 6b c0 21 0f b6 c0 44 33 c0 48 ff c2}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_ARS_2147973802_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Tedy_GH_2147973826_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.GH!MTB"
        threat_id = "2147973826"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {c6 85 90 03 00 00 67 80 b5 91 03 00 00 3a 80 b5 92 03 00 00 3b 80 b5 93 03 00 00 3c 80 b5 94 03 00 00 3d 80 b5 95 03 00 00 3e 80 b5 96 03 00 00 3f 80 b5 97 03 00 00 40 80 b5 98 03 00 00 41 80 b5 99 03 00 00 42}  //weight: 5, accuracy: High
        $x_1_2 = "LocalState\\WhatsApp" ascii //weight: 1
        $x_1_3 = "WhatsAppURLChat" ascii //weight: 1
        $x_1_4 = "ghost" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_AE_2147973832_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Tedy_MKX_2147974394_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.MKX!MTB"
        threat_id = "2147974394"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {83 f0 c3 48 83 c2 01 88 42 ff 0f b6 02 84 c0}  //weight: 20, accuracy: High
        $x_15_2 = {83 f2 c3 48 83 c1 01 88 51 ff 0f b6 11 84 d2}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_MKY_2147975159_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.MKY!MTB"
        threat_id = "2147975159"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8a 14 08 80 f2 5a 88 54 04 28 48 ff c0 48 83 f8 05}  //weight: 20, accuracy: High
        $x_10_2 = "IP: %s\\nCountry: %s\\nCookies: %d\\nPasswords: %d\\nWallets: %d\\nPC: %s\\nBot-ID: %s" ascii //weight: 10
        $x_5_3 = "Browsers\\Passwords\\Passwords_[%s]%s.txt" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Tedy_GPKM_2147975165_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.GPKM!MTB"
        threat_id = "2147975165"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_4_1 = {48 8b 00 48 8b 00 48 8b 40 20 48 89 04 24 48 8b 0c 24 48 b8 4c 6f 61 64 4c 69 62 72 48 89 04 24 c7 44 24 08 61 72 79}  //weight: 4, accuracy: High
        $x_3_2 = {48 89 04 24 48 8b 0c 24 48 b8 47 65 74 50 72 6f 63 41 48 89 04 24 c7 44 24 08 64 64 72 65 66 c7 44 24 0c 73 73 c6 44}  //weight: 3, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Tedy_ABTK_2147976399_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Tedy.ABTK!MTB"
        threat_id = "2147976399"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {45 0f b6 d2 42 8a 1c 06 89 d6 c1 ee 08 41 6b fa 7d 40 00 de 41 89 da 41 28 fa 45 00 ca 44 89 d3 80 e3 3f 40 00 f3 42 30 1c 18 49 ff c3 41 80 c1 11 81 c2}  //weight: 5, accuracy: High
        $x_5_2 = {89 ca 83 e2 1f 8a 54 14 30 30 c2 41 30 14 0e 48 ff c1 04}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
