...
rule Trojan_Win64_Rozena_AHD_2147959957_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.AHD!MTB"
        threat_id = "2147959957"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {33 c2 2b c2 48 98 48 8b [0-6] 0f be 04 01 8b [0-6] 33 c8 8b c1 48 63 4c 24 20 48 8b [0-6] 88 04 0a eb}  //weight: 30, accuracy: Low
        $x_20_2 = {48 63 4c 24 20 48 89 44 cc 50 48 63 44 24 20 48 8b 44 c4 50 48 89 44 24 40 c7 44 24 24 00 00 00 00 eb}  //weight: 20, accuracy: High
        $x_20_3 = {c6 44 24 53 65 c6 44 24 54 73 c6 44 24 55 73 c6 44 24 56 00 48 8d 54 24 48 48 8b 8c 24 88}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (
...
rule Trojan_Win64_Rozena_MKB_2147962472_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.MKB!MTB"
        threat_id = "2147962472"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_25_1 = {8b 45 f8 48 63 d0 48 8b 45 10 48 01 d0 44 0f b6 00 8b 45 fc 48 63 d0 48 8b 45 20 48 01 d0 0f b6 08 8b 45 f8 48 63 d0 48 8b 45 10 48 01 d0 44 89 c2 31 ca 88 10 83 45 fc 01 83 45 f8 01}  //weight: 25, accuracy: High
        $x_10_2 = "mysupersecretkey" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Rozena_AH_2147964910_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.AH!MTB"
        threat_id = "2147964910"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {0f 11 01 48 b8 2e 00 64 00 6c 00 6c 00 48 89 41 ?? 66 83 61 18 ?? 48 8d 54 24 24 83 22 ?? ff 15}  //weight: 20, accuracy: Low
        $x_30_2 = {48 89 f7 f3 aa 48 b8 50 00 41 00 54 00 48 00 48 8d 4c 24 26 48 89 01 66 83 61 08 ?? 48 89 f2 41 b8 ?? ?? 00 00 ff 15}  //weight: 30, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rozena_CM_2147965262_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.CM!MTB"
        threat_id = "2147965262"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {31 d2 4c 8b 6c 24 ?? c7 44 24 ?? 40 00 00 00 41 b9 00 10 00 00 4c 89 f1 ff 15}  //weight: 2, accuracy: Low
        $x_2_2 = {49 89 d9 49 89 f0 4c 89 f1 48 c7 44 24 ?? 00 00 00 00 49 89 c4 48 89 c2 ff 15 ?? ?? ?? ?? 45 31 c0 4c 89 ea 4c 89 e1 ff 15 ?? ?? ?? ?? 4c 89 e9 ff 15}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rozena_MCD_2147966146_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.MCD!MTB"
        threat_id = "2147966146"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {48 8b 0e 48 8b d7 41 ff d6 85 c0 0f 85 ?? ?? 00 00 48 83 c7 ?? ff c3 48 83 c6 ?? 83 fb ?? 72}  //weight: 2, accuracy: Low
        $x_2_2 = "Deobfuscated Payload" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Rozena_KKA_2147968225_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.KKA!MTB"
        threat_id = "2147968225"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8b 45 fc 48 63 d0 48 8b 45 10 48 01 d0 0f b6 08 8b 45 fc 48 63 d0 48 8b 45 10 48 01 d0 83 f1 01 89 ca 88 10 83 45 fc 01}  //weight: 20, accuracy: High
        $x_2_2 = "reverse_tcp_meterpreter" ascii //weight: 2
        $x_1_3 = "reverse_tcp_meterpreter_x64" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rozena_ARA_2147968348_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.ARA!MTB"
        threat_id = "2147968348"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {89 c1 ff c0 83 e1 07 41 8a 0c 08 30 0a 48 ff c2 3d 6c 05 00 00 75 e9}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Rozena_CB_2147976283_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.CB!MTB"
        threat_id = "2147976283"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {48 ff c9 44 8b 4c 24 08 41 8b 34 88 48 01 d6 48 31 c0 41 c1 c9 0d ac 41 01 c1 38 e0 75}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rozena_CZ_2147977182_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.CZ!MTB"
        threat_id = "2147977182"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {0f b6 04 10 89 c2 8b 45 ?? 31 d0 89 c1 8b 45 ?? 48 98 48 8d 15}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Rozena_PAHL_2147978142_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Rozena.PAHL!MTB"
        threat_id = "2147978142"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Rozena"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {4a 8d 0c 33 33 d2 48 8b c3 49 f7 f7 0f b6 84 15 ?? ?? ?? ?? 32 04 ?? 0f b6 d0 88 11 48 8d 0d}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
