...
rule Trojan_Win64_Injuke_LVK_2147969878_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Injuke.LVK!MTB"
        threat_id = "2147969878"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Injuke"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {b9 d8 85 40 00 ?? ?? ?? ?? ?? 81 c7 5d 13 3c 25 bf c9 54 66 51 31 0e 81 c7 e2 c3 da bf 81 ef 37 b8 36 dd 81 c6 01 00 00 00 81 ef 01 00 00 00 68 48 d7 a5 49 58 39 d6 75 c7}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Injuke_LR_2147972299_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Injuke.LR!MTB"
        threat_id = "2147972299"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Injuke"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {48 8b 4d a0 4c 8d 4d 98 c7 85 40 10 00 00 76 00 34 00 4c 8d 05 5f 55 01 00 c7 85 44 10 00 00 2e 00 30 00 48 8d 95 40 10 00 00 c7 85 48 10 00 00 2e 00 33 00 c7 85 4c 10 00 00 30 00 33 00 c7 85 50 10 00 00 31 00 39 00 66 44 89 ad 54 10 00 00 48 8b 01}  //weight: 20, accuracy: High
        $x_10_2 = {48 8b 4c 24 60 4c 8d 4d e8 33 c0 0f 29 45 b0 48 89 45 c0 48 8d 55 b0 45 33 c0 48 8b 01}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Injuke_SR_2147974476_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Injuke.SR!MTB"
        threat_id = "2147974476"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Injuke"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {42 8a 0c 00 32 0c 10 88 8c 04 6a 2b 00 00 48 ff c0}  //weight: 3, accuracy: High
        $x_1_2 = {4c 89 7c 24 20 41 b8 04 00 00 00 41 b9 08 00 00 00 48 89 e9 31 d2}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Injuke_GB_2147977583_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Injuke.GB!MTB"
        threat_id = "2147977583"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Injuke"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {41 0f b6 14 02 32 54 03 ?? 88 14 07 48 83 c0 01 49 39 c1}  //weight: 10, accuracy: Low
        $x_10_2 = {41 0f b6 14 00 41 32 54 01 ?? 41 88 14 02 48 83 c0 ?? 48 39 c1}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win64_Injuke_AB_2147978343_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Injuke.AB!MTB"
        threat_id = "2147978343"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Injuke"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {49 39 c5 74 ?? 89 c1 83 e1 0f 8a 8c 0c ?? ?? ?? ?? 30 4c 05 00 48 ff c0 eb}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
