...
rule Trojan_Win64_BroPass_A_2147978471_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/BroPass.A!MTB"
        threat_id = "2147978471"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "BroPass"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_25_1 = {48 c7 44 24 48 0f 00 00 00 48 89 5c 24 30 48 8d 8d d0 00 00 00 33 d2 66 c7 44 24 30 7b 00 41 b8 08 02 00 00 89 85 40 03}  //weight: 25, accuracy: High
        $x_5_2 = "AbeCustomCollect" ascii //weight: 5
        $x_3_3 = "\\Network\\Cookies" wide //weight: 3
        $x_2_4 = "\\Login Data" wide //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
