...
rule Trojan_Win64_Injector_NWB_2147969007_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Injector.NWB!MTB"
        threat_id = "2147969007"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Injector"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "iCAenGTOewfL.ayojID string; iCAenGTOewfL.lyPFow *GniY6Jk7iWK.EaYNdnv }]).Load" ascii //weight: 2
        $x_2_2 = "uPN1x7WGKig2.UisnTohHcxkR" ascii //weight: 2
        $x_1_3 = "fPuXS8l.(*G4NOnB17r).XORKeyStream" ascii //weight: 1
        $x_1_4 = "vcrl22QTuLuI.(*XWlAYV).MarshalBinary" ascii //weight: 1
        $x_1_5 = "ayCsaW.(*A91BhiJRI).NewProc" ascii //weight: 1
        $x_1_6 = "fPuXS8l.(*IOUwnBgVj82F).CryptBlocks" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Injector_MX_2147970168_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Injector.MX!MTB"
        threat_id = "2147970168"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Injector"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {45 8b c7 33 d2 b9 ff ff 1f 00 ff 15 06 de 01 00 48 8b f8 48 85 c0 0f 84 dd 00 00 00}  //weight: 1, accuracy: High
        $x_1_2 = {48 8b 45 c0 48 63 48 04 4c 89 6c 0d c0 48 8b 45 c0 48 63 48 04 8d 91 58 ff ff ff}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Injector_SXQ_2147973769_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_Injector_MKB_2147974577_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Injector.MKB!MTB"
        threat_id = "2147974577"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Injector"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {44 8b 42 24 44 8d 0c 09 4a 8d 0c 00 44 8b 42 1c 42 0f b7 0c 09 c1 e1 02 48 63 c9 48 8d 14 08 42 8b 14 02 48 01 d0}  //weight: 20, accuracy: High
        $x_15_2 = {44 6b c1 04 45 89 c0 49 01 c0 45 8b 0c 30 41 b8 6f 24 00 00 49 01 c1}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (
            ((1 of ($x_20_*))) or
...
rule Trojan_Win64_Injector_A_2147977412_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {4c 89 b5 a8 00 00 00 48 8b 05 ?? ?? ?? ?? 48 8d 8d a8 00 00 00 48 89 4c 24 20 4c 8b cf 4c 8b c3 48 8b 8d 80 00 00 00 ff d0 85 c0 75 49 48 39 bd a8 00 00 00 75 40 48 8b 05 ?? ?? ?? ?? 44 89 74 24 20}  //weight: 10, accuracy: Low
        $x_5_2 = {48 89 44 24 58 48 8d 1c 38 48 89 5c 24 68 4c 8b c7 33 d2 48 8b c8 e8 ?? ?? ?? ?? 48 89 5c 24 60 4c 8b c7 48 8b 54 24 58 48 8d 4c 24 70 ff 15 ?? ?? ?? ?? 48 8b 54 24 68 4c 89 74 24 68 48 8b 4c 24 60}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Injector_B_2147978326_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Injector.B!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {48 89 44 24 20 48 8b ce 41 b9 40 00 00 00 41 b8 06 00 00 00 ff 15 ?? ?? ?? ?? 85 c0 74 67 48 8d 44 24 38 41 b9 06 00 00 00 4c 8b c3 48 89 44 24 20 48 8b d7 48 8b ce ff 15}  //weight: 10, accuracy: Low
        $x_10_2 = {48 8d 4d e0 e8 ?? ?? ?? ?? 48 8d 55 80 48 83 fb 0f 48 0f 47 55 80 41 b8 01 00 00 00 48 8d 4d e0 e8}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
