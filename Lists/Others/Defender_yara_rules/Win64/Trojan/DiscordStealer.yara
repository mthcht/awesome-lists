...
rule Trojan_Win64_DiscordStealer_SXB_2147972662_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/DiscordStealer.SXB!MTB"
        threat_id = "2147972662"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "DiscordStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = "OurVaultStealer" ascii //weight: 30
        $x_20_2 = "Stealer.exe" ascii //weight: 20
        $x_10_3 = "kill.bat" ascii //weight: 10
        $x_5_4 = "discord" ascii //weight: 5
        $x_5_5 = "[\\w-]{24,26}\\.[\\w-]{6}\\.[\\w-]{25,110}" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_DiscordStealer_Z_2147974346_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/DiscordStealer.Z!MTB"
        threat_id = "2147974346"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "DiscordStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "steal_chrome_passwordsr" ascii //weight: 1
        $x_1_2 = "steal_firefox_passwordsr" ascii //weight: 1
        $x_1_3 = "steal_opera_gx_passwordsr" ascii //weight: 1
        $x_1_4 = "\\Discordz" ascii //weight: 1
        $x_1_5 = ".decrypt_payload" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
