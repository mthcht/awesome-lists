...
rule Trojan_Win64_Convagent_NC_2147900476_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.NC!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {0f 57 c0 0f 11 44 24 08 0f 11 44 24 18 48 8d 0d ce 99 02 00 48 89 4c 24 08 48 89 44 24 10 48 8b 44 24 30 48 89 44 24 18 48 8d 44 24 38 48 89 44 24 20 48 8d 44 24 08 48 89 04 24 e8 a2 fa 02 00 31 c0}  //weight: 2, accuracy: High
        $x_1_2 = {48 8d 05 90 d4 3d 00 48 89 04 24 e8 c7 78 fd ff 48 8b 84 24 80 00 00 00 84 00 8b 8c 24 88 00 00 00 48 63 c9 48 81 f9 00 00 00 40 0f 87 25 02 00 00}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Convagent_AL_2147924844_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.AL!MTB"
        threat_id = "2147924844"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "Sources\\Add\\vermut\\x64\\Release\\vermut.pdb" ascii //weight: 5
        $x_2_2 = "powershell.exe -WindowStyle Hidden -ExecutionPolicy Bypass -Command \"Add-MpPreference -ExclusionPath" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Convagent_MK_2147953620_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.MK!MTB"
        threat_id = "2147953620"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = {4c 63 c1 48 8d 05 0f e8 ff ff 48 89 44 24 30 c6 44 24 20 00 48 8d 15 1e 41 03 00 48 8d 4c 24 30}  //weight: 15, accuracy: High
        $x_10_2 = {48 89 4c 24 30 48 8d 0d 12 49 03 00 48 89 4c 24 20 48 8d 15 26 49 03 00 4c 8d 4c 24 30 41 b8 04 00 00 00 48 89 c1}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Convagent_MK_2147953620_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.MK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = {0f b6 43 40 83 63 44 fe 83 e0 f0 83 c8 05 88 43 40 f0 83 05 c9 bb 0b 00 01 48 8b 4b 30 48 85 c9}  //weight: 15, accuracy: High
        $x_10_2 = {4c 8b 05 f9 13 0a 00 41 89 fa 4c 89 cd 41 c1 fa 05 4d 63 d2 4d 8b 18 41 89 f8 41 83 e0 1f 49 c1 e0 06 4f 03 04 d3 41 80 78 08}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Convagent_MKA_2147957518_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.MKA!MTB"
        threat_id = "2147957518"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_15_1 = {41 bc 01 00 00 00 4c 89 e1 48 8b 95 98 05 00 00 48 8b 9d b8 05 00 00 49 89 d8 e8 ?? ?? ?? ?? 48 89 9d 00 05 00 00 4c 89 a5 80 05 00 00 4c 89 a5 08 05 00 00 48 89 9d 10 05 00 00 48 89 f1 48 8b 95 68 05}  //weight: 15, accuracy: Low
        $x_10_2 = {4c 01 fb 48 89 9d e0 04 00 00 0f 10 85 00 05 00 00 0f 29 85 d0 04 00 00 48 8b 95 d0 03 00 00 48 8d 04 55}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Convagent_ARR_2147957637_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {44 0f b6 c9 42 0f b6 14 0c 42 8d 0c 12 44 0f b6 d1 42 0f b6 0c 14 42 88 0c 0c 42 88 14 14 42 0f b6 0c 0c 03 d1 0f b6 ca 0f b6 14 0c 30 14 28 ff c0 3b c3}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Convagent_ARR_2147957637_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.ARR!MTB"
...
rule Trojan_Win64_Convagent_LMA_2147959066_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.LMA!MTB"
        threat_id = "2147959066"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
...
rule Trojan_Win64_Convagent_SXF_2147962947_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.SXF!MTB"
        threat_id = "2147962947"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {48 b8 8a ba 71 12 b4 83 d2 dc 48 89 44 24 ?? 48 8b 44 24 ?? 48 89 44 24 ?? 48 b8 61 91 2c 5b a5 ce 58 d0 48 89 44 24 ?? 48 8b 44 24 ?? 48 89 44 24 ?? 49 b8 cf c2 18 66 e4 f1 bd bf}  //weight: 30, accuracy: Low
        $x_10_2 = {33 db 48 8b 03 48 8b cb ff 10 48 8b 03 ba 01 00 00 00 48 8b cb ff 50 08 b9 10 00 00 00}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Convagent_SXG_2147964946_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.SXG!MTB"
        threat_id = "2147964946"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {f3 0f 6f 8c 08 ?? ?? ?? ?? f3 0f 6f 84 05 ?? ?? ?? ?? 0f 57 c8 f3 0f 7f 8c 05 ?? ?? ?? ?? 48 83 c0 10 48 83 f8 20 7c d8}  //weight: 20, accuracy: Low
        $x_10_2 = {48 89 45 00 48 8b 45 00 48 89 45 ?? 48 8b 84 11 ?? ?? ?? ?? 48 31 44 0d ?? 48 83 c1 08 48 83 f9 10}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Convagent_VGX_2147967508_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.VGX!MTB"
        threat_id = "2147967508"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0f b6 c2 42 32 84 31 ?? ?? ?? ?? 88 04 0b 02 d1 80 e2 7f 48 ff c1 48 83 f9 3d 72 e4}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Convagent_SXH_2147967726_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.SXH!MTB"
        threat_id = "2147967726"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {83 e0 0f c1 e9 04 0f b7 04 47 66 89 44 24 ?? 8b c1 83 e0 0f c1 e9 04 0f b7 04 47 66 89 44 24 ?? 8b c1 83 e0 0f c1 e9 04}  //weight: 30, accuracy: Low
        $x_10_2 = {66 41 89 08 48 8d 52 ?? 0f b7 4c 55 ?? 4d 8d 40 ?? 41 ff c2 66 85 c9 75 e7}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Convagent_AHA_2147968043_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.AHA!MTB"
        threat_id = "2147968043"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {44 09 c0 44 0f b6 42 ff 41 c1 e0 ?? 44 09 c0 89 84 0c b8 00 00 00 48 83 c1 ?? 48 83 f9 ?? 75}  //weight: 30, accuracy: Low
        $x_20_2 = {88 4a fc 88 6a fd c1 ee ?? c1 e9 ?? 40 88 72 fe 88 4a ff 49 83 f9 ?? 75}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Convagent_AHF_2147971170_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = "main.(*Client).connectWithRetry" ascii //weight: 30
        $x_20_2 = "main.(*Client).screenshotLoop" ascii //weight: 20
        $x_10_3 = "main.(*Client).handleExecuteCommand" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_Convagent_LR_2147972499_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.LR!MTB"
        threat_id = "2147972499"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {45 8b ca 8b c6 41 f7 e2 c1 ea 04 0f b7 c2 6b c8 32 41 0f b7 c2 66 2b c1 66 41 03 c4 66 42 31 84 4d ac 01 00 00 45 03 d7 41 83 fa 05}  //weight: 20, accuracy: High
        $x_10_2 = {45 03 d7 48 8d 40 02 66 44 39 30 75 ?? 45 03 d7 41 8b da 4c 8d 5d 58 4d 0f 44 de}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
            ((1 of ($x_20_*))) or
...
rule Trojan_Win64_Convagent_AHG_2147974544_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.AHG!MTB"
        threat_id = "2147974544"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {48 8d 44 24 68 4c 89 7c 24 30 4c 89 64 24 38 4c 8d 4c 24 60 f3 0f 6f 44 24 30 48 89 6c 24 40 33 d2 4c 89 74 24 48 41 b8 ?? ?? ?? ?? 0f 57 44 24 40 33 c9 66 0f 7f 44 24 50}  //weight: 30, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_Convagent_MKD_2147974772_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Convagent.MKD!MTB"
        threat_id = "2147974772"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Convagent"
        severity = "Critical"
