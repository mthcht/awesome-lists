...
rule Trojan_Win64_Kimsuky_DA_2147974418_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/Kimsuky.DA!MTB"
        threat_id = "2147974418"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "Kimsuky"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "wusa.exe" ascii //weight: 1
        $x_1_2 = "201ef99a-7fa0-444c-9399-19ba84f12a1a" ascii //weight: 1
        $x_1_3 = "winver.exe" ascii //weight: 1
        $x_1_4 = "taskmgr.exe" ascii //weight: 1
        $x_1_5 = "UpdateProcThreadAttribute" ascii //weight: 1
        $x_1_6 = "ncalrpc" ascii //weight: 1
        $x_1_7 = "CreateProcessWithLogonW" ascii //weight: 1
        $x_1_8 = "cmd /c %s" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
