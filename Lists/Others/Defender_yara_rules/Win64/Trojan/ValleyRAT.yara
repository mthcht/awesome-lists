...
rule Trojan_Win64_ValleyRAT_EM_2147973551_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ValleyRAT.EM!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {42 80 3c 01 63 75 38 42 80 7c 01 01 6f 75 30 42 80 7c 01 02 64 75 28 42 80 7c 01 03 65 75 20 42 80 7c 01 04 6d 75 18 42 80 7c 01 05 61 75 10 42 80 7c 01 06 72 75 08 42 80 7c 01 07 6b}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ValleyRAT_AHA_2147973729_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ValleyRAT.AHA!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = "\"%s\" --child \"%s\"" wide //weight: 30
        $x_20_2 = "%s%08X%08X.exe" ascii //weight: 20
        $x_10_3 = "C:\\windows\\system32\\drivers\\vmmouse.sys" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ValleyRAT_AAVR_2147973807_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win64_ValleyRAT_ABAT_2147974691_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ValleyRAT.ABAT!MTB"
        threat_id = "2147974691"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ValleyRAT"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {4c 8b c8 4c 2b d0 43 0f b6 14 0a 4d 8d 49 01 44 0f b6 05 ?? ?? ?? ?? 44 32 c2 45 88 41 ff 49 83 ee}  //weight: 5, accuracy: Low
        $x_5_2 = {48 8d 0c 24 48 03 ca 48 ff c2 42 0f b6 04 01 34 9e 88 01 49 3b d1}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ValleyRAT_SK_2147975014_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ValleyRAT.SK!MTB"
        threat_id = "2147975014"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ValleyRAT"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {8b c2 48 8d 7f 01 0f b6 4c 05 90 8d 42 01 32 4c 3e ff 41 8b d1 83 f8 20 88 4f ff 0f 42 d0 49 83 e8 01 75 dc}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_ValleyRAT_PL_2147978895_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/ValleyRAT.PL!MTB"
        threat_id = "2147978895"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "ValleyRAT"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {01 d1 0f b6 c9 8a 04 08 88 44 24 ?? 44 0f b6 44 24 ?? 48 8b 44 24 ?? 48 8b 4c 24 ?? 0f b6 14 08 44 31 c2 88 14 08 48 8b 44 24 ?? 48 83 c0 ?? 48 89 44 24 ?? e9}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
