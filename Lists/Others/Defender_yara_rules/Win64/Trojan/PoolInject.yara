...
rule Trojan_Win64_PoolInject_KK_2147957800_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/PoolInject.KK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {48 89 4b 10 48 89 4b 28 89 4b 30 48 89 4b 38 89 4b 40 48 89 4b 48 89 4b 50 48 89 4b 58 48 89 43 60 89 4b 18}  //weight: 20, accuracy: High
        $x_10_2 = {33 d2 0f be 0d ?? ?? ?? 00 03 c5 03 c6 f7 f1 0f be 0d ?? ?? ?? 00 2b c1 0f af c7 85 c0}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_PoolInject_KK_2147957800_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/PoolInject.KK!MTB"
...
rule Trojan_Win64_PoolInject_GVB_2147959812_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/PoolInject.GVB!MTB"
        threat_id = "2147959812"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "PoolInject"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {48 01 f3 48 83 c7 08 ff 15 68 1c 00 00 48 95 8a 07 48 ff c7 08 c0 74 d7 79 0a 48 0f b7 17 48 83 c7 02 eb 0a 48 89 f9 48 89 fa ff c8 f2 ae 48 89 e9 ff 15 4e 1c 00 00 48 09 c0 74 09 48 89 03 48 83 c3 08 eb ca}  //weight: 2, accuracy: High
        $x_1_2 = {48 89 4c 24 08 48 83 ec 28 e8 12 27 1a 00 83 e0 01 89 44 24 38 8b 44 24 38 b9 0d f0 ad ba ba ef be ad de 85 c0 0f 45 ca 48 89 4c 24 38 4c 8b 44 24 38 41 c7 00 7b 00 00 00 41 8b 00 05 c8 01 00 00 89 44 24 38 8b 44 24 38 85 c0 7e 0d}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_PoolInject_AHE_2147961247_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/PoolInject.AHE!MTB"
        threat_id = "2147961247"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "PoolInject"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {8b 44 24 04 0f b6 0c 24 48 8b 54 24 08 0f b6 04 02 33 c1 8b 4c 24 04 48 8b 54 24 08 88 04 0a e9}  //weight: 30, accuracy: High
        $x_20_2 = {c7 45 f0 4c 6f 61 64 c7 45 f4 4c 69 62 72 c7 45 f8 61 72 79 41 c6 45 fc 00}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win64_PoolInject_SXE_2147964692_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/PoolInject.SXE!MTB"
        threat_id = "2147964692"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "PoolInject"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {48 8b c2 48 c1 e8 3e 48 33 d0 49 0f af d0 48 03 d1 48 89 94 cc c0 00 00 00 48 ff c1 48 81 f9 38 01 00 00 72 db}  //weight: 30, accuracy: High
        $x_10_2 = {4c 8b 75 c8 49 c1 e6 04 4d 03 f0 48 ff 45 c8 41 0f b6 06 ff c8 83 f8 0f}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
