...
rule Trojan_Win64_RustyStealer_GDK_2147969935_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/RustyStealer.GDK!MTB"
        threat_id = "2147969935"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "RustyStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {6a 03 41 5c 6a 02 41 5e 4c 8b 2d ?? ?? ?? ?? 4c 8b 8d ?? ?? ?? ?? 41 83 ec ?? ?? ?? 4c 89 7c 24 ?? 44 89 f1 ba ?? ?? ?? ?? 45 31 c0 4c 89 ce 41 ff d5}  //weight: 5, accuracy: Low
        $x_5_2 = {b9 80 00 00 00 31 c0 48 89 d7 f3 ab 4c 8d 85 ?? ?? ?? ?? 41 c7 00 ?? ?? ?? ?? 31 c9 ff 15}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_RustyStealer_ARST_2147970953_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/RustyStealer.ARST!MTB"
        threat_id = "2147970953"
        type = "Trojan"
        platform = "Win64: Windows 64-bit platform"
        family = "RustyStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {44 89 d2 c1 ea 18 41 32 54 0c ff 45 8b 4c 0c f1 41 88 54 0c ff 45 89 d3 41 c1 eb 10 45 32 5c 0c fe 45 88 5c 0c fe 41 8b 74 0c fa 44 31 ce 41 89 74 0c fa 41 32 54 0c f8 41 88 54 0c f8 45 30 c3 45 88 5c 0c f7 44 31 d6 41 89 74 0c f3 45 89 c8}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win64_RustyStealer_NR_2147971204_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Reused P4ssw0rds" ascii //weight: 1
        $x_2_2 = "schtasks /createschtasks /run /tschtasks /deleteipconfig /displa" ascii //weight: 2
        $x_2_3 = "tracesteale1" ascii //weight: 2
        $x_1_4 = "powersheH" ascii //weight: 1
        $x_1_5 = "cookies" ascii //weight: 1
        $x_1_6 = "payload" ascii //weight: 1
        $x_1_7 = "p4ssw0rd reused across multiple sites" ascii //weight: 1
...
rule Trojan_Win64_RustyStealer_FUA_2147973576_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win64/RustyStealer.FUA!MTB"
