rule VirTool_Win64_Sysmekilesz_A_2147919486_0
{
    meta:
        author = "defender2yara"
        detection_name = "VirTool:Win64/Sysmekilesz.A!MTB"
        threat_id = "2147919486"
        type = "VirTool"
    ...
    strings:
        ...
        $x_1_4 = {48 8b 4d d8 48 89 e0 48 c7 40 30 00 00 00 00 c7 40 28 00 00 00 00 c7 40 20 03 00 00 00 45 31 c0 45 89 c1 ba ff 01 0f 00 ?? ?? ?? ?? ?? 48 89 45 d0 ?? ?? 48 8b 45 d0 48 89 85 98 00 00 00}  //weight: 1, accuracy: Low
