...
rule Ransom_Win64_FileCoder_KK_2147948345_1
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:Win64/FileCoder.KK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "All your files are encrypted and stolen" ascii //weight: 5
        $x_4_2 = "Files.EncryptFileName" ascii //weight: 4
        $x_3_3 = "Wallpaper.ChangeDesktopWallpaper" ascii //weight: 3
        $x_2_4 = "Log.DiscordLogMessage" ascii //weight: 2
        $x_1_5 = "Global\\Shalom" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Ransom_Win64_FileCoder_AMR_2147963744_0
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:Win64/FileCoder.AMR!MTB"
        threat_id = "2147963744"
        type = "Ransom"
        platform = "Win64: Windows 64-bit platform"
        family = "FileCoder"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {49 8b 4c 1e 08 49 8b 54 1e 10 4d 8b 07 49 83 c0 10 4d 8b 0c 24 49 83 c1 10 48 89 7c 24 28 4c 89 6c 24 20 e8 ?? ?? ?? ?? 48 83 c3 20 48 39 de 75 cf}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Ransom_Win64_FileCoder_RS_2147965804_0
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:Win64/FileCoder.RS!MTB"
        threat_id = "2147965804"
        type = "Ransom"
        platform = "Win64: Windows 64-bit platform"
        family = "FileCoder"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Step 12: File encryption complete" ascii //weight: 1
        $x_1_2 = "Step 9: Getting file paths..." ascii //weight: 1
        $x_1_3 = "[+] Walking through directories recursively" ascii //weight: 1
        $x_1_4 = "Step 13: Sending data to server.." ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Ransom_Win64_FileCoder_ATP_2147969879_1
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:Win64/FileCoder.ATP!MSR"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "root\\default path SystemRestore call Disable" ascii //weight: 1
        $x_1_2 = "/set {default} bootstatuspolicy ignoreallfailures" ascii //weight: 1
        $x_1_3 = "/set {default} recoveryenabled no" ascii //weight: 1
        $x_1_4 = "D:\\C# Projects\\NoMatter\\bin\\Release\\net10.0\\win-x64\\native\\NoMatter.pdb" ascii //weight: 1
        $x_1_5 = "files were encrypted. Total time:" ascii //weight: 1
        $x_1_6 = "SeLockMemoryPrivilege" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
