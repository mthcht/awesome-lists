...
rule Trojan_MSIL_NjRat_BAB_2147951957_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_NjRat_SLAA_2147954403_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.SLAA!MTB"
        threat_id = "2147954403"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {06 28 14 00 00 0a 74 12 00 00 01 0b 07 72 ?? 00 00 70 6f 15 00 00 0a 00 07 6f 16 00 00 0a 0c 08 6f 17 00 00 0a 28 18 00 00 0a 73 19 00 00 0a 0d 09 6f 1a 00 00 0a 13 04 11 04 28 1b 00 00 0a}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NjRat_SLCB_2147954517_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.SLCB!MTB"
        threat_id = "2147954517"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {28 1e 00 00 0a 20 70 11 01 00 28 1f 00 00 0a 72 01 00 00 70 28 20 00 00 0a 0a 28 14 00 00 06 0b 06 07 28 15 00 00 06 0c 08 28 13 00 00 06 de 0c}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NjRat_MCJ_2147954953_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.MCJ!MTB"
        threat_id = "2147954953"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {41 65 73 00 43 72 65 61 74 65 00 53 79 6d 6d 65 74 72 69 63 41 6c 67 6f 72 69 74 68 6d 00 73 65 74 5f 4b 65}  //weight: 1, accuracy: High
        $x_1_2 = {78 75 79 2e 65 78 65 00 4c 6f 61 64 65 72 00 6d 73 63 6f 72 6c 69 62}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NjRat_BAC_2147958338_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.BAC!MTB"
        threat_id = "2147958338"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {13 05 11 05 08 ?? ?? ?? ?? ?? 11 05 07 ?? ?? ?? ?? ?? 11 05 17 ?? ?? ?? ?? ?? 11 05 18 ?? ?? ?? ?? ?? 73 31 00 00 0a 13 06 02 1f 30 02 8e b7 1f 30 da 73 32 00 00 0a 11 05 ?? ?? ?? ?? ?? 16 73 34 00 00 0a 13 07 11 07 11 06 ?? ?? ?? ?? ?? de 0c 11 07 2c 07 11 07 ?? ?? ?? ?? ?? dc 11 06 ?? ?? ?? ?? ?? 0a de 1c de 0c}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NjRat_BAD_2147958551_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.BAD!MTB"
        threat_id = "2147958551"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {00 1f 20 8d 39 00 00 01 13 04 08 ?? ?? ?? ?? ?? 03 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 13 05 11 05 16 11 04 16 1f 10 ?? ?? ?? ?? ?? 00 11 05 16 11 04 1f 0f 1f 10 ?? ?? ?? ?? ?? 00 07 11 04 ?? ?? ?? ?? ?? 00 07 18 ?? ?? ?? ?? ?? 00 07 ?? ?? ?? ?? ?? 13 06 02 ?? ?? ?? ?? ?? 13 07 ?? ?? ?? ?? ?? 11 06 11 07 16 11 07 8e 69 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 0d 09 0a de 11}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NjRat_BAD_2147958551_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.BAD!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {13 11 11 14 73 37 00 00 0a 13 16 11 16 11 11 16 73 38 00 00 0a 0d 11 14 8e b7 17 da 17 d6 8d 34 00 00 01 13 07 09 11 07 16 11 07 8e b7 ?? ?? 00 00 0a 0a ?? ?? 00 00 0a 13 06 11 16 ?? ?? 00 00 0a 00 09 ?? ?? 00 00 0a 00 ?? ?? 00 00 0a 11 07 16 06 ?? ?? 00 00 0a 13 04 11 04 ?? ?? 00 00 0a 13 13 11 06 ?? ?? 00 00 0a 72 c6 9d 01 70 ?? ?? 00 00 0a 17 17 8d 03 00 00 01 13 17 11 17 16 11 13 a2 00 11 17}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NjRat_AHNB_2147959504_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.AHNB!MTB"
        threat_id = "2147959504"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {fe 0c 03 00 fe 0c 02 00 9a fe 0e 01 00 fe 0c 00 00 fe 0c 01 00 20 02 00 00 00 28 ?? 01 00 0a 28 ?? 01 00 0a 28 ?? 01 00 0a 28 ?? 00 00 0a fe 0e 00 00 fe 0c 02 00 20 01 00 00 00 d6 fe 0e 02 00 fe 0c 02 00 fe 0c 03 00 8e b7 3f}  //weight: 4, accuracy: Low
        $x_2_2 = {11 09 11 0e 8f 16 00 00 01 25 71 16 00 00 01 11 0c 11 0e 91 61 d2 81 16 00 00 01 11 0e 17 58 13 0e 11 0e 11 08 32 d9}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NjRat_SLWM_2147962451_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.SLWM!MTB"
        threat_id = "2147962451"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {73 ff 05 00 06 13 0a 11 0a 28 fb 00 00 06 7d 06 00 00 04 11 0a 28 fc 00 00 06 7d 07 00 00 04 28 fd 00 00 06 13 0f 28 fe 00 00 06 13 10}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NjRat_AZQB_2147963473_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.AZQB!MTB"
        threat_id = "2147963473"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {17 0c 2b 32 0f 01 08 17 03 08 17 28 ?? 00 00 0a 28 ?? 00 00 0a 20 00 ?? 00 00 da 04 6f ?? 00 00 0a d6 28 ?? 00 00 0a 28 ?? 00 00 0a 28 ?? 00 00 0a 00 08 17 d6 0c 08 07 31 ca}  //weight: 5, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
...
rule Trojan_MSIL_NjRat_ADSB_2147964734_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.ADSB!MTB"
        threat_id = "2147964734"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {0a 13 05 00 11 05 20 00 01 00 00 6f ?? 00 00 0a 00 11 05 20 80 00 00 00 6f ?? 00 00 0a 00 07 09 20 e8 03 00 00 73 ?? 00 00 0a 13 06 11 05 11 06 11 05 6f ?? 00 00 0a 1e 5b 6f ?? 00 00 0a 6f ?? 00 00 0a 00 11 05 11 06 11 05 6f ?? 00 00 0a 1e 5b 6f ?? 00 00 0a 6f ?? 00 00 0a 00 11 05 17 6f ?? 00 00 0a 00 11 04 11 05 6f ?? 00 00 0a 17 73 ?? 00 00 0a 13 07 00 11 07 02 16 02 8e 69 6f ?? 00 00 0a 00 11 07 6f ?? 00 00 0a 00 00 de 14 11 07 14 fe 01 13 09 11 09 2d 08 11 07 6f ?? 00 00 0a 00 dc 00 11 04 6f ?? 00 00 0a 13 08 de 28}  //weight: 5, accuracy: Low
        $x_1_2 = "CreateDecryptor" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
...
rule Trojan_MSIL_NjRat_PAR_2147972484_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.PAR!MTB"
        threat_id = "2147972484"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {00 00 0a 00 07 17 6f ?? 00 00 0a 00 07 18 6f ?? 00 00 0a 00 07 6f ?? 00 00 0a 0c 00 73 ?? 00 00 0a 0d 00 09 08 17 73 ?? 00 00 0a 13 04 11 04 02 16 02 8e 69 6f ?? 00 00 0a 00 11 04 6f ?? 00 00 0a 00 09 6f}  //weight: 4, accuracy: Low
        $x_2_2 = {00 73 39 00 00 0a 0d 08 09 6f ?? 00 00 0a 00 09 6f ?? 00 00 0a 0a}  //weight: 2, accuracy: Low
        $x_1_3 = "FromBase64String" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
...
rule Trojan_MSIL_NjRat_PR_2147972587_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.PR!MTB"
        threat_id = "2147972587"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {00 00 0a 00 07 04 6f ?? 00 00 0a 00 00 73 ?? ?? 00 0a 0c 00 08 07 6f ?? 00 00 0a 17 73 ?? ?? 00 0a 0d 09 02 16 02 8e 69 6f ?? 00 00 0a 00 09 6f 3d 00 00 0a 00}  //weight: 5, accuracy: Low
        $x_3_2 = {00 73 39 00 00 0a 0d 08 09 6f ?? 00 00 0a 00 09 6f ?? 00 00 0a 0a}  //weight: 3, accuracy: Low
        $x_1_3 = "FromBase64String" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
...
rule Trojan_MSIL_NjRat_PU_2147972588_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NjRat.PU!MTB"
        threat_id = "2147972588"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NjRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {00 00 0a 00 07 6f ?? 00 00 0a 0c 00 73 ?? 00 00 0a 0d 00 09 08 17 73 ?? 00 00 0a 13 04 11 04 02 16 02 8e 69 6f ?? 00 00 0a 00 11 04 6f ?? 00 00 0a 00 09 6f ?? 00 00 0a 0a}  //weight: 4, accuracy: Low
        $x_2_2 = "$1131fc1b-81d6-4a65-9b0d-327a01fa1398" ascii //weight: 2
        $x_1_3 = "servidor.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NjRat_AUXB_2147973579_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {0a 0b 07 20 00 01 00 00 6f ?? 00 00 0a 00 07 17 6f ?? 00 00 0a 00 07 18 6f ?? 00 00 0a 00 07 03 6f ?? 00 00 0a 00 07 04 6f ?? 00 00 0a 00 00 73 ?? 00 00 0a 0c 00 08 07 6f ?? 00 00 0a 17 73 ?? 00 00 0a 0d 09 02 16 02 8e 69 6f ?? 00 00 0a 00 09 6f ?? 00 00 0a 00 de 0c}  //weight: 5, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
        $x_1_3 = "CreateDecryptor" ascii //weight: 1
    condition:
        (filesize < 20MB) and
