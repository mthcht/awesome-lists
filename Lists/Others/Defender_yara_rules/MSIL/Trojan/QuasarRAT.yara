...
rule Trojan_MSIL_QuasarRAT_BAA_2147958406_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/QuasarRAT.BAA!MTB"
        threat_id = "2147958406"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {00 00 0a 03 1f 20 ?? ?? 00 00 0a 16 1f 20 ?? ?? 00 00 0a ?? ?? 00 00 0a ?? ?? 00 00 0a 06 1f 10 8d 08 00 00 01 ?? ?? 00 00 0a 06 ?? ?? 00 00 0a 0b 07 02 16 02 8e 69 ?? ?? 00 00 0a 0c de 14 07 2c 06 07 6f 08 00 00 0a dc}  //weight: 3, accuracy: Low
        $x_1_2 = "CreateDecryptor" ascii //weight: 1
...
rule Trojan_MSIL_QuasarRAT_SI_2147958435_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/QuasarRAT.SI!MTB"
        threat_id = "2147958435"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {06 28 41 05 00 06 0b 28 41 05 00 06 0c 28 d5 00 00 0a 7e 47 01 00 04 6f d7 00 00 0a 0d 08 8e 69 8d 1b 01 00 01 13 04 16 13 05 2b 1e 11 04 11 05 08 11 05 91 09 11 05 09 8e 69 5d 91 61 07 11 05 91 61 d2 9c 11 05 17 58 13 05 11 05 08 8e 69 32 db}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_QuasarRAT_BAK_2147962640_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/QuasarRAT.BAK!MTB"
        threat_id = "2147962640"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {11 07 11 08 11 07 11 08 91 20 95 00 00 00 61 d2 9c 11 08 17 58 13 08 11 08 11 07 8e 69 32 e1}  //weight: 2, accuracy: High
        $x_1_2 = "FromBase64String" ascii //weight: 1
...
rule Trojan_MSIL_QuasarRAT_BAK_2147962640_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/QuasarRAT.BAK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {1f 20 8d 28 00 00 01 13 05 08 ?? ?? 00 00 0a 03 ?? ?? 00 00 0a ?? ?? 00 00 0a 13 07 11 07 16 11 05 16 1f 10 ?? ?? 00 00 0a 11 07 16 11 05 1f 0f 1f 10 ?? ?? 00 00 0a 07 11 05 ?? ?? 00 00 0a 07 18 ?? ?? 00 00 0a 07 ?? ?? 00 00 0a 13 04 02 ?? ?? 00 00 0a 13 06 ?? ?? 00 00 0a 11 04 11 06 16 11 06 8e b7 ?? ?? 00 00 0a ?? ?? 00 00 0a 0a 06 0d de 0f}  //weight: 2, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
        $x_1_3 = "Invoke" ascii //weight: 1
    condition:
        (filesize < 20MB) and
...
rule Trojan_MSIL_QuasarRAT_BAB_2147963002_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_QuasarRAT_BAB_2147963002_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {00 06 11 06 06 11 06 91 66 d2 9c 06 11 06 06 11 06 91 19 63 06 11 06 91 1b 62 60 d2 9c 06 11 06 06 11 06 91 11 05 11 06 11 05 8e 69 5d 91 61 d2 9c 00 11 06 17 58 13 06 11 06 06 8e 69 fe 04 13 08 11 08 2d bb}  //weight: 2, accuracy: High
        $x_1_2 = "FromBase64String" ascii //weight: 1
        $x_1_3 = "Invoke" ascii //weight: 1
    condition:
        (filesize < 20MB) and
...
rule Trojan_MSIL_QuasarRAT_BAB_2147963002_2
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {0d 00 09 07 ?? ?? 00 00 0a 17 73 ?? 00 00 0a 13 04 00 11 04 06 16 06 8e 69 ?? ?? 00 00 0a 00 00 de 14 11 04 14 fe 01 13 06 11 06 2d 08 11 04 ?? ?? 00 00 0a 00 dc 00 09 ?? ?? 00 00 0a 13 05 de 30 09 14 fe 01 13 06 11 06 2d 07 09 ?? ?? 00 00 0a 00 dc}  //weight: 3, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
        $x_1_3 = "Invoke" ascii //weight: 1
    condition:
        (filesize < 20MB) and
...
rule Trojan_MSIL_QuasarRAT_BAB_2147963002_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/QuasarRAT.BAB!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {00 11 08 11 0e 11 0f ?? ?? 00 00 0a 13 10 11 0c 11 0d 25 17 58 13 0d 12 10 ?? ?? 00 00 0a 9c 11 0d 11 0b fe 04 16 fe 01 13 1d 11 1d 2d 11 11 0c 11 0d 25 17 58 13 0d 12 10 ?? ?? 00 00 0a 9c 11 0d 11 0b fe 04 16 fe 01 13 1d 11 1d 2d 11 11 0c 11 0d 25 17 58 13 0d 12 10 ?? ?? 00 00 0a 9c 11 0e 17 58 13 0e 11 0e 11 08 ?? ?? 00 00 0a fe 04 13 1d 11 1d 2d 0b 00 16 13 0e 11 0f 17 58 13 0f 00 00 11 0d 11 0b fe 04 13 1d 11 1d 3a 6f ff ff ff}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_QuasarRAT_BAC_2147964657_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/QuasarRAT.BAC!MTB"
        threat_id = "2147964657"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {0a 0b de 0a 08 2c 06 08 ?? ?? 00 00 0a dc 06 16 73 ?? 00 00 0a 0d 07 73 ?? 00 00 0a 13 04 09 11 04 ?? ?? 00 00 0a 11 04 ?? ?? 00 00 0a 13 05 de 20 11 04 2c 07 11 04 ?? ?? 00 00 0a dc}  //weight: 2, accuracy: Low
        $x_1_2 = "CreateDecryptor" ascii //weight: 1
        $x_1_3 = "Invoke" ascii //weight: 1
    condition:
        (filesize < 20MB) and
...
rule Trojan_MSIL_QuasarRAT_BAC_2147964657_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/QuasarRAT.BAC!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {11 06 11 04 ?? ?? 00 00 0a 17 73 29 00 00 0a 13 07 11 07 08 16 08 8e 69 ?? ?? 00 00 0a 11 07 ?? ?? 00 00 0a de 0c 11 07 2c 07 11 07 ?? ?? 00 00 0a dc 11 06 ?? ?? 00 00 0a 13 08 de 18 11 06 2c 07 11 06 ?? ?? 00 00 0a dc}  //weight: 2, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
...
rule Trojan_MSIL_QuasarRAT_ZFG_2147965009_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/QuasarRAT.ZFG!MTB"
        threat_id = "2147965009"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {02 11 12 11 13 6f ?? 00 00 0a 13 14 11 0b 03 fe 04 13 15 11 15 2c 17 00 11 08 12 14 28 ?? 00 00 0a 6f ?? 00 00 0a 00 11 0b 17 58 13 0b}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_QuasarRAT_BA_2147976938_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/QuasarRAT.BA!MTB"
        threat_id = "2147976938"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "QuasarRAT"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {11 06 1d 5d 13 07 11 04 11 06 91 13 08 11 08 11 07 59 20 00 01 00 00 5d 13 08 11 08 16 2f 0a 11 08 20 00 01 00 00 58 13 08 11 08 11 05 61 13 08 11 04 11 06 11 08 d2 9c 11 06 17 58 13 06 11 06 11 04 8e 69 32 ba}  //weight: 5, accuracy: High
