...
rule Trojan_MSIL_ClipBanker_A_2147765585_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/ClipBanker.A!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {0a 06 7e 01 00 00 0a 7d 05 00 00 04 06 fe 06 0f 00 00 06 73 02 00 00 0a 73 03 00 00 0a 0b 07 16 6f 04 00 00 0a 07 6f 05 00 00 0a 07}  //weight: 10, accuracy: High
        $x_5_2 = "http://{0}/bot/{1}?{2}" wide //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_ClipBanker_SX_2147961988_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/ClipBanker.SX!MTB"
        threat_id = "2147961988"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {28 05 00 00 0a 2c 37 28 06 00 00 0a 0a 06 7e 03 00 00 04 28 07 00 00 0a 2c 24 06 28 08 00 00 0a 2d 1c 06 80 03 00 00 04 06 28 03 00 00 06 0b 07 28 09 00 00 0a 2d 07 07 06 28 05 00 00 06 de 03}  //weight: 30, accuracy: High
        $x_20_2 = {02 17 8d 0b 00 00 01 0d 09 16 1f 20 9d 09 17 6f 0f 00 00 0a 0a 06 13 04 16 13 05 2b 1d 11 04 11 05 9a 0b 07 72 97 05 00 70 28 0c 00 00 0a 2d 04 16 0c de 10 11 05 17 58 13 05 11 05 11 04 8e 69 32 db 17 2a 08 2a}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_ClipBanker_VD_2147963024_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/ClipBanker.VD!MTB"
        threat_id = "2147963024"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {7e 7f 00 00 0a 72 32 04 00 70 17 6f 80 00 00 0a 0a 06 72 18 04 00 70 03 6f 81 00 00 0a 00 06 6f 82 00 00 0a 00 de 0d}  //weight: 5, accuracy: High
        $x_1_2 = "e6ecbd24-1507-434b-9159-07acb84a5523" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_ClipBanker_ARS_2147963755_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/ClipBanker.ARS!MTB"
        threat_id = "2147963755"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_15_1 = {a2 2b 0e 08 17 58 0c 08 7e ?? ?? ?? ?? 8e 69 32 cd}  //weight: 15, accuracy: Low
        $x_5_2 = {dc 07 25 6f ?? ?? ?? ?? 13 05 11 05 17 59}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_ClipBanker_FAA_2147965825_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/ClipBanker.FAA!MTB"
        threat_id = "2147965825"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {07 08 06 08 91 1f 32 61 d1 9d 08 17 58 0c 08 06 8e 69 32 ec}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_ClipBanker_VDA_2147970159_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/ClipBanker.VDA!MTB"
        threat_id = "2147970159"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "WindowsFormsApp" ascii //weight: 1
        $x_2_2 = "hiddenClipboardCryptoChanger" ascii //weight: 2
        $x_1_3 = "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run" ascii //weight: 1
        $x_2_4 = "AddressesCryptocurrency" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_ClipBanker_VDC_2147975313_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/ClipBanker.VDC!MTB"
        threat_id = "2147975313"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "ClipBanker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {17 80 02 00 00 04 72 25 01 00 70 17 73 2b 00 00 0a 80 03 00 00 04 72 71 01 00 70 17 73 2b 00 00 0a 80 04 00 00 04 72 e9 01 00 70 17 73 2b 00 00 0a 80 05 00 00 04 2a}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
