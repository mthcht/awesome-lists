...
rule Trojan_MSIL_Venomrat_MCT_2147966329_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Venomrat.MCT!MTB"
        threat_id = "2147966329"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Venomrat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Gohxwakfmbh.Properties" ascii //weight: 1
        $x_1_2 = "seraaa369" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
