...
rule Trojan_MSIL_Redline_ARTB_2147966900_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Redline.ARTB!MTB"
        threat_id = "2147966900"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Redline"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {06 0a 06 03 7d ?? 00 00 04 06 02 7d ?? 00 00 04 00 06 7e ?? 00 00 04 25 2d 17 26 7e ?? 00 00 04 fe ?? ?? 00 00 06 73 ?? 00 00 0a 25 80 ?? 00 00 04 7d ?? 00 00 04 06 fe ?? ?? 00 00 06 73 ?? 00 00 0a 0b}  //weight: 4, accuracy: Low
        $x_2_2 = {07 16 06 7b ?? 00 00 04 6f ?? 00 00 0a 28 ?? 00 00 0a 06 fe ?? ?? 00 00 06 73 ?? 00 00 0a 28 ?? 00 00 2b 6f ?? 00 00 0a 73 ?? 00 00 0a 7e ?? 00 00 04 25 2d 17 26 7e ?? 00 00 04 fe ?? ?? 00 00 06 73 ?? 00 00 0a 25 80 ?? 00 00 04 7e ?? 00 00 04 25 2d 17 26 7e ?? 00 00 04 fe ?? ?? 00 00 06 73 ?? 00 00 0a 25 80 ?? 00 00 04 28 ?? 00 00 2b 0c 2b 00 08 2a}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
