...
rule Trojan_MSIL_Injuke_MX_2147967443_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Injuke.MX!MTB"
        threat_id = "2147967443"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Injuke"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {c7 44 24 28 08 00 00 08 c7 44 24 20 00 00 00 00 41 b9 00 00 00 00 41 b8 00 00 00 00 48 89 c2 b9 00 00 00 00 48 8b 05 a3 69 00 00}  //weight: 1, accuracy: High
        $x_1_2 = "CurrentVersion\\Winlogon" ascii //weight: 1
        $x_1_3 = "Api.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Injuke_BAC_2147971808_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Injuke.BAC!MTB"
        threat_id = "2147971808"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Injuke"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {07 73 28 00 00 0a 0c 08 ?? ?? 00 00 0a 0d 16 13 04 38 9e 00 00 00 08 ?? ?? 00 00 0a 13 05 ?? ?? 00 00 0a 08 11 05 ?? ?? 00 00 0a ?? ?? 00 00 0a 13 06 08 ?? ?? 00 00 0a 13 07 11 07 16 30 07 ?? ?? 00 00 2b 2b 08 08 11 07 ?? ?? 00 00 0a 13 08 11 06}  //weight: 2, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
...
rule Trojan_MSIL_Injuke_AEXB_2147972951_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Injuke.AEXB!MTB"
        threat_id = "2147972951"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Injuke"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {11 13 11 1b 11 12 11 1b 91 7e ?? 00 00 04 11 1b 7e ?? 00 00 04 8e 69 5d 91 61 d2 9c 00 11 1b 17 58 13 1b 11 1b 11 12 8e 69 fe 04 13 1c 11 1c 2d ce}  //weight: 5, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
