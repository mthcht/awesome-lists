...
rule Trojan_MSIL_Tedy_AT_2147840275_5
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Tedy.AT!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {13 08 11 08 11 05 16 11 07 6f ?? 00 00 0a 13 09 11 09 28 ?? 00 00 06 13 0a 28 ?? 00 00 0a 11 0a 6f ?? 00 00 0a 13 06 11 04 11 06 16 11 06 8e 69 6f ?? 00 00 0a 00 28 ?? 00 00 0a 7e ?? 00 00 04 6f ?? 00 00 0a 13 0b 11 04 11 0b 16 11 0b 8e 69 6f ?? 00 00 0a 00 11 04 6f ?? 00 00 0a 00 11 04 11 05 16 11 05 8e 69}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Tedy_ATY_2147848084_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Tedy.ATY!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {13 0c 11 0b 28 ?? 00 00 0a 13 07 11 07 19 28 ?? 00 00 2b 1f 0c 28 ?? 00 00 2b 28 ?? 00 00 2b 13 0d 11 07 1f 0f 28 ?? 00 00 2b 11 07 8e 69 1f 0f 59 1f 10 59 28 ?? 00 00 2b 28 ?? 00 00 2b 13 0e 11 07 11 07 8e 69 1f 10 59 28 ?? 00 00 2b 28 ?? 00 00 2b 13 0f 09 11 0d 11 0e 11 0f 28}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Tedy_ARR_2147957141_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_11_1 = {11 08 11 09 93 13 04 11 04 28 ?? ?? ?? ?? 2d 19 11 04 1f 2d 2e 13 7e ?? ?? ?? ?? 11 04 1f 2d}  //weight: 11, accuracy: Low
        $x_9_2 = {1f 7b 33 0b 08 2d 04 11 08 13 07 08 17 58 0c 11 05 11 08}  //weight: 9, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Tedy_AHA_2147968187_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = "<ExtractAllSecrets>b_" ascii //weight: 30
        $x_20_2 = "<ScanWordlistFuzzy>b__" ascii //weight: 20
        $x_10_3 = "<ReadTelegramAccountInfo>b" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Tedy_AHA_2147968187_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Tedy.AHA!MTB"
...
rule Trojan_MSIL_Tedy_SPPU_2147971971_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Tedy.SPPU!MTB"
        threat_id = "2147971971"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0c 03 07 03 6f ?? ?? ?? 0a 5d 6f ?? ?? ?? 0a 08 1f 20 59 0d 1f 20 59 13 04 09 11 04 59 1f 5f 58 1f 5f 5d 13 05 06 07 11 05 1f 20 58 d1 9d 07 17 58}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Tedy_BGU_2147972341_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Tedy.BGU!MTB"
        threat_id = "2147972341"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Tedy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {0a 02 17 9a ?? ?? 00 00 0a 0b 16 0c 2b 0d 06 08 06 08 91 07 61 d2 9c 08 17 58 0c 08 06 8e 69 32 ed 06 ?? ?? 00 00 0a 0d 09 02 18 9a ?? ?? 00 00 0a 13 04 11 04 02 19 9a ?? ?? 00 00 0a 13 05 11 05 14 17 8d 01 00 00 01 13 07 11 07 16 02 1a 9a a2 11 07 ?? ?? 00 00 0a 13 06 11 06 2c 0c 11 06 ?? ?? 00 00 0a ?? ?? 00 00 0a de 03}  //weight: 2, accuracy: Low
...
rule Trojan_MSIL_Tedy_PAHY_2147973598_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_Tedy_AVN_2147973734_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_Tedy_A_2147977444_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "PoseidonLoader" wide //weight: 1
        $x_1_2 = "Completed. PC Spoofed Now." wide //weight: 1
        $x_1_3 = "[1]: Spoof" wide //weight: 1
        $x_1_4 = "Your keyboard and mouse are stopped" wide //weight: 1
        $x_1_5 = "C:\\antiOS\\host.txt" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Tedy_A_2147977444_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Tedy.A!MTB"
