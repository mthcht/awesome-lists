...
rule Trojan_MSIL_Zapchast_SX_2147966595_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zapchast.SX!MTB"
        threat_id = "2147966595"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zapchast"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = "Process Hollowing" ascii //weight: 20
        $x_10_2 = "[ENI][HOLLOW] Spawning regasm" ascii //weight: 10
        $x_5_3 = "[ENI][PAYLOAD]" ascii //weight: 5
        $x_5_4 = "[ENI][AMSI] blind" ascii //weight: 5
        $x_1_5 = "[ENI][IAT] Resolved" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zapchast_ARR_2147975205_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zapchast.ARR!MTB"
        threat_id = "2147975205"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zapchast"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {0c 08 16 3f ?? ?? ?? ?? 08 1d 58 0b 08 1d 58 02 50}  //weight: 4, accuracy: Low
        $x_10_2 = {2c 04 11 06 13 04 11 06 17 58 13 06 11 06 08 31 bc}  //weight: 10, accuracy: High
        $x_6_3 = {02 02 50 11 04 17 58 72 ?? 07 00 70 6f ?? ?? ?? ?? 51 17 0a 08 1d 58}  //weight: 6, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
