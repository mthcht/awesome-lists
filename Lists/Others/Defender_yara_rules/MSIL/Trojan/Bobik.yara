...
rule Trojan_MSIL_Bobik_KK_2147946820_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Bobik.KK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = "] SilentRDP" ascii //weight: 3
        $x_2_2 = "Set-MpPreference -DisableRealtimeMonitoring $true" ascii //weight: 2
        $x_1_3 = "--TelegramFileBoundary--" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Bobik_SX_2147968905_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Bobik.SX!MTB"
        threat_id = "2147968905"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Bobik"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {08 73 46 00 00 0a 25 72 ?? 00 00 70 06 72 ?? 00 00 70 28 2a 00 00 0a 6f 47 00 00 0a 00 25 16 6f 48 00 00 0a 00 28 49 00 00 0a 26 16 28 4a 00 00 0a 00 dd 94 00 00 00}  //weight: 30, accuracy: Low
        $x_10_2 = {07 28 43 00 00 0a 26 08 28 3f 00 00 0a 16 fe 01 13 0a 11 0a 2c 22 00 08 72 ?? 00 00 70 28 39 00 00 0a 13 0b 06 11 0b 17 28 44 00 00 0a 00 11 0b 08 28 45 00 00 0a 00 00}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Bobik_ARR_2147970485_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_12_1 = {02 8e 69 17 30 03 15 2b 08 02 17 9a 28 ?? ?? ?? ?? 0a 06 16 32 0a}  //weight: 12, accuracy: Low
        $x_8_2 = {70 00 72 00 65 00 5f 00 73 00 74 00 72 00 6d 00 5f 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 2e 00 65 00 78 00 65 00}  //weight: 8, accuracy: Low
        $x_8_3 = {70 72 65 5f 73 74 72 6d 5f ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 2e 65 78 65}  //weight: 8, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
...
rule Trojan_MSIL_Bobik_AVN_2147972488_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Bobik.AVN!MTB"
        threat_id = "2147972488"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Bobik"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {06 07 8f 13 00 00 01 25 71 13 00 00 01 1f 7b 61 d2 81 13 00 00 01 07 17 58 0b 07 06 8e 69 fe 04 0d 09 2d dc}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Bobik_YYQ_2147976217_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Bobik.YYQ!MTB"
        threat_id = "2147976217"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Bobik"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {16 13 09 2b 6d 11 04 11 09 11 08 6f ?? 00 00 0a 13 0a 12 0a 28 ?? 00 00 0a 13 0b 12 0a 28 ?? 00 00 0a 13 0c 12 0a 28 ?? 00 00 0a 13 0d 12 0a 28 ?? 00 00 0a 13 0e 20 ff 00 00 00 11 0c 59 13 0c}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Bobik_A_2147977597_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Bobik.A!MTB"
        threat_id = "2147977597"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Bobik"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_6_1 = {11 08 06 07 16 16 11 05 11 06 73 13 00 00 0a 20 20 00 cc 00 6f 14 00 00 0a de 0c}  //weight: 6, accuracy: High
        $x_4_2 = {1f 46 6a 73 1c 00 00 0a a2 11 07 02 16 9a 11 09 11 0a 6f 1d 00 00 0a de 0c}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Bobik_AA_2147977626_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Bobik.AA!MTB"
        threat_id = "2147977626"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Bobik"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_12_1 = {0b 08 11 04 6f ?? ?? ?? ?? 13 0f 12 0f 28 ?? ?? ?? ?? ?? ?? ?? ?? ?? 0c 09 11 04}  //weight: 12, accuracy: Low
        $x_8_2 = {0d 11 0c 17 58 13 0c 11 0c 11 0b 8e 69 32 8f}  //weight: 8, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
