...
rule Trojan_MSIL_Zusy_A_2147935981_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.A!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {28 06 00 00 0a 0a 28 07 00 00 0a 0b 7e 01 00 00 04 0c 1f 28 28 08 00 00 0a 0d 08 09 1b 6f 09 00 00 0a 2c 17}  //weight: 5, accuracy: High
        $x_3_2 = "=== Shell @" wide //weight: 3
        $x_2_3 = "clrjit_svc" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_A_2147935981_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.A!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {7e 0f 00 00 04 09 16 09 8e 69 6f 51 00 00 0a 7e 0f 00 00 04 6f 52 00 00 0a de 1b}  //weight: 30, accuracy: High
        $x_20_2 = {18 05 a2 28 34 00 00 06 28 2e 00 00 06 28 15 00 00 06 38 0a 00 00 00 20 e8 03 00 00 28 3a 00 00 0a 7e 15 00 00 04 2d ef 28 2b 00 00 06}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_BAD_2147944547_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {26 20 04 00 00 00 38 b5 ff ff ff 11 01 16 ?? ?? 00 00 0a 13 02 38 00 00 00 00 11 00 16 73 05 00 00 0a 13 09 20 01 00 00 00 7e 58 00 00 04 7b 48 00 00 04 39 88 ff ff ff 26 20 02 00 00 00 38 7d ff ff ff 00}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_HD_2147947638_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.HD!MTB"
        threat_id = "2147947638"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "PROCESS_CREATE_THREAD" ascii //weight: 1
        $x_1_2 = "CreateRemoteThread" ascii //weight: 1
        $x_1_3 = "VirtualAllocEx" ascii //weight: 1
        $x_1_4 = "WriteProcessMemory" ascii //weight: 1
        $x_20_5 = {5a 00 58 00 68 00 77 00 62 00 47 00 39 00 79 00 5a 00 58 00 49 00 3d 00 00}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (
...
rule Trojan_MSIL_Zusy_AGCB_2147948975_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.AGCB!MTB"
        threat_id = "2147948975"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {fe 09 00 00 fe 0c 02 00 20 01 00 00 00 59 fe 0c 07 00 59 91 fe 09 01 00 fe 0c 02 00 20 01 00 00 00 59 fe 0c 07 00 59 91 fe 01 fe 0e 09 00 fe 0c 09 00 3a 0e 00 00 00 20 00 00 00 00 fe 0e 08 00 dd 33 00 00 00 fe 0c 07 00 20 01 00 00 00 58 fe 0e 07 00 fe 0c 07 00 fe 0c 03 00 fe 04 fe 0e 09 00 fe 0c 09 00 3a}  //weight: 5, accuracy: High
        $x_2_2 = {fe 09 00 00 8e 69 fe 0e 02 00 fe 0c 02 00 20 80 00 00 00 5d fe 0e 03 00 fe 0c 00 00 d3 fe 0e 04 00 fe 0c 01 00 d3 fe 0e 05 00 fe 0c 00 00 d3 fe 0c 02 00 58 fe 0c 03 00 59 fe 0e 06 00 38}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_ZCP_2147949195_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.ZCP!MTB"
        threat_id = "2147949195"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {08 8e b7 17 da 11 04 da 02 17 8d ?? 00 00 01 13 06 11 06 16 11 04 8c ?? 00 00 01 a2 11 06 14 28 ?? 00 00 0a 28 ?? 00 00 0a 09 06 17 8d ?? 00 00 01 13 08 11 08 16 11 04 8c ?? 00 00 01 06 14 72 01 00 00 70 16 8d ?? 00 00 01 14 14 14 28 ?? 00 00 0a 28 24 00 00 0a a2 11 08 14 28 ?? 00 00 0a 28 ?? 00 00 0a 28 ?? 00 00 06 28 ?? 00 00 0a 9c 11 04 17 d6 13 04 11 04 11 07 31 83}  //weight: 6, accuracy: Low
        $x_5_2 = {02 03 61 04 61 8c ?? 00 00 01}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_PGZC_2147949620_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.PGZC!MTB"
        threat_id = "2147949620"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "jqKMqhIPpyUgtDdnAZddpcOCPf" ascii //weight: 1
        $x_1_2 = "aPuJLfUmbQOfYbOwDLYdwaFCQE" ascii //weight: 1
        $x_1_3 = "caSnrqLfJRGjATrYnSmHPOPCIR" ascii //weight: 1
        $x_1_4 = "NMabyndbvgvDwgKijqOTLviIfz" ascii //weight: 1
        $x_1_5 = "XXkUPInCHUmdHLjerrxjyzdFNZ" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_GTB_2147950335_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.GTB!MTB"
        threat_id = "2147950335"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {6a 5e 26 16 13 0a 2b 2b 11 05 11 0a 8f 18 00 00 01 25 47 08 d2 61 d2 52 11 0a 20 ff 00 00 00 5f 2d 0b 08 08 5a 20 b7 5c 8a 00 6a 5e 0c 11 0a 17 58 13 0a 11 0a 11 05 8e 69 32 cd 11 06 2a}  //weight: 10, accuracy: High
        $x_1_2 = "ToBase64String" ascii //weight: 1
        $x_1_3 = {6b 6f 69 00 55 6e 6c 6f 63 6b 65 72 2e 65 78 65 00 3c 4d 6f 64 75 6c 65 3e 00}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_PGAM_2147950390_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.PGAM!MTB"
        threat_id = "2147950390"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {58 13 1f 11 1f 1f 10 64 d1 13 18 11 18 d2 13 2c 11 18 1e 63 d1 13 18 11 17 11 09 91 13 22 11 17 11 09 11 22 11 27 61 ?? ?? ?? 58 61 11 2c 61 d2 9c 11 22 13 21 ?? ?? ?? 58 13 09 11 09 11 2a 32 a4}  //weight: 5, accuracy: Low
        $x_5_2 = "DownloaderApp.exe" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_KAE_2147952427_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.KAE!MTB"
        threat_id = "2147952427"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
...
rule Trojan_MSIL_Zusy_MKA_2147952542_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.MKA!MTB"
        threat_id = "2147952542"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = {73 09 00 00 06 72 01 00 00 70 72 33 00 00 70 72 4d 00 00 70 72 99 00 00 70 6f 08 00 00 06 dd 06}  //weight: 15, accuracy: High
        $x_10_2 = {73 03 00 00 06 0a 73 05 00 00 06 0b 73 07 00 00 06 0c 16 0d 14 13 04}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_SLWE_2147953176_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.SLWE!MTB"
        threat_id = "2147953176"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {02 7b 03 00 00 04 06 6c 6f 0d 00 00 0a 00 02 7b 03 00 00 04 17 6f 0e 00 00 0a 00 2b 0d 00 20 e8 03 00 00 28 0f 00 00 0a 00 00 02 7b 02 00 00 04 0b 07}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_SPCB_2147954899_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.SPCB!MTB"
        threat_id = "2147954899"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {02 8e 69 8d 79 00 00 01 0a 16 0b 2b 1b 06 07 02 07 91 7e ?? 00 00 04 07 7e ?? 00 00 04 8e 69 5d 91 61 d2 9c 07 17 58 0b 07 02 8e 69 32 df 06 2a}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_SLDC_2147955298_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.SLDC!MTB"
        threat_id = "2147955298"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {72 01 00 00 70 0b 06 73 04 00 00 0a 6f 05 00 00 0a 06 72 8e 00 00 70 07 6f 06 00 00 0a 06 73 04 00 00 0a 6f 05 00 00 0a 73 07 00 00 0a 0c 08 07 6f 08 00 00 0a 08 17 6f 09 00 00 0a}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_ALZ_2147956230_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.ALZ!MTB"
        threat_id = "2147956230"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0b 16 0d 2b 12 07 09 08 09 6f ?? 00 00 0a 1f ?? 61 d2 9c 09 17 58 0d 09 08 6f}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_SLBC_2147957070_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.SLBC!MTB"
        threat_id = "2147957070"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {0b 28 27 00 00 0a 72 75 00 00 70 28 28 00 00 0a 0c 07 08 28 03 00 00 06 72 95 00 00 70 08 28 29 00 00 0a 28 2a 00 00 0a 06 28 2b 00 00 0a 0d 09 8e}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_AYE_2147959038_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.AYE!MTB"
        threat_id = "2147959038"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = "Worm" ascii //weight: 10
        $x_1_2 = "Allein.exe" ascii //weight: 1
        $x_1_3 = "Spread" ascii //weight: 1
        $x_1_4 = "GetLogicalDrives" ascii //weight: 1
        $x_1_5 = "open=putin.exe" wide //weight: 1
...
rule Trojan_MSIL_Zusy_NRC_2147959418_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.NRC!MTB"
        threat_id = "2147959418"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {08 09 9a 6f ?? 00 00 0a 6f ?? 00 00 0a 13 04 11 04 28 ?? 00 00 06 28 ?? 00 00 06 28 ?? 00 00 0a 6f ?? 00 00 0a 13 05}  //weight: 2, accuracy: Low
        $x_1_2 = {4a 00 00 0a 74 37 00 00 01 13 06 07 11 06 6f ?? 00 00 0a 6f ?? 00 00 0a 11 05 6f ?? 00 00 0a 3a d9 ff ff ff}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_ARR_2147959550_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_Zusy_ARR_2147959550_3
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {0c 06 08 16 08 8e 69 6f ?? ?? ?? ?? 00 06 07 16 07 8e 69}  //weight: 10, accuracy: Low
        $x_6_2 = {0d 02 13 04 09 11 04 16 11 04 8e 69 6f ?? ?? ?? ?? 0a de 1e 25}  //weight: 6, accuracy: Low
        $x_4_3 = {17 6a da b7 17 d6 8d ?? 00 00 01 80 ?? 00 00 04 00 2b 14}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_ARR_2147959550_5
{
    ...
    strings:
        ...
        $x_3_2 = "PAGE_EXECUTE_READWRITE" ascii //weight: 3
        $x_2_3 = "*BSJB" ascii //weight: 2
        $x_1_4 = "MEMORY_BASIC_INFORMATION" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_ARR_2147959550_6
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.ARR!MTB"
...
rule Trojan_MSIL_Zusy_SWQR_2147960829_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_Zusy_AHC_2147961490_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.AHC!MTB"
        threat_id = "2147961490"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {0a 11 0b 6f ?? ?? ?? 0a 6f ?? ?? ?? 0a 13 0e 11 0e 28 ?? ?? ?? 06 13 0f 11 0f 1f 09 28 ?? ?? ?? 06 13 10 11 10 28 ?? ?? ?? 06 13 11 28 ?? ?? ?? 0a 11 11 6f ?? ?? ?? 0a 13 12 11 12 8e 69 28 ?? ?? ?? 0a 13 13 7e ?? ?? ?? 0a 2c 07 11 13}  //weight: 30, accuracy: Low
        $x_20_2 = "25$bcD0987yuio25" ascii //weight: 20
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_SX_2147961910_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.SX!MTB"
        threat_id = "2147961910"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {02 8e 69 8d 3e 00 00 01 0a 16 0b 2b 22 02 02 8e 69 17 59 07 59 91 0c 06 07 08 20 f0 00 00 00 5f 1a 63 08 1f 0f 5f 1a 62 60 d2 9c 07 17 58 0b 07 02 8e 69 32 d8 06 2a}  //weight: 30, accuracy: High
        $x_20_2 = {02 8e 69 8d 3e 00 00 01 0a 16 0b 2b 28 02 07 91 7e 08 00 00 04 61 18 62 02 07 91 7e 08 00 00 04 61 1c 63 60 d2 0c 06 07 08 7e 08 00 00 04 61 d2 9c 07 17 58 0b 07 02 8e 69 32 d2 06 2a}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_MCQ_2147962105_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.MCQ!MTB"
        threat_id = "2147962105"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "4c3de041-b52e-4cf0-8be0-38c504bfe165" ascii //weight: 1
        $x_1_2 = {63 6c 74 2e 65 78 65 00 63 6c 74}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_RR_2147962783_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.RR!MTB"
        threat_id = "2147962783"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {03 2c 07 03 8e 69 1f 40 2f 06 28 [0-5] 2a 03 1f 3c 28 [0-5] 0a 06 16 32 06}  //weight: 1, accuracy: Low
        $x_1_2 = "PerformInjection" ascii //weight: 1
...
rule Trojan_MSIL_Zusy_KK_2147963164_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {11 0a 11 7a 11 08 11 7a 91 11 09 11 7a 11 09 8e 69 5d 91 61 d2 9c 00 11 7a 13 27 11 27 17 58 13 7a 11 7a 11 08 8e 69 fe 04 13 7b 11 7b 2d d0}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_KK_2147963164_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {1f 2c 11 08 18 5a 58 13 13 11 04 11 13 11 12 20 ff 00 00 00 5f d2 9c 11 04 11 13 17 58 11 12 1e 63 20 ff 00 00 00 5f d2 9c 06 17 58 0a 11 08 17 58 13 08 11 08 09 3f 55}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_KK_2147963164_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.KK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = "$bb6e702e-414e-401a-9ac9-f6125567ce7f" ascii //weight: 10
        $x_2_2 = "get_Assembly" ascii //weight: 2
        $x_1_3 = "Runner_A" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_KK_2147963164_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.KK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "PolarRAT_Mutex_X9F2" ascii //weight: 5
        $x_4_2 = "PASSWORD_STEAL" ascii //weight: 4
        $x_3_3 = "PolarSvcTask" ascii //weight: 3
        $x_2_4 = ".polar_kl.dat" ascii //weight: 2
        $x_1_5 = "PolarClient.ClientCore+<SendBeaconAsync>" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_KK_2147963164_4
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.KK!MTB"
...
rule Trojan_MSIL_Zusy_ZWI_2147963428_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.ZWI!MTB"
        threat_id = "2147963428"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {fe 0c 08 00 fe 0c 0e 00 fe 0c 0f 00 6f ?? 00 00 0a fe 0e 10 00 fe 0c 0c 00 fe 0c 0d 00 25 28 ?? 05 00 06 58 fe 0e 0d 00 fe 0d 10 00 28 ?? 00 00 0a 9c fe 0c 0d 00 fe 0c 0b 00 fe 04 28 ?? 03 00 06 fe 01 fe 0e 1d 00 fe 0c 1d 00}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_SJ_2147963446_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_Zusy_MKD_2147964155_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.MKD!MTB"
        threat_id = "2147964155"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {6f 25 00 00 0a 06 20 00 00 10 00 6f 26 00 00 0a 06 20 00 00 10 00 6f 27 00 00 0a 06 16 6f 28 00 00 0a 02 28 29 00 00 0a 03 73 2a 00 00 0a}  //weight: 20, accuracy: High
        $x_15_2 = {09 fe 06 19 00 00 06 73 1b 00 00 0a 73 1c 00 00 0a a2 07 08 9a 17 6f 21 00 00 0a 07 08 9a 1a 6f 22 00 00 0a 07 08 9a 6f 1d 00 00 0a 08 17 58 0c 08 06 32 b5}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_SXC_2147965025_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.SXC!MTB"
        threat_id = "2147965025"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {20 00 04 00 00 8d 0f 00 00 01 0d 08 09 6f ?? 00 00 0a 00 07 8e 69 09 8e 69 58 8d 0f 00 00 01 13 04 07 16 11 04 16 07 8e 69 28 ?? 00 00 0a 00 09 16 11 04 07 8e 69 09 8e 69 28 ?? 00 00 0a 00 72 ?? ?? 00 70 28 ?? 00 00 0a 00 28 ?? 00 00 0a 72 ?? ?? 00 70 08 20 e8 03 00 00 20 0f 27 00 00}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_LRB_2147965373_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.LRB!MTB"
        threat_id = "2147965373"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {11 07 28 65 01 00 0a 13 08 16 0d 2b 47 11 08 09 9a 13 09 11 09 6f db 00 00 0a 06 33 0c 11 09 6f 29 00 00 0a de 2a 26 de 27 00 11 09 6f 61 01 00 0a 11 09 20 b8 0b 00 00}  //weight: 20, accuracy: High
        $x_10_2 = {11 05 11 06 9a 13 07 07 11 07 1b 28 91 00 00 0a 2c 05 17 13 04 de 5e 11 06 17 58 13 06 11 06 11 05 8e 69 32 db 7e 7f 00 00 04 13 05 16 13 06 2b 1d 11 05 11 06 9a 13 08 07 11 08 1b 28 91 00 00 0a 2c 05 17 13 04 de 2d 11 06 17 58 13 06 11 06 11 05 8e 69 32 db 08 72 97 55 00 70 1b 6f 15 01 00 0a 16}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_PGAR_2147965404_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.PGAR!MTB"
        threat_id = "2147965404"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {09 16 11 04 08 8e 69 09 8e 69 28 0c 00 00 0a 00 28 0d 00 00 0a 72 93 01 00 70 07 1f 64 20 e7 03 00 00 6f 0e 00 00 0a 8c 05 00 00 01 72 af 01 00 70 28 0f 00 00 0a 28 10 00 00 0a 13 05 11 05 11 04}  //weight: 5, accuracy: High
        $x_5_2 = {28 11 00 00 0a 00 72 b9 01 00 70 11 05 28 04 00 00 0a 00 72 fd 01 00 70 28 03 00 00 0a 00 11 05 28 12 00 00 0a 26 00 de 05}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_ZZF_2147967191_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.ZZF!MTB"
        threat_id = "2147967191"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {11 0d 1f 0d 5a 20 00 01 00 00 5d d2 13 0e 07 11 0d 07 11 0d 91 7e ?? 00 00 04 11 0d 7e ?? 00 00 04 8e 69 5d 91 61 11 0e 61 d2 9c 11 0d 17 58 13 0d 11 0d 07 8e 69 32 c8}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_ZHD_2147968747_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.ZHD!MTB"
        threat_id = "2147968747"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {16 0d 2b 1f 08 09 8f ?? 00 00 01 25 71 ?? 00 00 01 06 09 06 8e 69 5d 91 61 d2 81 ?? 00 00 01 09 17 58 0d 09 08 8e 69 32 db 28 ?? 00 00 0a 28 ?? 00 00 0a 13 06 12 06 72 ?? 00 00 70 28 ?? 00 00 0a 16 1e}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_GPKE_2147969475_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.GPKE!MTB"
        threat_id = "2147969475"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {6e 00 73 00 73 00 33 00 2e 00 64 00 6c 00 6c 00 00 05 5b 00 5d 00 00 11 4e 00 53 00 53 00 5f 00 49 00 6e 00 69 00 74 00 00 19 4e 00 53 00 53 00 5f 00 53 00 68 00 75 00 74 00 64 00 6f 00 77 00 6e 00 00 1f 50 00 4b 00 31 00 31 00 53 00 44 00 52 00 5f 00 44 00 65 00 63 00 72 00 79 00 70 00 74}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_AMN_2147971351_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.AMN!MTB"
        threat_id = "2147971351"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {11 09 11 08 8e 69 fe 04 16 fe 01 13 0e 11 0e 2c 02 2b 2f 11 08 11 09 11 04 6f ?? 00 00 0a 08 11 09 09 5d 91 61 d2 9c 11 09 17 58 13 09 00 11 0d 17 58 13 0d}  //weight: 5, accuracy: Low
        $x_5_2 = {14 0b de 55 11 08 16 28 ?? 00 00 0a 13 0a 11 0a 16 31 0c 11 0a 11 08 8e 69 1a 59 fe 02 2b 01 17 13 13 11 13 2c 04 14 0b de 2f 11 0a 8d ?? 00 00 01 13 0b 11 08 1a 11 0b 16 11 0a}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_SXG_2147972404_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.SXG!MTB"
        threat_id = "2147972404"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {fe 01 2d 5d 07 73 2d 00 00 0a ?? ?? ?? ?? ?? ?? ?? ?? ?? 28 2e 00 00 0a ?? ?? ?? ?? ?? ?? ?? ?? ?? 28 2e 00 00 0a 6f 2f 00 00 0a 16 73 30 00 00 0a 16 73 31 00 00 0a 73 32 00 00 0a 0c 08 28 33 00 00 0a 17}  //weight: 30, accuracy: Low
        $x_10_2 = {28 2b 00 00 0a 72 ?? 08 00 70 ?? 28 06 00 00 06 6f 2c 00 00 0a 0b}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_CAT_2147972487_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.CAT!MTB"
        threat_id = "2147972487"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {08 09 06 09 91 07 61 d2 9c 00 09 13 04 11 04 17 58 0d 09 06 8e 69 fe 04 13 05 11 05 2d e1}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_KKC_2147972592_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.KKC!MTB"
        threat_id = "2147972592"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {11 0b 11 3c 11 09 11 3c 91 11 0a 11 3c 11 0a 8e 69 5d 91 61 d2 9c 00 11 3c 17 58 13 3c 11 3c 11 09 8e 69 fe 04 13 3d 11 3d 2d d4}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_ABFK_2147973061_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.ABFK!MTB"
        threat_id = "2147973061"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {fe 0c 08 00 fe 0c 0e 00 fe 0c 0f 00 6f ?? 00 00 0a fe 0e 10 00 fe 0c 0c 00 fe 0c 0d 00 25 28 ?? 03 00 06 58 fe 0e 0d 00 fe 0d 10 00 28 ?? 00 00 0a 9c fe 0c 0d 00 fe 0c 0b 00 fe 04 28 ?? 05 00 06 fe 01 fe 0e 1d 00 fe 0c 1d 00 3a 1d 00 00 00 fe 0c 0c 00 fe 0c 0d 00 25}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Zusy_GPKG_2147974208_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.GPKG!MTB"
        threat_id = "2147974208"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "ExecuteAssembly.merged.dll" ascii //weight: 2
        $x_2_2 = "X19TQ1JPTExQT1NJVElPTg==" wide //weight: 2
        $x_2_3 = "X19TQ1JPTExQQVRI" wide //weight: 2
        $x_3_4 = "SecurePassword" wide //weight: 3
    condition:
        (filesize < 20MB) and
        (
            ((2 of ($x_2_*))) or
...
rule Trojan_MSIL_Zusy_KKA_2147976503_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.KKA!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "Program+<RunSlowlorisTask>d__" ascii //weight: 5
        $x_4_2 = "Program+<FetchAndRunConfig>d__" ascii //weight: 4
        $x_3_3 = "Program+<TryFetchRemoteConfig>d__" ascii //weight: 3
        $x_2_4 = "Program+<CheckAndUpdateExe>d__" ascii //weight: 2
        $x_1_5 = "<configCipher>5__1" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Zusy_AA_2147977617_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Zusy.AA!MTB"
        threat_id = "2147977617"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {9c 08 08 06 91 08 07 91 58 20 ?? ?? ?? ?? 5d 91 13 07 09 11 05 02 11 05 91 11 07 61 d2 9c 11 05 17 58 13 05}  //weight: 10, accuracy: Low
        $x_8_2 = {1f 64 34 12 02 7b ?? ?? ?? ?? 17 58 0c 02 08 7d ?? ?? ?? ?? 2b 07 02 16}  //weight: 8, accuracy: Low
        $x_2_3 = "$61bccfbd-2a2f-4882-90a5-86d05565ed67" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
