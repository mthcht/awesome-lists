...
rule Trojan_MSIL_WebShell_ARR_2147967870_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/WebShell.ARR!MTB"
        threat_id = "2147967870"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "WebShell"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_15_1 = {13 09 11 09 16 d0 ?? 00 00 1b 28 ?? ?? ?? ?? a2 11 09 28 ?? ?? ?? ?? 14 17 8d ?? ?? ?? ?? 13 0a 11 0a 16 09 a2 11 0a}  //weight: 15, accuracy: Low
        $x_5_2 = {09 16 09 8e 69 6f ?? 00 00 0a 0d}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_WebShell_ARR_2147967870_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/WebShell.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_11_1 = {25 16 03 a2 25 17 04 a2 25 18 06 a2 25 19 07 a2 25 1a 08 a2 25 1b 09 a2 26 03}  //weight: 11, accuracy: High
        $x_9_2 = {41 00 70 00 70 00 5f 00 57 00 65 00 62 00 5f 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 2e 00 64 00 6c 00 6c 00}  //weight: 9, accuracy: Low
        $x_9_3 = {41 70 70 5f 57 65 62 5f ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 2e 64 6c 6c}  //weight: 9, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
            ((1 of ($x_11_*) and 1 of ($x_9_*))) or
            (all of ($x*))
        )
}
...
rule Trojan_MSIL_WebShell_LR_2147972615_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/WebShell.LR!MTB"
        threat_id = "2147972615"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "WebShell"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {11 23 11 22 73 41 00 00 0a 13 25 18 17 1c 73 42 00 00 0a 13 26 11 26 11 25 14 14 6f 43 00 00 0a 13 27 11 27 6f 44 00 00 0a 20 d0 07 00 00 17 6f 45 00 00 0a 13 28 11 26 6f 46 00 00 0a 2c 22 11 26 16 6f 47 00 00 0a 03 6f 48 00 00 0a 11 20 11 26 6f 49 00 00 0a}  //weight: 30, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_WebShell_SX_2147973774_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_WebShell_A_2147977533_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/WebShell.A!MTB"
        threat_id = "2147977533"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "WebShell"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {13 06 02 6f ?? 00 00 0a 6f ?? 00 00 0a 08 16 1f 10 6f ?? 00 00 0a 6f ?? 00 00 0a 02}  //weight: 20, accuracy: Low
        $x_10_2 = "silverlight_shell_aspx" ascii //weight: 10
        $x_5_3 = "silverlight_ml_aspx" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
