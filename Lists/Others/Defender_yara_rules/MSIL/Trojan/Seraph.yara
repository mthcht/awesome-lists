...
rule Trojan_MSIL_Seraph_APTB_2147966792_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Seraph.APTB!MTB"
        threat_id = "2147966792"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Seraph"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {0a 0c 08 20 ?? ?? 00 00 28 ?? ?? 00 06 28 ?? 00 00 0a 6f ?? 00 00 0a 08 20 ?? ?? 00 00 28 ?? ?? 00 06 28 ?? 00 00 0a 6f ?? 00 00 0a 08 08 6f ?? 00 00 0a 08 6f ?? 00 00 0a 6f ?? 00 00 0a 0d 73 ?? 00 00 0a 13 04 11 04 09 17 73 ?? 00 00 0a 13 05 11 05 06 16 06 8e 69 6f ?? 00 00 0a 11 04 6f ?? 00 00 0a 13 06 de 28}  //weight: 5, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
        $x_1_3 = "CreateDecryptor" ascii //weight: 1
    condition:
        (filesize < 20MB) and
...
rule Trojan_MSIL_Seraph_VD_2147967558_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Seraph.VD!MTB"
        threat_id = "2147967558"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Seraph"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {28 69 00 00 06 20 19 de e8 19 28 1e 00 00 06 7e 42 00 00 04 6f 91 00 00 0a 74 21 00 00 1b 2a}  //weight: 2, accuracy: High
        $x_1_2 = "$2c2da2d7-ccfb-48fa-b674-5e694221ec64" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
