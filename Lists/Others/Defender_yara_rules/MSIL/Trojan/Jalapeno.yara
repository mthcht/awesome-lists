rule Trojan_MSIL_Jalapeno_AJL_2147910601_0
{
    ...
    strings:
        $x_1_1 = {11 04 1f 16 5d 91 13 05 02 07 11 04 91 11 05 61 07 11 04 17 58 08 7e ?? 00 00 04 20 61 01 00 00 7e ?? 00 00 04 20 61 01 00 00 91 7e ?? 00 00 04 20 de 00 00 00 91 5a 20 c2 00 00 00 5f 9c 5d 91}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Jalapeno_AJL_2147910601_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.AJL!MTB"
...
rule Trojan_MSIL_Jalapeno_AH_2147936279_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.AH!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = "UpdateKxeProcessList" ascii //weight: 10
        $x_20_2 = "get_KxeProcesses" ascii //weight: 20
        $x_30_3 = "FetchAndRunConfig" ascii //weight: 30
        $x_40_4 = "RecordFirstRunTime" ascii //weight: 40
        $x_50_5 = "CheckForKxeProcesses" ascii //weight: 50
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Jalapeno_PE_2147959403_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.PE!MTB"
        threat_id = "2147959403"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {11 0c 11 09 6f ?? 00 00 0a 17 73 0d 00 00 0a 13 02 38 00 00 00 00 00 11 02 02 16 02 8e 69 6f ?? 00 00 0a 38}  //weight: 2, accuracy: Low
        $x_2_2 = "54a184a1-d4db-44f0-9f28-e87a90fb3714" ascii //weight: 2
        $x_2_3 = "Fjxrcotwpi.Properties.Resources.resources" ascii //weight: 2
        $x_1_4 = {73 14 00 00 0a 13 06 20 01 00 00 00 7e 16 00 00 04 7b 18 00 00 04 39 88 ff ff ff 26 20 07 00 00 00 38 7d ff ff ff 00 11 0a 8d 08 00 00 01 13 0b}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Jalapeno_AJNB_2147960106_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.AJNB!MTB"
        threat_id = "2147960106"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {16 0a 2b 1b 00 7e ?? 00 00 04 06 7e ?? 00 00 04 06 91 20 58 06 00 00 59 d2 9c 00 06 17 58 0a 06 7e ?? 00 00 04 8e 69 fe 04 0b 07 2d d7}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_QB_2147960164_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.QB!MTB"
        threat_id = "2147960164"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
...
rule Trojan_MSIL_Jalapeno_MCQ_2147961260_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.MCQ!MTB"
        threat_id = "2147961260"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "$2277a1bb-745e-4da7-a493-e81f996fedab" ascii //weight: 1
        $x_1_2 = "_update.exe" ascii //weight: 1
        $x_1_3 = "costura.costura.pdb.compressed" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_ZBJ_2147961376_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.ZBJ!MTB"
        threat_id = "2147961376"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {06 09 08 6f ?? 00 00 0a 13 04 12 04 28 ?? 00 00 0a 2d 15 12 04 28 ?? 00 00 0a 2d 0c 12 04 28 ?? 00 00 0a 16 fe 01 2b 01 16 13 05 11 05 2c 02 2b 71 12 04}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Jalapeno_BAP_2147961879_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.BAP!MTB"
        threat_id = "2147961879"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {02 07 02 07 91 06 07 06 8e 69 5d 91 61 20 aa 00 00 00 61 d2 9c 07 17 58 0b 07 02 8e 69 32 e1}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Jalapeno_ARR_2147962418_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_8_1 = {5f d1 0b 07 08 61 06 11 05 1f 0f 5f 93 61 d1 0b 06 07 1f 0f 5f 93 0c 07 1a 63}  //weight: 8, accuracy: High
        $x_2_2 = "RijndaelManaged" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_ARR_2147962418_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_12_1 = {0d 08 09 6f ?? ?? ?? ?? 00 07 8e 69 09 8e 69 58 8d ?? ?? ?? ?? 13 04 07 16 11 04 16 07 8e 69}  //weight: 12, accuracy: Low
        $x_8_2 = {09 16 11 04 07 8e 69 09 8e 69 28}  //weight: 8, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_ARR_2147962418_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.ARR!MTB"
...
rule Trojan_MSIL_Jalapeno_GPAX_2147962483_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.GPAX!MTB"
        threat_id = "2147962483"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_8_1 = {04 17 fe 01 16 fe 01 0c 08 2d 10 02 06 02 06 91 17 07 1f 1f 5f 62 60 d2 9c 2b 0f 02 06 02 06 91 17 07 1f 1f 5f 62 66 5f d2 9c}  //weight: 8, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_ZLG_2147965354_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.ZLG!MTB"
        threat_id = "2147965354"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {02 11 1d 11 1e 6f ?? 00 00 0a 13 1f 11 12 03 fe 04 2c 14 11 0f 12 1f 28 ?? 00 00 0a 6f ?? 00 00 0a 11 12 17 58 13 12 11 12 03 fe 04 2c 14 11 0f 12 1f}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_ME_2147965366_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.ME!MTB"
        threat_id = "2147965366"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {00 00 06 0c 08 8e b7 28 ?? 00 00 0a 72 ?? ?? 00 70 28 ?? 00 00 0a 28 ?? 00 00 06 0d 07 09 16 09 8e b7 6f ?? 00 00 0a 07 08 16 08 8e b7 6f ?? 00 00 0a 06 07 6f ?? 00 00 0a 16 07 6f ?? 00 00 0a b7 16 14 fe ?? ?? 00 00 06 73 ?? 00 00 0a 14 6f ?? 00 00 0a 26}  //weight: 5, accuracy: Low
        $x_2_2 = {16 7e 0b 00 00 04 12 01 73 ?? 00 00 0a 80 ?? 00 00 04 07 0a de}  //weight: 2, accuracy: Low
        $x_1_3 = {7e 0c 00 00 04 20 e8 03 00 00 d8 28 ?? 00 00 0a}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_ZSG_2147965684_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.ZSG!MTB"
        threat_id = "2147965684"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {02 11 12 11 13 6f ?? 00 00 0a 13 14 11 0b 03 fe 04 2c 14 11 08 12 14 28 ?? 00 00 0a 6f ?? 00 00 0a 11 0b 17 58 13 0b 11 0b 03 fe 04 2c 14}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Jalapeno_SLWX_2147966178_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.SLWX!MTB"
        threat_id = "2147966178"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {72 85 00 00 70 0a 06 28 18 00 00 0a 25 26 0b 28 4a 00 00 0a 25 26 07 16 07 8e 69 6f 4b 00 00 0a 25 26 0a 28 2e 00 00 0a}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_MCT_2147966328_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.MCT!MTB"
        threat_id = "2147966328"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "a3c6-7b402f88794b" ascii //weight: 1
        $x_1_2 = "Tfamiwxhmb" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_MCT_2147966328_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.MCT!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {20 d0 07 00 00 28 01 00 00 06 18 28 14 00 00 06 12 01 7b 14 00 00 04 28 08 00 00 06 13 04 11 04 15 33 2a 12 01 7b 13 00 00 04 17}  //weight: 1, accuracy: High
        $x_1_2 = {12 01 7b 19 00 00 04 20 30 75 00 00 28 09 00 00 06 26 12 01 7b 1a 00 00 04 28 04 00 00 06 26 12 01 7b 19 00 00 04 28 04 00 00 06 26 17 2a 1e 02 28 16 00 00 0a 2a 00 00 42 53 4a 42}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_MSIL_Jalapeno_MKB_2147967334_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.MKB!MTB"
        threat_id = "2147967334"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {6f de 00 00 0a 28 10 00 00 0a 6f 41 00 00 0a 0a 28 10 00 00 0a 0b 07 72 c5 01 00 70 6f df 00 00 0a 0d}  //weight: 20, accuracy: High
        $x_15_2 = {02 08 9a 72 ?? ?? 00 70 28 ?? ?? 00 0a 2d 24 02 08 72 ?? ?? 00 70 02 08 9a 72 ?? ?? 00 70 72 ?? ?? 00 70 6f ?? ?? 00 0a 72 ?? ?? 00 70 28 ?? ?? 00 0a a2 08 17 58 0c 08 02 8e 69 32 c3}  //weight: 15, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_KTX_2147968147_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.KTX!MTB"
        threat_id = "2147968147"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_4_1 = {8d 64 00 00 01 25 16 0f 00 28 38 00 00 0a 9c 25 17 0f 00 28 39 00 00 0a 9c 25 18 0f 00 28 3a 00 00 0a 9c 6f 3b 00 00 0a}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_SPOT_2147970003_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.SPOT!MTB"
        threat_id = "2147970003"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0b 07 19 6f ?? ?? ?? 0a 07 17 6f ?? ?? ?? 0a 07 20 00 01 00 00 6f ?? ?? ?? 0a 07 20 00 01 00 00 6f ?? ?? ?? 0a 28 ?? ?? ?? 0a 06 6f ?? ?? ?? 0a 0c 02 28 ?? ?? ?? 0a 0d 09 8e 69 8d ?? 00 00 01 13 04 07 08 08 6f ?? ?? ?? 0a 13 05 09 73 ?? ?? ?? 0a 13 06 11 06 11 05 16 73 ?? ?? ?? 0a 13 07 11 07 11 04 16 11 04 8e 69 6f ?? ?? ?? 0a 26 11 07 6f ?? ?? ?? 0a 11 07 6f ?? ?? ?? 0a de 0c 11}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_SX_2147973764_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_Jalapeno_NYA_2147974834_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.NYA!MTB"
        threat_id = "2147974834"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "E8F9D7C6-5A4B-4E3D-9F2C-8B1A7E6D5F4C" ascii //weight: 2
        $x_1_2 = "zJvHY3xeG4" ascii //weight: 1
        $x_1_3 = "CreateEncryptor" ascii //weight: 1
        $x_1_4 = "aQL28PqXx" ascii //weight: 1
        $x_1_5 = "FromBase64String" ascii //weight: 1
...
rule Trojan_MSIL_Jalapeno_NYD_2147974845_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.NYD!MTB"
        threat_id = "2147974845"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "E9C7A6F8-5D4B-4A3E-9F2C-8B1A7D6E5F4C" ascii //weight: 2
        $x_1_2 = "03DCEB56B5842C722DE2821DA9906CD70AB73267EAB1A3947BFD894D19372BC7" ascii //weight: 1
        $x_1_3 = "CreateEncryptor" ascii //weight: 1
        $x_1_4 = "0E448EF5E5E60630BDDB19388CB6378436E3C65D03DD66DA7C6EBFF563BD857A" ascii //weight: 1
        $x_1_5 = "FromBase64String" ascii //weight: 1
        $x_1_6 = "RijndaelManaged" ascii //weight: 1
    condition:
        (filesize < 20MB) and
...
rule Trojan_MSIL_Jalapeno_AF_2147978242_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.AF!MTB"
        threat_id = "2147978242"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {11 04 02 7b 80 00 00 04 6f ?? 00 00 0a 5d 6f ?? 00 00 0a 7d 84 00 00 04 38 3e ff ff ff 00 02 7b 85 00 00 04 11 01 39 2a 00 00 00 11 01 17 3b 11 00 00 00 0f 00 7c 84 00 00 04 28 ?? 00 00 0a 38 0c 00 00 00 0f 00 7c 84 00 00 04 28 ?? 00 00 0a 38 0c 00 00 00 0f 00 7c 84 00 00 04 28 ?? 00 00 0a 6f ?? 00 00 0a 38}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Jalapeno_AL_2147978437_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Jalapeno.AL!MTB"
        threat_id = "2147978437"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Jalapeno"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {66 25 61 16 fe 01 2d 04 2b 00 2b 00 02 7b ?? 00 00 04 2a}  //weight: 5, accuracy: Low
