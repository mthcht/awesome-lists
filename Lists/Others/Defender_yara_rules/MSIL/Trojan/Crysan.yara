...
rule Trojan_MSIL_Crysan_MK_2147961853_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Crysan.MK!MTB"
        threat_id = "2147961853"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Crysan"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_35_1 = {11 0a 11 0b 9a 13 0c 00 06 11 0c 6f 21 00 00 0a 28 22 00 00 0a 13 0d 11 09 11 0c 6f 23 00 00 0a 11 0d 6f 24 00 00 0a 00 00 11 0b 17 58 13 0b 11 0b 11 0a 8e 69 32 c9}  //weight: 35, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Crysan_MKA_2147962310_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Crysan.MKA!MTB"
        threat_id = "2147962310"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Crysan"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_35_1 = "AntiAnalysis" ascii //weight: 35
        $x_30_2 = "AdvancedCrypto" ascii //weight: 30
        $x_25_3 = "StealthExecutor" ascii //weight: 25
        $x_20_4 = "ExecuteStealth" ascii //weight: 20
        $x_15_5 = "payload" ascii //weight: 15
        $x_10_6 = "MultiLayerDecrypt" ascii //weight: 10
        $x_5_7 = "sandbox" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Crysan_HLN_2147964634_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Crysan.HLN!MTB"
        threat_id = "2147964634"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Crysan"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {0a 0a 02 8e 69 8d 0c 00 00 01 0b 16 0c 2b 13 07 08 02 08 91 06 08 06 8e 69 5d 91 61 d2 9c 08 17 58 0c 08 02 8e 69 32 e7}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Crysan_PGAH_2147964928_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Crysan.PGAH!MTB"
        threat_id = "2147964928"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Crysan"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {02 03 02 4b 04 03 05 66 60 61 58 0e 07 0e 04 e0 95 58 7e 1a 01 00 04 0e 06 17 59 e0 95 58 0e 05 28 f2 02 00 06 58 54}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Crysan_BAE_2147970746_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {06 07 02 07 91 03 07 03 8e 69 5d 91 61 d1 9d 07 17 58 0b 07 02 8e 69 32 e7}  //weight: 2, accuracy: High
