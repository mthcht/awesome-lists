...
rule Trojan_MSIL_XenoRAT_SJ_2147958825_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/XenoRAT.SJ!MTB"
        threat_id = "2147958825"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "XenoRAT"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {06 72 63 00 00 70 20 96 7a 92 7f 28 74 00 00 06 28 75 00 00 06 6f 3c 00 00 0a 11 05 20 95 32 e7 ad 5a 20 8f a3 1f 9f 58 2b b4 06 6f 3d 00 00 0a 11 05 20 a3 c6 30 d6 5a 20 67 45 80 5c 61 2b 9e}  //weight: 1, accuracy: High
...
rule Trojan_MSIL_XenoRAT_SX_2147965413_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/XenoRAT.SX!MTB"
        threat_id = "2147965413"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "XenoRAT"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {28 1f 00 00 0a 28 2d 00 00 0a 0d 08 09 16 09 8e 69 6f 1c 00 00 0a 00 00 de 12}  //weight: 20, accuracy: High
        $x_10_2 = {00 14 0a 1e 8d 0f 00 00 01 25 d0 26 00 00 04 28 0c 00 00 0a 0b 73 0d 00 00 0a 0c}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
