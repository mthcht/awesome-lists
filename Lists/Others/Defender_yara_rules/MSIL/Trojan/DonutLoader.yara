...
rule Trojan_MSIL_DonutLoader_ADL_2147969304_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/DonutLoader.ADL!MTB"
        threat_id = "2147969304"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "DonutLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {5d 1f 64 58 28 ?? 00 00 0a 28 ?? 00 00 06 0a 06 2c 07 06 8e 69 1f 64 2f 01 2a 7e ?? 00 00 0a 06 8e 69 20 00 30 00 00 1f 40 28 ?? 00 00 06 0b 07 7e ?? 00 00 0a 28 ?? 00 00 0a 2c 01 2a 06 16 07 06 8e 69}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_DonutLoader_ARL_2147973821_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_DonutLoader_AUL_2147973822_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_DonutLoader_ADO_2147975952_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/DonutLoader.ADO!MTB"
        threat_id = "2147975952"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "DonutLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {15 33 09 09 28 ?? 00 00 06 26 de 78 12 04 fe 15 03 00 00 02 12 04 20 07 00 01 00 7d 0d 00 00 04 09 12 04 28 ?? 00 00 06 2d 10 09 28 ?? 00 00 06 26 09 28 ?? 00 00 06 26 de 4a 11 04 13 05 12 04}  //weight: 1, accuracy: Low
        $x_2_2 = {06 8e 69 20 00 30 00 00 1f 40 28 ?? 00 00 06 0d 09 7e ?? 00 00 0a 28 ?? 00 00 0a 2c 09 08 28 ?? 00 00 06 26 de 2c 08 09 06 06 8e 69 12 04}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_DonutLoader_ADI_2147975983_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/DonutLoader.ADI!MTB"
        threat_id = "2147975983"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "DonutLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {13 06 08 16 9a 6f ?? 00 00 0a 28 ?? 00 00 06 25 08 17 9a 6f ?? 00 00 0a 28 ?? 00 00 06 28 ?? 00 00 2b 13 07 25 08 18 9a 6f ?? 00 00 0a 28 ?? 00 00 06 28 ?? 00 00 2b 13 08 25 08 19 9a 6f ?? 00 00 0a 28 ?? 00 00 06 28 ?? 00 00 2b 13 09 25 08 1a 9a 6f}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_DonutLoader_AOD_2147976209_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/DonutLoader.AOD!MTB"
        threat_id = "2147976209"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "DonutLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {02 8e 69 20 00 30 00 00 1f 40 28 ?? 00 00 06 0a 06 7e ?? 00 00 0a 28 ?? 00 00 0a 2c 0c 28 ?? 00 00 06 16 28 ?? 00 00 06 26 02 16 06 02 8e 69 28 ?? 00 00 0a 7e ?? 00 00 0a 16 06 7e ?? 00 00 0a 16 7e ?? 00 00 0a 28 ?? 00 00 06 0b 07 7e}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_DonutLoader_AL_2147977512_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {16 13 06 2b 23 08 11 06 8f ?? 00 00 01 25 71 ?? 00 00 01 07 11 06 07 8e 69 5d 91 61 d2 81 ?? 00 00 01 11 06 17 58 13 06 11 06 08 8e 69}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
