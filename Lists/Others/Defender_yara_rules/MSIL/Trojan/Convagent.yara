...
rule Trojan_MSIL_Convagent_MK_2147961106_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Convagent.MK!MTB"
        threat_id = "2147961106"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {28 0b 00 00 0a 16 9a 0a 72 01 00 00 70 72 0d 00 00 70 06 72 0d 00 00 70 28 0c 00 00 0a 28 0d 00 00 0a 26 00 de 21 0b 00 72 11 00 00 70 07 6f 0e 00 00 0a 28 0f 00 00 0a 28 10 00 00 0a 00 28 11 00 00 0a 26 00 de}  //weight: 20, accuracy: High
        $x_15_2 = "obj\\Debug\\SilentRunner" ascii //weight: 15
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Convagent_VD_2147967550_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Convagent.VD!MTB"
        threat_id = "2147967550"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {00 14 fe 06 02 00 00 06 73 07 00 00 0a 73 08 00 00 0a 0b 07 06 6f 09 00 00 0a 6f 0a}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
