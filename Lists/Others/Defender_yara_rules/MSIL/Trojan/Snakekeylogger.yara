...
rule Trojan_MSIL_Snakekeylogger_ASK_2147842158_2
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {6a 0d 2b 41 02 02 7b ?? 00 00 04 06 07 6f ?? 01 00 0a 7d ?? 00 00 04 02 02 7b ?? 00 00 04 02 7b ?? 00 00 04 6f ?? 01 00 0a 59 7d ?? 00 00 04 02 02 7b ?? 00 00 04 2d 03 1a 2b 01 18 7d ?? 00 00 04 03 0d 2b 00 09 2a}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Snakekeylogger_ASK_2147842158_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Snakekeylogger.ASK!MTB"
...
rule Trojan_MSIL_Snakekeylogger_SGEA_2147936245_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Snakekeylogger.SGEA!MTB"
        threat_id = "2147936245"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Snakekeylogger"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {25 16 0f 00 28 ?? 00 00 0a 9c 25 17 0f 00 28 ?? 00 00 0a 9c 25 18 0f 00 28 ?? 00 00 0a 9c 6f ?? 00 00 0a 00 11}  //weight: 3, accuracy: Low
