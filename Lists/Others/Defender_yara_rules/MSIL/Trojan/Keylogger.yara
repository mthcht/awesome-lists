...
rule Trojan_MSIL_Keylogger_KK_2147965819_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "screenshotTriggerWord" ascii //weight: 1
        $x_2_2 = "processSteal_Tick" ascii //weight: 2
        $x_3_3 = "clipboardLogger_Tick" ascii //weight: 3
        $x_4_4 = "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run" ascii //weight: 4
        $x_5_5 = "FTP Log.txt" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Keylogger_SX_2147966188_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Keylogger.SX!MTB"
        threat_id = "2147966188"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Keylogger"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {06 07 02 07 18 5a 18 6f ?? ?? 00 0a 1f 10 28 ?? ?? 00 0a 7e ?? ?? 00 04 61 d2 9c 07 17 58 0b 07 06 8e 69 32 db}  //weight: 30, accuracy: Low
        $x_10_2 = {1f 1c 91 08 1f 1d 91 1e 62 60 08 1f 1e 91 1f 10 62 60 08 1f 1f 91 1f 18}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Keylogger_JX_2147969727_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Keylogger.JX!MTB"
        threat_id = "2147969727"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Keylogger"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {06 28 01 00 00 06 0b 07 20 00 80 00 00 5f 20 00 80 00 00 fe 01 0c 08 2c 4b 00 7e 02 00 00 04 06 6f 11 00 00 0a 16 fe 01 0d 09 2c 35 00 7e 02 00 00 04 06 6f 12 00 00 0a 26 06 28 05 00 00 06 13 04 11 04 28 13 00 00 0a 16 fe 01 13 05 11 05 2c 0f}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Keylogger_AAA_2147973524_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_Keylogger_ARR_2147974079_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Keylogger.ARR!MTB"
        threat_id = "2147974079"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Keylogger"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {17 33 0f 02 02 7b ?? ?? ?? 04 17 58 7d ?? ?? ?? 04 2a 04 6f 37 00 00 0a 1c 33 0f 02 7b ?? ?? ?? 04 18 33 06 02}  //weight: 10, accuracy: Low
        $x_8_2 = {1c 2e 1e 07 6f ?? ?? ?? ?? 1f 75 2e 14 07 6f ?? ?? ?? ?? 1f 45 2e 0a 07}  //weight: 8, accuracy: Low
        $x_2_3 = "==AI6ACZy92dzNXYQBiclNXVg0VZtBSZzV3W" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
