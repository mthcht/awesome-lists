...
rule Trojan_MSIL_NanoCore_PA_2147772984_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NanoCore.PA!MTB"
        threat_id = "2147772984"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NanoCore"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {28 3e 00 00 0a 06 6f 28 00 00 0a 0c 28 3e 00 00 0a 02 6f 28 00 00 0a 0d 07 08 08 6f 3f 00 00 0a 13 05 73 40 00 00 0a}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_NanoCore_PGNC_2147965688_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NanoCore.PGNC!MTB"
        threat_id = "2147965688"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NanoCore"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {02 11 0a 11 0b 6f ?? 00 00 0a 13 0d 12 0d 28 ?? 00 00 0a 06 07 6f ?? 00 00 0a 59 13 0f 25 1f 10 63 20 ff 00 00 00 5f d2 13 13 25 1e 63 20 ff 00 00 00 5f d2 13 14 16 63}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NanoCore_ZDE_2147967317_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NanoCore.ZDE!MTB"
        threat_id = "2147967317"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NanoCore"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {04 06 03 6f ?? 00 00 0a 5d 91 06 1b 58 04 8e 69 58 1f 1f 5f 63 20 ff 00 00 00 5f d2 61 d2 81 ?? 00 00 01 06 17 58 0a 06 02 8e 69 fe 04 0c 08 2d c2 02 0b 2b 00 07 2a}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_NanoCore_PAA_2147974249_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NanoCore.PAA!MTB"
        threat_id = "2147974249"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NanoCore"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {13 0a 2b 33 11 08 11 0a 8f 13 00 00 01 25 71 13 00 00 01 08 d2 61 d2 81 13 00 00 01 11 0a 20 ff 00 00 00 5f 2d 0b 08 08 5a 20 b7 5c 8a 00 6a 5e 0c 11 0a 17 58 13 0a 11 0a 11 08 8e 69 32 c5 11 09 2a}  //weight: 3, accuracy: High
...
rule Trojan_MSIL_NanoCore_PAB_2147974250_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NanoCore.PAB!MTB"
        threat_id = "2147974250"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NanoCore"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {11 02 11 03 6f 19 00 00 0a 17 73 1a 00 00 0a 13 05 38 2f 00 00 00 28 1b 00 00 0a 03 6f 1c 00 00 0a 11 01 20 e8 03 00 00 73 1d 00 00 0a 13 04 38 86 ff ff ff 11 03 20 80 00 00 00 6f 1e 00 00 0a 38 d1 ff ff ff 00 11 05 02 16 02 8e 69 6f 1f 00 00 0a 38 00 00 00 00 11 05 6f 20 00 00 0a 38 00 00 00 00 dd 8a ff ff ff}  //weight: 3, accuracy: High
...
rule Trojan_MSIL_NanoCore_PAD_2147978397_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/NanoCore.PAD!MTB"
        threat_id = "2147978397"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "NanoCore"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "1c4363a9-86a1-482c-aa2f-dc1fbb633999" ascii //weight: 1
        $x_1_2 = "c6d4cd4c-f3fc-41df-ac27-78e40684eee4" ascii //weight: 1
        $x_2_3 = "7a8649e2-8511-41a3-9f99-93b0f5f90708" ascii //weight: 2
