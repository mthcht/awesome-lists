...
rule Trojan_MSIL_PureRat_AS_2147968751_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.AS!MTB"
        threat_id = "2147968751"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {04 00 04 28 ?? 0e 00 06 7e ?? 04 00 04 28 ?? 0e 00 06 7e ?? 00 00 04 7e}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
...
rule Trojan_MSIL_PureRat_AT_2147968977_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.AT!MTB"
        threat_id = "2147968977"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_6_1 = {00 06 75 09 00 00 01 25 13 0b 72 01 00 00 70 7e}  //weight: 6, accuracy: High
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
...
rule Trojan_MSIL_PureRat_AV_2147969171_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.AV!MTB"
        threat_id = "2147969171"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {61 7e 51 04 00 04 28 ?? 0b 00 06 6f ?? 00 00 0a 25}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
...
rule Trojan_MSIL_PureRat_AW_2147969688_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.AW!MTB"
        threat_id = "2147969688"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {02 00 04 28 ?? 06 00 06 6f ?? 00 00 0a 20}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_2_5 = "protobuf-net" ascii //weight: 2
        ...
        $x_2_8 = "System.Net.Sockets" ascii //weight: 2
        $x_2_9 = "FromBase64String" ascii //weight: 2
        $x_2_10 = "set_UseShellExecute" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (
            ((3 of ($x_5_*) and 4 of ($x_2_*))) or
            ((1 of ($x_6_*) and 1 of ($x_5_*) and 6 of ($x_2_*))) or
            ((1 of ($x_6_*) and 2 of ($x_5_*) and 4 of ($x_2_*))) or
            ((1 of ($x_6_*) and 3 of ($x_5_*) and 1 of ($x_2_*))) or
            (all of ($x*))
        )
}

rule Trojan_MSIL_PureRat_AX_2147969973_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.AX!MTB"
        threat_id = "2147969973"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {04 00 04 61 7e ?? 04 00 04 28 ?? 0d 00 06 20}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
...
rule Trojan_MSIL_PureRat_AY_2147970158_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.AY!MTB"
        threat_id = "2147970158"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {05 00 04 20 38 00 00 00 28 ?? 0b 00 06}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
...
rule Trojan_MSIL_PureRat_AZ_2147970326_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.AZ!MTB"
        threat_id = "2147970326"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {0c 00 06 17 28 ?? 07 00 06 28 ?? 00 00 0a 7e}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
...
rule Trojan_MSIL_PureRat_ABA_2147970778_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABA!MTB"
        threat_id = "2147970778"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {01 00 06 6f ?? 00 00 06 7e ?? 04 00 04 28}  //weight: 6, accuracy: Low
        $x_6_2 = {01 00 06 6f ?? 00 00 06 7e ?? 03 00 04 28}  //weight: 6, accuracy: Low
        $x_5_3 = "m8DD" ascii //weight: 5
        $x_5_4 = "m8DE" ascii //weight: 5
        $x_5_5 = "m8DC" ascii //weight: 5
        $x_5_6 = "PureHVNC_Lib." ascii //weight: 5
        $x_2_7 = "CreateDecryptor" ascii //weight: 2
        $x_2_8 = "GZipStream" ascii //weight: 2
        $x_2_9 = "System.Net.Sockets" ascii //weight: 2
        $x_2_10 = "ProtoBuf.Serializers.IProtoSerializer.Write" ascii //weight: 2
        $x_2_11 = "ProtoBuf.Serializers.IProtoTypeSerializer.HasCallbacks" ascii //weight: 2
        $x_2_12 = "FromBase64String" ascii //weight: 2
        $x_2_13 = "Microsoft.CodeAnalysis" ascii //weight: 2
        $x_2_14 = "WritePacked" ascii //weight: 2
        $x_2_15 = "set_UseShellExecute" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (
            ((3 of ($x_5_*) and 7 of ($x_2_*))) or
            ((4 of ($x_5_*) and 5 of ($x_2_*))) or
            ((1 of ($x_6_*) and 1 of ($x_5_*) and 9 of ($x_2_*))) or
            ...
            ((2 of ($x_6_*) and 1 of ($x_5_*) and 6 of ($x_2_*))) or
            ((2 of ($x_6_*) and 2 of ($x_5_*) and 4 of ($x_2_*))) or
            ((2 of ($x_6_*) and 3 of ($x_5_*) and 1 of ($x_2_*))) or
            ((2 of ($x_6_*) and 4 of ($x_5_*))) or
            (all of ($x*))
        )
}

rule Trojan_MSIL_PureRat_ABB_2147970974_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABB!MTB"
        threat_id = "2147970974"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {03 00 04 61 7e ?? 04 00 04 28 ?? 0c 00 06 20}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
        ...
        $x_2_12 = "Microsoft.CodeAnalysis" ascii //weight: 2
        $x_2_13 = "WritePacked" ascii //weight: 2
        $x_2_14 = "set_UseShellExecute" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (
            ((3 of ($x_5_*) and 7 of ($x_2_*))) or
...
rule Trojan_MSIL_PureRat_ABC_2147971237_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABC!MTB"
        threat_id = "2147971237"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {03 00 04 61 7e ?? 03 00 04 28 ?? 0c 00 06 20}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
...
rule Trojan_MSIL_PureRat_ABD_2147971487_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABD!MTB"
        threat_id = "2147971487"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {05 00 06 1f 24 28 ?? 00 00 0a 7e ?? 01 00 04 28}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
        ...
        $x_2_12 = "GetFolderPath" ascii //weight: 2
        $x_2_13 = "WriteByte" ascii //weight: 2
        $x_2_14 = "set_IV" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (
            ((3 of ($x_5_*) and 7 of ($x_2_*))) or
...
rule Trojan_MSIL_PureRat_ABE_2147971909_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABE!MTB"
        threat_id = "2147971909"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {28 06 00 00 0a 6f ?? 00 00 0a 6f ?? 00 00 0a 17 28 ?? 00 00 06 28 0a}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
        ...
        $x_2_7 = "GZipStream" ascii //weight: 2
        $x_2_8 = "System.Net.Sockets" ascii //weight: 2
        $x_2_9 = "ReadAllBytes" ascii //weight: 2
        $x_2_10 = "FromBase64String" ascii //weight: 2
        $x_2_11 = "set_UseShellExecute" ascii //weight: 2
        $x_2_12 = "GetFolderPath" ascii //weight: 2
        $x_2_13 = "WriteByte" ascii //weight: 2
...
rule Trojan_MSIL_PureRat_ABF_2147972383_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABF!MTB"
        threat_id = "2147972383"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {05 00 04 7b ?? 05 00 04 61 7e ?? 06 00 04 28 a5 0f 00 06}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_5_5 = "PureHVNC_Lib." ascii //weight: 5
...
rule Trojan_MSIL_PureRat_ABG_2147972456_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABG!MTB"
        threat_id = "2147972456"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {08 00 04 28 ?? 18 00 06 20 01 00 00 00 7e ?? 07 00 04 7b}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_2_5 = "protobuf-net" ascii //weight: 2
...
rule Trojan_MSIL_PureRat_ABH_2147973023_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABH!MTB"
        threat_id = "2147973023"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {03 00 04 7b ?? 03 00 04 61 7e ?? 04 00 04 28 ?? 08 00 06 20}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_2_5 = "protobuf-net" ascii //weight: 2
...
rule Trojan_MSIL_PureRat_ABI_2147973711_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {03 00 06 7e ?? 02 00 04 28 ?? 07 00 06 7e cb 02 00 04 28 ?? 07 00 06 2a}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_2_5 = "protobuf-net" ascii //weight: 2
...
rule Trojan_MSIL_PureRat_ABJ_2147973712_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {04 1f 1a 28 ?? 00 00 0a 0b 06 1f 1c 28 ?? 00 00 0a 7d ?? 00 00 04 06}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
...
rule Trojan_MSIL_PureRat_ABK_2147973713_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABK!MTB"
        threat_id = "2147973713"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
...
rule Trojan_MSIL_PureRat_ABM_2147976208_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureRat.ABM!MTB"
        threat_id = "2147976208"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {02 00 04 28 ?? 07 00 06 20 00 00 00 00 7e 67 02 00 04 7b ?? 02 00 04 3a ?? ff ff ff 26 20 00 00 00 00 38 c1 ff ff ff 2a 7e}  //weight: 6, accuracy: Low
        $x_5_2 = "m8DD" ascii //weight: 5
        $x_5_3 = "m8DE" ascii //weight: 5
        $x_5_4 = "m8DC" ascii //weight: 5
        $x_2_5 = "protobuf-net" ascii //weight: 2
