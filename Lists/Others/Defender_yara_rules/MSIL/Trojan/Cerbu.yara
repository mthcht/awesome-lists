...
rule Trojan_MSIL_Cerbu_ZKE_2147967421_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Cerbu.ZKE!MTB"
        threat_id = "2147967421"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Cerbu"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {04 20 ff 00 00 00 5f 2b 1d 03 6f ?? 00 00 0a 0c 2b 17 08 06 08 06 93 02 7b ?? 0b 00 04 07 91 04 60 61 d1 9d 2b 03 0b 2b e0 06 17 59 25 0a 16 2f 02 2b 05 2b dd 0a 2b c8}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_Cerbu_NYX_2147974755_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Cerbu.NYX!MTB"
        threat_id = "2147974755"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Cerbu"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "xTEeqRBwbhOr" ascii //weight: 2
        $x_1_2 = "SFBgFrMqUoOW" ascii //weight: 1
        $x_1_3 = "UhbzEmMgfRiV" ascii //weight: 1
        $x_1_4 = "kBeAnwBKYPHA" ascii //weight: 1
        $x_1_5 = "grwlPEJBUkPHW" ascii //weight: 1
        $x_2_6 = {11 12 26 16 2d 01 00 00 17 62 61 11 0a 25 58 61 65 17 12 10}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Cerbu_NZD_2147975309_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Cerbu.NZD!MTB"
        threat_id = "2147975309"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Cerbu"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = "BzPURNxwqHXau" ascii //weight: 1
        $x_1_2 = "xjobrOoJCrgeQ" ascii //weight: 1
        $x_1_3 = "HhHIEbfeByjZS" ascii //weight: 1
        $x_1_4 = "ymopTmIOyWOtl" ascii //weight: 1
        $x_1_5 = "rpcRIxqOCvoFq" ascii //weight: 1
        $x_2_6 = {25 58 58 11 ?? 17 62 61 11 ?? 25 58 61 11}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
