...
rule Trojan_MSIL_PureLogsStealer_ABP_2147961187_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureLogsStealer.ABP!MTB"
        threat_id = "2147961187"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureLogsStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {02 8c 03 00 00 1b 03 04 6f ?? 01 00 0a 0b 11 05 20 ba 00 00 00 93 20 ?? 62 00 00 59 13 04 38 ?? ff ff ff 06 17 58 0a 0e 04 25 5a 0e 04 58 18 5d 2c 08}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_PureLogsStealer_ZHI_2147962833_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureLogsStealer.ZHI!MTB"
        threat_id = "2147962833"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureLogsStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {25 16 03 6f ?? 00 00 0a 16 03 6f ?? 00 00 0a 0a 12 00 20 ?? 00 00 00 20 ?? 00 00 00 28 ?? 00 00 06 73 ?? 00 00 0a a2 25 17 03 6f ?? 00 00 0a 17 03 6f ?? 00 00 0a 0a 12 00 20 ?? 01 00 00 20 ?? 01 00 00 28 ?? 00 00 06 73 ?? 00 00 0a a2 25 18 03}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_PureLogsStealer_ABPL_2147973815_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {16 94 02 7b ?? 00 00 04 17 94 6f ?? ?? 00 0a a4 ?? 00 00 01 02 7b ?? 00 00 04 02 7b ?? 00 00 04 6f ?? ?? 00 0a 00 17 8c ?? 00 00 01 0a 2b 00 06 2a}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_PureLogsStealer_ABFG_2147974775_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/PureLogsStealer.ABFG!MTB"
        threat_id = "2147974775"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "PureLogsStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {26 2b 0e 07 02 7b 39 00 00 04 6f ?? 00 00 0a 2b c7 07 6f ?? 00 00 0a 0c 08 03 72 81 29 00 70 28 ?? ?? 00 06 03 8e 69 72 a9 29 00 70 28 ?? ?? 00 06 59 6f ?? 00 00 0a 0d de 14}  //weight: 4, accuracy: Low
        $x_1_2 = "CreateDecryptor" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
