...
rule Trojan_MSIL_Disabler_A_2147978221_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Disabler.A!MTB"
        threat_id = "2147978221"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Disabler"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "/set {default} recoveryenabled No" wide //weight: 1
        $x_1_2 = "/set {default} bootmenupolicy Legacy" wide //weight: 1
        $x_1_3 = "/set {bootmgr} displaybootmenu No" wide //weight: 1
        $x_1_4 = "/set {bootmgr} timeout 0" wide //weight: 1
        $x_1_5 = "DisableRegistryTools" wide //weight: 1
        $x_1_6 = "DisableChangePassword" wide //weight: 1
        $x_1_7 = "NoStartMenuShutdown" wide //weight: 1
        $x_1_8 = "ForceUnlockLogon" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
