...
rule Trojan_MSIL_CrimsonRat_AMS_2147941541_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CrimsonRat.AMS!MTB"
        threat_id = "2147941541"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CrimsonRat"
        severity = "Critical"
...
rule Trojan_MSIL_CrimsonRat_ACN_2147941565_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CrimsonRat.ACN!MTB"
        threat_id = "2147941565"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CrimsonRat"
        severity = "Critical"
...
rule Trojan_MSIL_CrimsonRat_ACO_2147941643_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CrimsonRat.ACO!MTB"
        threat_id = "2147941643"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CrimsonRat"
        severity = "Critical"
...
rule Trojan_MSIL_CrimsonRat_ACA_2147942038_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CrimsonRat.ACA!MTB"
        threat_id = "2147942038"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CrimsonRat"
        severity = "Critical"
