...
rule Trojan_MSIL_Exnet_MK_2147960195_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Exnet.MK!MTB"
        threat_id = "2147960195"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Exnet"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = {39 1d 00 00 00 26 20 05 00 00 00 38 12 00 00 00 38 c7 ff ff ff 20 00 00 00 00 fe 0e 00 00 fe 0c 00 00 45 01 00 00 00 13 00 00 00 fe 0c 00 00 20 dc 03 00 00 3b e5 ff ff ff 38 00 00 00 00 2a}  //weight: 15, accuracy: High
        $x_10_2 = {26 20 01 00 00 00 38 12 00 00 00 38 c7 ff ff ff 20 00 00 00 00 fe 0e 00 00 fe 0c 00 00 45 01 00 00 00 13 00 00 00 fe 0c 00 00 20 dc 03 00 00 3b e5 ff ff ff 38 00 00 00 00 00 2a}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Exnet_ARR_2147961323_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_MSIL_Exnet_ARR_2147961323_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_11_1 = {8e 69 5d 91 61 d2 9c 00 11 0e 17 58 13 0e 11 0e 09 8e 69 fe 04 13 0f 11 0f 2d d0}  //weight: 11, accuracy: High
        $x_9_2 = {11 13 11 14 16 11 14 8e 69 6f ?? ?? ?? ?? 00 00 11 15 17 58 13 15 11 15 1f 0f fe 04 13 16 11 16 2d dd}  //weight: 9, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Exnet_ARR_2147961323_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Exnet.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_8_1 = {06 91 06 61 20 ?? ?? ?? ?? 61 d2 9c 06 17 58 0a 06 7e 46 00 00 04 8e 69 fe 04}  //weight: 8, accuracy: Low
        $x_7_2 = {06 07 18 5a 58 0a 07 17 58 0b 07 1f 32 32 f1}  //weight: 7, accuracy: High
        $x_5_3 = {2b 15 06 07 8f ?? ?? 00 01 25 47 7e ?? ?? 00 04 61 d2 52 07 17 58 0b 07 06 8e 69}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Exnet_ARR_2147961323_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Exnet.ARR!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_7_1 = "<rg4KcEAd3hhEzn17sXT6>b__6_0" ascii //weight: 7
        $x_3_2 = "U40xNGMt6Nfoo5N6q" ascii //weight: 3
        $x_10_3 = "ZgEHgWPJ.exe" ascii //weight: 10
        $x_6_4 = "qwZFyMrfsaDBtvPy2E17" ascii //weight: 6
        $x_4_5 = "<rg4KcEAd3hhEzn17sXT6>b__2" ascii //weight: 4
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Exnet_MKB_2147963055_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Exnet.MKB!MTB"
        threat_id = "2147963055"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Exnet"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {02 28 1d 00 00 0a 0a de 03 26 de 45 06 6f 1e 00 00 0a 0b 16 0c 2b 34 07 08 9a ?? ?? 00 00 70 1f 18 6f 1f 00 00 0a}  //weight: 20, accuracy: Low
        $x_15_2 = {07 6f 10 00 00 0a 08 17 6f 11 00 00 0a 08 17 6f 12 00 00 0a 08 16 6f 13 00 00 0a 08 16 6f 14 00 00 0a 08 20 ff ff 00 00 1e}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Exnet_MKC_2147966030_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Exnet.MKC!MTB"
        threat_id = "2147966030"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Exnet"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_35_1 = {62 11 05 11 0c 17 58 91 1f 10 62 60 11 05 11 0c 18 58 91 1e 62 60 11 05 11 0c 19 58 91 60 13 0d 11 0c 1a 58 13 0e 11 0e 11 0d 58 11 05 8e}  //weight: 35, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
