...
rule Trojan_MSIL_Disco_KK_2147967952_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {06 07 8f 59 00 00 01 25 47 7e 09 00 00 04 07 7e 09 00 00 04 8e 69 5d 91 61 d2 52 07 17 58 0b 07 06 8e 69 32 db}  //weight: 20, accuracy: High
        $x_2_2 = "VenyraXorKey" ascii //weight: 2
        $x_1_3 = "VenyraStealer" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_Disco_KK_2147967952_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Disco.KK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "KryptonStealer.Exfil.TelegramSender" ascii //weight: 5
        $x_4_2 = "StealTokensFromLevelDb" ascii //weight: 4
        $x_3_3 = "DecryptChromiumValue" ascii //weight: 3
        $x_2_4 = "/sendDocument" ascii //weight: 2
...
rule Trojan_MSIL_Disco_KKA_2147970440_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/Disco.KKA!MTB"
        threat_id = "2147970440"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Disco"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "GetChromiumCreditCards" ascii //weight: 5
        $x_4_2 = "discord\\Local Storage\\leveldb" ascii //weight: 4
        $x_3_3 = "InfoStealer+<SendToDiscord>d__13" ascii //weight: 3
        $x_2_4 = "**Stealer Report**" ascii //weight: 2
        $x_1_5 = "GrabBrowserData" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
