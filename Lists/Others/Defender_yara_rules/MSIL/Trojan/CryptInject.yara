...
rule Trojan_MSIL_CryptInject_MBZ_2147942278_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CryptInject.MBZ!MTB"
        threat_id = "2147942278"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CryptInject"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "bcYrJyAyPf" wide //weight: 2
        $x_1_2 = "e579baefae58" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_CryptInject_MCHI_2147952576_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CryptInject.MCHI!MTB"
        threat_id = "2147952576"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CryptInject"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {13 07 16 13 08 2b 12 11 05 11 07 11 08 91 6f 0d 00 00 0a 11 08 17 58 13 08}  //weight: 1, accuracy: High
        $x_1_2 = {6c 00 79 00 00 15 47 00 65 00 74 00 4d 00 65 00 74 00 68 00 6f 00 64 00 73 00 00 09 4c 00 6f 00 61}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_CryptInject_CC_2147954727_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CryptInject.CC!MTB"
        threat_id = "2147954727"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CryptInject"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {06 07 61 0a 06 18 58 0a 07 17 58 0b 07 1b 32 f0}  //weight: 6, accuracy: High
        $x_2_2 = {03 8e 69 20 ?? ?? ?? ?? 1f 40 28}  //weight: 2, accuracy: Low
        $x_2_3 = {11 06 03 03 8e 69 12 07 28}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_CryptInject_MCW_2147971896_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CryptInject.MCW!MTB"
        threat_id = "2147971896"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CryptInject"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {06 07 03 07 91 04 61 d2 9c 07 17 58 0b 07 03 8e 69 32 ed}  //weight: 1, accuracy: High
        $x_1_2 = "f73e29e55f38" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_CryptInject_CZ_2147974101_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CryptInject.CZ!MTB"
        threat_id = "2147974101"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CryptInject"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {06 07 03 07 91 04 07 04 8e 69 5d 91 61 d2 9c 07 17 58 0b 07 03 8e 69 fe 04 0d 09 2d}  //weight: 10, accuracy: High
        $x_1_2 = "shellcode injection" wide //weight: 1
        $x_1_3 = "injected" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_CryptInject_AC_2147978472_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/CryptInject.AC!MTB"
        threat_id = "2147978472"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "CryptInject"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0a 26 02 28 ?? 00 00 0a 06 28 ?? 00 00 0a 6f ?? 00 00 0a 07 28 ?? 00 00 06 2d 01 2a 73 ?? 00 00 0a 25 73 ?? 00 00 0a 6f ?? 00 00 0a 25 6f ?? 00 00 0a 28 ?? 00 00 0a 72 ?? 00 00 70 28 ?? 00 00 0a 6f ?? 00 00 0a 6f ?? 00 00 0a 25 6f}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
