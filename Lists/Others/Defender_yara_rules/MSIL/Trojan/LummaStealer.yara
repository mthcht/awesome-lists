...
rule Trojan_MSIL_LummaStealer_MIV_2147941717_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/LummaStealer.MIV!MTB"
        threat_id = "2147941717"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {02 03 66 5f 02 66 03 5f 60 8c 95 00 00 01 0a 2b 00 06 2a}  //weight: 5, accuracy: High
...
rule Trojan_MSIL_LummaStealer_BSA_2147942025_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/LummaStealer.BSA!MTB"
        threat_id = "2147942025"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "LummaStealer"
        severity = "Critical"
...
rule Trojan_MSIL_LummaStealer_AZVA_2147942931_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/LummaStealer.AZVA!MTB"
        threat_id = "2147942931"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "LummaStealer"
        severity = "Critical"
...
rule Trojan_MSIL_LummaStealer_ASQB_2147963054_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/LummaStealer.ASQB!MTB"
        threat_id = "2147963054"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {02 8e 69 8d ?? 00 00 01 0a 16 0b 2b 1a 06 07 02 07 91 03 07 03 6f ?? 00 00 0a 5d 6f ?? 00 00 0a 61 d2 9c 07 17 58 0b 07 02 8e 69 32 e0 06 2a}  //weight: 4, accuracy: Low
        $x_3_2 = {0a 0b 06 8e 69 8d ?? 00 00 01 0c 16 0d 2b 13 08 09 06 09 91 07 09 07 8e 69 5d 91 61 d2 9c 09 17 58 0d 09 06 8e 69 32 e7 28 ?? 00 00 0a 08 6f ?? 00 00 0a 2a}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_MSIL_LummaStealer_CQ_2147964189_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MSIL/LummaStealer.CQ!MTB"
        threat_id = "2147964189"
        type = "Trojan"
        platform = "MSIL: .NET intermediate language scripts"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {58 13 0c 11 09 08 5a 11 0b 58 13 0d 11 04 11 0c 18 58 91 13 0e 11 05 11 0d 20 ff 00 00 00 11 0e 59 1f 72 61 d2 9c 11 0b 17 58 13 0b 11 0b 08}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_MSIL_LummaStealer_AH_2147973721_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {11 06 11 05 8e 69 2f 2a 11 05 11 06 07 6f ?? ?? ?? 0a 11 09 11 06 06 8e 69 5d 58 47 61 d2 9c 11 06 17 58 13 06 11 0c 17 58 13 0c 11 0c 08 19 5a 32 ce}  //weight: 30, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
