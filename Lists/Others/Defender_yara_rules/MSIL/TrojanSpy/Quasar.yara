...
rule TrojanSpy_MSIL_Quasar_SR_2147967907_0
{
    meta:
        author = "defender2yara"
        detection_name = "TrojanSpy:MSIL/Quasar.SR!MTB"
        threat_id = "2147967907"
        type = "TrojanSpy"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Quasar"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {08 1f 64 6a da 0c 11 05 17 d6 13 05 11 05 11 04 31 ee}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule TrojanSpy_MSIL_Quasar_SS_2147968975_0
{
    meta:
        author = "defender2yara"
        detection_name = "TrojanSpy:MSIL/Quasar.SS!MTB"
        threat_id = "2147968975"
        type = "TrojanSpy"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Quasar"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "server.Resources.resources" ascii //weight: 1
        $x_1_2 = "$cc7fad03-816e-432c-9b92-001f2d358386" ascii //weight: 1
        $x_1_3 = "server1.exe" ascii //weight: 1
        $x_1_4 = "2026 Utility Application" ascii //weight: 1
        $x_1_5 = "Server Development Software" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
