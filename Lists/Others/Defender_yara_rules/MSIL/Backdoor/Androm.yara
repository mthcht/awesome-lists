...
rule Backdoor_MSIL_Androm_AGQA_2147938131_0
{
    meta:
        author = "defender2yara"
        detection_name = "Backdoor:MSIL/Androm.AGQA!MTB"
        threat_id = "2147938131"
        type = "Backdoor"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Androm"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {06 17 9a 6f ?? 00 00 0a 1e 09 5a 59 13 04 11 04 16 fe 04 13 05 11 05 2c 0a 00 1e 11 04 58 0c 16 13 04 00 7e ?? 00 00 04 07 09 59 06 17 9a 11 04 08 6f ?? 00 00 0a 18 28 ?? 00 00 0a 9c 00 09 17 58 0d 09 07 fe 02 16 fe 01 13 06 11 06 2d b0}  //weight: 5, accuracy: Low
