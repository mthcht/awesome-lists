...
rule Backdoor_MSIL_Crysan_AMQB_2147962881_0
{
    meta:
        author = "defender2yara"
        detection_name = "Backdoor:MSIL/Crysan.AMQB!MTB"
        threat_id = "2147962881"
        type = "Backdoor"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Crysan"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {0a 20 e8 03 00 00 73 ?? 00 00 0a 0b 06 07 1f 20 6f ?? 00 00 0a 6f ?? 00 00 0a 00 06 07 1f 10 6f ?? 00 00 0a 6f ?? 00 00 0a 00 06 6f ?? 00 00 0a 0c 08 02 16 02 8e 69 6f ?? 00 00 0a 0d de 12 06 14 fe 01 13 04 11 04 2d 07 06 6f ?? 00 00 0a 00 dc}  //weight: 5, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
        $x_1_3 = "CreateDecryptor" ascii //weight: 1
    condition:
        (filesize < 20MB) and
...
rule Backdoor_MSIL_Crysan_AVQB_2147963379_0
{
    meta:
        author = "defender2yara"
        detection_name = "Backdoor:MSIL/Crysan.AVQB!MTB"
        threat_id = "2147963379"
        type = "Backdoor"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Crysan"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {16 13 05 2b 25 08 11 05 8f ?? 00 00 01 25 71 ?? 00 00 01 11 04 11 05 11 04 8e 69 5d 91 61 d2 81 ?? 00 00 01 11 05 17 58 13 05 11 05 08 8e 69 fe 04 13 15 11 15 2d ce}  //weight: 4, accuracy: Low
        $x_2_2 = {0a 13 09 11 09 11 06 6f ?? 00 00 0a 00 11 09 11 07 6f ?? 00 00 0a 00 11 09 17 6f ?? 00 00 0a 00 11 09 18 6f ?? 00 00 0a 00 11 09 6f ?? 00 00 0a 11 08 16 11 08 8e 69 6f ?? 00 00 0a 13 0a}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Backdoor_MSIL_Crysan_AWSB_2147965784_0
{
    meta:
        author = "defender2yara"
        detection_name = "Backdoor:MSIL/Crysan.AWSB!MTB"
        threat_id = "2147965784"
        type = "Backdoor"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Crysan"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {70 0c 06 0d 09 8e 69 8d ?? 00 00 01 13 04 16 13 05 38 ?? 00 00 00 11 04 11 05 09 11 05 91 08 28 ?? 00 00 0a 59 d2 9c 11 05 17 58 13 05 11 05 09 8e 69 32 e2}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
