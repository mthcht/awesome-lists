...
rule Backdoor_MSIL_SneakyGrunt_B_2147965675_0
{
    meta:
        author = "defender2yara"
        detection_name = "Backdoor:MSIL/SneakyGrunt.B!dha"
        threat_id = "2147965675"
        type = "Backdoor"
        platform = "MSIL: .NET intermediate language scripts"
        family = "SneakyGrunt"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "nameHashed" ascii //weight: 1
        $x_1_2 = "ca.exe" wide //weight: 1
        $x_1_3 = "/delete/permanent" wide //weight: 1
        $x_1_4 = "uploadKey" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
