...
rule Backdoor_MSIL_Bladabindi_AXPB_2147962200_0
{
    meta:
        author = "defender2yara"
        detection_name = "Backdoor:MSIL/Bladabindi.AXPB!MTB"
        threat_id = "2147962200"
        type = "Backdoor"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Bladabindi"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {17 0b 2b 42 00 02 07 17 59 6f ?? 00 00 0a 28 ?? 00 00 0a 03 07 03 6f ?? 00 00 0a 5d 6f ?? 00 00 0a 28 ?? 00 00 0a 59 2b 2d 06 08 d1 13 04 12 04 28 ?? 00 00 0a 28 ?? 00 00 0a 2b 07 00 07 17 58 0b 2b 03 0a 2b f6 07 02 6f ?? 00 00 0a fe 02 16 fe 01 13 05 2b 03 0c 2b d0 11 05 2d 02 2b 05 2b a3}  //weight: 5, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
...
rule Backdoor_MSIL_Bladabindi_AWRB_2147964363_0
{
    meta:
        author = "defender2yara"
        detection_name = "Backdoor:MSIL/Bladabindi.AWRB!MTB"
        threat_id = "2147964363"
        type = "Backdoor"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Bladabindi"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {0a 13 04 11 04 16 09 16 1f 10 28 ?? 00 00 0a 00 11 04 16 09 1f 10 1f 10 28 ?? 00 00 0a 00 07 09 6f ?? 00 00 0a 00 07 18 6f ?? 00 00 0a 00 07 18 6f ?? 00 00 0a 00 07 6f ?? 00 00 0a 13 05 02 28 ?? 00 00 0a 13 06 28 ?? 00 00 0a 11 05 11 06 16 11 06 8e 69 6f ?? 00 00 0a 6f ?? 00 00 0a 0a 2b 00 06 2a}  //weight: 5, accuracy: Low
        $x_1_2 = "FromBase64String" ascii //weight: 1
        $x_1_3 = "CreateDecryptor" ascii //weight: 1
    condition:
        (filesize < 20MB) and
...
rule Backdoor_MSIL_Bladabindi_SY_2147968973_0
{
    meta:
        author = "defender2yara"
        detection_name = "Backdoor:MSIL/Bladabindi.SY!MTB"
        threat_id = "2147968973"
        type = "Backdoor"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Bladabindi"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {11 04 16 11 04 8e 69 6f 5d 00 00 0a 28 5e 00 00 0a 13 05 7e 11 00 00 04 2c 15 16 2d 0d 7e 10 00 00 04 02 11 05 6f 5f 00 00 0a de 03}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Backdoor_MSIL_Bladabindi_SZ_2147975012_0
{
    meta:
        author = "defender2yara"
        detection_name = "Backdoor:MSIL/Bladabindi.SZ!MTB"
        threat_id = "2147975012"
        type = "Backdoor"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Bladabindi"
        severity = "Critical"
    ...
    strings:
        ...
        $x_2_2 = "$405cba39-e772-4d8d-94ab-23e584ee59e9" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
