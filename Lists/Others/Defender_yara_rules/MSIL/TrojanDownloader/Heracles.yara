...
rule TrojanDownloader_MSIL_Heracles_MK_2147968640_0
{
    meta:
        author = "defender2yara"
        detection_name = "TrojanDownloader:MSIL/Heracles.MK!MTB"
        threat_id = "2147968640"
        type = "TrojanDownloader"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Heracles"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = "<SendBrowserDataAsync>d" ascii //weight: 15
        $x_10_2 = "<SendApplicationDataAsync>d" ascii //weight: 10
        $x_5_3 = "<SendUserInfoAsync>d" ascii //weight: 5
        $x_3_4 = "<SendCryptoWalletAsync>d" ascii //weight: 3
        $x_2_5 = "<SendDiscordAsync>d" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule TrojanDownloader_MSIL_Heracles_CAT_2147972486_0
{
    meta:
        author = "defender2yara"
        detection_name = "TrojanDownloader:MSIL/Heracles.CAT!MTB"
        threat_id = "2147972486"
        type = "TrojanDownloader"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Heracles"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {00 11 0a 11 0c 11 0a 11 0c 91 11 05 61 d2 9c 00 11 0c 17 58 13 0c 11 0c 11 0a 8e 69 fe 04 13 0d 11 0d 2d dc}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
