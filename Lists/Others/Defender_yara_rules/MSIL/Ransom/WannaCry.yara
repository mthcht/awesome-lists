...
rule Ransom_MSIL_WannaCry_B_2147972528_0
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:MSIL/WannaCry.B!AMTB"
        threat_id = "2147972528"
        type = "Ransom"
        platform = "MSIL: .NET intermediate language scripts"
        family = "WannaCry"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "\\@Please_Read_Me@.txt" ascii //weight: 1
        $x_1_2 = ".WNCRY" ascii //weight: 1
        $x_1_3 = "Ooops, your files have been encrypted!" ascii //weight: 1
        $x_1_4 = "WanaCrypt0r" ascii //weight: 1
