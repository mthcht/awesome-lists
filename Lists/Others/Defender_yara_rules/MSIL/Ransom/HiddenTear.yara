...
rule Ransom_MSIL_HiddenTear_F_2147972527_0
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:MSIL/HiddenTear.F!AMTB"
        threat_id = "2147972527"
        type = "Ransom"
        platform = "MSIL: .NET intermediate language scripts"
        family = "HiddenTear"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "FXCK.Properties" ascii //weight: 1
        $x_2_2 = "\\Documents\\Malware\\FXCK\\obj\\Debug\\FXCK.pdb" ascii //weight: 2
        $x_1_3 = "Get fucked lmao!" ascii //weight: 1
        $x_1_4 = ".fxcked" ascii //weight: 1
        $x_2_5 = "OOPS YOUR FILES HAVE BEEN ENCRYPTED" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (
            ((1 of ($x_2_*) and 3 of ($x_1_*))) or
...
rule Ransom_MSIL_HiddenTear_G_2147973541_0
{
    meta:
        author = "defender2yara"
