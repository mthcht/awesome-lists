...
rule Ransom_MSIL_Cryptolocker_AMTB_2147969807_0
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:MSIL/Cryptolocker!AMTB"
        threat_id = "2147969807"
        type = "Ransom"
        platform = "MSIL: .NET intermediate language scripts"
        family = "Cryptolocker"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "*** STOP: 0x0000000A" ascii //weight: 1
        $x_1_2 = "StolenData.zip" ascii //weight: 1
        $x_1_3 = "create MalwareService binPath= " ascii //weight: 1
        $x_1_4 = "Meme Time!" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
