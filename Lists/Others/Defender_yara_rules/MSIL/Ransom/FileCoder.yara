...
rule Ransom_MSIL_FileCoder_AB_2147766650_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {11 0a 1f 0b 64 11 0a 1f 15 62 60 13 0d 11 1a 20 27 62 a9 d1 5a 20 8e f4 da a2 61}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Ransom_MSIL_FileCoder_AB_2147766650_2
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:MSIL/FileCoder.AB!MTB"
...
rule Ransom_MSIL_FileCoder_KK_2147968288_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "SYSWIPED.txt" ascii //weight: 5
        $x_4_2 = "EncryptAllDrives" ascii //weight: 4
        $x_3_3 = "DisableTaskMgr" ascii //weight: 3
        $x_2_4 = "DropRansomNotes" ascii //weight: 2
...
rule Ransom_MSIL_FileCoder_KK_2147968288_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "EncryptAllFiles" ascii //weight: 5
        $x_4_2 = "TelegramStealer" ascii //weight: 4
        $x_3_3 = "EnsureAllPersistence" ascii //weight: 3
        $x_2_4 = "TargetExtensions" ascii //weight: 2
...
rule Ransom_MSIL_FileCoder_KK_2147968288_2
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:MSIL/FileCoder.KK!MTB"
...
rule Ransom_MSIL_FileCoder_F_2147973599_0
{
    meta:
        author = "defender2yara"
