...
rule Trojan_AndroidOS_Coper_J_2147948601_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:AndroidOS/Coper.J!MTB"
        threat_id = "2147948601"
        type = "Trojan"
        platform = "AndroidOS: Android operating system"
        family = "Coper"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {89 c7 89 34 24 e8 a6 f9 06 00 89 3c 24 e8 ce bc 06 00}  //weight: 1, accuracy: High
        $x_1_2 = {53 83 ec 18 e8 00 00 00 00 5b 81 c3 41 58 07 00 0f 28 44 24 20 0f 11 04 24 e8 a0 f7 06 00 83 c4 18 5b c3}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
