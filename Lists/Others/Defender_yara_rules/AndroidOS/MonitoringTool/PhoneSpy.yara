...
rule MonitoringTool_AndroidOS_PhoneSpy_J_466765_0
{
    meta:
        author = "defender2yara"
        detection_name = "MonitoringTool:AndroidOS/PhoneSpy.J!MTB"
        threat_id = "466765"
        type = "MonitoringTool"
        platform = "AndroidOS: Android operating system"
        family = "PhoneSpy"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "mspapptrakapp/alarm/PhoneCallReceiver" ascii //weight: 1
        $x_1_2 = "mspapptrakapp/alarm/activities/PhoneAlreadyRegistered" ascii //weight: 1
        $x_1_3 = "mspapptrakapp/alarm/services/InitAddPhoneService" ascii //weight: 1
        $x_1_4 = "mspapptrakapp/alarm/services/TrackLocation" ascii //weight: 1
        $x_1_5 = "com.spyapp.webbrowser" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (4 of ($x*))
}
