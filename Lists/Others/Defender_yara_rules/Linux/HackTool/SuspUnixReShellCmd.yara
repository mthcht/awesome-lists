...
rule HackTool_Linux_SuspUnixReShellCmd_PA_2147973947_0
{
    meta:
        author = "defender2yara"
        detection_name = "HackTool:Linux/SuspUnixReShellCmd.PA"
        threat_id = "2147973947"
        type = "HackTool"
        platform = "Linux: Linux platform"
        family = "SuspUnixReShellCmd"
        severity = "High"
...
rule HackTool_Linux_SuspUnixReShellCmd_PC_2147974103_0
{
    meta:
        author = "defender2yara"
        detection_name = "HackTool:Linux/SuspUnixReShellCmd.PC"
        threat_id = "2147974103"
        type = "HackTool"
        platform = "Linux: Linux platform"
        family = "SuspUnixReShellCmd"
        severity = "High"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {74 00 65 00 6c 00 6e 00 65 00 74 00 20 00 [0-48] 7c 00 [0-4] 2f 00 62 00 69 00 6e 00 2f 00 [0-4] 73 00 68 00 [0-4] 3e 00}  //weight: 1, accuracy: Low
        $x_1_2 = {6e 00 63 00 20 00 [0-48] 7c 00 [0-4] 2f 00 62 00 69 00 6e 00 2f 00 [0-4] 73 00 68 00 [0-4] 3e 00}  //weight: 1, accuracy: Low
...
rule HackTool_Linux_SuspUnixReShellCmd_PB_2147974319_0
{
    meta:
        author = "defender2yara"
        detection_name = "HackTool:Linux/SuspUnixReShellCmd.PB"
        threat_id = "2147974319"
        type = "HackTool"
        platform = "Linux: Linux platform"
        family = "SuspUnixReShellCmd"
        severity = "High"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {2f 00 62 00 69 00 6e 00 2f 00 [0-4] 73 00 68 00 20 00 2d 00 69 00 [0-32] 7c 00 20 00 6f 00 70 00 65 00 6e 00 73 00 73 00 6c 00 20 00 73 00 5f 00 63 00 6c 00 69 00 65 00 6e 00 74 00 [0-16] 2d 00 63 00 6f 00 6e 00 6e 00 65 00 63 00 74 00}  //weight: 1, accuracy: Low
