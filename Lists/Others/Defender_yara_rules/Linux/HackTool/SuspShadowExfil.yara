rule HackTool_Linux_SuspShadowExfil_PA_2147973894_0
{
    meta:
        author = "defender2yara"
        detection_name = "HackTool:Linux/SuspShadowExfil.PA"
        threat_id = "2147973894"
        type = "HackTool"
...
rule HackTool_Linux_SuspShadowExfil_PB_2147973895_0
{
    meta:
        author = "defender2yara"
...
rule HackTool_Linux_SuspShadowExfil_PC_2147973896_0
{
    meta:
        author = "defender2yara"
        detection_name = "HackTool:Linux/SuspShadowExfil.PC"
        threat_id = "2147973896"
        type = "HackTool"
        platform = "Linux: Linux platform"
        family = "SuspShadowExfil"
        severity = "High"
