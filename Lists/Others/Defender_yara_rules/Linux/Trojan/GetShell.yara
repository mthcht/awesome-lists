...
rule Trojan_Linux_GetShell_H_2147945395_0
{
    ...
    strings:
        ...
        $n_2_4 = {f3 0f 1e fa 41 55 31 ff 41 54 55 53 48 81 ec e8 00 00 00 64 48 8b 04 25 28 00 00 00 48 89 84 24 d8 00 00 00 31 c0 e8 a5 ff ff ff 48 89 05 ce 2e 00 00 48 85 c0 74 6d 48 89 c7 48 8d 5c 24 08 4c 8d 6c 24 10 e8 57 ff ff ff 89 05 a9 2e 00 00 41 89 c4 e8 39 ff ff ff 48 89 c5 66 0f 1f 44 00 00}  //weight: -2, accuracy: High
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (2 of ($x*))
