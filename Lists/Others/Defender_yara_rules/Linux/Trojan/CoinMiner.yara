...
rule Trojan_Linux_CoinMiner_AMTB_2147960269_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Linux/CoinMiner!AMTB"
        threat_id = "2147960269"
        type = "Trojan"
        platform = "Linux: Linux platform"
        family = "CoinMiner"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "82.221.103.244" ascii //weight: 2
        $x_2_2 = "router.bittorrent.com" ascii //weight: 2
        $x_1_3 = "reverseShell" ascii //weight: 1
        $x_1_4 = "rsaEncryption" ascii //weight: 1
        $x_1_5 = "miner" ascii //weight: 1
...
rule Trojan_Linux_CoinMiner_A_2147973682_0
{
    meta:
        author = "defender2yara"
