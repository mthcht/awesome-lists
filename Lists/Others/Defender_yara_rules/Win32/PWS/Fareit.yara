...
rule PWS_Win32_Fareit_W_2147806898_0
{
    ...
    strings:
        $x_1_1 = "MSVBVM60.DLL" ascii //weight: 1
        $x_1_2 = {31 34 24 eb 50 00 ff 37 [0-255] 31 34 24 [0-255] e8 [0-255] 83 c2 04 [0-255] 83 d7 04 [0-255] 0f 85}  //weight: 1, accuracy: Low
        $x_1_3 = {31 34 24 85 50 00 ff 37 [0-255] 31 34 24 [0-255] e8 [0-255] 83 c2 04 [0-255] 83 d7 04 [0-255] 0f 85}  //weight: 1, accuracy: Low
        $x_1_4 = {31 34 24 66 50 00 ff 37 [0-255] 31 34 24 [0-255] e8 [0-255] 83 c2 04 [0-255] 83 d7 04 [0-255] 0f 85}  //weight: 1, accuracy: Low
