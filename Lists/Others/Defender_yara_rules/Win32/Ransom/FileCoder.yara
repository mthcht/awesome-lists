...
rule Ransom_Win32_FileCoder_BAD_2147949228_0
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:Win32/FileCoder.BAD!MTB"
        threat_id = "2147949228"
        type = "Ransom"
        platform = "Win32: Windows 32-bit platform"
        family = "FileCoder"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "-MpPreference -DisableRealtimeMonitoring $trueIcepick payload executed" ascii //weight: 1
        $x_1_2 = "README.txt" ascii //weight: 1
        $x_1_3 = "Your files are encrypted with AES" ascii //weight: 1
        $x_1_4 = "Pay $1000 in Bitcoin to" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Ransom_Win32_FileCoder_A_2147971024_0
{
    meta:
        author = "defender2yara"
        detection_name = "Ransom:Win32/FileCoder.A!AMTB"
        threat_id = "2147971024"
        type = "Ransom"
        platform = "Win32: Windows 32-bit platform"
        family = "FileCoder"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "War by [WarGame,#eof]" ascii //weight: 1
        $x_1_2 = "You are read the mail!" ascii //weight: 1
        $x_1_3 = "Warn on Mapi Send" ascii //weight: 1
        $x_1_4 = "somesomeWar_EOF" ascii //weight: 1
        $x_1_5 = "\\kkk.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
