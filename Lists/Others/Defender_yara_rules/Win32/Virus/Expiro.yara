...
rule Virus_Win32_Expiro_HNZ_2147963304_0
{
    meta:
        author = "defender2yara"
        detection_name = "Virus:Win32/Expiro.HNZ!MTB"
        threat_id = "2147963304"
        type = "Virus"
        platform = "Win32: Windows 32-bit platform"
        family = "Expiro"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_500_1 = {2e 72 65 6c 6f 63 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 40 00 00 e2 00 00 00 00 00 00 00 00 00 00}  //weight: 500, accuracy: Low
        $x_1_2 = {30 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 30 ?? 30}  //weight: 1, accuracy: Low
        $x_1_3 = {31 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 31 ?? 31}  //weight: 1, accuracy: Low
        $x_1_4 = {32 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 32 ?? 32}  //weight: 1, accuracy: Low
        $x_1_5 = {32 00 02 00 00 00 00 00 ?? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00}  //weight: 1, accuracy: Low
        $x_1_6 = {33 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 33 ?? 33}  //weight: 1, accuracy: Low
        $x_1_7 = {34 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 34 ?? 34}  //weight: 1, accuracy: Low
        $x_1_8 = {35 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 35 ?? 35}  //weight: 1, accuracy: Low
        $x_1_9 = {36 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 36 ?? 36}  //weight: 1, accuracy: Low
        $x_1_10 = {37 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 37 ?? 37}  //weight: 1, accuracy: Low
        $x_1_11 = {38 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 38 ?? 38}  //weight: 1, accuracy: Low
        $x_1_12 = {39 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 39 ?? 39}  //weight: 1, accuracy: Low
        $x_1_13 = {3a 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 3a ?? 3a}  //weight: 1, accuracy: Low
        $x_1_14 = {3b 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 3b ?? 3b}  //weight: 1, accuracy: Low
        $x_1_15 = {3c 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 3c ?? 3c}  //weight: 1, accuracy: Low
        $x_1_16 = {3d 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 3d ?? 3d}  //weight: 1, accuracy: Low
        $x_1_17 = {3e 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 3e ?? 3e}  //weight: 1, accuracy: Low
        $x_1_18 = {3f 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 3f ?? 3f}  //weight: 1, accuracy: Low
        $x_1_19 = {a1 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 04 00 a0 ?? a0}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
            ((1 of ($x_500_*) and 1 of ($x_1_*))) or
