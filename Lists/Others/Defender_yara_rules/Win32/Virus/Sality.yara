...
rule Virus_Win32_Sality_2147648243_0
{
    meta:
        author = "defender2yara"
        detection_name = "Virus:Win32/Sality"
        threat_id = "2147648243"
        type = "Virus"
        platform = "Win32: Windows 32-bit platform"
        family = "Sality"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "http://89.119.67.154/testo5/" ascii //weight: 2
        $x_2_2 = "http://kukutrustnet777.info/home.gif" ascii //weight: 2
        $x_2_3 = "http://kukutrustnet888.info/home.gif" ascii //weight: 2
        $x_2_4 = "http://kukutrustnet987.info/home.gif" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (2 of ($x*))
}
...
rule Virus_Win32_Sality_HNB_2147936832_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {ba 00 00 00 00 60 00 [0-96] 60 [0-255] c1}  //weight: 4, accuracy: Low
...
rule Virus_Win32_Sality_PC_2147949775_0
{
    meta:
        author = "defender2yara"
        detection_name = "Virus:Win32/Sality.PC!MTB"
        threat_id = "2147949775"
        type = "Virus"
        platform = "Win32: Windows 32-bit platform"
        family = "Sality"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {51 6a 00 6a 00 6a 00 6a 00 6a 00 8d 95 00 f8 ff ff 52 6a 00 ff 15 00 10 00 10}  //weight: 2, accuracy: High
        $x_1_2 = {6a 00 6a 00 6a 04 6a 00 6a 02 68 00 00 00 40 8d 85 00 f8 ff ff 50 ff 15 0c 10 00 10}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
