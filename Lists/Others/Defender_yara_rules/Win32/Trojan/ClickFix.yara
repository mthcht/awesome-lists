...
rule Trojan_Win32_ClickFix_ZH_2147940389_0
{
    ...
    strings:
        ...
        $x_5_3 = "http" wide //weight: 5
        $x_5_4 = {69 00 77 00 72 00 [0-48] 69 00 65 00 78 00 [0-48] 69 00 64 00 3a 00}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
...
rule Trojan_Win32_ClickFix_ZGA_2147941490_0
{
    ...
    strings:
        ...
        $x_400_9 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 [0-255] 5e 00 [0-5] 5e 00 [0-16] 68 00 74 00 74 00 70 00}  //weight: 400, accuracy: Low
        $n_600_10 = ".ps1" wide //weight: -600
        $n_600_11 = ".hta" wide //weight: -600
        $n_600_12 = "explorer http:" wide //weight: -600
        $n_600_13 = "\\application\\chrome.exe" wide //weight: -600
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (
