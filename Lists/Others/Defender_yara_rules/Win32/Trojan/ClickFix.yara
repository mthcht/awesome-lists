...
rule Trojan_Win32_ClickFix_AB_2147940112_0
{
    ...
    strings:
        ...
        $x_1_20 = "travel.image-gene-saver.it.com" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}
...
rule Trojan_Win32_ClickFix_SEZ_2147940391_0
{
    ...
    strings:
        ...
        $x_10_50 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 6c 00 6f 00 6c 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_51 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 70 00 72 00 65 00 73 00 73 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_52 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 73 00 63 00 69 00 65 00 6e 00 63 00 65 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_53 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 73 00 68 00 6f 00 70 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_54 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 73 00 69 00 74 00 65 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_55 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 73 00 70 00 61 00 63 00 65 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_56 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 73 00 74 00 6f 00 72 00 65 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_57 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 73 00 74 00 72 00 65 00 61 00 6d 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_58 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 73 00 74 00 75 00 64 00 79 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_59 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 74 00 65 00 63 00 68 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_60 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 74 00 65 00 63 00 68 00 6e 00 6f 00 6c 00 6f 00 67 00 79 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_61 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 74 00 65 00 72 00 72 00 69 00 66 00 79 00 65 00 6e 00 79 00 62 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_62 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 74 00 6f 00 64 00 61 00 79 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_63 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 74 00 6f 00 70 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_64 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 76 00 69 00 70 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_65 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 77 00 6f 00 72 00 6b 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_66 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 77 00 6f 00 72 00 6c 00 64 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_67 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 78 00 6c 00 6c 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_68 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 78 00 79 00 7a 00 2f 00}  //weight: 10, accuracy: Low
        $x_10_69 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 79 00 6f 00 6b 00 6f 00 68 00 61 00 6d 00 61 00 2f 00}  //weight: 10, accuracy: Low
        $n_500_70 = ".ps1" wide //weight: -500
        $n_500_71 = ".hta" wide //weight: -500
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (1 of ($x*))
