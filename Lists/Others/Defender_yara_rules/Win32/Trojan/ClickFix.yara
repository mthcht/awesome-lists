...
rule Trojan_Win32_ClickFix_SEZ_2147940391_0
{
    ...
    strings:
        ...
        $x_10_79 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 72 00 61 00 72 00}  //weight: 10, accuracy: Low
        $x_10_80 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 30 00 78 00 [0-16] 2e 00 63 00}  //weight: 10, accuracy: Low
        $x_10_81 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 30 00 78 00 [0-16] 2e 00 6c 00 6f 00}  //weight: 10, accuracy: Low
        $x_10_82 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 30 00 78 00 [0-16] 2e 00 6d 00 73 00 69 00 78 00}  //weight: 10, accuracy: Low
        $x_10_83 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 72 00 75 00 [0-16] 2e 00 63 00 68 00 65 00 63 00 6b 00 3f 00 74 00 3d 00}  //weight: 10, accuracy: Low
        $x_10_84 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 [0-32] 68 00 74 00 74 00 70 00 [0-48] 2e 00 72 00 75 00 [0-16] 2e 00 67 00 6f 00 6f 00 67 00 6c 00 65 00 3f 00 74 00 3d 00}  //weight: 10, accuracy: Low
        $n_500_85 = ".ps1" wide //weight: -500
        $n_500_86 = ".hta" wide //weight: -500
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (1 of ($x*))
