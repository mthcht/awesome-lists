rule Trojan_Win32_Havoc_A_2147909957_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Havoc.A"
        threat_id = "2147909957"
        type = "Trojan"
...
rule Trojan_Win32_Havoc_C_2147909958_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Havoc.C"
        threat_id = "2147909958"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Havoc"
        severity = "Critical"
