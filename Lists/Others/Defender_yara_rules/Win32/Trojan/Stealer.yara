...
rule Trojan_Win32_Stealer_DAC_2147936285_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealer.DAC!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {f7 e2 01 df 01 d7 05 ?? ?? ?? ?? 81 d7 ?? ?? ?? ?? 89 fa 89 fb c1 ea 18 c1 eb 0c 31 d3 8b 16 32 9a ?? ?? ?? ?? 3b 96 ?? ?? ?? ?? 74 ?? 88 1c 11 42}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Stealer_DAF_2147941144_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealer.DAF!MTB"
        threat_id = "2147941144"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Stealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {8b 45 08 8b 4d 0c 03 08 89 4d f8 8b 45 08 8b 4d 0c 03 48 10 89 4d ec 8b 45 f8 3b 45 0c}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Stealer_DAJ_2147941627_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealer.DAJ!MTB"
        threat_id = "2147941627"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Stealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {8b 45 f0 30 0c 03 43 3b 5d fc 0f 82}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Stealer_DAI_2147941710_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealer.DAI!MTB"
        threat_id = "2147941710"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Stealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {8b 4d 08 30 04 0f 47 3b 7d 0c 0f 82}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Stealer_DAK_2147941711_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealer.DAK!MTB"
        threat_id = "2147941711"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Stealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {2b f8 31 3b 83 45 d0 04 83 c3 04 8b 45 d0 3b 45 cc 72}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Stealer_DAK_2147941711_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealer.DAK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {8a c3 8d 0c 1a 2c ?? 30 41 0a 43 83 fb ?? 72}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Stealer_LMA_2147944139_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealer.LMA!MTB"
        threat_id = "2147944139"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Stealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {0f b6 94 08 fc b3 d8 c3 31 ca 89 55 f0 8b 55 f0 80 c2 94 88 94 08 fc b3 d8 c3 41 81 f9 18 4c 27 3c}  //weight: 20, accuracy: High
        $x_20_2 = {09 d6 89 f2 31 da f7 d6 21 de 8d 3c 1a 29 f7 f7 d2 21 fa 8d b1 00 80 16 3d 89 df f7 d7 09 f7 89 c6 09 de 21 f7 01 df 89 d6 31 fe f7 d2 21 fa 8d b8 00 81 e9 c2 21 df 8b 5d ec 01 d2 f7 d2 01 f2 09 fa f7 d2 89 55 f0 8b 55 f0 80 c2 64}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Stealer_LMB_2147944506_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealer.LMB!MTB"
        threat_id = "2147944506"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Stealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {89 c2 0f b6 44 05 00 89 fe 21 c6 31 c7 8d 04 77 01 c1 0f b6 74 15 01 01 c6 01 f1 0f b6 44 15 02 01 f0 01 c1 0f b6 74 15 03 89 c7 21 f7 31 f0 8d 04 78 01 c1 0f b6 74 15 04 01 c6 01 f1 0f b6 44 15 05 01 f0 01 c1 0f b6 74 15 06 01 c6 01 f1 0f b6 7c 15 07 01 f7 01 f9}  //weight: 20, accuracy: High
        $x_20_2 = {89 ca 21 c2 01 c8 29 d0 89 d1 01 c9 f7 d1 01 d1 31 c1 f7 d1 21 c1 89 0c 24 8b 04 24 05 24 d1 ee cb 0f b6 c0 83 c4 0c}  //weight: 20, accuracy: High
        $x_5_3 = {0f b6 3c 31 89 c3 c1 eb 04 31 f8 83 e0 0f 33 1c 85 fc e6 44 00 89 d8 c1 e8 04 89 dd f7 d5 83 cd 0f 01 eb 43 c1 ef 04 31 df 33 04 bd fc e6 44 00 46 39 f2}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
