...
rule Trojan_Win32_NamedPipeUtils_AM_2147948657_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/NamedPipeUtils.AM"
        threat_id = "2147948657"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "NamedPipeUtils"
        severity = "Critical"
    ...
    strings:
        ...
        $x_1_3 = "installutil.exe" ascii //weight: 1
        $x_1_4 = "named_pipe" ascii //weight: 1
        $x_1_5 = "& exit" ascii //weight: 1
        $n_1_6 = "dg06e39e-7876-4ba3-beee-42bd80ff363q" wide //weight: -1
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (all of ($x*))
