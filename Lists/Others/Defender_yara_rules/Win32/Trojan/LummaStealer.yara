...
rule Trojan_Win32_LummaStealer_NL_2147899512_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {89 5c 24 04 89 3c 24 89 f1 ff d5 83 ec 08 89 f0 83 c4 0c 5e 5f 5b 5d}  //weight: 2, accuracy: High
        $x_1_2 = {03 14 08 ff 74 24 0c 56 ff d2 83 c4 08 89 f0 5e}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_NL_2147899512_4
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.NL!MTB"
...
rule Trojan_Win32_LummaStealer_MK_2147901715_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.MK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = {09 fb 31 f3 21 f2 09 da 83 e0 01 f7 d8 25 df b0 08 99 33 81 34 06}  //weight: 15, accuracy: High
        $x_10_2 = {89 d0 21 c8 01 ca 01 c0 29 c2 89 d0 c1 e8 12 21 c1 01 d0}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_Z_2147927310_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {55 8d 44 24 08 50 53 57 8b 44 24 10 ff 70 44 ff 50 3c 83 c4}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_Z_2147927310_7
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {7c 24 64 89 c2 b9 03 00 00 00 87 d6 f3 a5 87 d6 8d 7c 24 70 8d 50 0c b9 01 00 00 00 87 d6 f3 66 a5 87 d6}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_Z_2147927310_22
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.Z!MTB"
...
rule Trojan_Win32_LummaStealer_Z_2147927310_23
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.Z!MTB"
...
rule Trojan_Win32_LummaStealer_FAJ_2147947010_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.FAJ!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {32 0f 32 4d ff 8b 5d 14 8b 45 ?? 88 0f 8b 4d 08 3b 55 0c 72}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_LMX_2147947891_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.LMX!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {32 0c 28 fe c2 8a 44 24 14 32 cf 32 cb 8a d8 32 cd 88 4c 24 30 b1 08 2a ca d2 eb 8a ca d2 e0 0a d8 8b 44 24 18 0f b6 d3 8a cb 03 c2}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_FAI_2147947931_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.FAI!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {8a 1c 18 8b 44 24 40 33 c8 83 c0 02 f7 74 24 5c 0f b6 04 2a 03 44 24 28 03 c1 0f b6 d3 03 d0 8b 44 24 38 81 e2 ff 03 00 00 89 54 24 28}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_FAL_2147948268_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.FAL!MTB"
        threat_id = "2147948268"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {50 45 00 00 4c 01 08 00 d8 1a aa 68 00 00 00 00 00 00 00 00 e0 00 02 01 0b 01 0e 2b 00 b2 04 00 00 ?? 07 00 00 00 00 00 ?? ?? ?? 00 00 10 00 00 00 d0 04 00 00 00 40 00 00}  //weight: 10, accuracy: Low
        $x_10_2 = {6a b1 04 00 00 10 00 00 00 88 02 00 00 04 00 00 00 00 00 00 00 00 00 00 00 00 00 00 20 00 00 60 20 20 20 20 20 20 20 20 58 1c 01 00 00 d0 04 00 00 78 00 00 00 8c 02 00 00 00 00 00 00 00 00 00 00 00 00 00 40 00 00 40}  //weight: 10, accuracy: High
        $x_1_3 = "checkprotection" ascii //weight: 1
        $x_1_4 = "XWLSoftwareVersion" ascii //weight: 1
        $x_1_5 = "showcode" ascii //weight: 1
        $x_1_6 = "SOFTWARE\\WinLicense" ascii //weight: 1
        $x_1_7 = "XprotExit" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_AHD_2147952255_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.AHD!MTB"
        threat_id = "2147952255"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {0b 01 0e 00 00 f0 04 00 00 94 00 00 00 ?? ?? ?? ?? ?? ?? 00 00 10 00}  //weight: 20, accuracy: Low
        $x_30_2 = {2e 69 64 61 74 61 20 20 00 10 00 00 00 f0 05 00 00 02 00 00 00 e2 05}  //weight: 30, accuracy: High
        $x_50_3 = {20 20 20 00 20 20 20 20 00 d0 05 00 00 10 00 00 00 d0 05 00 00 10}  //weight: 50, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_AT_2147952572_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.AT!MTB"
        threat_id = "2147952572"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0f b6 c8 8b c3 25 ?? ?? ?? ?? 79 ?? 48 83 c8 ?? 40 33 c8 81 e1 ?? ?? ?? ?? 79 ?? 49 81 c9 ?? ?? ?? ?? 41 8b 45 ?? 30 0c 03 43 3b 5d ?? 0f 82}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_GPAS_2147952659_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.GPAS!MTB"
        threat_id = "2147952659"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_8_1 = {99 f7 f9 fe c2 33 c0 88 55 ?? 0f 1f 40 00 0f 1f 84 00 00 00 00 00 02 d0 32 ?? ?? ?? ?? 00 88 94 05}  //weight: 8, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_GPAT_2147952809_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.GPAT!MTB"
        threat_id = "2147952809"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_8_1 = {59 1f 72 61 d2 9c 11 0c 17 58 13 0c 11 09 17 58}  //weight: 8, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_AHE_2147953209_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.AHE!MTB"
        threat_id = "2147953209"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {d1 fa 8d 14 52 f7 da 88 54 ?? ff 0f b6 54 24 26 89}  //weight: 20, accuracy: Low
        $x_30_2 = {89 d7 f7 e9 c1 fa ?? 69 d2 ?? ?? ?? ?? 89 c8 29 d1 81 c1 ?? ?? ?? ?? 39 cb 0f 8d}  //weight: 30, accuracy: Low
        $x_10_3 = {8b 7c 24 1c 8b 94 24 30 02 00 00 8b 9c 24 28 02 00 00 89 c1 0f b6 74 24 21}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_AR_2147954229_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.AR!MTB"
        threat_id = "2147954229"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {0f 95 c2 88 d4 30 cc 20 e2 20 cc 88 d5 20 e5 30 d4 08 ec 30 e0 08 cc f6 d0 f6 d4}  //weight: 20, accuracy: High
        $x_15_2 = {89 ca 20 e0 30 c1 80 f2 01 34 01 08 d0 34 01 08 c8 88 c1 20 e8 80 f5 01 80 f1 01 88 ea 30 ca 20 e9 20 ea 08 c1 89 d0}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_AR_2147954229_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.AR!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {0f b6 54 24 02 0f b6 4c 24 03 89 d3 88 cf 88 ce 80 f3 01 80 f7 01 88 dd 08 fe 20 cf 30 d5 80 f7 01 88 f0 20 dd 08 d3}  //weight: 20, accuracy: High
        $x_10_2 = {89 d0 30 ca 08 c8 80 f2 01 89 c1 30 d1 08 c2 88 f0 34 01 80 f2 01 88 c4 08 ca 88 f1 20 f4}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_ARR_2147954235_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.ARR!MTB"
        threat_id = "2147954235"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {01 ca 83 f0 ?? 21 c8 01 c0 29 c2 89 54 24}  //weight: 5, accuracy: Low
        $x_3_2 = {89 c1 01 d1 21 d0 01 c0 89 ca 31 c2 f7 d0 21 c1}  //weight: 3, accuracy: High
        $x_2_3 = {89 d6 f7 de 8d b4 30 ?? ?? ?? ?? 29 d0 8d 84 01 ?? ?? ?? ?? 21 ce 01 f6 29 f0}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_ARR_2147954235_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8d 71 ff 0f af f1 89 f1 f7 d1 21 ce 31 ce 89 f1}  //weight: 20, accuracy: High
        $x_5_2 = {08 e5 88 ec 80 f5 01 20 c5 34}  //weight: 5, accuracy: High
        $x_20_3 = {08 dd 30 dc 80 f5 ?? 08 e5 88 c4 30 d4 20 c2 20 c4 34}  //weight: 20, accuracy: Low
        $x_5_4 = {88 fc 08 c4 88 d0 88 de 80 f4}  //weight: 5, accuracy: High
        $x_20_5 = {89 5d 98 0f af c1 89 c2 89 c6 25 ?? ?? ?? ?? f7 d2 81 e6 ?? ?? ?? ?? 89 d1 81 e1}  //weight: 20, accuracy: Low
        $x_5_6 = {88 d5 08 e1 20 c5 30 d0 88 cc 08 e8 88 c5 80 f4}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (
...
rule Trojan_Win32_LummaStealer_AMB_2147954336_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.AMB!MTB"
        threat_id = "2147954336"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {08 e0 30 c1 08 cb 89 d8 80 e3 95 f6 d0 24 6a 08 c3 89 d0 80 f3 95 20 d8 30 d3 ba ?? ?? ?? ?? 08 c3 88 1c 37 8b 45 ?? 40 89 45 ?? 81 fa}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_GXT_2147956473_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.GXT!MTB"
        threat_id = "2147956473"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {89 d6 21 ce 31 ca 8d 14 72 35 ?? ?? ?? ?? 21 c8 01 c0 29 c2 89 54 24 ?? 8b 44 24 ?? 04 ?? 8b 4c 24 ?? 8b 14 24 88 04 11 8b 04 24 89 c1 83 e1 ?? d1 e1 83 f0 ?? 01 c8 89 04 24}  //weight: 10, accuracy: Low
        $x_10_2 = {89 d6 21 ce 31 ca 8d 14 72 83 f0 ?? 21 c8 01 c0 29 c2 89 54 24 ?? 8b 44 24 ?? 04 ?? 8b 4c 24 ?? 8b 14 24 88 04 11 8b 04 24 83 e8 ?? 89 04 24}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_LummaStealer_GPK_2147956821_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.GPK!MTB"
        threat_id = "2147956821"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_8_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 02 00 00 00 b3 bc e1 05 00 00 00 00 9d cf d1 05 00 00 00 00 00 a6 39 00 f7 5f 44 de 21 71 d1 05}  //weight: 8, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_KK_2147956940_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_LummaStealer_KK_2147956940_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.KK!MTB"
...
rule Trojan_Win32_LummaStealer_KK_2147956940_3
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {c8 09 00 00 89 ?? 81 ?? fe ff ff 7f 09 ?? 89 ?? 83 e7 01 f7 df 81 e7 df b0 08 99 33 bc ?? f8 0f 00 00 d1 ?? 31 ?? 89 bc ?? 84 13 00 00 83 c0 04}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_MKB_2147957716_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.MKB!MTB"
        threat_id = "2147957716"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = {89 c7 8a 84 24 74 01 00 00 88 84 24 34 02 00 00 c6 84 24 26 01 00 00 6a c6 84 24 27 01 00 00 fb c6 84 24 28 01 00 00 67}  //weight: 15, accuracy: High
        $x_10_2 = {89 d0 09 d8 21 da 29 d0 89 cb f7 d3 21 c3 89 c2 f7 d2 21 ca 0f af d3}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_GVQ_2147958564_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.GVQ!MTB"
        threat_id = "2147958564"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {33 c0 01 1e ba 8a a5 08 00 8b 7d c8 03 fa 03 fb 03 f8 c7 45 a8 16 19 00 00}  //weight: 2, accuracy: High
        $x_1_2 = {03 f8 31 3e 83 c3 04 83 c6 04 3b 5d cc 72 b6}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_AHF_2147958665_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.AHF!MTB"
        threat_id = "2147958665"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {89 fb 31 fb 21 d3 31 fb 89 f2 31 f2 21 c2 31 f2 29 d9 19 d5 89 cf}  //weight: 30, accuracy: High
        $x_20_2 = {31 ce 81 f6 ?? ?? ?? ?? 0f af 30 01 fe 4e a1 ?? ?? ?? ?? 89 34 b8 47 81 ff ?? ?? ?? ?? 75}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_KKA_2147959985_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b 04 24 8b 4c 24 10 0f b6 0c 01 35 ?? ?? ?? ?? 89 44 24 04 8b 44 24 04 [0-3] 54 24}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_KKA_2147959985_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.KKA!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {0f b6 14 08 89 ce 81 f6 ?? ?? ?? ?? 89 75 f0 8b 75 f0 21 d6 89 75 e4 8b 75 f0 21 d6 89 75 e8 8b 75 [0-20] 01 d6 [0-30] ec 8b [0-30] 83 f9 14}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_CL_2147960135_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.CL!MTB"
        threat_id = "2147960135"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {02 c8 0f b6 04 16 88 0d ?? ?? ?? ?? 42 8a 0d ?? ?? ?? ?? 32 c8 88 0d ?? ?? ?? ?? 80 3c 16 00 75}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_ABL_2147960712_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.ABL!MTB"
        threat_id = "2147960712"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {89 fa 81 ca ?? ?? ?? ?? 21 da 09 f2 d1 ea 89 fe 83 e7 01 f7 df 81 e7 ?? ?? ?? ?? 33 3c 81 31 d7 89 bc 81 ?? ?? ?? ?? 40 3d e1 04 00 00 75}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_FAO_2147960913_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_LummaStealer_KKC_2147962095_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {89 ce 83 e6 f5 89 cf 83 e7 0a 83 c9 0a 0f af cf 83 f7 0a 0f af fe 0f be d2 01 ca 8d 0c 17 83 c1 d0 0f b6 50 01 40 89 d6 83 c6 d0 83 fe 0a}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_KKC_2147962095_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.KKC!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {89 c2 81 f2 ?? ?? ?? ?? 89 14 24 8b 14 24 8b 34 24 21 ce 01 ca 29 f2 89 54 24 0c 8b 54 24 0c 8b 34 24 21 ce 29 f2 89 54 24 08 8b 4c 24 08 80 c1 ?? ?? ?? ?? ?? 40 83 f8}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_KKD_2147962096_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_LummaStealer_KKE_2147962265_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.KKE!MTB"
        threat_id = "2147962265"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b 04 24 8b 4c 24 [0-15] 35 ?? ?? ?? ?? 89 44 24 ?? 8b 44 24 [0-20] 21 [0-5] 89 44 24 ?? 8b 44 24 [0-5] 8b 4c 24 [0-15] c8 89 44 24 ?? 8b 44 24 08 [0-5] 8b 4c 24 18 8b 14 24 88 04 11 8b 04 24 [0-20] 89 04 24 eb}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_PAA_2147963742_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.PAA!MTB"
        threat_id = "2147963742"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {8b 44 24 24 8b ac 24 80 00 00 00 32 0c 07 8b 44 24 18 32 0c 07 32 0b 32 4c 24 12 8b 44 24 74 88 0b 8b 4c 24 6c 3b 54 24 78}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_NKI_2147963841_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.NKI!MTB"
        threat_id = "2147963841"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {0f b6 00 89 c1 8b 45 ?? ba ?? ?? ?? ?? f7 75 ?? 8b 45 ?? 01 d0 0f b6 00 31 c1 8b 55 ?? 8b 45 ?? 01 d0 89 ca 88 10 83 45 ?? ?? 8b 45 ?? 3b 45 ?? 72}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_PAB_2147963898_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.PAB!MTB"
        threat_id = "2147963898"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {89 54 24 2c 88 18 8b 4c 24 14 8b 5c 24 20 8a 04 0a 88 04 0b 8b 44 24 14 8a 4c 24 13 88 0c 02 8b d6 8b 74 24 28 89 54 24 30 81 fa 00 10 00 00}  //weight: 3, accuracy: High
        $x_2_2 = {32 0c 07 8b 44 24 18 32 0c 07 32 0b 32 4c 24 12 8b 44 24 74 88 0b 8b 4c 24 6c}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_PGLV_2147963944_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.PGLV!MTB"
        threat_id = "2147963944"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {3c 4e 6f 6e 65 3e 00 00 3c 4e 6f 6e 65 3e 00 00 00 00 00 00 63 6d 64 20 2f 76 20 2f 63 20 53 65 74 20 ?? ?? ?? ?? 3d 63 6d 64 20 26 20 21 ?? ?? ?? ?? 21 20 3c 20 [0-31] 73 63 2e 65 78 65 20 2f 3f 6a 68 64 66 79 37 33 37 38 37 34 32 39 38 33 75 6b 72 6a 73 64 [0-255] 3c 4e 6f 6e 65 3e 00 00 3c 4e 6f 6e 65 3e}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_PAC_2147964057_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.PAC!MTB"
        threat_id = "2147964057"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {8b c2 8d 34 17 8b ca 83 e0 7f 83 e1 1f 8a 1c 28 32 99 ?? ?? ?? ?? 32 99 ?? ?? ?? ?? 32 da 8b 54 24 38 03 d6 88 1e 8d 42 ff 25 7f 00 00 80}  //weight: 3, accuracy: Low
        $x_2_2 = {8b 54 24 20 c0 e8 02 42 32 c8 89 54 24 20 88 0e 81 fa 00 01 00 00 7c 98}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_PAD_2147964772_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.PAD!MTB"
        threat_id = "2147964772"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {4a 81 ca 00 fc ff ff 42 8b 44 24 58 89 54 24 2c 88 18 8b 4c 24 14 8b 5c 24 20 8a 04 0a 88 04 0b 8b 44 24 14 8a 4c 24 13 88 0c 02 8b d6 8b 74 24 28 89 54 24 30 81 fa 00 10 00 00 0f 8c}  //weight: 3, accuracy: High
        $x_2_2 = {8b 4c 24 14 8b 7c 24 20 8a 04 0e 88 04 0f 8b 44 24 14 88 14 06 8b d7}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_UYR_2147966639_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.UYR!MTB"
        threat_id = "2147966639"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {83 3c 24 04 72 ?? eb ?? 8b 04 24 8b 4c 24 ?? 8a 0c 01 35 ?? ?? ?? ?? 89 44 24 ?? 8b 44 24 ?? 30 c8 04 ?? 8b 4c 24 ?? 8b 14 24 88 04 11 8b 04 24 83 c0 ?? 89 04 24 eb}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_AHA_2147966744_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.AHA!MTB"
        threat_id = "2147966744"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {33 cd 33 4c 24 34 8d 7a 01 8a 04 30 33 ca 88 44 24 13 8b c7 99 f7 7c 24 78}  //weight: 30, accuracy: High
        $x_20_2 = {88 04 31 8a cb 8b 44 24 14 8a 6c 24 11 8b 74 24 28 32 cd d0 eb 88 0c 06 8a cd}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_ABK_2147966803_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.ABK!MTB"
        threat_id = "2147966803"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {01 f1 53 bb ?? ?? ?? ?? 01 cb 31 03 5b 59 83 ec}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_PGLJ_2147968565_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.PGLJ!MTB"
        threat_id = "2147968565"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {c0 e0 02 32 c8 32 cb 88 0c 17 8b d6 89 54 24 ?? 81 fa ?? ?? ?? ?? 0f 8c}  //weight: 5, accuracy: Low
        $x_5_2 = {8b fa 8b 4c 24 ?? 32 c3 8b 54 24 ?? 88 01 8b 4c 24 ?? 81 f9 ?? ?? ?? ?? 0f 8c}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_GXM_2147968755_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.GXM!MTB"
        threat_id = "2147968755"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {0f b6 2c 03 31 d5 31 dd 87 cd 88 0c 18 87 cd 43 39 d9 7f ec 31 d2}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_LVM_2147969241_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.LVM!MTB"
        threat_id = "2147969241"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {21 cf 01 fe 8b bd ec fe ff ff 29 f2 8b b5 f8 fe ff ff 89 95 d8 fa ff ff 8b 8d d8 fa ff ff 89 ca 83 f2 57 d1 e1 83 e1 50 29 d1 88 4c 05 c0 83 c0 01 e9 77 ff ff ff}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_LummaStealer_KAN_2147969418_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.KAN!MTB"
        threat_id = "2147969418"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {8b c3 c1 e0 ?? 33 d8 8b c7 0f af c7 8b cb 83 e1 ?? 03 c5 c1 f8 ?? 2b c8 81 c1 ?? ?? ?? ?? 83 f9 ?? 7d}  //weight: 1, accuracy: Low
        $x_1_2 = {89 0a 83 c2 ?? 47 83 ee ?? 75 ?? 8b 74 24 ?? 46 83 6c 24 ?? ?? 89 74 24 ?? 75}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_LummaStealer_VA_2147978546_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/LummaStealer.VA!MTB"
        threat_id = "2147978546"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "LummaStealer"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {01 f3 0f b7 08 83 c0 02 66 85 c9 74 24 0f b7 e9 31 c9 81 fd 00 08 00 00 0f 92 c2 be 01 00 00 00 81 fd 80 00 00 00 72 d8 88 d1 83 f1 03 89 ce eb cf}  //weight: 1, accuracy: High
        $x_1_2 = {88 08 89 f1 c1 e9 06 80 e1 3f 80 c9 80 88 48 01 80 e2 3f 80 ca 80 88 50 02 be 03 00 00 00 e9 71 ff ff ff}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
