...
rule Trojan_Win32_ShellcodeRunner_ARR_2147959025_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_8_1 = {41 0f b6 c2 41 32 c0 0f b6 c8 41 f6 c3 ?? 41 0f b6 c2 41 0f 44 c8 02 c0}  //weight: 8, accuracy: Low
        $x_12_2 = {48 ff c0 32 4a f0 88 0a 48 83 f8}  //weight: 12, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ShellcodeRunner_ARR_2147959025_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.ARR!MTB"
...
rule Trojan_Win32_ShellcodeRunner_ARR_2147959025_3
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_11_1 = {46 0f b6 1c 01 45 30 cb 46 88 1c 02 46 0f b6 5c 01 ?? 45 30 cb 46 88 5c 02 ?? 46 0f b6 5c 01 ?? 45 30 cb 46 88 5c 02 02 46 0f b6 5c 01 03 45 30 cb 46 88 5c 02}  //weight: 11, accuracy: Low
        $x_9_2 = {46 0f b6 14 01 45 30 ca 46 88 14 02 49 ff c0 48 ff c8}  //weight: 9, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ShellcodeRunner_LM_2147960484_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.LM!MTB"
        threat_id = "2147960484"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ShellcodeRunner"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {83 e2 07 03 c2 c1 f8 03 89 45 d0 eb ?? 8b 55 d0 83 c2 09 89 55 d0 eb ?? 8b 45 d0 83 e8 08 89 45 d0}  //weight: 10, accuracy: Low
        $x_5_2 = {8b 95 24 ff ff ff 83 ea 04 89 95 24 ff ff ff e9 ?? ?? ?? ?? 6b 85 24 ff ff ff 05 89 85 24 ff ff ff e9 ?? ?? ?? ?? 8b 85 24 ff ff ff 99 b9 05 00 00 00 f7 f9 89 85 24 ff ff ff e9 ?? ?? ?? ?? 8b 95 24 ff ff ff 83 c2 06 89 95 24 ff ff ff}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ShellcodeRunner_ARA_2147967000_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.ARA!MTB"
        threat_id = "2147967000"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ShellcodeRunner"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {8b c1 33 d2 f7 f7 8a 82 e0 fe ?? ?? 32 81 f8 e7 ?? ?? 88 04 0e 41 81 f9 e5 16 00 00 72 e2}  //weight: 2, accuracy: Low
        $x_2_2 = {f7 f7 0f b6 82 ?? ?? ?? 10 32 81 ?? ?? 02 10 88 44 0e 03 83 c1 04 81 f9 ?? ?? ?? ?? 72 97}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ShellcodeRunner_MKA_2147968145_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.MKA!MTB"
        threat_id = "2147968145"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ShellcodeRunner"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {c7 45 fc 05 00 00 00 8d 55 e4 8b 45 e8 52 ff 36 8b 08 50 ff 51 1c 83 cf ff 89 45 d8 c7 45 fc ff ff ff ff 8b cf f0 0f c1 4e 08}  //weight: 30, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ShellcodeRunner_MKA_2147968145_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.MKA!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {c6 44 24 68 bd 80 74 24 69 34 80 74 24 6a 35 80 74 24 6b 36 80 74 24 6c 37 80 74 24 6d 38 80 74 24 6e 39 80 74 24 6f 3a 80 74 24 70 3b 80 74 24 71 3c 34 3d}  //weight: 20, accuracy: High
        $x_15_2 = {40 0f b6 c7 2a c1 04 33 41 30 00 ff c7 4d 8d 40 01 83 ff 3a}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ShellcodeRunner_KKB_2147968226_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.KKB!MTB"
        threat_id = "2147968226"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ShellcodeRunner"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8d 3c 80 bb 6e 5b cd 04 31 df 89 0c 24 8b 0d ?? ?? ?? ?? 8d 2c 40 31 dd 8b 4c 29 01 33 4c 3a 01 81 c1 e2 9c b5 dd 8b 15 ?? ?? ?? ?? 8b 92 73 5b cd 04 8b 3d ?? ?? ?? ?? c1 e0 02 35 6f 5b cd 04 8b 04 07 bf 6b 47 c0 39 31 f8 01 d0 40 51 56 ff d0 8b 4c 24 08 83 c4 08 b8 77 8b 62 3e}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_ShellcodeRunner_SX_2147969024_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.SX!MTB"
        threat_id = "2147969024"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ShellcodeRunner"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {0f b6 4c 15 ec 8b c1 83 e1 0f c1 e8 04 0f b6 80 ?? ?? ?? ?? 88 04 57 0f b6 81 ?? ?? ?? ?? 88 44 57 01 42 83 fa 10 72 d8}  //weight: 30, accuracy: Low
        $x_10_2 = {66 0f 64 c1 0f 55 c3 0f 55 d3 0f 54 d0 0f 28 c6 66 0f fc c1 0f 54 c2 0f 55 d1 0f 56 c2 0f 11 45 d8 68 04 01 00 00}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ShellcodeRunner_SXA_2147969173_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.SXA!MTB"
        threat_id = "2147969173"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ShellcodeRunner"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {0f b6 4c 15 ec 8b c1 83 e1 0f c1 e8 04 0f b6 ?? ?? ?? ?? ?? 88 04 57 0f b6 ?? ?? ?? ?? ?? 88 44 57 01 42 83 fa 10 72 d8}  //weight: 30, accuracy: Low
        $x_10_2 = {80 f9 05 0f b6 d8 0f b6 c2 8a d6 0f 47 d8 8a c6 2c 20 80 ea 61 0f b6 c8 80 fa 05 0f b6 c6 0f 47 c8 3a d9}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ShellcodeRunner_SXB_2147969440_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.SXB!MTB"
        threat_id = "2147969440"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ShellcodeRunner"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {33 d2 32 81 ?? ?? ?? ?? 88 44 0e ?? 8d 41 ?? f7 f7 0f b6 82 ?? ?? ?? ?? 33 d2 32 81 ?? ?? ?? ?? 88 44 0e ?? 8d 41 ?? f7 f7 0f b6 82 ?? ?? ?? ?? 33 d2 32 81 ?? ?? ?? ?? 88 44 0e ?? 8d 41 ?? f7 f7 0f b6 82 ?? ?? ?? ?? 32 81 ?? ?? ?? ?? 88 44 0e ?? 83 c1 ?? 81 f9}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_ShellcodeRunner_DC_2147973515_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {69 59 b4 42 b3 90 68 bb 3f 6e d8 76 44 57 81 d5 f6 ce 93 fc 66 30 70 a4 e7 c4 7d 5e 78 cb 54 59 fc 4a 57 0f 1a a5 c7 81 e1 d4 fb 95 f0 bc b2 10 9a 1e 9c c5 35 b5 7c 81 60 9e 8a 43 5d 93 f7 96 db 35 d0 3e 39 8b 1c 7d a8 57 84 ec}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_ShellcodeRunner_YBJ_2147976436_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {8a 26 31 c9 41 39 3c 0e 74 13 50 32 24 0e 88 64 15 00 58 41 42 38 c1 76 ec 01 ce eb e3}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_ShellcodeRunner_YBJ_2147976436_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ShellcodeRunner.YBJ!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {eb 2f 8b 55 f4 8b 45 f0 8b 04 85 ?? ?? ?? ?? 89 54 24 04 89 04 24 a1}  //weight: 6, accuracy: Low
        $x_1_2 = "31c931db-ebff-5a33-04fe-89c604904fc1" ascii //weight: 1
        $x_1_3 = "fa3108ef-c801-c183-0140-29c839f975f4" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
