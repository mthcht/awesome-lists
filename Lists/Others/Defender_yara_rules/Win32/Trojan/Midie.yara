...
rule Trojan_Win32_Midie_AMI_2147961550_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Midie.AMI!MTB"
        threat_id = "2147961550"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Midie"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {8b 4d f8 8b 55 08 8b 04 8a 03 45 fc 03 45 f4 c1 e0 03 8b 4d f8 8b 55 08 8b 0c 8a 03 4d fc 03 4d f4 c1 e9 1d 0b c1 89 45 fc 8b 55 f4 03 55 fc 89 55 f4 8b 45 c8 8b 54 85 d0 03 55 f4 8b 4d f4 d3 e2 8b 45 c8 8b 44 85 d0}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Midie_MK_2147973792_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Midie.MK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {b8 ff 03 00 00 66 23 c8 0f b6 c1 35 58 2d 4d 2f 69 d0 1b 02 00 01 0f b7 c1 c1 e8 08 33 d0}  //weight: 20, accuracy: High
        $x_15_2 = {05 37 0c 00 00 8b d8 48 c1 e8 10 83 e0 1f 8a 04 10 42 88 84 31 ?? ?? ?? ?? 49 03 cc 48 83 f9 06}  //weight: 15, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Midie_LR_2147976092_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Midie.LR!MTB"
        threat_id = "2147976092"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Midie"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b 10 8b c8 8b 42 0c ff d0 8d 58 10 89 5c 24 14 c6 44 24 28 01 8b 54 24 34 8b 4a f8 b8 01 00 00 00 2b 42 fc 0b c8 7d ?? 55 8d 4c 24 38}  //weight: 20, accuracy: Low
        $x_10_2 = {83 fa 04 0f ?? ?? ?? ?? ?? 8b 44 24 18 8a cc 02 c0 c0 e9 04 02 c0 0a c8 0f b6 d1}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
