...
rule Trojan_Win32_Guildma_GXM_2147976167_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Guildma.GXM!MTB"
        threat_id = "2147976167"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Guildma"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = "\\tempwj\\hwasrhelaxb.gif" ascii //weight: 3
        $x_3_2 = "\\tempwj\\hwasrhela98.dll" ascii //weight: 3
        $x_1_3 = "DVCLAL" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
