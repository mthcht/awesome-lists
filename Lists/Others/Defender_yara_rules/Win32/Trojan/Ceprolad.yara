rule Trojan_Win32_Ceprolad_A_2147726914_0
{
    ...
    strings:
        ...
        $n_50_15 = "http://localhost/fio-62833e7bae788a6973cdf8d5.crl" wide //weight: -50
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (
...
rule Trojan_Win32_Ceprolad_A_2147726914_1
{
    ...
    strings:
        ...
        $n_50_25 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 44 00 59 00 4e 00 2d 00 44 00 4d 00 2d 00 62 00 69 00 61 00 62 00 74 00 72 00 69 00 78 00 30 00 31 00 2e 00 62 00 69 00 61 00 62 00 2e 00 61 00 75 00 2e 00 90 00 02 00 32 00 2e 00 6e 00 65 00 74 00 2f 00 54 00 65 00 6c 00 65 00 70 00 68 00 6f 00 6e 00 79 00 2f 00 90 00 02 00 32 00 2e 00 54 00 65 00 6c 00 65 00 70 00 68 00 6f 00 6e 00 79 00 2e 00 78 00 62 00 61 00 70 00}  //weight: -50, accuracy: High
        $n_50_26 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 74 00 72 00 69 00 78 00 2e 00 61 00 75 00 2e 00 90 00 02 00 32 00 2e 00 6e 00 65 00 74 00 2f 00 54 00 65 00 6c 00 65 00 70 00 68 00 6f 00 6e 00 79 00 2f 00 90 00 02 00 32 00 2e 00 54 00 65 00 6c 00 65 00 70 00 68 00 6f 00 6e 00 79 00 2e 00 78 00 62 00 61 00 70 00}  //weight: -50, accuracy: High
        $n_50_27 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 90 00 02 00 10 00 2e 00 70 00 6f 00 77 00 65 00 72 00 62 00 69 00 2e 00 63 00 6f 00 6d 00 2f 00 68 00 6f 00 6d 00 65 00}  //weight: -50, accuracy: High
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (
...
rule Trojan_Win32_Ceprolad_A_2147726914_2
{
    ...
    strings:
        ...
        $n_50_26 = "http://localhost/fio-62833e7bae788a6973cdf8d5.crl" wide //weight: -50
        $n_50_27 = "/Citrix/FASSToreWeb/ " wide //weight: -50
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (1 of ($x*))
