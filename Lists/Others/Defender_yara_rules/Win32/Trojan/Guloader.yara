...
rule Trojan_Win32_Guloader_RR_2147833669_3
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "\\Transskriberingernes" wide //weight: 1
        $x_1_2 = "viserinstrumenter.eff" wide //weight: 1
        $x_1_3 = "Software\\Microsoft\\Windows\\CurrentVersion\\sprogede\\atomlre" wide //weight: 1
        $x_1_4 = "\\Fllen\\Fastetiders" wide //weight: 1
        $x_1_5 = "\\Fllen\\Pythagoreans" wide //weight: 1
        $x_1_6 = "\\turlough\\Nonfan150.dll" wide //weight: 1
        $x_1_7 = "\\Tributtens" wide //weight: 1
        $x_1_8 = "taktregulerendes.bla" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Guloader_RR_2147833669_5
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "pseudomorphism\\Uninstall\\udbygningsplans\\Tykpandetheden" wide //weight: 1
        $x_1_2 = "shuntmodstandene" wide //weight: 1
        $x_1_3 = "\\mandibuliform\\tastaturer.ini" wide //weight: 1
        $x_1_4 = "Kulminationen32\\sommerhusomraadernes" wide //weight: 1
        $x_1_5 = "%Podsolic%\\berlines\\war" wide //weight: 1
        $x_1_6 = "dobbeltrudes\\Uninstall\\findyrkes" wide //weight: 1
        $x_1_7 = "respiratored" wide //weight: 1
        $x_1_8 = "Radiotelegrafiens.Pri" wide //weight: 1
        $x_1_9 = "bankettens.fll" wide //weight: 1
        $x_1_10 = "diabolarchy.gro" wide //weight: 1
        $x_1_11 = "udraabsordet.slb" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Guloader_RR_2147833669_6
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "\\Application Data\\clochards\\prink.Syn" wide //weight: 1
        $x_1_2 = "\\JohnDoe\\Application Data\\udbeder.dll" wide //weight: 1
        $x_1_3 = "drslgerens\\skovgangsmndenes" wide //weight: 1
        $x_1_4 = "\\brnehavepdagog\\immunochemical.txt" wide //weight: 1
        $x_1_5 = "\\acuminated.ini" wide //weight: 1
        $x_1_6 = "backfische\\nonpacificatory\\" wide //weight: 1
        $x_1_7 = "\\astute\\subnitrate.txt" wide //weight: 1
        $x_1_8 = "\\plankton.zip" wide //weight: 1
        $x_1_9 = "\\ungarnsopholdene.zip" wide //weight: 1
        $x_1_10 = "gestussernes\\Politikkerne\\paapasselig" wide //weight: 1
        $x_1_11 = "\\Anfract185\\unevasively.exe" wide //weight: 1
        $x_1_12 = "Approksimative\\Uninstall\\tuaregiske\\Atonicity40" wide //weight: 1
        $x_1_13 = "%superattainableness%\\Foredragsrkker192\\anthonie" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Guloader_SQD_2147960422_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Guloader.SQD!MTB"
        threat_id = "2147960422"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Guloader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "antikiser\\kolonneafstand" ascii //weight: 2
        $x_1_2 = "spencerkjole\\epigyny.jpg" ascii //weight: 1
        $x_1_3 = "Tvangsfjernelsens.sub" ascii //weight: 1
        $x_1_4 = "Koggerets.har" ascii //weight: 1
        $x_1_5 = "akseltrykkene.bes" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Guloader_SI_2147963090_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Brndingerne.aff" ascii //weight: 1
        $x_1_2 = "postanvisningers.fib" ascii //weight: 1
        $x_1_3 = "subjektsprdikaters.tes" ascii //weight: 1
        $x_1_4 = "kostplaner\\Uninstall\\gipspladers" ascii //weight: 1
        $x_1_5 = "Punctate\\gnistredes" ascii //weight: 1
        $x_1_6 = "curiousness forureningsbegrebets" ascii //weight: 1
        $x_1_7 = "\\indazine.dll" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Guloader_SI_2147963090_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Guloader.SI!MTB"
    ...
    strings:
        ...
        $x_1_2 = "Amitotically.kry" ascii //weight: 1
        $x_1_3 = "Diskofilers16.lre" ascii //weight: 1
        $x_1_4 = "Bonaght.bss" ascii //weight: 1
        $x_1_5 = "Heterotic.pre" ascii //weight: 1
        $x_1_6 = "Mimbar.ang" ascii //weight: 1
        $x_1_7 = "Quaestorship33.mol" ascii //weight: 1
        $x_1_8 = "luskers.non" ascii //weight: 1
        $x_1_9 = "oligoplasmia.ben" ascii //weight: 1
        $x_1_10 = "scoop.sam" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Guloader_SI_2147963090_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Guloader.SI!MTB"
...
rule Trojan_Win32_Guloader_SI_2147963090_3
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "\\Erodering162\\Klemmelses\\bogensernes" ascii //weight: 1
        $x_1_2 = "Nonabsoluteness" ascii //weight: 1
        $x_1_3 = "\\agronome\\mobula\\nittens\\Engelsholm152" ascii //weight: 1
        $x_1_4 = "antidancing.ast" ascii //weight: 1
        $x_1_5 = "outmiracle.non" ascii //weight: 1
        $x_1_6 = "synectics.mes" ascii //weight: 1
        $x_1_7 = "urutu.dal" ascii //weight: 1
        $x_1_8 = "maalformulering\\Bedamp21\\Indryknings220\\recking" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Guloader_KX_2147968587_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Guloader.KX!MSR"
        threat_id = "2147968587"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Guloader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "infuriating tegnebog" ascii //weight: 1
        $x_1_2 = "korsfstelserne.exe" ascii //weight: 1
        $x_1_3 = "exclam forvrrelses" ascii //weight: 1
        $x_1_4 = "betalingsfristernes bromatologi serenaderne" ascii //weight: 1
        $x_1_5 = "jordarve" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Guloader_SC_2147974161_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Guloader.SC!MTB"
        threat_id = "2147974161"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Guloader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "bjergtinde crafting" ascii //weight: 2
        $x_1_2 = "diskvalificerende" ascii //weight: 1
        $x_1_3 = "recompensatory gletschere" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Guloader_SC_2147974161_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Guloader.SC!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Brugergrupper.mun" ascii //weight: 1
        $x_1_2 = "beskyttelsestoldens.vol" ascii //weight: 1
        $x_1_3 = "faginspektrens.sup" ascii //weight: 1
        $x_1_4 = "multidenticulate.spi" ascii //weight: 1
        $x_1_5 = "ruttedes.min" ascii //weight: 1
        $x_1_6 = "skorstenenes.mat" ascii //weight: 1
        $x_1_7 = "\\clandestinely.exe" ascii //weight: 1
        $x_1_8 = "stakaandedes" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Guloader_SG_2147974428_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Guloader.SG!MTB"
        threat_id = "2147974428"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Guloader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "\\Talehrelreres" ascii //weight: 1
        $x_1_2 = "\\lredrengens" ascii //weight: 1
        $x_1_3 = "frstehjlpen.ini" ascii //weight: 1
        $x_1_4 = "C:\\TEMP\\smeeky" ascii //weight: 1
        $x_1_5 = "\\Spelean\\nudzhing.bin" ascii //weight: 1
        $x_1_6 = "\\astay\\straffebestemmelse.htm" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Guloader_SL_2147978166_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Guloader.SL!MTB"
        threat_id = "2147978166"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Guloader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Stubharves144\\Untransitorily187\\swimmingness" ascii //weight: 1
        $x_1_2 = "Bombesprngninger\\regilt\\dgnpladser" ascii //weight: 1
        $x_1_3 = "avantgardes.sco" ascii //weight: 1
        $x_1_4 = "keelhaling.unr" ascii //weight: 1
        $x_1_5 = "filings.tth" ascii //weight: 1
        $x_1_6 = "mestendels" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
