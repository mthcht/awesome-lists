...
rule Trojan_Win32_SusOdbcconf_AM_2147948227_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/SusOdbcconf.AM"
        threat_id = "2147948227"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "SusOdbcconf"
        severity = "Critical"
    ...
    strings:
        ...
        $x_1_3 = "odbcconf.exe /s /a {regsvr " wide //weight: 1
        $x_1_4 = "phonehome" wide //weight: 1
        $n_1_5 = "506079a9-3427-44b1-b745-a1c985d03219" wide //weight: -1
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (all of ($x*))
