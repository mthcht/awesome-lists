...
rule Trojan_Win32_ICLoader_RR_2147963465_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.RR!MTB"
        threat_id = "2147963465"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {33 c2 88 5e 08 25 ff 00 00 00 33 d8 89 5d e4 8b 0e 8b 45 dc 8b 56 04 89 06 8b 45 e0 89 4d dc 89 46 04 8b 4e 08 8b 46 08 c1 e1 17 33 c3}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_ICLoader_GPKA_2147973643_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 bb 9c 69 00 4a 01 66 00 00 be 0a 00 1a 48 20 ff cb 93 65 00 00 d4 00 00 b5 e8 6d 26}  //weight: 4, accuracy: High
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 71 a0 69 00 e4 04 66 00 00 be 0a 00 fd 1e 8a 15 60 97 65 00 00 d4 00 00 e4 1a 3f ad}  //weight: 4, accuracy: High
        $x_4_3 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 e1 ba 69 00 70 1f 66 00 00 be 0a 00 1e 4a 7f 0a f6 b1 65 00 00 d4 00 00 55 22 2d 38}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}
...
rule Trojan_Win32_ICLoader_GPKB_2147973645_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 c5 76 74 00 38 db 70 00 00 be 0a 00 c6 fe 65 40 a6 6d 70 00 00 d4 00 00 c3 60 7a e8}  //weight: 4, accuracy: High
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 d8 6a 74 00 52 cf 70 00 00 be 0a 00 58 9c 8e 15 e4 61 70 00 00 d4 00 00 aa f9 1a f8}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GPKC_2147974170_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKC!MTB"
        threat_id = "2147974170"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 c9 79 cc 87 d3 2a 66}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ICLoader_GPKD_2147974295_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKD!MTB"
        threat_id = "2147974295"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 2f 46 69 7b 7a d1 70}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ICLoader_GPKE_2147974327_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKE!MTB"
        threat_id = "2147974327"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 f8 75 da f6 dc 09 66}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ICLoader_GPKF_2147974549_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKF!MTB"
        threat_id = "2147974549"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 37 1f ae 04 b1 d0 65}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ICLoader_GPKG_2147974612_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKG!MTB"
        threat_id = "2147974612"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 b7 86 af e4 f9 42 70}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ICLoader_GPKH_2147974853_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKH!MTB"
        threat_id = "2147974853"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 71 c9 5f 1b 0f c1 65}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ICLoader_GPKI_2147975166_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKI!MTB"
        threat_id = "2147975166"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? 69 00 ?? ?? 66 00 00 be 0a 00 83 36 7e ee 4e b1 65}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? 69 00 ?? ?? 66 00 00 be 0a 00 4a ad b0 3f 42 9f 65}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GPKJ_2147975218_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKJ!MTB"
        threat_id = "2147975218"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? 69 00 ?? ?? 66 00 00 be 0a 00 87 34 21 1b da aa 65}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ICLoader_GPKK_2147975327_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKK!MTB"
        threat_id = "2147975327"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 23 73 8b a4 3e f1 65}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 ae 0a 00 76 3d 5f 0c cf 2a 6d}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GPKL_2147975413_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPKL!MTB"
        threat_id = "2147975413"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 02 11 e7 80 74 c7}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_ICLoader_GPAU_2147975851_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPAU!MTB"
        threat_id = "2147975851"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 49 4c 6c ce 82 a3 65}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 fc a0 12 9b 9d 6b 65}  //weight: 4, accuracy: Low
        $x_4_3 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 ab dd 37 6e c0 dc 65}  //weight: 4, accuracy: Low
        $x_4_4 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 d8 a9 2e 5c 23 49 65}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GPAV_2147975944_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPAV!MTB"
        threat_id = "2147975944"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 d5 8e f5 a4 64 6d 65}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 5a c3 ca 6a 10 4b 65}  //weight: 4, accuracy: Low
        $x_4_3 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 13 c1 05 5b ed 9a 65}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}
...
rule Trojan_Win32_ICLoader_GPAX_2147976259_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPAX!MTB"
        threat_id = "2147976259"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 dd b9 48 8e de 39 65}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 c8 c7 54 09 1e 2c 70}  //weight: 4, accuracy: Low
        $x_4_3 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 1f f4 e7 84 d9 89 65}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GPAY_2147976348_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GPAY!MTB"
        threat_id = "2147976348"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 ff b6 95 3e ed 1c 70}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 9f 6d e6 64 e1 5a 65}  //weight: 4, accuracy: Low
        $x_4_3 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 3f 71 46 08 0e 58 65}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GA_2147977139_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GA!MTB"
        threat_id = "2147977139"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 9d 19 28 5a 3e 7c 65}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 07 09 ca ff 98 87 65}  //weight: 4, accuracy: Low
        $x_4_3 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 68 b1 3a a7 4c 7d 6f}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GC_2147977564_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GC!MTB"
        threat_id = "2147977564"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 ca 77 c4 9e 2d f8 66}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 50 67 26 3b f6 7b 67}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GP_2147977769_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GP!MTB"
        threat_id = "2147977769"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ICLoader"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 0b 33 49 b9 fb a8 6a}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 0b 33 49 b9 47 8b 6a}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GP_2147977769_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GP!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 2e a3 95 11 3f 95 65}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 bb 67 49 9a 5f 7a 65}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}

rule Trojan_Win32_ICLoader_GP_2147977769_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ICLoader.GP!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_4_1 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 8c cb fb 43 bf fb 66}  //weight: 4, accuracy: Low
        $x_4_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 6c 28 92 58 e9 d2 66}  //weight: 4, accuracy: Low
        $x_4_3 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 ?? ?? ?? 00 ?? ?? ?? 00 00 be 0a 00 f6 38 70 fd 59 bb 66}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}
