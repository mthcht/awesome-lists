...
rule Trojan_Win32_Babar_MBXY_2147925396_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Babar.MBXY!MTB"
        threat_id = "2147925396"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Babar"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {55 8b ec 6a ff 68 ?? ?? 7c 00 68 ?? ?? 7c 00 64 a1 00 00 00 00 50 64 89 25 00 00 00 00 83 ec 58 53 56 57 89 65 e8 ff 15 ?? ?? 7c 00 33 d2 8a d4}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
