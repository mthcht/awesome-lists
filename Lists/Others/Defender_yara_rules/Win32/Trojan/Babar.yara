...
rule Trojan_Win32_Babar_ABR_2147901335_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {89 d7 f7 eb c1 fa 05 89 d8 c1 fb 1f 29 da 6b da 61 89 c2 29 d8 31 e8 89 cb c1 e1 05 29 d9 31 c1 88 0c 1e 89 f8 e9}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Babar_ABR_2147901335_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Babar.ABR!MTB"
...
rule Trojan_Win32_Babar_ABR_2147901335_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Babar.ABR!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {33 c9 66 89 8d 20 f9 ff ff c7 85 1c f9 ff ff 01 00 00 00 89 9d 34 f9 ff ff 33 c0 89 85 38 f9 ff ff 89 85 3c f9 ff ff 89 85 40 f9 ff ff 8d 95 34 f9 ff ff 52 8d 85 f0 f8 ff ff 50 53 53 68 00 00 00 08 53 53 53 8d 8d 48 f9 ff ff 51 8d 95 58 fd ff ff 52}  //weight: 2, accuracy: High
        $x_1_2 = {0f b6 71 fe 8b de c1 eb 04 0f b6 9b 54 67 42 00 88 18 83 e6 0f 0f b6 9e 54 67 42 00 88 58 01 0f b6 71 ff 8b de c1 eb 04 0f b6 9b 54 67 42 00 88 58 02 83 e6 0f 0f b6 9e 54 67 42 00 88 58 03 0f b6 31 8b de c1 eb 04 0f b6 9b 54 67 42 00 88 58 04 83 e6 0f 0f b6 9e 54 67 42 00 88 58 05 0f b6 71 01 8b de c1 eb 04 0f b6 9b 54 67 42 00 88 58 06 83 e6 0f 0f b6 9e 54 67 42 00 88 58 07 83 c0 08}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Babar_SX_2147964479_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Babar.SX!MTB"
        threat_id = "2147964479"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Babar"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_15_1 = {83 c4 10 8a 06 04 5c 0f b6 c0 83 c0 03 24 fc}  //weight: 15, accuracy: High
        $x_10_2 = {0f af c1 8b 4c 24 ?? a3 ?? ?? ?? ?? 8b 44 24 04 8b d0 03 c1 23 d1 66 a3}  //weight: 10, accuracy: Low
        $x_5_3 = {8b 74 24 1c a3 ?? ?? ?? ?? 8b 5c 24 18 33 c9 8a 06 04 5c 38 0d}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Babar_LR_2147977347_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Babar.LR!MTB"
        threat_id = "2147977347"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Babar"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b 95 d0 fe ff ff 89 c8 83 e0 03 8a ?? ?? ?? ?? ?? 30 04 0a f6 14 0a 41 39 ce 75 ?? 89 d0 31 db}  //weight: 20, accuracy: Low
        $x_10_2 = {8b 85 d4 fe ff ff 0f b7 40 06 39 c2 73 ?? 6b c2 28 8b 8d c4 fe ff ff 01 c8 8b 48 10 85 c9 74 ?? 8b 70 14 8d 3c 31}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
