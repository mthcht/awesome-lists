...
rule Trojan_Win32_Lumma_ENZ_2147941728_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lumma.ENZ!MTB"
        threat_id = "2147941728"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Lumma"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {33 3c 81 31 d7 89 bc 81 0c f0 ff ff 40 3d e1 04 00 00}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
