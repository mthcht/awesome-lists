...
rule Trojan_Win32_SuspClickFix_R6_2147969776_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/SuspClickFix.R6"
        threat_id = "2147969776"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "SuspClickFix"
        severity = "Critical"
...
rule Trojan_Win32_SuspClickFix_Z2_2147970080_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_SuspClickFix_Z4_2147971224_0
{
    ...
    strings:
        ...
        $x_1_2 = {70 00 75 00 73 00 68 00 64 00 [0-16] 20 00 5c 00 5c 00}  //weight: 1, accuracy: Low
...
rule Trojan_Win32_SuspClickFix_Z4_2147971224_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/SuspClickFix.Z4"
...
rule Trojan_Win32_SuspClickFix_Z4_2147971224_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/SuspClickFix.Z4"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {5c 00 53 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 72 00 75 00 6e 00 64 00 6c 00 6c 00 33 00 32 00 2e 00 65 00 78 00 65 00 00 00}  //weight: 1, accuracy: High
        $x_1_2 = {72 00 75 00 6e 00 64 00 6c 00 6c 00 33 00 32 00 20 00 [0-16] 2e 00 [0-6] 2c 00 23 00 31 00}  //weight: 1, accuracy: Low
        $x_1_3 = {72 00 75 00 6e 00 64 00 6c 00 6c 00 33 00 32 00 20 00 [0-16] 2e 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 2d 00 ?? ?? ?? ?? ?? ?? ?? ?? 2d 00 ?? ?? ?? ?? ?? ?? ?? ?? 2d 00 ?? ?? ?? ?? ?? ?? ?? ?? 2d 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 2c 00 23 00 31 00}  //weight: 1, accuracy: Low
        $x_1_4 = {72 00 75 00 6e 00 64 00 6c 00 6c 00 33 00 32 00 20 00 2f 30 30 00 2c 00 23 00 31 00}  //weight: 1, accuracy: Low
        $x_1_5 = {72 00 75 00 6e 00 64 00 6c 00 6c 00 33 00 32 00 20 00 2f 30 30 00 2e 00 64 00 6c 00 6c 00 2c 00 52 00 75 00 6e 00}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (2 of ($x*))
}
