...
rule Trojan_Win32_Remcos_AMR_2147924103_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Remcos.AMR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {52 68 04 01 00 00 ff 15 ?? ?? ?? ?? 68 60 32 27 09 8d 85 e4 f9 ff ff 50 ff 15 ?? ?? ?? ?? c7 85 d8 f7 ff ff b0 32 27 09 c7 85 d0 f7 ff ff dc 32 27 09 c7 85 d4 f7 ff ff f0 32 27 09 68 04 01 00 00 8d 8d dc f7 ff ff 51 6a 00 ff 15 ?? ?? ?? ?? 8b 95 cc f7 ff ff 52 8d 85 f4 fd ff ff 50}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Remcos_SX_2147955084_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Remcos.SX!MTB"
        threat_id = "2147955084"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Remcos"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {99 f7 f9 8b 4d 0c 33 c0 8a 04 0a 8b 0f 03 c6 03 c1}  //weight: 10, accuracy: High
        $x_8_2 = {8b ce 8d 73 01 8b d1 6a ?? c1 e9 ?? f3 a5 8b ca 83 e1 ?? f3 a4}  //weight: 8, accuracy: Low
        $x_5_3 = {00 ff d6 4f 75 db}  //weight: 5, accuracy: High
        $x_2_4 = "SetProcessDEPPolicy" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Remcos_SEC_2147957150_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Remcos.SEC!MTB"
        threat_id = "2147957150"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Remcos"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {33 c2 8b 55 f0 89 45 d4 8b 45 e0 a2 ?? ?? ?? ?? 33 c1 0f af d6 89 45 e0 8a 45 e4 c7 45 f0 ?? ?? ?? ?? 32 c2 89 55 dc a2 ?? ?? ?? ?? ff 15 ?? ?? ?? ?? 8b 45 d4 a2 ?? ?? ?? ?? 8b 45 e0 0b 45 e8 2b 45 e0 89 45 d8 ff 15}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Remcos_ACM_2147959783_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Remcos.ACM!MTB"
        threat_id = "2147959783"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Remcos"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {8d 44 24 08 50 8d 44 24 1c 50 68 28 04 00 00 8d 44 24 0c 50 ff 15 ?? ?? ?? ?? 68 ?? 15 46 00 68 ?? 15 46 00 e8}  //weight: 2, accuracy: Low
        $x_1_2 = {c6 44 24 10 b8 c6 44 24 11 01 c6 44 24 12 00 c6 44 24 13 00 c6 44 24 14 00 c6 44 24 15 c3 8d 44 24 04 50 6a 06 8d 44 24 18 50 56 8b 44 24 10 50 ff 15}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Remcos_SNE_2147966742_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Remcos.SNE!MTB"
        threat_id = "2147966742"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Remcos"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "\\triste\\maldivian.ini" ascii //weight: 1
        $x_1_2 = "\\slethvars\\jimmy" ascii //weight: 1
        $x_1_3 = "\\konspirations\\dyreforsgene.gif" ascii //weight: 1
        $x_1_4 = "\\fokusets\\temperaturstrukturfunktioner.ini" ascii //weight: 1
        $x_1_5 = "Datamatisk.sto" ascii //weight: 1
        $x_1_6 = "excellences.acc" ascii //weight: 1
        $x_1_7 = "\\sexfirma.lnk" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Remcos_SNR_2147973362_0
{
    meta:
        author = "defender2yara"
