...
rule Trojan_Win32_Phorpiex_APX_2147924417_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {53 8d 45 e8 50 ff 75 f8 8d 85 d0 e9 ff ff 50 ff 75 f0 ff 15 ?? ?? ?? ?? 8d 45 f8 50 68 ff 0f 00 00 8d 85 d0 e9 ff ff 50 ff 75 f4}  //weight: 1, accuracy: Low
        $x_2_2 = "178.16.54.109" wide //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Phorpiex_APX_2147924417_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Phorpiex.APX!MTB"
...
rule Trojan_Win32_Phorpiex_AKP_2147961062_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Phorpiex.AKP!MTB"
        threat_id = "2147961062"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Phorpiex"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {8d 85 f0 fb ff ff 50 68 60 52 41 00 ff 15 ?? ?? ?? ?? 8d 8d f0 fb ff ff 51 68 70 52 41 00 8d 95 f8 fd ff ff 52 ff 15 ?? ?? ?? ?? 83 c4 0c 8d 85 f8 fd ff ff 50}  //weight: 2, accuracy: Low
        $x_1_2 = {50 68 70 54 41 00 8d 8d f8 fd ff ff 51 ff 15 ?? ?? ?? ?? 83 c4 0c 8d 95 f8 fd ff ff 52}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Phorpiex_ABP_2147965176_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Phorpiex.ABP!MTB"
        threat_id = "2147965176"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Phorpiex"
        severity = "Critical"
