...
rule Trojan_Win32_SusWebSessionCookie_AM_2147948936_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/SusWebSessionCookie.AM"
        threat_id = "2147948936"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "SusWebSessionCookie"
        severity = "Critical"
    ...
    strings:
        ...
        $x_1_4 = "& copy" ascii //weight: 1
        $x_1_5 = "\\User Data\\" ascii //weight: 1
        $n_1_6 = "ja06e39e-7876-4ba3-beee-42bd80ff362k" wide //weight: -1
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (all of ($x*))
