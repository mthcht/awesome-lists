...
rule Trojan_Win32_Convagent_BAD_2147944384_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {41 8b 45 08 03 45 f8 0f b6 10 33 94 8d ?? ?? ?? ?? 8b 45 08 03 45 f8 88 10 e9}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Convagent_BAD_2147944384_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Convagent.BAD!MTB"
...
rule Trojan_Win32_Convagent_KK_2147951395_2
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8a 74 24 10 8a c3 32 c7 f6 c6 01 0f b6 c8 0f b6 c3 0f 44 c8 d0 ee 8a d9 88 74 24 10 8a cf 02 c9 8a c1 0f b6 c9 34 1b 84 ff 0f b6 d0 0f 49 d1 8a fa 83 ee 01}  //weight: 20, accuracy: High
        $x_10_2 = {8b 4d f8 32 c3 8b 55 08 32 c7 32 45 ff 83 c4 40 88 44 8a 03 41 89 4d f8 83 f9 04}  //weight: 10, accuracy: High
        $x_5_3 = {8a 44 0a fc 32 44 29 f0 88 04 0a 41 83 f9 10}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Convagent_ARR_2147956042_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {f7 f9 52 8d 54 3c 14 68}  //weight: 2, accuracy: High
        $x_8_2 = {8b c1 33 d2 f7 f3 8a 04 2a 8a 14 31 32 d0 88 14 31 41 3b cf}  //weight: 8, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Convagent_ARR_2147956042_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Convagent.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_15_1 = {8b cb 8a 81 ?? ?? ?? ?? 34 ?? 88 44 0d 90 41 83 f9}  //weight: 15, accuracy: Low
        $x_5_2 = {88 45 dc a1 ?? ?? ?? ?? 33 c9 41 3b c1 0f 84}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Convagent_ARR_2147956042_2
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_15_1 = {83 f0 01 48 8b 4c 24 18 48 8b 5c 24 20 89 c2 48 8b 44 24 68}  //weight: 15, accuracy: High
        $x_5_2 = {48 8b 72 18 48 83 c6 fe 48 83 fe 0b 0f 87 ?? ?? ?? ?? 4c 8b 42 ?? 48 8d 05}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Convagent_ARR_2147956042_4
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Convagent.ARR!MTB"
...
rule Trojan_Win32_Convagent_BAF_2147961318_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {89 d8 89 d9 c1 e8 18 c1 e9 0c 31 c1 32 8e ?? ?? ?? ?? 0f b6 d1 8d 8c 24 90 00 00 00 e8}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Convagent_BAF_2147961318_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Convagent.BAF!MTB"
...
rule Trojan_Win32_Convagent_BAF_2147961318_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Convagent.BAF!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {6a 40 68 00 30 00 00 ff 77 50 6a 00 ff 15 ?? ?? ?? ?? 8b d0 89 55 fc 85 d2 0f 84 ?? ?? ?? ?? 0f b7 4f 06 56 0f b7 77 14 83 c6 18 8d 04 89 03 f7 c1 e0 03 2b c3 03 c6 50 53 52}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Convagent_TON_2147961501_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Convagent.TON!MTB"
        threat_id = "2147961501"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {47 0f b6 84 3d f8 fe ff ff 88 84 35 f8 fe ff ff 88 8c 3d f8 fe ff ff 0f b6 84 35 f8 fe ff ff 8b 4d f8 03 c2 0f b6 c0 0f b6 84 05 f8 fe ff ff 30 04 19 43 3b 5d fc 7c}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Convagent_CPIM_2147969682_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Convagent.CPIM!MTB"
        threat_id = "2147969682"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Convagent"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Boryspilska street" ascii //weight: 1
        $x_1_2 = "PRIVATELY OWNED ENTERPRISE LINUSOFTECH" ascii //weight: 1
...
rule Trojan_Win32_Convagent_LRG_2147973741_0
{
    meta:
        author = "defender2yara"
