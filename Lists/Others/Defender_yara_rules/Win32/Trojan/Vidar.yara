...
rule Trojan_Win32_Vidar_SJ_2147964678_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "main.init" ascii //weight: 1
        $x_1_2 = "main.Citizenship" ascii //weight: 1
        $x_1_3 = "main.Architectural" ascii //weight: 1
        $x_1_4 = "main.Britannica" ascii //weight: 1
        $x_1_5 = "main.Programmers" ascii //weight: 1
        $x_1_6 = "main.Singapore" ascii //weight: 1
        $x_1_7 = "main.Bacterial" ascii //weight: 1
        $x_1_8 = "main.Violations" ascii //weight: 1
        $x_1_9 = "main.Citizenship.func1" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Vidar_SJ_2147964678_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Vidar.SJ!MTB"
...
rule Trojan_Win32_Vidar_GVF_2147965809_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Vidar.GVF!MTB"
        threat_id = "2147965809"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Vidar"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {0f b6 34 0b 48 89 d7 48 c1 ff 08 29 fe 40 88 34 19 48 ff c3 48 39 d8 7f e7}  //weight: 2, accuracy: High
        $x_1_2 = {0f b6 34 0b 31 d6 31 de 40 88 34 19 48 ff c3 48 39 d8 7f ec}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Vidar_LVK_2147969749_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Vidar.LVK!MTB"
        threat_id = "2147969749"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Vidar"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {41 89 f8 4c 39 c3 7e 0e 46 0f b6 0c 00 45 84 c9 75 ec 0f 1f 40 00 4c 39 c1 72 34 49 39 f0 72 24 48 89 f2 48 29 ce 49 29 d0 48 c1 fe 3f 48 21 f2 48 8d 1c 10 31 c0}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Vidar_SL_2147970336_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Vidar.SL!MTB"
        threat_id = "2147970336"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Vidar"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {49 89 f2 48 c1 fe 3f 49 29 f1 49 6b f1 61 4d 89 d1 49 29 f2 41 31 fa 4c 89 c6 49 c1 e0 05 49 29 f0 45 31 d0 44 88 04 33 49 89 f0 4d 89 ca}  //weight: 1, accuracy: High
        $x_1_2 = {0f b6 3c 02 31 f7 31 d7 40 88 3c 10 48 ff c2}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Vidar_SN_2147970568_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Vidar.SN!MTB"
        threat_id = "2147970568"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Vidar"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {89 f8 c1 ff 1f 29 fa 6b fa 61 89 c2 29 f8 31 e8 89 dd c1 e3 05 29 eb 31 c3 88 1c 29 89 f0}  //weight: 1, accuracy: High
        $x_1_2 = {0f b6 2c 0b 31 d5 31 dd 95 88 04 19 95 43}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Vidar_LR_2147972053_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Vidar.LR!MTB"
        threat_id = "2147972053"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Vidar"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {48 ba 00 00 00 00 00 00 44 40 48 89 94 24 d8 01 00 00 48 be 00 00 00 00 00 00 f0 3f 48 89 b4 24 e0 01 00 00 49 b8 00 00 00 00 00 00 3e 40}  //weight: 20, accuracy: High
        $x_10_2 = {4c 89 8c 24 00 02 00 00 c6 84 24 08 02 00 00 00 c6 84 24 10 02 00 00 00 49 ba 00 00 00 00 00 00 34 40 4c 89 94 24 18 02}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Vidar_AA_2147973688_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_Vidar_MK_2147973782_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {89 45 c4 8b 45 30 c1 e8 0e 69 c8 55 e6 de c8 8b 45 20 33 c1 89 45 20 8b 45 c8 c1 e8 0a}  //weight: 20, accuracy: High
        $x_15_2 = {89 45 18 8b 45 c4 8b 4d c0 81 f1 f6 22 a3 42 03 c8 89 4d c4 8b 45 b8 69 c8 2f 2c ad a8}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Vidar_YBC_2147975844_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Vidar.YBC!MTB"
        threat_id = "2147975844"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Vidar"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {8b 44 24 30 33 c8 89 4c 24 30 8b 4d 40 8b 45 40 c1 e9 19 c1 e0 07 0b c8 81 f1}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Vidar_YBH_2147978495_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Vidar.YBH!MTB"
        threat_id = "2147978495"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Vidar"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_4_1 = {8b 4c 24 30 8b 44 24 34 03 c8 89 4c 24 34 8b 4c 24 30 8b 44 24 34 33 c8 89 4c 24 30 8b 4c 24 30}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
