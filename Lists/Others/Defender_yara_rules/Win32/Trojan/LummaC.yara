...
rule Trojan_Win32_LummaC_HNAA_2147925579_0
{
    ...
    strings:
        ...
        $x_11_7 = {5c 41 70 70 44 61 74 61 5c 52 6f 61 6d 69 6e 67 00 00 00 [0-16] 68 74 74 70 73 3a 2f 2f [0-16] 2e ?? ?? ?? 2f [0-21] 2e 65 78 65 00 00 [0-255] 68 74 74 70 73 3a 2f 2f [0-21] 2e [0-4] 2f 61 70 69 00}  //weight: 11, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
