...
rule Trojan_Win32_Draftor_KK_2147978619_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Draftor.KK!MTB"
        threat_id = "2147978619"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Draftor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = "8815368314:AAHcMQo4pbxbT345X0CAGC0f_NgPYtdizD8" ascii //weight: 3
        $x_2_2 = "Global\\WindowsUpdateMutex" ascii //weight: 2
