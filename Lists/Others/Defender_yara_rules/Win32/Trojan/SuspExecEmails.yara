...
rule Trojan_Win32_SuspExecEmails_AM_2147948659_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/SuspExecEmails.AM"
        threat_id = "2147948659"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "SuspExecEmails"
        severity = "Critical"
    ...
    strings:
        ...
        $x_1_2 = " >NUL" ascii //weight: 1
        $x_1_3 = "*.pst & exit" ascii //weight: 1
        $n_1_4 = "z4896cf8-a4fa-40e9-90e0-3b2ddc3e3ce2" wide //weight: -1
    condition:
        (filesize < 20MB) and
        (not (any of ($n*))) and
        (all of ($x*))
