...
rule Trojan_Win32_Fragtor_ARA_2147893463_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.ARA!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_4_1 = {8b c3 33 d2 f7 f7 8a 04 33 85 db 8a 14 2a 7e 04 32 44 33 ff 8a cb 80 c1 3a 32 c8 2a ca 88 0c 33 4b 79 dd}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Fragtor_AFG_2147898089_2
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {68 84 71 40 00 e8 ?? ?? ?? ?? 50 68 ?? 71 40 00 e8 ?? ?? ?? ?? a3 c0 c8 40 00 68 a0 71 40 00 e8 ?? ?? ?? ?? 50 68 ac 71 40 00}  //weight: 2, accuracy: Low
        $x_1_2 = {8b 43 04 a3 ?? ?? ?? ?? 8b 43 08 a3 ?? ?? ?? ?? 8b 43 0c a3 ?? ?? ?? ?? 8b 43 10 a3 ?? ?? ?? ?? b8 78 71 40 00}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Fragtor_SX_2147920209_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.SX!MTB"
        threat_id = "2147920209"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {83 e0 01 f7 d8 21 d0 31 c6 8d 04 12 89 c7 83 f7 ?? 84 d2 0f 48 c7 89 c2 d0 e9 83 eb 01 75 df}  //weight: 2, accuracy: Low
        $x_2_2 = "Log=C:\\Temp\\broker.log" ascii //weight: 2
        $x_2_3 = "hello world" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Fragtor_AB_2147957586_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_8_1 = {33 d2 8b c6 f7 75 f4 8a 04 3a 88 04 0e 46 3b f3 72}  //weight: 8, accuracy: High
        $x_12_2 = {0f b6 0c 37 0f b6 c2 03 c8 0f b6 c1 8b 4d 18 8a 04 30 32 04 0b 88 01 41}  //weight: 12, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_AB_2147957586_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.AB!MTB"
...
rule Trojan_Win32_Fragtor_ARR_2147958669_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = {8a 14 06 30 14 39 47 3b 7d 0c 72}  //weight: 10, accuracy: High
        $x_8_2 = "rJh76dAd5ZYhNQt87ZQVEvAw" ascii //weight: 8
        $x_2_3 = "sdsdpl.exe" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_ARR_2147958669_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {0f 57 c8 66 0f 6e c0 66 0f 7e 09 66 0f 70 c8 ?? 66 0f fe cb 66 0f 6e c2 0f 54 ca}  //weight: 6, accuracy: Low
        $x_4_2 = {66 0f fe cd 66 0f 6e c7 0f 54 cc 66 0f 7e 1a 66 0f 67 c9 66 0f 67 c9 0f 57 c8}  //weight: 4, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_ARR_2147958669_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_12_1 = {0f b6 c2 03 c8 0f b6 c1 8a 84 05 fc fe ff ff 30 04 3e 46 8b 85 f4 fe ff ff 3b f3}  //weight: 12, accuracy: High
        $x_8_2 = {0f b6 ca 03 c8 0f b6 c9 89 8d ?? ?? ?? ?? 8a 04 0e 88 03 43 83 ad ?? ?? ?? ?? ?? 88 14 0e 75}  //weight: 8, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_ARR_2147958669_4
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.ARR!MTB"
...
rule Trojan_Win32_Fragtor_ARR_2147958669_5
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {8a cb f6 d1 32 cb 80 e1 ?? 32 d9 8d 55}  //weight: 10, accuracy: Low
        $x_20_2 = {4a 00 4a 00 56 00 31 00 33 00 4a 00 33 00 54 00 71 00 51 00 4e 00 6a 00 39 00 34 00 50 00 76 00 30 00 36 00 39 00 4b 00 77 00 61 00 6c 00 46 00 33 00 69 00 5a 00 76 00 44 00 39 00 38}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Fragtor_PGFT_2147959659_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.PGFT!MTB"
        threat_id = "2147959659"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {64 72 69 76 65 2e 75 73 65 72 63 6f 6e 74 65 6e 74 2e 67 6f 6f 67 6c 65 2e 63 6f 6d 2f 64 6f 77 6e 6c 6f 61 64 3f 69 64 3d 31 59 42 56 49 44 6b 5a 67 79 67 4e 66 55 55 32 72 62 4a 58 58 43 59 64 72 7a 61 79 35 72 4d 64 59 26 65 78 70 6f 72 74 3d 64 6f 77 6e 6c 6f 61 64 26 61 75 74 68 75 73 65 72 3d 30 26 63 6f 6e 66 69 72 6d 3d 74 00 2f 73 65 72 76 69 63 65}  //weight: 5, accuracy: High
        $x_5_2 = "0J7EFGABCeuvdDK489SEV56ewf332Nd123sfeW4werf5FDGwYZRtwz" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_MKC_2147960486_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.MKC!MTB"
        threat_id = "2147960486"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {40 48 f7 d0 89 05 06 b0 42 00 8b 15 68 3f 43 00 4a 81 f2 b3 0e 00 00 81 da 00 c0 00 02 89 15 8d 34 43 00 8b 15 8d 34 43 00 f7 d2 81 e2 e7 00 00 00 81 f2 00 00 b3 00}  //weight: 20, accuracy: High
        $x_15_2 = {2d 01 18 e7 ca f7 d3 2d f9 05 00 00 4b f7 d3 f7 d9 4b 40 35 00 00 00 42 f7 d0}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Fragtor_MKD_2147961569_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.MKD!MTB"
        threat_id = "2147961569"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {e0 2e 72 73 72 63 00 00 00 00 20 00 00 00 e0 93}  //weight: 20, accuracy: High
        $x_15_2 = {40 00 00 e0 2e 64 61 74 61 00 00 00 00 a0 0e 00 00 00 bd}  //weight: 15, accuracy: High
        $x_10_3 = {cf 73 94 f7 83 49 49 1b 78 06 00 45 4b e5 8f e8}  //weight: 10, accuracy: High
        $x_5_4 = {72 53 9f 00 6e 40 f1 f1 96 36 65 a6 be 12 fb 14}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_BAE_2147962134_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.BAE!MTB"
        threat_id = "2147962134"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {2b d8 8d 4c 24 20 03 ce 8d 04 0b 99 f7 7c 24 10 32 11 88 14 37 46 83 fe 0d 7c}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_LMD_2147962366_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.LMD!MTB"
        threat_id = "2147962366"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8a 14 31 80 c2 6d 80 f2 13 88 14 31 41 3b c8}  //weight: 20, accuracy: High
        $x_10_2 = {8b ec 0f b6 45 10 99 b9 f9 1c 00 00 f7 f9 56 8b 75 0c 8d 4a 13}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_PGFA_2147962604_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.PGFA!MTB"
        threat_id = "2147962604"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {66 0f fe cd 66 0f 6e c1 0f 54 cc 66 0f 7e 1f 66 0f 67 c9 66 0f 67 c9 0f 57 c8 66 0f 7e 4f ?? 83 c7 ?? 81 fa ?? ?? ?? ?? 0f 82}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_BMD_2147963728_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.BMD!MTB"
        threat_id = "2147963728"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {6a 00 8d 4d fc 51 6a 0c 68 ?? ?? ?? ?? 8b 55 f8 52 ff 15}  //weight: 2, accuracy: Low
        $x_2_2 = {8d 4d fc 51 6a 01 8d 55 08 52 8b 45 f8 50 ff 15}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_VX_2147963872_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.VX!MTB"
        threat_id = "2147963872"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_8_1 = {81 c1 1a 01 00 00 2a c8 8a 1c 30 66 83 f1 1e 2c 3a b0 20 66 33 4c 24 be 66 ba 1c 00 66 03 d0 33 d1 80 f3 a1 88 1e 66 83 f1 1e}  //weight: 8, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Fragtor_PGFG_2147964893_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.PGFG!MTB"
        threat_id = "2147964893"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {89 c3 0f b6 44 24 39 31 c9 3a 44 3e 01 0f 94 c1 e8 ?? ?? ?? ?? 88 c7 0f b6 44 24 3a 31 c9 20 df 3a 44 3e 02 0f 94 c1 e8 ?? ?? ?? ?? 88 44 24 0f 0f b6 44 24 3b 31 c9 3a 44 3e 03 0f 94 c1 e8 ?? ?? ?? ?? 88 c3 0f b6 44 24 3c 31 c9 22 5c 24 0f 20 fb 3a 44 3e 04 0f 94 c1}  //weight: 5, accuracy: Low
        $x_5_2 = {55 89 e5 83 ec 01 88 4d ff 0f b6 45 ff 83 c4 01 5d}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_SKP_2147965981_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.SKP!MTB"
        threat_id = "2147965981"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {31 c0 39 c3 74 09 8a 0c 02 88 0c 06 40 eb}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_LR_2147966160_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.LR!MTB"
        threat_id = "2147966160"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b 53 58 ff 43 14 8b 4b 14 8b 42 50 0f af c1 3d d0 07 00 00 73 ?? 8d 41 01 89 43 14 8b 4a 50 0f af c8}  //weight: 20, accuracy: Low
        $x_10_2 = {bb 0a 00 00 00 3b cb 0f 4c cb 89 4a 50 8b 4d f8 5b 85 c9 78 ?? 89 8a b8 00 00 00 85 c0}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Fragtor_PGFE_2147967273_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.PGFE!MTB"
        threat_id = "2147967273"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {89 f9 32 0c 16 88 0c 10 83 c2 01 39 d3 75 f1}  //weight: 5, accuracy: High
        $x_5_2 = {0f b6 42 e0 32 01 88 02 83 c2 01 83 c1 01 8d 85 ?? ?? ?? ?? 39 c1 75 e8}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_AHA_2147967320_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.AHA!MTB"
        threat_id = "2147967320"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {80 30 16 40 3d ?? ?? ?? ?? 72 f5 90 b8 ?? ?? ?? ?? 80 30 16 40 3d ?? ?? ?? ?? 72 f5 90 b8 ?? ?? ?? ?? 80 30 16 40 3d ?? ?? ?? ?? 72}  //weight: 30, accuracy: Low
        $x_20_2 = {16 16 16 16 46 72 9f 33 16 16 16 16 95 fa 7e}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_LRC_2147967900_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.LRC!MTB"
        threat_id = "2147967900"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8b 84 8d 34 ff ff ff 31 84 8d 38 ff ff ff 41 3b ce}  //weight: 20, accuracy: High
        $x_10_2 = {0f b6 37 8d 7f 04 0f b6 47 fd c1 e6 08 0b f0 0f b6 47 fe c1 e6 08 0b f0 0f b6 47 ff c1 e6 08 0b f0 8b 85 00 fb ff ff 89 30 83 c0 04}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Fragtor_LVG_2147969519_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.LVG!MTB"
        threat_id = "2147969519"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {88 85 b0 fa ff ff 89 c8 31 d8 32 85 b0 fa ff ff 31 f8 8d 3c 16 32 85 98 fa ff ff 31 c7 8d 42 01 f6 a5 a8 fa ff ff 31 f8 8b bd b4 fa ff ff 88 44 17 10 83 c2 01 39 95 8c fa ff ff 75 85}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_SXG_2147970814_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.SXG!MTB"
        threat_id = "2147970814"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {8b 95 94 ee ff ff c1 ea 09 33 95 20 d2 ff ff 89 95 94 ee ff ff 8b 85 94 ee ff ff 03 85 d4 d1 ff ff 35 0d e6 00 00}  //weight: 30, accuracy: High
        $x_20_2 = {c6 85 5b da ff ff a7 c6 85 5c da ff ff e8 c6 85 5d da ff ff 09 c6 85 5e da ff ff e1 c7 85 c0 eb ff ff 23 52 7a 00}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_PA_2147971240_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.PA!MTB"
        threat_id = "2147971240"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {64 a1 30 00 00 00 85 c0 74 49 8b 40 0c 85 c0 74 42 8b 50 14 33 c9 53 8d 58 14 3b d3 74 31}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Fragtor_AA_2147976939_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fragtor.AA!MTB"
        threat_id = "2147976939"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fragtor"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {4c 89 44 24 58 4c 8b 42 ?? 4c 89 44 24 60 4c 8b 42 ?? 4c 89 44 24 48 48 8b 52 ?? 48 89 54 24 68 48 8d 15}  //weight: 10, accuracy: Low
        $x_15_2 = "main.appendAllPasswords" ascii //weight: 15
        $x_4_3 = "main.logBasePath" ascii //weight: 4
        $x_6_4 = "main.killBrowsers" ascii //weight: 6
        $x_5_5 = "main.hideConsoleWindow" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
