...
rule Trojan_Win32_Lazy_AB_2147849152_1
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {01 ce 89 f0 c1 e0 ?? 01 f0 89 c1 c1 e9 ?? 31 c1 0f b7 44 5a ?? 43 66 85 c0 75}  //weight: 30, accuracy: Low
        $x_30_2 = {1f 40 00 83 cb ?? 0f b6 db 69 f6 ?? ?? ?? ?? 01 de 0f b7 5c 4f ?? 41 66 85 db 75}  //weight: 30, accuracy: Low
        $x_20_3 = {01 00 00 0f b6 5c 02 ?? 88 9c 04 ?? 01 00 00 0f b6 54 02 ?? 88 94 04 ?? 01 00 00}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
...
rule Trojan_Win32_Lazy_AB_2147849152_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.AB!MTB"
...
rule Trojan_Win32_Lazy_MKK_2147897126_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_35_1 = {0f b6 03 48 8d 5b ff 0f b6 0a 88 02 48 8d 52 01 88 4b 01 4a 8d 04 03 4a 8d 0c 02 48 3b c8}  //weight: 35, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Lazy_MKK_2147897126_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.MKK!MTB"
...
rule Trojan_Win32_Lazy_AHB_2147943560_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.AHB!MTB"
        threat_id = "2147943560"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Lazy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_3_1 = {8b 45 98 03 45 a4 d1 e8 89 45 8c 8b 45 c8 8b 4d e0 03 48 20 8b 55 8c 8b 04 91 89 45 80 8b 45 e0 03 45 80 89 85 74 ff ff ff 8b 45 ec 89 85 88 fe ff ff 8b 8d 74 ff ff ff}  //weight: 3, accuracy: High
        $x_2_2 = {8b 45 04 89 85 e8 fd ff ff 8d 45 04 89 85 f4 fd ff ff c7 85 30 fd ff ff 01 00 01 00 8b 40 fc 89 85 e4 fd ff ff 8b 45 0c 89 85 e0 fc ff ff 8b 45 10 89 85 e4 fc ff ff 8b 45 04 89 85 ec fc ff ff ff 15}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Lazy_KK_2147945650_2
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {0f b6 06 68 00 01 00 00 99 68 b3 01 00 00 33 d3 33 c7 52 50 e8 ?? ?? 00 00 46 8b f8 8b da 3b b5 2c fd ff ff}  //weight: 20, accuracy: Low
        $x_10_2 = {0f b6 07 68 00 01 00 00 99 33 55 fc 33 c3 68 b3 01 00 00 52 50 e8 ?? ?? 00 00 47 89 55 fc 8b d8 3b fe}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Lazy_KK_2147945650_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.KK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {0f b6 d0 0f b6 c4 c1 e0 08 09 d0 0f b6 d7 c1 e2 10 09 c2 0f b6 c3 c1 e0 18 09 d0 66 0f 6e c8 66 0f ef c8 66 ?? ?? ?? ?? 46 83 fe 3c}  //weight: 20, accuracy: Low
        $x_10_2 = {8a 1c 82 88 1c 81 8a 5c 82 01 88 5c 81 01 8a 5c 82 02 88 5c 81 02 8a 5c 82 03 88 5c 81 03 40 83 f8 08 75 dc}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Lazy_KK_2147945650_4
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.KK!MTB"
...
rule Trojan_Win32_Lazy_AA_2147965154_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.AA!MTB"
        threat_id = "2147965154"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Lazy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {01 c8 83 cb ?? 0f b6 cb 01 c1 0f b7 5c 77 ?? 46 66 85 db 75}  //weight: 20, accuracy: Low
        $x_30_2 = {0f b6 44 24 05 8b 4c 24 30 8b 54 24 34 01 c8 c1 e1 ?? 01 c8 89 84 24 cc 00 00 00}  //weight: 30, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Lazy_VGZ_2147966256_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.VGZ!MTB"
        threat_id = "2147966256"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Lazy"
        severity = "Critical"
...
rule Trojan_Win32_Lazy_MKH_2147966893_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.MKH!MTB"
        threat_id = "2147966893"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Lazy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {0f b7 4c 55 00 0f b6 9a 4c 58 00 10 8d 71 bf 8d 41 20 66 83 fe 1a 8d 73 20 0f 42 c8 8d 43 bf 3c 1a 0f 42 de 38 cb}  //weight: 20, accuracy: High
        $x_15_2 = {b9 fe ff ff ff 83 ec 10 8b 84 24 40 02 00 00 8b 94 24 44 02 00 00 83 c0 ff 83 d2 ff 39 c1 b8 0e 00 00 00 19 d0}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Lazy_SXQ_2147967927_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.SXQ!MTB"
        threat_id = "2147967927"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Lazy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {8b c8 83 e1 03 8a 89 ?? ?? ?? ?? 32 d1 88 ?? ?? ?? ?? ?? 40 83 ef 01 75 e1}  //weight: 30, accuracy: Low
        $x_10_2 = {8b 0c b1 03 cf 8a 01 84 c0 ?? ?? b8 c5 9d 1c 81 ?? ?? 0f b6 c0 41 35 c5 9d 1c 81 69 d0 93 01 00 01 e8 ?? ?? ?? ?? 3b 45 fc ?? ?? 8b 4d f8 46 3b f3}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Lazy_MKI_2147968410_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.MKI!MTB"
        threat_id = "2147968410"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Lazy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {2e 8d b4 26 00 00 00 00 8d b4 26 00 00 00 00 83 f0 ab 83 c2 01 88 42 ff 0f b6 02 84 c0}  //weight: 20, accuracy: High
        $x_15_2 = {83 f0 b7 83 c2 01 88 42 ff 0f b6 02 84 c0}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Lazy_KWX_2147972555_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.KWX!MTB"
        threat_id = "2147972555"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Lazy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {0f ac df 0d c1 eb 0d 0f a4 f2 07 31 da c1 e6 07 31 fe}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Lazy_YAW_2147978907_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Lazy.YAW!MTB"
        threat_id = "2147978907"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Lazy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_12_1 = {0f b6 55 18 32 14 01 88 54 0d b0 48 ff c1 48 83 f9 0b}  //weight: 12, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
