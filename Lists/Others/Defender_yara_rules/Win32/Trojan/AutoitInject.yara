...
rule Trojan_Win32_AutoitInject_ASBB_2147948567_0
{
    ...
    strings:
        ...
        $x_4_7 = {26 00 20 00 42 00 49 00 4e 00 41 00 52 00 59 00 4c 00 45 00 4e 00 20 00 28 00 20 00 24 00 [0-50] 20 00 29 00 20 00 26 00 20 00 22 00 5d 00 22 00 20 00 2c 00 20 00 24 00 [0-50] 20 00 29 00 20 00 2c 00 20 00 31 00 20 00 2c 00 20 00 24 00 [0-50] 20 00 29 00}  //weight: 4, accuracy: Low
        $x_4_8 = {26 20 42 49 4e 41 52 59 4c 45 4e 20 28 20 24 [0-50] 20 29 20 26 20 22 5d 22 20 2c 20 24 [0-50] 20 29 20 2c 20 31 20 2c 20 24 [0-50] 20 29}  //weight: 4, accuracy: Low
