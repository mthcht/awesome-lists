...
rule Trojan_Win32_Androm_BAJ_2147959956_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAJ!MTB"
        threat_id = "2147959956"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {03 c3 03 c7 89 45 ?? c7 45 a4 39 19 00 00 6a 00 e8 [0-31] 8b 55 ?? 03 55 ?? 81 ea 39 19 00 00 2b d7 03 c2 31 06 83 c3 04 83 c6 04 3b 5d ?? 72}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAK_2147960108_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAK!MTB"
        threat_id = "2147960108"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {03 c3 03 c7 89 45 ?? c7 45 ?? 2b 16 00 00 6a 00 e8 ?? ?? ?? ?? 8b 55 ?? 03 55 ?? 81 ea 2b 16 00 00 2b d7 2b d0 31 16 83 c3 04 83 c6 04 3b 5d ?? 72}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAK_2147960108_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {03 c3 03 c7 89 45 ?? c7 45 ?? 2b 16 00 00 6a 00 e8 ?? ?? ?? ?? 8b 55 ?? 03 55 ?? 81 ea 2b 16 00 00 2b d7 2b d0 52 6a 00 e8 ?? ?? ?? ?? 5a 2b d0 31 16 83 c3 04 83 c6 04 3b 5d ?? 72}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAL_2147961544_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAL!MTB"
        threat_id = "2147961544"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
...
rule Trojan_Win32_Androm_BAL_2147961544_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAL!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {03 c6 03 c7 89 45 bc c7 45 ac b2 84 31 00 6a 00 e8 ?? ?? ?? ?? 8b 55 bc 03 55 ac 81 ea b2 84 31 00 2b d7 03 c2 50 6a 00 e8 ?? ?? ?? ?? 5a 2b d0 31 13 83 c6 04 83 c3 04 3b 75 d4 72}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAM_2147963589_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAM!MTB"
        threat_id = "2147963589"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {2b c2 83 c0 04 89 45 ?? ff 75 ?? b9 33 d1 00 00 b9 33 d1 00 00 b9 33 d1 00 00 b9 33 d1 00 00 b9 33 d1 00 00 b9 33 d1 00 00 ff 75 ?? b9 33 d1 00 00}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAM_2147963589_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAM!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {2b c2 83 c0 04 89 45 ?? ff 75 ?? b9 7c 0d 00 00 b9 7c 0d 00 00 b9 7c 0d 00 00 b9 7c 0d 00 00 b9 7c 0d 00 00 b9 7c 0d 00 00 ff 75 ?? b9 7c 0d 00 00}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAM_2147963589_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAM!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {2b c2 83 c0 04 89 45 ?? ff 75 ?? b9 5c 11 00 00 b9 5c 11 00 00 b9 5c 11 00 00 b9 5c 11 00 00 b9 5c 11 00 00 b9 5c 11 00 00 ff 75 ?? b9 5c 11 00 00 ff 75 ?? b9 5c 11 00 00 ff 75 ?? b9 5c 11 00 00}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAN_2147963958_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAN!MTB"
        threat_id = "2147963958"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {2b c2 83 c0 04 89 45 ?? ff 75 ?? b9 d6 85 00 00 b9 d6 85 00 00 b9 d6 85 00 00 b9 d6 85 00 00 b9 d6 85 00 00 b9 d6 85 00 00 ff 75}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAN_2147963958_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAN!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {2b c2 83 c0 04 89 45 ?? ff 75 ?? b9 c8 18 00 00 b9 c8 18 00 00 b9 c8 18 00 00 b9 c8 18 00 00 b9 c8 18 00 00 b9 c8 18 00 00 ff 75 ?? b9 c8 18 00 00}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAO_2147964253_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAO!MTB"
        threat_id = "2147964253"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {ba 00 10 00 00 b8 80 ae 3b 00 03 45 ?? 2b c2 83 c0 04 89 45 ?? ff 75 ?? b9}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAP_2147964420_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAP!MTB"
        threat_id = "2147964420"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
...
rule Trojan_Win32_Androm_BAP_2147964420_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAP!MTB"
...
rule Trojan_Win32_Androm_BAP_2147964420_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAP!MTB"
...
rule Trojan_Win32_Androm_BAQ_2147964898_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAQ!MTB"
        threat_id = "2147964898"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {ba 00 10 00 00 b8 80 ae 3b 00 03 45 ?? 2b c2 83 c0 [0-47] b9 e3 a8 00 00}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAQ_2147964898_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAQ!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {81 ef 31 d4 00 00 2b f8 6a 00 e8 ?? ?? ?? ?? 2b f8 31 3e 83 c3 04 83 c6 04 3b 5d ?? 0f}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Androm_BAR_2147965467_1
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {01 1e ba 8a a5 08 00 03 55 c8 03 d3 03 c2 31 06 83 c3 04 83 c6 04 3b 5d cc 72}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAR_2147965467_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {83 c3 04 83 c6 04 3b 5d ?? 0f 82 ?? ?? ?? ?? ba 00 10 00 00 b8 80 de 03 00 03 45 ?? 2b c2 83 c0 04 89 45}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAS_2147968000_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {03 f8 31 3e 83 c3 04 83 c6 04 3b 5d cc 72}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAS_2147968000_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAS!MTB"
...
rule Trojan_Win32_Androm_BAH_2147968014_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAH!MTB"
        threat_id = "2147968014"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {ba 00 10 00 00 b8 ?? ?? ?? ?? 03 45 d0 2b c2 83 c0 04 89 45 ec 8b 45 fc}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Androm_BAT_2147969108_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Androm.BAT!MTB"
        threat_id = "2147969108"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Androm"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {ba 00 10 00 00 b8 a0 22 03 00 03 45 ?? 2b c2 83 c0 04 89 45 ?? 8b 45 ?? 50}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
