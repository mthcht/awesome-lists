...
rule Trojan_Win32_GuLoader_SH_2147959159_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "cirkuss rigsstatistikerens weathered" ascii //weight: 1
        $x_1_2 = "sibilated skarnkassen" ascii //weight: 1
        $x_1_3 = "pyloroplasty racehorses" ascii //weight: 1
        $x_1_4 = "adoptivmor.tip" ascii //weight: 1
        $x_1_5 = "glycaemia.gaz" ascii //weight: 1
        $x_1_6 = "madreporacean.sug" ascii //weight: 1
        $x_1_7 = "Barberen.che" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_SWA_2147959400_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.SWA!MTB"
        threat_id = "2147959400"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "\\foreintend\\sphaerocobaltite\\reade" ascii //weight: 1
        $x_1_2 = "\\borehullerne\\Korset.bin" ascii //weight: 1
        $x_1_3 = "Nedrigheder49.ini" ascii //weight: 1
        $x_1_4 = "Sikkerhedsventilens.buc" ascii //weight: 1
        $x_1_5 = "Thunderlike254.bac" ascii //weight: 1
        $x_1_6 = "carromatas.clo" ascii //weight: 1
        $x_1_7 = "impoverishment.ynd" ascii //weight: 1
        $x_1_8 = "nonlibidinous.moo" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_SWD_2147959653_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.SWD!MTB"
        threat_id = "2147959653"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "aalholms.exe" ascii //weight: 1
        $x_1_2 = "vidriks lumskeri coiffeurs" ascii //weight: 1
        $x_1_3 = "fodervikkers genoprette obelus" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_RDW_2147959734_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RDW!MTB"
        threat_id = "2147959734"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "symbolisers detraction semantological" ascii //weight: 1
        $x_1_2 = "udkommanderedes cantily" ascii //weight: 1
        $x_1_3 = "bryderiet" ascii //weight: 1
        $x_1_4 = "diaskoperne.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_RDY_2147959836_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RDY!MTB"
        threat_id = "2147959836"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Aftjeningers\\anmeldelsespligter\\boligselskabers" ascii //weight: 1
        $x_1_2 = "intolerances\\glutelins\\chronology" ascii //weight: 1
        $x_1_3 = "\\Whangees17\\Nedfldningen214" ascii //weight: 1
        $x_1_4 = "%Parcellist%\\Palermitan\\Unprotect" ascii //weight: 1
        $x_1_5 = "\\Dikterer.htm" ascii //weight: 1
        $x_1_6 = "\\trvlerodens\\idem.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_RDZ_2147960109_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RDZ!MTB"
        threat_id = "2147960109"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "\\finned\\supersalient\\Taxametersystemet" ascii //weight: 1
        $x_1_2 = "typebestemmer\\Nonreceptivity111" ascii //weight: 1
        $x_1_3 = "%overdevout%\\transversale" ascii //weight: 1
        $x_1_4 = "\\irradicate.jpg" ascii //weight: 1
        $x_1_5 = "iagttagerrollerne skg amazona" ascii //weight: 1
        $x_1_6 = "ramies" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_REA_2147960258_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REA!MTB"
        threat_id = "2147960258"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "towner siphonobranchiate colibakterie" ascii //weight: 1
        $x_1_2 = "belaegning chalottelgene" ascii //weight: 1
...
rule Trojan_Win32_GuLoader_REC_2147960507_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REC!MTB"
        threat_id = "2147960507"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "%Swindling26%\\biocellate" ascii //weight: 1
        $x_1_2 = "\\astrologi\\Absorbefacient\\fuldskaeg" ascii //weight: 1
        $x_1_3 = "sagsgeren canette" ascii //weight: 1
        $x_1_4 = "genuinenesses" ascii //weight: 1
        $x_1_5 = "skovrankens individfil" ascii //weight: 1
        $x_1_6 = "mediofrontal.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_RED_2147960775_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RED!MTB"
        threat_id = "2147960775"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "skjortekjolens\\Rodeos\\Glassier" ascii //weight: 1
        $x_1_2 = "%Gavlhuses250%\\Siksakke\\Grusningernes" ascii //weight: 1
        $x_1_3 = "storyer civilretlige kjerummene" ascii //weight: 1
        $x_1_4 = "tttrykt interbranch" ascii //weight: 1
        $x_1_5 = "syntone ansamlingen.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_REG_2147961088_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REG!MTB"
        threat_id = "2147961088"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "letvgtere undercrossing" ascii //weight: 1
        $x_1_2 = "cleavland" ascii //weight: 1
        $x_1_3 = "nednormering kalmykkens overharshly" ascii //weight: 1
        $x_1_4 = "prerevising bilcock erhvervsfiskeres" ascii //weight: 1
        $x_1_5 = "haptene ordforraads.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_SWI_2147961149_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.SWI!MTB"
        threat_id = "2147961149"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Cosmogonist255.ele" ascii //weight: 1
        $x_1_2 = "Personalechefer219.gan" ascii //weight: 1
        $x_1_3 = "luxemburger.sku" ascii //weight: 1
        $x_1_4 = "prognosearbejderne.dat" ascii //weight: 1
        $x_1_5 = "\\diapered\\udarbejdet.htm" ascii //weight: 1
        $x_1_6 = "\\unshouted\\asketrets.ini" ascii //weight: 1
        $x_1_7 = "\\bllehats\\Ceramist157.ini" ascii //weight: 1
        $x_1_8 = "\\ansigtscremen\\Spiritist.htm" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_REJ_2147964510_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REJ!MTB"
        threat_id = "2147964510"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "beskedens coldbloodedness arraignable" ascii //weight: 1
        $x_1_2 = "sunkets hjemkalder" ascii //weight: 1
        $x_1_3 = "bevillingshaver abandonee telt" ascii //weight: 1
        $x_1_4 = "chercock bairdi.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_REK_2147964630_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REK!MTB"
        threat_id = "2147964630"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "ecphova\\bumblefoot\\parmo\\" ascii //weight: 1
        $x_1_2 = "\\limail\\simpelthen" ascii //weight: 1
        $x_1_3 = "\\pokeweed\\Bliss\\sdskifte.lnk" ascii //weight: 1
        $x_1_4 = "%phallorrhagia%\\tweedet\\aleksandrinsk\\" ascii //weight: 1
        $x_1_5 = "\\afpatruljere\\umindelighed.ini" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_REL_2147964732_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REL!MTB"
        threat_id = "2147964732"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "returbilletten" ascii //weight: 1
        $x_1_2 = "kattejernes outtrump" ascii //weight: 1
        $x_1_3 = "programflader kompilere" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_REN_2147965336_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REN!MTB"
        threat_id = "2147965336"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "laanekontorers" ascii //weight: 1
        $x_1_2 = "ejaculate occultation uafhaengighed" ascii //weight: 1
        $x_1_3 = "marmoreredes" ascii //weight: 1
        $x_1_4 = "scoon herreliv.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_REQ_2147966205_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REQ!MTB"
        threat_id = "2147966205"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "unencroached" ascii //weight: 1
        $x_1_2 = "deaminized trimethylamine" ascii //weight: 1
        $x_1_3 = "tilgodesaa landvsensretskendelserne.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_RER_2147966632_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RER!MTB"
        threat_id = "2147966632"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "athodyds kommunisternes" ascii //weight: 1
        $x_1_2 = "atomanlg tunisian" ascii //weight: 1
        $x_1_3 = "tvebakkerne postgenial.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_RES_2147966987_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RES!MTB"
        threat_id = "2147966987"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "anklagerers opisthodetic kombinationsuddannelsers" ascii //weight: 1
        $x_1_2 = "telefonnglernes eliminative sknhedspletter" ascii //weight: 1
        $x_1_3 = "rnnebrgeleernes shir" ascii //weight: 1
        $x_1_4 = "barselloven" ascii //weight: 1
        $x_1_5 = "morbidezza.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_RET_2147967838_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RET!MTB"
        threat_id = "2147967838"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "Shrimper\\sigmoidally\\Nonillatively" ascii //weight: 1
        $x_1_2 = "%Koncentratet%\\prunkende\\Treks79" ascii //weight: 1
        $x_1_3 = "unfixated nonministerial" ascii //weight: 1
        $x_1_4 = "paymasters tvrmundes" ascii //weight: 1
        $x_1_5 = "agestole.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_REW_2147968866_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REW!MTB"
        threat_id = "2147968866"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "\\colostration\\transfigurationen" ascii //weight: 1
        $x_1_2 = "%terrarier%\\nonfelonious" ascii //weight: 1
        $x_1_3 = "unorganizable" ascii //weight: 1
        $x_1_4 = "budgerigars" ascii //weight: 1
        $x_1_5 = "brugerinterfacet.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_REX_2147969109_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REX!MTB"
        threat_id = "2147969109"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "jvnbyrdige ancipital picayunish" ascii //weight: 1
        $x_1_2 = "velgjorte unsystematizedly" ascii //weight: 1
        $x_1_3 = "lavenergihusene lambda" ascii //weight: 1
        $x_1_4 = "kaskaders.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_REY_2147969179_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.REY!MTB"
        threat_id = "2147969179"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "cara loesningshaefte blyantsspidseres" ascii //weight: 1
        $x_1_2 = "tabulatorkode" ascii //weight: 1
        $x_1_3 = "spatiummet fjervgtene confusers" ascii //weight: 1
        $x_1_4 = "sletbages databasemodellens.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_RFE_2147971626_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "\\korrektheds\\Sigillarid\\dokumentdisketter" ascii //weight: 5
        $x_2_2 = "%modgang%\\Omblgede147" ascii //weight: 2
        $x_1_3 = "englobement skabtes smeltelig" ascii //weight: 1
        $x_1_4 = "kibbes eksportafgifts" ascii //weight: 1
        $x_1_5 = "jernbaners" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_RFG_2147972996_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RFG!MTB"
        threat_id = "2147972996"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "\\oversublime\\Knapning" ascii //weight: 5
        $x_1_2 = "landingspunkt nydere scandal" ascii //weight: 1
        $x_1_3 = "fortrdelsernes sammensparendes" ascii //weight: 1
        $x_1_4 = "fremprovokerer" ascii //weight: 1
        $x_1_5 = "unrestrictedness omgrdedes" ascii //weight: 1
        $x_1_6 = "beskikkelsernes thoke.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_RFH_2147973569_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "undistinguished emnetidsskriftets.exe" ascii //weight: 2
        $x_1_2 = "adulterises livsfjern" ascii //weight: 1
        $x_1_3 = "snobbiness intercolumnation" ascii //weight: 1
        $x_1_4 = "lanceringen rasmine" ascii //weight: 1
        $x_1_5 = "stimulatives foreimagination" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_SNP_2147973580_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_GuLoader_RFI_2147974367_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RFI!MTB"
        threat_id = "2147974367"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "\\Matronly\\subicular.txt" ascii //weight: 2
        $x_1_2 = "nonegregious" ascii //weight: 1
        $x_1_3 = "bisttendes" ascii //weight: 1
        $x_1_4 = "offgrade nausity.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_RFJ_2147975003_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RFJ!MTB"
        threat_id = "2147975003"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "ufordjelighedens\\fucoids\\retouchpenselen" ascii //weight: 2
        $x_1_2 = "%langvarige%\\eftersgnings\\Annulments120" ascii //weight: 1
        $x_1_3 = "\\hydnocarpic\\magnetized.ini" ascii //weight: 1
        $x_1_4 = "99\\synsbedragets.gif" ascii //weight: 1
        $x_1_5 = "\\Katalysatorens.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_RFK_2147975210_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RFK!MTB"
        threat_id = "2147975210"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "skinnebenenes\\billedsampler" ascii //weight: 2
        $x_1_2 = "\\despoticalness\\trykkogere.zip" ascii //weight: 1
        $x_1_3 = "unsecreting skemaformerne" ascii //weight: 1
        $x_1_4 = "maskinvrkstederne" ascii //weight: 1
        $x_1_5 = "bemandingskrav traktrers.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_RFS_2147976803_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.RFS!MTB"
        threat_id = "2147976803"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "\\centralenhed\\panzieri\\postgangens" ascii //weight: 2
        $x_1_2 = "fascicled giustino" ascii //weight: 1
        $x_1_3 = "tasteoperatrer" ascii //weight: 1
        $x_1_4 = "fuldmaaneansigtet bombadil talt" ascii //weight: 1
        $x_1_5 = "\\starteren.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_XA_2147977055_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.XA!MTB"
        threat_id = "2147977055"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "Monzonitic\\Aandshovmods\\collegernes" ascii //weight: 2
        $x_1_2 = "kristian prerecognize nonassignable" ascii //weight: 1
        $x_1_3 = "doloroso" ascii //weight: 1
        $x_1_4 = "erhverssygdomslisternes deserteringerne impropitious" ascii //weight: 1
        $x_1_5 = "settlor marekats.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_GuLoader_XC_2147977511_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.XC!MTB"
        threat_id = "2147977511"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "\\underlinemen\\pinafore" ascii //weight: 2
        $x_1_2 = "%tilpasningsevner%\\Sanseorganernes\\unpenetrably" ascii //weight: 1
        $x_1_3 = "\\asplenieae\\bellmouth.ini" ascii //weight: 1
        $x_1_4 = "\\Antrkkenes114.jpg" ascii //weight: 1
        $x_1_5 = "\\saddens.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_XD_2147978298_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.XD!MTB"
        threat_id = "2147978298"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "\\Herty\\Rerig\\unshowiness" ascii //weight: 2
        $x_1_2 = "haan\\quintupled\\Pyttens" ascii //weight: 1
        $x_1_3 = "afpilning wigher" ascii //weight: 1
        $x_1_4 = "mea ecstasys entalsformens" ascii //weight: 1
        $x_1_5 = "slutakkorderne determination.exe" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_GuLoader_XE_2147978532_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/GuLoader.XE!MTB"
        threat_id = "2147978532"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "GuLoader"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "overvejelses.exe" ascii //weight: 2
        $x_1_2 = "skindde puebloisation" ascii //weight: 1
        $x_1_3 = "elijah" ascii //weight: 1
        $x_1_4 = "brackishness" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
