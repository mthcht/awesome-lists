rule Trojan_Win32_SuspMasqueradedRenPy_EB_2147968548_0
{
    ...
    strings:
        ...
        $x_1_2 = {5c 00 72 00 75 00 6e 00 2e 00 65 00 78 00 65 00 00 00}  //weight: 1, accuracy: High
        $x_1_3 = {5c 00 6f 00 70 00 65 00 6e 00 2e 00 65 00 78 00 65 00 00 00}  //weight: 1, accuracy: High
