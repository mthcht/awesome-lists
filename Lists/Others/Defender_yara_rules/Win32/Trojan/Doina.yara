...
rule Trojan_Win32_Doina_ABD_2147963680_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Doina.ABD!MTB"
        threat_id = "2147963680"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Doina"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {3a 2f 2f 36 32 2e 36 30 2e 32 32 36 2e 31 35 39 2f [0-15] 2e 65 78 65}  //weight: 1, accuracy: Low
        $x_1_2 = "Global\\dsfdsoijbvoxiUHUokpoCVS9XVF848" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Doina_ARR_2147966954_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Doina.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b c6 99 f7 7d 0c 8b c6 83 e0 ?? 8a 44 05 fc 8b ca c1 f9 ?? 32 c1 8b ca c1 f9 ?? 32 c1 8b 4d 08 32 c2 8d 14 0e 8a 0c 0e 84 c9 74}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
