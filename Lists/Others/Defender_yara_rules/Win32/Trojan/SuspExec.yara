...
rule Trojan_Win32_SuspExec_HG_2147961030_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/SuspExec.HG!MTB"
        threat_id = "2147961030"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "SuspExec"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "/create /tn winservers /sc onlogon /tr" wide //weight: 1
        $x_1_2 = "/create /tn desktop /sc onlogon /tr" wide //weight: 1
        $x_1_3 = "/tn xwormclient" wide //weight: 1
        $x_50_4 = "\\appdata\\roaming\\subdir\\client.exe" wide //weight: 50
        $x_50_5 = "\\appdata\\roaming\\desktop\\desktop.exe" wide //weight: 50
        $x_50_6 = "\\appdata\\roaming\\xwormclient.exe" wide //weight: 50
    condition:
        (filesize < 20MB) and
        (
            ((1 of ($x_50_*) and 1 of ($x_1_*))) or
...
rule Trojan_Win32_SuspExec_SVA_2147972035_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/SuspExec.SVA"
        threat_id = "2147972035"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "SuspExec"
        severity = "Critical"
    ...
    strings:
        ...
        $x_10_3 = "teams.webtalk.work/api" wide //weight: 10
        $x_10_4 = "hellolargeworld.com" wide //weight: 10
    condition:
        (filesize < 20MB) and
        (
            ((1 of ($x_10_*) and 1 of ($x_1_*))) or
