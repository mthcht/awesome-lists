...
rule Trojan_Win32_ValleyRat_AVY_2147945345_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {50 ff d6 68 ?? ?? ?? ?? 8d 85 fc f7 ff ff 50 ff d6 68 ?? ?? ?? ?? 8d 85 fc f7 ff ff 50 ff d6 68 ?? ?? ?? ?? 8d 85 fc f7 ff ff 50 ff d6 68 ?? ?? ?? ?? 8d 85 fc f7 ff ff 50 ff d6 bb}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ValleyRat_AVY_2147945345_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.AVY!MTB"
...
rule Trojan_Win32_ValleyRat_AP_2147961170_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.AP!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {89 45 f8 8b 45 fc 0f b6 84 05 ?? ?? ?? ?? 89 45 f0 8b 45 fc 8b 4d f8 8a 8c 0d ?? ?? ?? ?? 88 8c 05 ?? ?? ?? ?? 8b 45 f8 8a 4d f0 88 8c 05 ?? ?? ?? ?? 8b 45 fc 0f b6 84 05 ?? ?? ?? ?? 8b 4d f8 0f b6 8c 0d ?? ?? ?? ?? 03 c1 25 ff 00 00 80 79 ?? 48 0d 00 ff ff ff 40 0f b6 84 05 ?? ?? ?? ?? 8b 4d 10 03 4d f4 0f b6 09 33 c8 8b 45 10 03 45 f4 88 08 e9}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_ValleyRat_AVR_2147969428_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_ValleyRat_AVR_2147969428_2
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {8d 85 d0 fd ff ff 51 0f 47 85 d0 fd ff ff 50 6a 0c 68 58 88 00 10 51 ff b5 5c fd ff ff 8d 8d 2c fd ff ff e8 ?? ?? ?? ?? 68 9c 84 00 10 8d 95 2c fd ff ff c6 45 fc 03 8d 8d b8 fd ff ff e8 ?? ?? ?? ?? 83 c4 04 c6 45 fc 05 8b 8d 40 fd ff ff}  //weight: 3, accuracy: Low
        $x_2_2 = {d1 f9 51 50 8d 8d 44 fd ff ff e8 ?? ?? ?? ?? 68 2c 88 00 10 8d 95 44 fd ff ff c7 45 fc 00 00 00 00 8d 8d d0 fd ff ff}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ValleyRat_C_2147973600_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_ValleyRat_BAA_2147973694_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_ValleyRat_PLA_2147976273_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.PLA!MTB"
        threat_id = "2147976273"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ValleyRat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {41 6b c0 34 2a d0 80 c2 31 32 14 37 88 16 8b 55 f8 83 f9 18}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ValleyRat_OLZ_2147976322_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.OLZ!MTB"
        threat_id = "2147976322"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ValleyRat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {8a c8 c0 e1 03 2a c8 80 c1 2d 32 ca 88 4c 05 ec 40 83 f8 10 7c ea}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ValleyRat_SYT_2147976323_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.SYT!MTB"
        threat_id = "2147976323"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ValleyRat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {2d 24 7e e2 bb 21 be 45 2f b8 2f 92 60 26 26 6e 7d 0a 30 12 e8 3c 76 50 ce 13 90 88 a8 5e fd 7a}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ValleyRat_AT_2147977198_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.AT!MTB"
        threat_id = "2147977198"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ValleyRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {89 55 f8 8b 45 fc 0f b6 8c 05 ?? ?? ?? ?? 89 4d f0 8b 55 fc 8b 45 f8 8a 8c 05 ?? ?? ?? ?? 88 8c 15 ?? ?? ?? ?? 8b 55 f8 8a 45 f0 88 84 15 ?? ?? ?? ?? 8b 4d fc 0f b6 94 0d ?? ?? ?? ?? 8b 45 f8 0f b6 8c 05 ?? ?? ?? ?? 03 d1 81 e2 ff 00 00 80 79 ?? 4a 81 ca 00 ff ff ff 42 0f b6 94 15 ?? ?? ?? ?? 8b 45 10 03 45 f4 0f b6 08 33 ca 8b 55 10 03 55 f4 88 0a e9}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ValleyRat_CH_2147977540_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.CH!MTB"
        threat_id = "2147977540"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ValleyRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {b8 aa 00 00 00 66 33 44 ?? 94 66 89 44 ?? e4}  //weight: 10, accuracy: Low
        $x_2_2 = "AVAST" ascii //weight: 2
        $x_2_3 = "SOPHOS" ascii //weight: 2
        $x_2_4 = "SENTINELAGENT" ascii //weight: 2
        $x_2_5 = "FORTICLIENT" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ValleyRat_BC_2147977595_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.BC!MTB"
        threat_id = "2147977595"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ValleyRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {0f 10 04 01 0f 28 ca 0f 57 c8 0f 11 0c 01 0f 10 84 05 ?? ?? ?? ?? 0f 28 ca 0f 57 c2 0f 11 84 05 ?? ?? ?? ?? 0f 10 04 06 0f 57 c2 0f 11 04 06 0f 10 04 03 0f 57 c8 0f 11 0c 03 83 c0 40 3b c2 72 ?? 8b 1d ?? ?? ?? ?? 3b c7 73 ?? 80 b4 05 34 c3 f0 ff 7b 40 3b c7 72}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ValleyRat_BF_2147977682_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.BF!MTB"
        threat_id = "2147977682"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ValleyRat"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {8b 45 f4 8b 48 08 8b 45 14 03 45 f8 0f b6 00 99 be c8 01 00 00 f7 fe 83 c2 36 8b 45 fc 0f be 04 01 33 c2 8b 4d f4 8b 49 08 8b 55 fc 88 04 11 8b 45 f8 40 89 45 f8 8b 45 fc 99 6a 0a 59 f7 f9 85 d2 75}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_ValleyRat_BV_2147978580_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/ValleyRat.BV!MTB"
        threat_id = "2147978580"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "ValleyRat"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {fe c2 88 96 ?? ?? ?? ?? 0f b6 d2 8a 04 32 02 c1 88 86 ?? ?? ?? ?? 8a 0c 32 0f b6 c0 8a 04 30 88 04 32 0f b6 86 ?? ?? ?? ?? 88 0c 30 0f b6 86 ?? ?? ?? ?? 8a 96 ?? ?? ?? ?? 0f b6 0c 30 0f b6 c2 0f b6 04 30 03 c8 0f b6 c1 8b 4d 08 8a 04 30 32 04 0f 88 01 41 89 4d 08 8a 8e ?? ?? ?? ?? 83 eb 01 75}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
