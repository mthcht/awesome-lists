...
rule Trojan_Win32_KillMBR_ENII_2147942195_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/KillMBR.ENII!MTB"
        threat_id = "2147942195"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "KillMBR"
        severity = "Critical"
...
rule Trojan_Win32_KillMBR_GBVL_2147966694_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/KillMBR.GBVL!MTB"
        threat_id = "2147966694"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "KillMBR"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "repos\\N17Pro3426\\Release\\N17Pro3426.pdb" ascii //weight: 2
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
