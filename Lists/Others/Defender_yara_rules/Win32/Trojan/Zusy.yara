...
rule Trojan_Win32_Zusy_A_2147829609_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.A!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_1_1 = {8b c1 33 d2 f7 f6 8a 44 15 a4 30 81 ?? ?? ?? ?? 41 81 f9 ?? ?? ?? ?? 72 e7}  //weight: 1, accuracy: Low
        $x_1_2 = {33 d2 8b c1 f7 f6 0f b6 44 15 ?? 33 d2 30 81 ?? ?? ?? ?? 8d 41 01 f7 f6 0f b6 44 15}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}
...
rule Trojan_Win32_Zusy_AZU_2147898966_0
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {89 44 24 40 c7 44 24 4c 06 00 00 00 8d 05 c3 ab 4c 00 89 44 24 48 c7 44 24 54 08 00 00 00 8d 05 db ae 4c 00 89 44 24 50 8b 44 24 1c 89 44 24 5c 89 54}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_AZU_2147898966_3
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {f7 e9 c1 fa 08 8b ca c1 e9 1f 03 ca 8b 15 ?? ?? ?? ?? 69 d2 6d 08 00 00 6a 01 68 00 17 45 00 6a 00 2b ce 68 80 16 45 00 2b ca 68 d8 1d 44 00 81 c1 2e 32 00 00 6a 00}  //weight: 2, accuracy: Low
        $x_1_2 = {03 d1 c1 fa 0c 8b c2 c1 e8 1f 03 c2 8b c8 b8 37 ed b2 a5 f7 ee 8b 35 ?? ?? ?? ?? c1 fa 0a 8b c2 c1 e8 1f 03 c2 2b c1}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_AZU_2147898966_4
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.AZU!MTB"
...
rule Trojan_Win32_Zusy_AZU_2147898966_5
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.AZU!MTB"
...
rule Trojan_Win32_Zusy_GA_2147925881_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.GA!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_4_1 = {c7 00 5c 76 69 72 c7 40 04 75 73 5f 6c c7 40 08 6f 67 2e 74 c7 40 0b 74 78 74 00 c7 44 24 04}  //weight: 4, accuracy: High
        $x_2_2 = {4c 6f 61 64 4c 69 62 72 61 72 79 41 00 00 7d 04 51 75 65 72 79 50 65 72 66 6f 72 6d 61 6e 63 65 46 72 65 71 75 65 6e 63 79 00 84 04 51 75 65 72 79 55 6e 62 69 61 73 65 64 49 6e 74 65 72 72 75 70 74 54 69 6d}  //weight: 2, accuracy: High
        $x_1_3 = {4e 74 57 61 69 74 46 6f 72 53 69 6e 67 6c 65 4f 62 6a 65 63 74 00 bd 03 52 74 6c 44 6c 6c 53 68 75 74 64 6f 77 6e 49 6e 50 72 6f 67 72 65 73 73}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_KK_2147944060_3
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b c8 8d 47 01 33 ca 2b ca 80 f9 ?? 0f 45 c7 46 8b f8 3b f5}  //weight: 20, accuracy: Low
        $x_10_2 = {8b c8 33 ca 2b ca 8b 54 24 10 80 f9 ?? 8d 42 01 0f 45 c2 8b c8 8b 44 24 0c 40 89 4c 24 10 89 44 24 0c 3b c7}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_KK_2147944060_4
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8b 45 f4 89 c2 c1 ea 1f 01 d0 d1 f8 89 c2 8b 45 08 01 d0 8b 4d f4 8b 55 f0 01 ca 0f b6 00 88 02 8b 45 f4 89 c2 c1 ea 1f 01 d0 d1 f8 89 c2 8b 45 08 01 d0 8b 55 f4 8d 4a 01 8b 55 f0 01 ca 0f b6 00 88 02 83 45 f4 01}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_KK_2147944060_6
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {c7 85 b0 fe ff ff 00 00 00 00 8d 85 f0 fe ff ff 89 44 24 0c 8d 85 b0 fe ff ff 89 44 24 08 8b 45 10 c7 85 f0 fe ff ff 00 00 00 00 89 44 24 04 8b 45 0c 89 04 24}  //weight: 20, accuracy: High
        $x_10_2 = {c7 41 78 00 00 00 00 83 c1 08 c7 41 74 00 00 00 00 39 ce}  //weight: 10, accuracy: High
        $x_5_3 = {e8 5d 10 00 00 b9 35 00 00 00 31 d2 f7 f1 8a 44 15 b2 88 04 33 46 eb e3}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_LMM_2147952485_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.LMM!MTB"
        threat_id = "2147952485"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b 55 84 8b 85 20 ff ff ff 8d 4c 10 dc 0f b6 95 4e ff ff ff 83 c2 3f 23 ca 88 4d e7 8b 85 20 ff ff ff 83 c8 13 8b ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 0b c1 66 89 45 90 8b 55 ec 83 c2 63 2b 95 40 ff ff ff 89 55 88}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_SXL_2147953212_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_3_1 = {0f b6 55 e3 8b 45 a0 8d 4c 10 eb 8b 55 9c 2b 95 d8 fe ff ff 23 ca 88 8d 77 ff ff ff 8b 85 00 ff ff ff 2b 45 b8 8b 4d 9c 2b 4d f4 23 4d 9c}  //weight: 3, accuracy: High
        $x_2_2 = {0f b7 45 ac 03 d0 2b 55 cc 83 ea ?? 0f b6 8d 5f ff ff ff 23 ca 88 8d 5f ff ff ff}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_PGZS_2147953817_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.PGZS!MTB"
        threat_id = "2147953817"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {6e a9 84 b0 fa 01 20 bd fd 97 04 93 5b 7a cb a5 70 dd 8e 2b 83 fa cf 83 eb a5 50 13 32 d2 57 2e 05 8d 8a d8 39 9f f5 ec 90 95 bb 77 7b 24 4b 44 7f cd f0 f7 6d 75 35 d3 a3 99 de be 78 41 26 6d b3 0d df cb f2 0f de c8 34 f1 58 46 14 d5 91 6c}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_AR_2147954231_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.AR!MTB"
        threat_id = "2147954231"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {12 6f 33 24 75 08 c7 44 24 ?? 9f 86 01 00 21 d7 24 83 7c}  //weight: 30, accuracy: Low
        $x_20_2 = {00 38 21 7f 00 30 2d ?? ?? ?? ?? c5 6a 1a 21 81 ?? ?? ?? ?? 0c ?? 44 24 ?? a1}  //weight: 20, accuracy: Low
        $x_10_3 = {30 32 42 00 00 00 00 00 2e 3f 41 56 5f}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_MKB_2147954934_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.MKB!MTB"
        threat_id = "2147954934"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_15_1 = {0f b6 55 fb 0f b6 85 6e ff ff ff 03 d0 0f b7 8d 30 ff ff ff 33 d1 0f b7 85 44 ff ff ff 03 c2 66 89 85 44 ff ff ff}  //weight: 15, accuracy: High
        $x_10_2 = {0f b7 85 78 ff ff ff 2b d0 03 55 c8 33 55 c8 88 55 f9}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_ARR_2147956041_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = "A!l@l$C!l^i#c%k" ascii //weight: 20
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_ARR_2147956041_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_7_1 = {57 0f af 06 83 c0 ?? 8b cb 50 6a}  //weight: 7, accuracy: Low
        $x_13_2 = {0f af d0 03 d7 89 14 81 8b 0e 40 3b c1}  //weight: 13, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_ARR_2147956041_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8b 4d f8 0f be 11 83 f2 ?? 8b 45 f8 88 10 8b 4d f8 0f be 11 89 55 e0 8b 45 f8 83 c0 ?? 89 45 f8 83 7d e0}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_ARR_2147956041_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.ARR!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_10_1 = {87 2c 24 5c 89 14 24 57 89 0c 24 8b 14 24 83 ec}  //weight: 10, accuracy: High
        $x_7_2 = {47 30 16 b0 83 41 5d}  //weight: 7, accuracy: High
        $x_3_3 = {ab 3b cd 5b c7 30 dd 65 c0 72 ?? ?? 4c 11 b4 59}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_ARR_2147956041_4
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_15_1 = {3a 43 da 33 06 4d 6c 3c 45}  //weight: 15, accuracy: High
        $x_5_2 = {dc 36 02 ec 98 6b c1 ?? ee d3 ce 32 4a fc}  //weight: 5, accuracy: Low
        $x_15_3 = {33 3c 24 31 3c 24 33 3c 24 5c 8d 44 24 24}  //weight: 15, accuracy: High
        $x_5_4 = {67 32 15 66 e7 ?? ?? ?? d6 ed 53 ab}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
...
rule Trojan_Win32_Zusy_ARR_2147956041_5
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_6_1 = {40 88 34 11 48 ff c2 48 39 d3 7e ?? 0f b6 34 10 0f b6 3d ?? ?? ?? ?? 31 fe 48 39 d3}  //weight: 6, accuracy: Low
        $x_10_2 = {48 89 54 24 2c 48 8d 44 24 22 bb ?? ?? ?? ?? 48 89 d9 e8 ?? ?? ?? ?? 48 89 d9 48 89 c3 48 8b 44 24 40}  //weight: 10, accuracy: Low
        $x_4_3 = {48 89 c1 4c 29 c9 48 39 c8 72 ?? 48 89 cb 48 89 c1 31 ff 31 f6 4c 89 c0 48 83 c4 50 5d}  //weight: 4, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_ARR_2147956041_6
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.ARR!MTB"
...
rule Trojan_Win32_Zusy_ARR_2147956041_7
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.ARR!MTB"
...
rule Trojan_Win32_Zusy_AHM_2147957414_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.AHM!MTB"
        threat_id = "2147957414"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {66 89 84 24 58 01 00 00 0f 1f 84 ?? ?? ?? ?? ?? 8b c1 83 e0 ?? 0f b6 80 ?? ?? ?? ?? 66 33 44 4c 14 66 89 84 4c 40 01 00 00 41 83 f9 ?? 72}  //weight: 30, accuracy: Low
        $x_20_2 = {66 33 4c 04 2c 66 89 8c 04 5c 01 00 00 0f b7 4c 04 2e 66 33 ca 66 89 8c 04 5e 01 00 00 83 ef ?? 0f}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_MKD_2147957470_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_15_1 = {31 c9 49 c1 e1 ?? 49 41 49 83 c1 ?? c1 e1 4d 59 0f b6 0c 32 0f b6 04 37 03 c8}  //weight: 15, accuracy: Low
        $x_10_2 = {8a 04 37 88 04 32 51 83 ?? ?? 31 c9 49 49 41 49 49 41 49}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_JT_2147957530_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.JT!MTB"
        threat_id = "2147957530"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {c7 45 e4 31 03 16 21 c6 45 e8 53 c7 45 d8 32 04 04 28 c6 45 dc 4d c7 45 b0 6f 09 19 21 c7 45 b8 34 1c 05 25 c7 45 bc 55 0b 41 19 c7 45 c0 22 04 04 27 c7 45 c4 4a 43 5f 5d c7 45 c8 22 1e 0e 37 c7 45 cc 4e 08 46 1a c7 45 d0 25 08 0f 37 c7 45 d4 0f 00 57 40}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_ABZ_2147958843_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.ABZ!MTB"
        threat_id = "2147958843"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {31 c3 89 da 8b 45 f0 83 c0 04 89 94 85 ?? ?? ?? ?? 8b 45 f0 83 c0 04 8b 94 85 ?? ?? ?? ?? 8b 45 f0 8d 0c 85 ?? ?? ?? ?? 8b 45 0c 01 c8 89 10}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_BAH_2147959362_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.BAH!MTB"
        threat_id = "2147959362"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {89 45 f4 8b 45 f4 89 45 fc 8b 45 fc 8b 40 3c 03 45 f4 89 45 f8 8b 45 f8 8b 40 28 03 45 f4 89 45 f0 8d 45 ec}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_LMZ_2147961491_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.LMZ!MTB"
        threat_id = "2147961491"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {66 33 44 4c 34 66 89 84 4c f0 00 00 00 41 83 f9 0b 72 e1 8d 84 24 f0 00 00 00 e9}  //weight: 20, accuracy: High
        $x_10_2 = {c7 44 24 4c 61 00 68 00 c7 44 24 50 8c 00 1a 00 33 c9 c7 44 24 54 70 00 65 00 c7 44 24 58 c9 00 49 00 c7 44 24 5c 2e 00 68 00 c7 44 24 60 96 00 17 00 66 89 44 24 64}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_NUA_2147964154_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.NUA!MTB"
        threat_id = "2147964154"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = "SYfEeswxoymxx" ascii //weight: 2
        $x_1_2 = "XRsYvwMfQQqbIlZjDUhVnrTXOAVMlWwgeEY" ascii //weight: 1
        $x_1_3 = "wrZYSllCUyVTRoAiiztmAx" ascii //weight: 1
        $x_1_4 = "FpcFJdqnHkArsIylmOotAOopUoCpFoeitHpsTXsYw" ascii //weight: 1
        $x_1_5 = "ssiBASQLqlhYdGxuSVFCILBQrnjbiYWjpyNjGvKbvhLLpOchJGOiGwjpxXArmPsNKqnNYAmDhzJqrqZ" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_LRA_2147964561_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.LRA!MTB"
        threat_id = "2147964561"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {30 84 0d 69 fb ff ff 41 83 f9 12 72 ?? c6 85 7b fb ff ff 00 b1 07 c7 85 94 fb ff ff 07 6c 62 75 33 c0 c7 85 98 fb ff ff 69 62 6b 34 c7 85 9c fb ff ff 35 29 63 6b 66 c7 85 a0 fb ff ff 6b 00}  //weight: 20, accuracy: Low
        $x_10_2 = {8d 85 49 fd ff ff 30 14 08 41 83 f9 0d 73 ?? 8a 95 48 fd ff ff}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_LR_2147964864_0
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {a1 30 50 40 00 8b 0d 34 50 40 00 89 c2 83 ea 01 0f af c2 83 e0 01 83 f8 00 0f 94 c0 83 f9 0a 0f 9c c1 08 c8 a8 01}  //weight: 20, accuracy: High
        $x_10_2 = {8b 4c 24 70 89 c8 40 83 e9 64 0f 92 c1 89 44 24 70 b9 ?? ?? ?? ?? b8 48 f3 d8 19 0f 42 c1}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_LR_2147964864_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.LR!MTB"
...
rule Trojan_Win32_Zusy_PGZM_2147965982_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.PGZM!MTB"
        threat_id = "2147965982"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {8b 55 f4 8b 45 08 01 d0 0f b6 10 8b 4d f4 8b 45 f0 01 c8 83 f2 35 88 10 83 45 f4 01 8b 45 f4 3b 45 0c 7c dc}  //weight: 5, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_BAI_2147967413_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.BAI!MTB"
        threat_id = "2147967413"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = {8b 54 24 2c 29 d0 8b 54 24 30 8d 0c 10 89 e0 89 da ff d1}  //weight: 5, accuracy: High
        $x_1_2 = "://pastebin.com/raw/AqndxJKK" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_IFZ_2147968502_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.IFZ!MTB"
        threat_id = "2147968502"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {6a 0c 8b c1 5f f7 f7 8a 44 15 e8 30 04 0b 41 3b 8d ?? ?? ?? ?? 72}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_LRK_2147968619_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.LRK!MTB"
        threat_id = "2147968619"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {33 d2 6a 0c 8b c1 5e f7 f6 8b 75 1c 8a 84 15 74 28 00 00 30 04 31 41 3b 4d 2c}  //weight: 30, accuracy: High
        $x_20_2 = {80 f1 fa 88 8c 05 b4 28 00 00 40 83 f8 05}  //weight: 20, accuracy: High
        $x_10_3 = {66 8b 45 f0 8b 4d 18 ff 45 f8 83 45 18 0e 66 89 01 0f b7 43 04 39 45 f8}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_LRK_2147968619_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.LRK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {48 89 84 24 80 00 00 00 c7 44 24 30 01 00 00 00 c7 44 24 78 00 00 00 00 48 8d 05 10 12 00 00 48 89 44 24 40 48 8d 05 14 12 00 00 48 89 44 24 48 c7 44 24 54 01 00 00 00 48 c7 44 24 58 00 00 00 00 48 c7 44 24 60 00 00 00 00 c7 44 24 68 01 00 00 00 48 c7 44 24 70 00 00 00 00 4c 8d 4c 24 78 4c 8d 44 24 40}  //weight: 20, accuracy: High
        $x_10_2 = "P@ssword233" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_HAV_2147969809_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.HAV!MTB"
        threat_id = "2147969809"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {2b c8 8b c1 8b 4c 24 30 03 0c c2 89 4c 24 30 8b 44 24 30 48 83 c4 28 c3}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_MX_2147970419_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.MX!MTB"
        threat_id = "2147970419"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {eb 13 33 c0 40 c3 8b 65 e8 c7 45 fc fe ff ff ff b8 ff 00 00 00 e8 38 01 00 00 c3 b8 4d 5a}  //weight: 1, accuracy: High
        $x_1_2 = "win.dat_" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_YSL_2147971913_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.YSL!MTB"
        threat_id = "2147971913"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "[CHROME] Firefox prefs.js patched: crash recovery disable" ascii //weight: 1
        $x_1_2 = "Device Management Sync Servic" wide //weight: 1
        $x_1_3 = "Global\\WinSvcHostMonitor" wide //weight: 1
        $x_1_4 = "hidden before paint" ascii //weight: 1
        $x_1_5 = "-new-instance -no-remote -url" wide //weight: 1
        $x_1_6 = "[CHROME] Ghost cloaked and ready." ascii //weight: 1
        $x_1_7 = "--disable-infobars" wide //weight: 1
        $x_1_8 = "--hide-crash-restore-bubble" wide //weight: 1
        $x_1_9 = "--disable-backgrounding-occluded-windows" wide //weight: 1
        $x_1_10 = "--disable-renderer-backgrounding " wide //weight: 1
        $x_1_11 = "--disable-occlusion-tracking " wide //weight: 1
        $x_1_12 = "--mute-audio" wide //weight: 1
        $x_1_13 = "browser.sessionstore.resume_from_crash" ascii //weight: 1
        $x_1_14 = "ssclean_%u.bat" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Zusy_LRL_2147972216_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Zusy.LRL!MTB"
        threat_id = "2147972216"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Zusy"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {0f af d0 8b c2 c1 e0 0d 33 d0 8b c2 c1 e8 11 33 d0}  //weight: 20, accuracy: High
        $x_10_2 = {8b c2 c1 e0 05 33 c2 89 04 b5 90 13 51 00 46 81 fe 00 04 00 00}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_MKE_2147973781_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {48 8d 15 2a 2b 00 00 66 0f 6c c1 48 8d 05 2b 2b 00 00 48 8d 0d f2 2a 00 00 66 48 0f 6e d0 0f 11 44 24 28 66 48 0f 6e c2 48 8d 5c 24 20 48 c7 44 24 48 00 00 00 00 66 0f 6c c2 0f 11 44 24 38}  //weight: 20, accuracy: High
        $x_15_2 = {48 8d 05 37 2d 00 00 48 8d 3d 3d 2d 00 00 66 0f 6c c1 66 48 0f 6e d0 48 8d 05 38 2d 00 00 66 48 0f 6e d8 48 8d 05 47 2d 00 00 66 48 0f 6e e0}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Zusy_MKF_2147973799_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8d 50 ff 0f af d0 f7 d2 83 ca fe 83 fa ff 0f 94 c0 83 f9 0a 0f 9c c4 30 c4 b8 0b 4f 48 fa be 0b 4f 48 fa}  //weight: 20, accuracy: High
        $x_15_2 = {8d 50 ff 0f af d0 89 d5 83 f5 fe b9 3b e1 3d 54 b8 f9 1c cd 43 be 3b e1 3d 54 85 d5}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
