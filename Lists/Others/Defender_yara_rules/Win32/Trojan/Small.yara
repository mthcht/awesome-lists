...
rule Trojan_Win32_Small_EM_2147836902_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Small.EM!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = {4c 01 03 00 a0 43 e2 34}  //weight: 1, accuracy: High
        $x_1_2 = "UnmapViewOfFile" ascii //weight: 1
        $x_1_3 = "MapViewOfFile" ascii //weight: 1
        $x_1_4 = "OpenFileMappingA" ascii //weight: 1
        $x_1_5 = "DRAMMAP" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Small_C_2147945084_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Small.C!MTB"
        threat_id = "2147945084"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Small"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {c3 55 89 e5 90 c9 68 ?? ?? ?? ?? c3 80 74 0a ff 20 e2}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
