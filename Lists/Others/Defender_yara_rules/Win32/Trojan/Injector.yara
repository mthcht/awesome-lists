...
rule Trojan_Win32_Injector_KK_2147957799_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Injector.KK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {8a 08 40 88 4d e4 8a 0a 88 48 ff 8a 4d e4 88 0a}  //weight: 20, accuracy: High
        $x_10_2 = {83 f0 5a 42 88 42 ff}  //weight: 10, accuracy: High
        $x_5_3 = "MpStartShellcode" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Injector_AHB_2147961826_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Injector.AHB!MTB"
        threat_id = "2147961826"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Injector"
        severity = "Critical"
...
rule Trojan_Win32_Injector_MKC_2147965215_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Injector.MKC!MTB"
        threat_id = "2147965215"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Injector"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_35_1 = {2d 94 6b cc 06 05 8b 6b cc 06 80 3b cc ?? ?? c6 03 00 bb 00 10 00 00 68 69 d1 8c 57 68 41 82 12 03 53 50}  //weight: 35, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Injector_MKZ_2147965681_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Injector.MKZ!MTB"
        threat_id = "2147965681"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Injector"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {8b c8 8b 45 f8 33 d2 f7 f1 52 8b 4d 08 e8 ?? ?? ?? ?? 0f be 10 8b 85 30 ff ff ff 0f be 08 33 ca 8b 95 30 ff ff ff 88 0a eb}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Injector_KKB_2147965901_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Injector.KKB!MTB"
        threat_id = "2147965901"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Injector"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {8d 87 00 b0 00 10 8a 08 c0 c9 03 32 8a ?? ?? ?? ?? 6a 0c 88 08 8d 42 01 99 59 f7 f9 47 3b fe}  //weight: 20, accuracy: Low
        $x_10_2 = {8d 45 fc 50 6a 40 56 be 00 b0 00 10 56 ff 15 34 80 00 10}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Injector_LR_2147972500_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Injector.LR!MTB"
        threat_id = "2147972500"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Injector"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {33 c0 83 f8 01 0f 84 ?? ?? ?? ?? 33 c0 85 c0 74 ?? 48 8d 05 eb e1 00 00 48 89 44 24 70 eb ?? 48 8d 05 1d e2 00 00 48 89 44 24 70}  //weight: 20, accuracy: Low
        $x_10_2 = {c7 84 24 a0 00 00 00 ff 01 1f 00 c7 84 24 a4 00 00 00 02 00 00 00 c7 84 24 a8 00 00 00 00 00 00 00 c7 84 24 bc 00 00 00 00 00 00 00 c7 84 24 c0 00 00 00 05 00 00 00 48 8b 44 24 78 48 89 84 24 c8 00 00 00 4c 8d 8c 24 80 00 00 00 45 33 c0 48 8d 94 24 a0 00 00 00 b9 01 00 00 00}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Injector_MKF_2147975445_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Injector.MKF!MTB"
        threat_id = "2147975445"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Injector"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {b8 39 8e e3 38 41 f7 e0 c1 ea 03 8d 0c d2 c1 e1 02 44 2b c1 48 8d 0d 5c 0b 00 00 42 0f b7 04 41 44 8b c2 66 89 44 5c 58 48 ff c3 85 d2}  //weight: 20, accuracy: High
        $x_15_2 = {41 8a 04 10 88 02 49 03 d6 8b 47 54 48 8b ca 48 2b ce 48 3b c8}  //weight: 15, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
