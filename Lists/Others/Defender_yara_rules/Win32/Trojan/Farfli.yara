...
rule Trojan_Win32_Farfli_KK_2147949264_2
{
    meta:
        ...
        strings_accuracy = "High"
    strings:
        $x_20_1 = {0f b6 1c 30 80 c3 86 30 d3 88 1c 30 46 39 f1}  //weight: 20, accuracy: High
        $x_10_2 = "PuppetProcessAsUser scessully.." ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Farfli_KK_2147949264_3
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Farfli.KK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {89 46 14 89 5e 20 89 5e 18 89 5e 1c ?? ?? ?? ?? 89 46 24 89 5e 30 89 5e 28 89 5e 2c ?? ?? ?? ?? 89 46 34 89 5e 40 89 5e 38 89 5e 3c}  //weight: 20, accuracy: Low
        $x_10_2 = {80 34 38 a7 40 3b c6}  //weight: 10, accuracy: High
        $x_5_3 = "fnt1122tdll" ascii //weight: 5
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Farfli_KK_2147949264_4
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Farfli.KK!MTB"
...
rule Trojan_Win32_Farfli_SXF_2147961338_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Farfli.SXF!MTB"
        threat_id = "2147961338"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Farfli"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {66 0f ef c8 66 0f f8 ca 0f 11 89 ?? ?? ?? ?? 83 c1 10 81 f9 00 dc 01 00 72 d8}  //weight: 20, accuracy: Low
        $x_10_2 = {44 6f 77 6e c7 85 ?? ?? ?? ?? 6c 6f 61 64 f3 0f 7e 85 ?? ?? ?? ?? c7 85 ?? ?? ?? ?? 73 5c 2a 2e}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Farfli_SXG_2147964691_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Farfli.SXG!MTB"
        threat_id = "2147964691"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Farfli"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {c6 45 bd 70 c6 45 be 70 c6 45 bf 6c c6 45 c0 69 c6 45 c1 63 c6 45 c2 61 c6 45 c3 74 c6 45 c4 69 c6 45 c5 6f c6 45 c6 6e c6 45 c7 73}  //weight: 30, accuracy: High
        $x_10_2 = {c6 45 ed 69 c6 45 ee 6e c6 45 ef 53 c6 45 f0 74 c6 45 f1 61 c6 45 f2 30 c6 45 f3 5c c6 45 f4 44 c6 45 f5 65 c6 45 f6 66 c6 45 f7 61 c6 45 f8 75 c6 45 f9 6c c6 45 fa 74 88 5d fb}  //weight: 10, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Farfli_SXA_2147969174_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Farfli.SXA!MTB"
        threat_id = "2147969174"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Farfli"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {68 20 4e 00 00 ff d3 8d 85 a4 f5 ff ff c7 85 a4 f5 ff ff 00 00 00 00 50 68 ?? ?? ?? ?? ff d6 83 bd a4 f5 ff ff 00 75 d8}  //weight: 30, accuracy: Low
        $x_20_2 = {0f ac f7 1e c1 ee 1e 83 c7 01 83 d6 00 0f ac c1 1e c1 e8 1e 83 c1 01 83 d0 00 50}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Farfli_SXB_2147971007_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Farfli.SXB!MTB"
        threat_id = "2147971007"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Farfli"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_30_1 = {c6 45 fc 04 8b 08 ff 51 4c 85 c0 ?? ?? ?? ?? ?? ?? 83 65 e4 00 8b 45 e0 8d 55 e4 52 50 c6 45 fc 05 8b 08 ff 51 44}  //weight: 30, accuracy: Low
        $x_20_2 = {8d 4d f0 e8 ?? ?? ?? ?? 6a 4c 59 33 d2 f7 f1 8b ce 0f b7 ?? ?? ?? ?? ?? ?? 50 e8 ?? ?? ?? ?? 83 eb 01 75 dc}  //weight: 20, accuracy: Low
        $x_30_3 = "A30BD1B1-CB43-4604-86F5-56594AEE26A3" ascii //weight: 30
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
