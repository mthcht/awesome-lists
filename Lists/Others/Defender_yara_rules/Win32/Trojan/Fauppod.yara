...
rule Trojan_Win32_Fauppod_ZPU_2147942457_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fauppod.ZPU!MTB"
        threat_id = "2147942457"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fauppod"
        severity = "Critical"
...
rule Trojan_Win32_Fauppod_GZK_2147942710_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fauppod.GZK!MTB"
        threat_id = "2147942710"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fauppod"
        severity = "Critical"
...
rule Trojan_Win32_Fauppod_ZCT_2147942914_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fauppod.ZCT!MTB"
        threat_id = "2147942914"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fauppod"
        severity = "Critical"
...
rule Trojan_Win32_Fauppod_ZHT_2147943035_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fauppod.ZHT!MTB"
        threat_id = "2147943035"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fauppod"
        severity = "Critical"
...
rule Trojan_Win32_Fauppod_ZTT_2147943790_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Fauppod.ZTT!MTB"
        threat_id = "2147943790"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Fauppod"
        severity = "Critical"
