rule Trojan_Win32_Evasion_SearchHijack_2147949579_0
{
    ...
    strings:
        ...
        $x_1_2 = "igfxtray.ex" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Evasion_EmbeddedPE_2147950364_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Evasion.EmbeddedPE.AV.B"
        threat_id = "2147950364"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Evasion"
        severity = "Critical"
    ...
    strings:
        $x_1_1 = "sb_" wide //weight: 1
        $x_1_2 = "bdata_payload.ex" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
