...
rule Trojan_Win32_Azorult_BAH_2147949979_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Azorult.BAH!MTB"
        threat_id = "2147949979"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Azorult"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {2b f1 33 c6 03 d0 a1 ?? ?? ?? ?? 03 85 ?? ?? ?? ?? 88 10}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
