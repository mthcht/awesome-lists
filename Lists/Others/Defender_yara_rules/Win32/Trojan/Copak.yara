...
rule Trojan_Win32_Copak_BAJ_2147961118_0
{
    meta:
        author = "defender2yara"
...
rule Trojan_Win32_Copak_KK_2147961194_0
{
    meta:
        author = "defender2yara"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {7c 9a 65 00 [0-15] 8d [0-50] 81 ?? ff 00 00 00 [0-30] 81 ?? f4 01 00 00 75}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Copak_KK_2147961194_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Copak.KK!MTB"
...
rule Trojan_Win32_Copak_BAK_2147961745_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Copak.BAK!MTB"
        threat_id = "2147961745"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Copak"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {8a 03 29 ff 09 f7 88 02 09 ff 42 89 ff 01 fe 09 ff 81 c3 02 00 00 00 89 f7 01 f6 39 cb 7e}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Copak_BAK_2147961745_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Copak.BAK!MTB"
        ...
        strings_accuracy = "High"
    strings:
        $x_2_1 = {21 ff 53 21 ff 01 d2 89 d7 8b 34 24 83 c4 04 29 d7 21 d2 41 09 ff 81 ef a8 48 13 b1 42 81 f9}  //weight: 2, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Copak_BAK_2147961745_2
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Copak.BAK!MTB"
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {8d 34 32 21 f8 8b 36 bf ?? ?? ?? ?? 48 89 ff 81 e6 ff 00 00 00 89 f8 42 89 c0 01 f8 81 c7 01 00 00 00 81 fa f4 01 00 00 75}  //weight: 2, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Copak_KKA_2147961791_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Copak.KKA!MTB"
        threat_id = "2147961791"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Copak"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {a0 56 46 00 c3 [0-26] 08 4a 48 00 [0-26] e8 ?? 00 00 00 [0-26] 31 [0-26] 81 ?? 02 00 00 00 [0-26] 39 ?? 7c}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Copak_KKB_2147961792_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Copak.KKB!MTB"
        threat_id = "2147961792"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Copak"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_20_1 = {a0 96 45 00 c3 [0-31] cc ?? 47 00 [0-31] e8 ?? 00 00 00 [0-31] 31 [0-35] 81 ?? 02 00 00 00 [0-35] 39 ?? 7c}  //weight: 20, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule Trojan_Win32_Copak_PGCA_2147967598_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Copak.PGCA!MTB"
        threat_id = "2147967598"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Copak"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {68 20 e7 64 00 c3 [0-31] ec 09 71 00 [0-15] e8 ?? 00 00 00 [0-15] 31 [0-15] 81 ?? 01 00 00 00 [0-15] 39 ?? 75}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Copak_PGCG_2147969031_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Copak.PGCG!MTB"
        threat_id = "2147969031"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Copak"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {f4 01 00 00 75 05 ?? 00 00 00 00 [0-31] 31 [0-15] 81 ?? 02 00 00 00 [0-15] 39 ?? 0f 8c}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Copak_PGCH_2147970041_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Copak.PGCH!MTB"
        threat_id = "2147970041"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Copak"
        severity = "Critical"
        ...
        strings_accuracy = "Low"
    strings:
        $x_5_1 = {68 a0 06 b1 00 c3 [0-15] 86 88 d6 00 5b [0-15] e8 ?? 00 00 00 [0-8] 31 19 [0-15] 81 c1 02 00 00 00 [0-15] 21 ?? 39 f1 7c}  //weight: 5, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
