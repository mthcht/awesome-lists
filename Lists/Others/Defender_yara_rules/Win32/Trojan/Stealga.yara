rule Trojan_Win32_Stealga_DA_2147938208_0
{
    ...
    strings:
        $x_10_1 = "\\rat\\client\\stealer" ascii //weight: 10
        $x_1_2 = "AVIBrowserBase@stealer" ascii //weight: 1
        $x_1_3 = "AVChromeBrowser@stealer" ascii //weight: 1
        $x_1_4 = "AVEdgeBrowser@stealer" ascii //weight: 1
        $x_1_5 = "AVFirefoxBrowser@stealer" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}

rule Trojan_Win32_Stealga_DA_2147938208_1
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealga.DA!MTB"
...
rule Trojan_Win32_Stealga_HAK_2147966677_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Stealga.HAK!MTB"
        threat_id = "2147966677"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Stealga"
        severity = "Critical"
