...
rule Trojan_Win32_Bayrob_EM_2147960280_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:Win32/Bayrob.EM!MTB"
        threat_id = "2147960280"
        type = "Trojan"
        platform = "Win32: Windows 32-bit platform"
        family = "Bayrob"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "tKMqzKIALqdruZokSeE" ascii //weight: 1
        $x_1_2 = "wBSmvXL" ascii //weight: 1
        $x_1_3 = "kPIKZxDdLdQQRtvcu" ascii //weight: 1
        $x_1_4 = "OPbCFwbnkPqMwGDHzsyiiACFaBO" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
