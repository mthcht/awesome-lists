...
rule Trojan_Win32_ConAtt_B_2147910644_0
{
    ...
    strings:
        ...
        $x_10_2 = {63 00 6f 00 6e 00 68 00 6f 00 73 00 74 00 2e 00 65 00 78 00 65 00 [0-6] 2d 00 2d 00 68 00 65 00 61 00 64 00 6c 00 65 00 73 00 73 00 [0-6] 63 00 6d 00 64 00 [0-48] 70 00 75 00 73 00 68 00 64 00 [0-48] 3d 00 72 00 75 00 6e 00 64 00 6c 00 6c 00 33 00 32 00 26 00 73 00 65 00 74 00}  //weight: 10, accuracy: Low
    condition:
        (filesize < 20MB) and
        (1 of ($x*))
}
