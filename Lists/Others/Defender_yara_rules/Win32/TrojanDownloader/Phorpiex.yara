...
rule TrojanDownloader_Win32_Phorpiex_AH_2147964219_0
{
    meta:
        author = "defender2yara"
        detection_name = "TrojanDownloader:Win32/Phorpiex.AH!MTB"
        threat_id = "2147964219"
        type = "TrojanDownloader"
        platform = "Win32: Windows 32-bit platform"
        family = "Phorpiex"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_30_1 = {ba 70 00 00 00 66 89 95 26 f9 ff ff b8 3a 00 00 00 66 89 85 28 f9 ff ff b9 2f 00 00 00 66 89 8d 2a f9 ff ff ba 2f 00 00 00}  //weight: 30, accuracy: High
        $x_20_2 = {c6 85 a1 fd ff ff 32 c6 85 a2 fd ff ff 2e c6 85 a3 fd ff ff 64 c6 85 a4 fd ff ff 6c c6 85 a5 fd ff ff 6c c6 85 a6 fd ff ff 00}  //weight: 20, accuracy: High
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
