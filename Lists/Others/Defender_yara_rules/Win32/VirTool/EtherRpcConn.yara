rule VirTool_Win32_EtherRpcConn_A_2147963485_0
{
    ...
    strings:
        ...
        $x_1_9 = {62 73 63 2e 62 6c 6f 63 6b 72 61 7a 6f 72 2e 78 79 7a 00}  //weight: 1, accuracy: High
        $x_1_10 = {62 73 63 2e 72 70 63 2e 62 6c 78 72 62 64 6e 2e 63 6f 6d 00}  //weight: 1, accuracy: High
    condition:
        (filesize < 20MB) and
        (
