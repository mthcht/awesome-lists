...
rule VirTool_Win32_SuspSystemDiscovery_A_2147958104_0
{
    meta:
        author = "defender2yara"
        detection_name = "VirTool:Win32/SuspSystemDiscovery.A"
        threat_id = "2147958104"
        type = "VirTool"
        platform = "Win32: Windows 32-bit platform"
        family = "SuspSystemDiscovery"
        severity = "Critical"
    ...
    strings:
        ...
        $x_10_2 = "win32_ComputerSystem" wide //weight: 10
        $x_1_3 = " /c ,powershell.exe " wide //weight: 1
        $x_1_4 = " /c ;powershell.exe " wide //weight: 1
        $x_1_5 = " /c =powershell.exe " wide //weight: 1
        $x_1_6 = " /c @powershell.exe " wide //weight: 1
    condition:
        (filesize < 20MB) and
        (
