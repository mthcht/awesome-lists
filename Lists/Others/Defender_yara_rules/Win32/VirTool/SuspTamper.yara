rule VirTool_Win32_SuspTamper_A_2147957415_0
{
    ...
    strings:
        ...
        $x_2_3 = "DefenderKiller" wide //weight: 2
        $x_1_4 = ".bat" wide //weight: 1
        $x_3_5 = {55 00 6e 00 6c 00 6f 00 63 00 6b 00 65 00 72 00 [0-16] 20 00 2f 00 44 00}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
...
rule VirTool_Win32_SuspTamper_A_2147957415_1
{
    meta:
        author = "defender2yara"
        detection_name = "VirTool:Win32/SuspTamper.A"
