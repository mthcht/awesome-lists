...
rule VirTool_Win32_SuspClickFix_M_2147954202_1
{
    ...
    strings:
        ...
        $x_1_2 = {66 00 69 00 6e 00 67 00 65 00 72 00 [0-8] 20 00 [0-48] 40 00 [0-64] 2e 00}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
...
rule VirTool_Win32_SuspClickFix_M_2147954202_2
{
    meta:
        ...
        strings_accuracy = "Low"
    strings:
        $x_2_1 = {5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 53 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 66 00 69 00 6e 00 67 00 65 00 72 00 2e 00 65 00 78 00 65 00 00 00}  //weight: 2, accuracy: High
        $x_1_2 = {66 00 69 00 6e 00 67 00 65 00 72 00 20 00 [0-32] 40 00 [0-64] 2e 00}  //weight: 1, accuracy: Low
        $x_1_3 = {66 00 69 00 6e 00 67 00 65 00 72 00 2e 00 65 00 78 00 65 00 20 00 [0-32] 40 00 [0-64] 2e 00}  //weight: 1, accuracy: Low
        $x_3_4 = "copy C:\\Windows\\system32\\finger.exe C:\\Users\\" wide //weight: 3
        $x_3_5 = {66 00 6f 00 72 00 20 00 [0-64] 20 00 69 00 6e 00 20 00 [0-32] 66 00 69 00 6e 00 67 00 65 00 72 00 [0-48] 40 00 [0-32] 2e 00 [0-32] 2e 00}  //weight: 3, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
...
rule VirTool_Win32_SuspClickFix_M3_2147962014_0
{
    ...
    strings:
        ...
        $x_1_3 = {63 00 6d 00 64 00 [0-8] 20 00 2f 00 ?? ?? 20 00 66 00 69 00 6e 00 67 00 65 00 72 00 [0-8] 20 00 [0-32] 40 00 [0-64] 2e 00 [0-32] 7c 00 [0-4] 43 00 3a 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 63 00 6d 00 64 00 2e 00 65 00 78 00 65 00}  //weight: 1, accuracy: Low
        $x_1_4 = {63 00 6d 00 64 00 [0-8] 20 00 2f 00 ?? ?? 20 00 66 00 69 00 6e 00 67 00 65 00 72 00 [0-8] 20 00 [0-32] 40 00 [0-64] 2e 00 [0-32] 7c 00 [0-4] 63 00 6d 00 64 00}  //weight: 1, accuracy: Low
        $x_1_5 = {20 00 26 00 20 00 66 00 69 00 6e 00 67 00 65 00 72 00 [0-8] 20 00 [0-32] 40 00 [0-64] 2e 00 [0-32] 7c 00 [0-4] 43 00 3a 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 63 00 6d 00 64 00 2e 00 65 00 78 00 65 00}  //weight: 1, accuracy: Low
        $x_1_6 = {20 00 26 00 20 00 66 00 69 00 6e 00 67 00 65 00 72 00 [0-8] 20 00 [0-32] 40 00 [0-64] 2e 00 [0-32] 7c 00 [0-4] 63 00 6d 00 64 00}  //weight: 1, accuracy: Low
        $x_1_7 = {20 00 63 00 6f 00 70 00 79 00 20 00 43 00 3a 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 66 00 69 00 6e 00 67 00 65 00 72 00 2e 00 65 00 78 00 65 00 20 00 43 00 3a 00 5c 00 55 00 73 00 65 00 72 00 73 00 5c 00 [0-240] 7c 00 [0-4] 43 00 3a 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 63 00 6d 00 64 00 2e 00 65 00 78 00 65 00}  //weight: 1, accuracy: Low
        $x_1_8 = {20 00 63 00 6f 00 70 00 79 00 20 00 43 00 3a 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 66 00 69 00 6e 00 67 00 65 00 72 00 2e 00 65 00 78 00 65 00 20 00 43 00 3a 00 5c 00 55 00 73 00 65 00 72 00 73 00 5c 00 [0-240] 7c 00 [0-4] 63 00 6d 00 64 00}  //weight: 1, accuracy: Low
    condition:
        (filesize < 20MB) and
        (
