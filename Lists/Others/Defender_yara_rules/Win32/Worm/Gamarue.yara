...
rule Worm_Win32_Gamarue_GXU_2147976029_0
{
    meta:
        author = "defender2yara"
        detection_name = "Worm:Win32/Gamarue.GXU!MTB"
        threat_id = "2147976029"
        type = "Worm"
        platform = "Win32: Windows 32-bit platform"
        family = "Gamarue"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_5_1 = "Lake Die Int" ascii //weight: 5
        $x_1_2 = "ssyewtsnptEo" ascii //weight: 1
        $x_1_3 = "Cysmn2ieyd8Tm" ascii //weight: 1
        $x_1_4 = "join Yea" ascii //weight: 1
        $x_1_5 = "Rangesure.pdb" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
