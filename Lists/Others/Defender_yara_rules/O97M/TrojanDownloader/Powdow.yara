...
rule TrojanDownloader_O97M_Powdow_RSA_2147949236_0
{
    meta:
        author = "defender2yara"
        detection_name = "TrojanDownloader:O97M/Powdow.RSA!MTB"
        threat_id = "2147949236"
        type = "TrojanDownloader"
        platform = "O97M: Office 97, 2000, XP, 2003, 2007, and 2010 macros - those that affect Word, Excel, and PowerPoint"
        family = "Powdow"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "=('ht'+'t'+'p'+'s:/'+'/ia402." ascii //weight: 1
        $x_1_2 = "= Chr(80) & \"lace('ET" ascii //weight: 1
        $x_1_3 = "us'+'.a'+'rc.i'+'o'+'/'+'tary.t'+'xt');$" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
