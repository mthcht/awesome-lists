...
rule TrojanDownloader_O97M_EncDoc_PABJ_2147977027_0
{
    meta:
        author = "defender2yara"
        detection_name = "TrojanDownloader:O97M/EncDoc.PABJ!MTB"
        threat_id = "2147977027"
        type = "TrojanDownloader"
        platform = "O97M: Office 97, 2000, XP, 2003, 2007, and 2010 macros - those that affect Word, Excel, and PowerPoint"
        family = "EncDoc"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_1_1 = "bworkbook_open()strcommand=\"powershellinvoke-webrequest-urihttps" ascii //weight: 1
        $x_1_2 = "shellexec=wshshell.exec(strcommand)stroutput=wshshellexec.stdout.readallmsgboxstroutpute" ascii //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
