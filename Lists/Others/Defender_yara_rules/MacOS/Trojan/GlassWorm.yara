...
rule Trojan_MacOS_GlassWorm_DA_2147967964_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MacOS/GlassWorm.DA!MTB"
        threat_id = "2147967964"
        type = "Trojan"
        platform = "MacOS: "
        family = "GlassWorm"
        severity = "Critical"
        ...
        strings_accuracy = "High"
    strings:
        $x_10_1 = "github.com/SquadMagistrate10/wnxtgkih/releases/download/claude/claude" ascii //weight: 10
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
