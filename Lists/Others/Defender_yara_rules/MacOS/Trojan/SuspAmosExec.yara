...
rule Trojan_MacOS_SuspAmosExec_F_2147953660_0
{
    meta:
        author = "defender2yara"
        detection_name = "Trojan:MacOS/SuspAmosExec.F"
        threat_id = "2147953660"
        type = "Trojan"
        platform = "MacOS: "
        family = "SuspAmosExec"
        severity = "Critical"
    ...
    strings:
        ...
        $x_3_2 = "mdls -name kMDItemFSSize -raw " wide //weight: 3
        $x_3_3 = "mkdir" wide //weight: 3
        $x_3_4 = {74 00 65 00 6c 00 6c 00 [0-32] 20 00 61 00 70 00 70 00 6c 00 69 00 63 00 61 00 74 00 69 00 6f 00 6e 00 [0-6] 54 00 65 00 72 00 6d 00 69 00 6e 00 61 00 6c 00}  //weight: 3, accuracy: Low
        $x_3_5 = {64 00 6f 00 20 00 73 00 68 00 65 00 6c 00 6c 00 20 00 73 00 63 00 72 00 69 00 70 00 74 00 [0-4] 63 00 61 00 74 00 20 00}  //weight: 3, accuracy: Low
        $x_1_6 = "reverse of every character" wide //weight: 1
        $x_1_7 = {6f 00 70 00 65 00 6e 00 20 00 66 00 6f 00 72 00 20 00 61 00 63 00 63 00 65 00 73 00 73 00 [0-32] 77 00 72 00 69 00 74 00 65 00}  //weight: 1, accuracy: Low
        $x_1_8 = {64 00 6f 00 20 00 73 00 68 00 65 00 6c 00 6c 00 20 00 73 00 63 00 72 00 69 00 70 00 74 00 [0-4] 66 00 69 00 6c 00 65 00 20 00}  //weight: 1, accuracy: Low
        $x_1_9 = "DS_Store" wide //weight: 1
        $x_1_10 = "market-history-cache.json" wide //weight: 1
    condition:
        (filesize < 20MB) and
        (all of ($x*))
}
